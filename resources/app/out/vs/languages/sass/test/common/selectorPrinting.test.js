 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/languages/sass/common/parser/sassParser', 'vs/languages/css/test/common/selectorPrinting.test'], function (require, exports, parser, selectorPrinterTest) {
    suite('Sass - selector printing', function () {
