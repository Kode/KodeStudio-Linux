 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/test/common/modesUtil', 'vs/languages/sass/common/sassTokenTypes', 'vs/languages/sass/common/sass.contribution'], function (require, exports, modesUtil, sassTokenTypes) {
    suite('Sass Colorizer', function () {
        var tokenizationSupport;
        var assertOnEnter;
        setup(function (done) {
            modesUtil.load('sass').then(function (mode) {
