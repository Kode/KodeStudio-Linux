 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/languages/sass/common/parser/sassParser', 'vs/languages/css/common/parser/cssNodes', 'vs/languages/css/test/common/symbols.test'], function (require, exports, parser, nodes, symbolsTest) {
    suite('Sass - Symbols', function () {
