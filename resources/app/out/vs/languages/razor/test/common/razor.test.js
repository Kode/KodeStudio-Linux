 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/test/common/modesUtil', 'vs/editor/common/modes', 'vs/languages/razor/common/razorTokenTypes', 'vs/languages/html/common/html', 'vs/languages/razor/common/razor.contribution'], function (require, exports, modesUtil, Modes, razorTokenTypes, html_1) {
    suite('Syntax Highlighting - Razor', function () {
        var tokenizationSupport;
        setup(function (done) {
            modesUtil.load('razor').then(function (mode) {
            ...
            modesUtil.executeTests(tokenizationSupport, [
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 14, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
