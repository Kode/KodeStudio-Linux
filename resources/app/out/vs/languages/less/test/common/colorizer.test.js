 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/common/modes', 'vs/editor/test/common/modesUtil', 'vs/languages/less/common/lessTokenTypes', 'vs/languages/css/common/css.contribution', 'vs/languages/javascript/common/javascript.contribution', 'vs/languages/less/common/less.contribution'], function (require, exports, Modes, modesUtil, lessTokenTypes) {
    suite('LESS-tokenization', function () {
        var tokenizationSupport;
        var assertOnEnter;
        setup(function (done) {
            modesUtil.load('less', ['javascript']).then(function (mode) {
