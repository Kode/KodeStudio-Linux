 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/css/common/parser/cssScanner', 'vs/languages/less/common/parser/lessScanner'], function (require, exports, assert, scanner, lessScanner) {
    function assertSingleToken(source, len, offset, text, type, ignoreWhitespace) {
