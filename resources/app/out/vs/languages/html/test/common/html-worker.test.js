 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/model/mirrorModel', 'vs/languages/html/common/htmlWorker', 'vs/base/common/uri', 'vs/editor/common/services/resourceServiceImpl', 'vs/platform/markers/common/markerService', 'vs/base/common/winjs.base', 'vs/editor/test/common/modesUtil', 'vs/editor/test/common/servicesTestUtils', 'vs/platform/test/common/nullThreadService'], function (require, exports, assert, mm, htmlWorker, uri_1, ResourceService, MarkerService, WinJS, modesUtil, servicesUtil2, nullThreadService_1) {
    suite('HTML - worker', function () {
        var mode;
        suiteSetup(function (done) {
            modesUtil.load('html').then(function (_mode) {
                mode = _mode;
                done();
            });
        });
        var mockHtmlWorkerEnv = function (url, content) {
            ...
            var markerService = new MarkerService.MarkerService(nullThreadService_1.NULL_THREAD_SERVICE);
