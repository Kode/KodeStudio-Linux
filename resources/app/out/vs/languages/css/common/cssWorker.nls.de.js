 ...
 *---------------------------------------------------------------------------------------------*/
define("vs/languages/css/common/cssWorker.nls.de", {
	...
	"vs/languages/css/common/parser/cssErrors": [
		"Zahl erwartet",
		"Bedingung erwartet",
		"at-Regel oder Selektor erwartet",
		"Punkt erwartet",
		...
		"Bezeichner erwartet",
		"Prozent erwartet",
		"URI oder Zeichenfolge erwartet",
		"URI erwartet",
		"Variablenname erwartet",
		"Variablenwert erwartet",
		"Eigenschaftswert erwartet",
		"{ erwartet.",
		"} erwartet.",
		"[ erwartet",
		"] erwartet",
		...
		") erwartet.",
		"Komma erwartet",
		"Seitenanweisung oder Deklaration erwartet",
		"unbekannte at-Regel",
		"unbekanntes Schlüsselwort",
		"Selektor erwartet",
		"Zeichenfolgenliteral erwartet",
	],
	"vs/languages/css/common/services/intelliSense": [
		"Erstellt eine Farbe aus den Werten für Rot, Grün und Blau.",
		"Erstellt eine Farbe aus den Werten für Rot, Grün, Blau und Alpha.",
		"Erstellt eine Farbe aus den Werten für Farbton, Sättigung und Helligkeit.",
		"Erstellt eine Farbe aus den Werten für Farbton, Sättigung, Helligkeit und Alpha.",
	],
	"vs/languages/css/common/services/lint": [
		"„{0}“",
		"{0}, „{1}“",
		"Standardregel \'@keyframes\' beim Definieren von Keyframes immer definieren",
		"Alle Anbieterspezifischen Regeln einschließen: {0} fehlt",
		"Standardeigenschaft „{0}“ für Kompatibilität definieren",
		"Alle Anbieterspezifischen Eigenschaften immer miteinschließen: {0} fehlt",
	],
