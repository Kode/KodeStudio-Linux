 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/languages/css/common/parser/cssNodes', 'vs/languages/css/common/services/browsers', 'vs/base/common/strings'], function (require, exports, nodes, browsers, strings) {
    exports.colors = {
        aliceblue: '#f0f8ff',
        antiquewhite: '#faebd7',
        aqua: '#00ffff',
