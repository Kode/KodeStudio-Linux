...
define("vs/languages/css/common/services/occurrences", ["require", "exports", 'vs/languages/css/common/parser/cssNodes', 'vs/languages/css/common/parser/cssSymbols'], function (require, exports, nodes, _symbols) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define("vs/languages/css/common/services/intelliSense", ["require", "exports", 'vs/languages/css/common/parser/cssNodes', 'vs/languages/css/common/parser/cssSymbols', 'vs/languages/css/common/services/languageFacts', 'vs/nls!vs/languages/css/common/services/intelliSense'], function (require, exports, nodes, cssSymbols, languageFacts, nls) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define("vs/languages/css/common/services/cssLanguageService", ["require", "exports", 'vs/base/common/winjs.base', 'vs/editor/common/services/resourceService'], function (require, exports, winjs, resourceService) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define("vs/languages/css/common/cssWorker", ["require", "exports", 'vs/nls!vs/languages/css/common/cssWorker', 'vs/base/common/severity', 'vs/base/common/strings', 'vs/base/common/winjs.base', 'vs/languages/css/common/services/cssLanguageService', 'vs/languages/css/common/services/languageFacts', './services/occurrences', 'vs/languages/css/common/services/intelliSense', 'vs/languages/css/common/parser/cssNodes', 'vs/languages/css/common/level', 'vs/languages/css/common/parser/cssParser', 'vs/languages/css/common/services/selectorPrinting', 'vs/languages/css/common/services/lint', 'vs/languages/css/common/services/lintRules', 'vs/platform/markers/common/markers', 'vs/editor/common/services/resourceService', 'vs/editor/common/modes/supports/suggestSupport', 'vs/editor/common/worker/validationHelper'], function (require, exports, nls, severity_1, strings, winjs, languageService, languageFacts, occurrences, cssIntellisense, nodes, _level, parser, selectorPrinting, lint, lintRules, markers_1, resourceService_1, suggestSupport_1, validationHelper_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    ...
    var CSSWorker = (function () {
        function CSSWorker(modeId, participants, resourceService, markerService) {
            var _this = this;
            this._modeId = modeId;
