 ...
 *---------------------------------------------------------------------------------------------*/
define("vs/languages/css/common/cssWorker.nls.ru", {
	...
	"vs/languages/css/common/parser/cssErrors": [
		"ожидается число",
		"ожидается условие",
		"ожидается at-правило или селектор",
		"ожидается точка",
		"ожидается двоеточие",
		...
		"ожидается процент",
		"ожидается универсальный код ресурса (URI) или строка",
		"ожидается универсальный код ресурса (URI)",
		"ожидается имя переменной",
		"ожидается значение переменной",
		"ожидается значение свойства",
		"ожидается \"{\"",
		"ожидается \"}\"",
		"ожидается \"[\"",
		"ожидается \"]\"",
		...
		"ожидается \")\"",
		"ожидается запятая",
		"ожидается директива или объявление страницы",
		"неизвестное at-правило",
		"неизвестное ключевое слово",
		"ожидается селектор",
		"ожидается строковый литерал",
	],
	"vs/languages/css/common/services/intelliSense": [
		"Создает цвет на основании значений красного, зеленого и синего цветов.",
		"Создает цвет на основании значений красного, зеленого, синего цветов и альфа-фактора.",
		"Создает цвет на основании значений оттенка, насыщенности и освещенности.",
		"Создает цвет на основании значений оттенка, насыщенности, освещенности и альфа-фактора.",
	],
	"vs/languages/css/common/services/lint": [
		"\"{0}\"",
		"{0}, \"{1}\"",
		"Всегда определяйте стандартное правило \"@keyframes\" при определении ключевых кадров.",
		"Всегда включайте все зависящие от поставщиков правила. Отсутствует: {0}",
		"Также для совместимости определяйте стандартное свойство \"{0}\"",
		"Всегда включайте все зависящие от поставщиков свойства. Отсутствует: {0}",
	],
