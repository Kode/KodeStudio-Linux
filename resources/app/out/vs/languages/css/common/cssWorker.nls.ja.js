 ...
 *---------------------------------------------------------------------------------------------*/
define("vs/languages/css/common/cssWorker.nls.ja", {
	...
	"vs/languages/css/common/services/intelliSense": [
		"赤、緑、青の値を指定して色を作成します。",
		"赤、緑、青の値とアルファ値を指定して色を作成します。",
		"色合い、鮮やかさ、明るさを指定して色を作成します。",
		"色合い、鮮やかさ、明るさ、アルファ値を指定して色を作成します。",
	],
	"vs/languages/css/common/services/lint": [
		"\'{0}\'",
		"{0}、\'{1}\'",
		"キーフレームを定義する場合は常に標準の規則 \'@keyframes\' を定義します。",
		"常にベンダー固有の規則をすべて含めます: 不足: {0}",
		"互換性のために標準のプロパティ \'{0}\' も定義します",
		"常にベンダー固有のプロパティをすべて含めます: 不足: {0}",
	],
