 ...
 *---------------------------------------------------------------------------------------------*/
define("vs/languages/css/common/cssWorker.nls.ko", {
	...
	"vs/languages/css/common/services/intelliSense": [
		"빨강, 녹색 및 파랑 값으로 색을 만듭니다.",
		"빨강, 녹색, 파랑 및 알파 값으로 색을 만듭니다.",
		"색상,채도 및 명도 값으로 색을 만듭니다.",
		"색상, 채도, 명도 및 알파 값으로 색을 만듭니다.",
	],
	"vs/languages/css/common/services/lint": [
		"\'{0}\'",
		"{0}, \'{1}\'",
		"키 프레임을 정의할 때 표준 규칙 \'@keyframes\'를 항상 정의합니다.",
		"모든 공급업체 관련 규칙을 항상 포함해야 하는데 {0}이(가) 없습니다.",
		"호환성을 위해 표준 속성 \'{0}\'도 정의합니다.",
		"모든 공급업체 관련 속성을 항상 포함해야 하는데 {0}이(가) 없습니다.",
	],
