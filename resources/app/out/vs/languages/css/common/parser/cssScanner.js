...
define(["require", "exports"], function (require, exports) {
    ...
    var Scanner = (function () {
        ...
        Scanner.prototype.finishToken = function (token, type, text) {
        ...
        Scanner.prototype.scan = function (ignoreWhitespace) {
            ...
            if (this._number()) {
                ...
                if (this.stream.advanceIfChar(_PRC)) {
                    ...
                    var tokenType = staticUnitTable[dim];
        ...
        Scanner.prototype._comment = function () {
