 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/css/common/parser/cssParser', 'vs/languages/css/common/services/lint', 'vs/languages/css/common/services/lintRules', 'vs/languages/css/common/level', './css-worker.test'], function (require, exports, assert, parser, lint, lintRules, _level, workerTests) {
    function assertEntries(node, rules) {
        ...
        for (var i = 0; i < entries.length; i++) {
            var entry = entries[i], idx = rules.indexOf(entry.getRule());
            rules.splice(idx, 1);
        }
