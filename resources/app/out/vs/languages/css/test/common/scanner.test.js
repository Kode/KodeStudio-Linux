 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/css/common/parser/cssScanner'], function (require, exports, assert, Scanner) {
    suite('CSS - Scanner', function () {
        function assertSingleToken(scan, source, len, offset, text, type, ignoreWhitespace) {
