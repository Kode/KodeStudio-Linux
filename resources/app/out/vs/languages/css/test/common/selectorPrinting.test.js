 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/css/common/parser/cssParser', 'vs/languages/css/common/parser/cssNodes', 'vs/base/common/objects', 'vs/languages/css/common/services/selectorPrinting', './css-worker.test'], function (require, exports, assert, parser, nodes, objects, selectorPrinter, workerTests) {
    ...
    function assertElement(p, input, element) {
