 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/css/common/parser/cssParser', 'vs/languages/css/common/parser/cssScanner', 'vs/languages/css/common/parser/cssNodes', 'vs/languages/css/common/parser/cssErrors'], function (require, exports, assert, _parser, scanner, nodes, errors) {
    function assertNode(text, parser, f) {
    ...
    function assertNoNode(text, parser, f) {
        var node = parser.internalParse(text, f);
        assert.ok(node === null);
    }
    exports.assertNoNode = assertNoNode;
    function assertError(text, parser, f, error) {
        var node = parser.internalParse(text, f);
        assert.ok(node !== null, 'no node returned');
        var markers = nodes.ParseErrorCollector.entries(node);
        if (markers.length === 0) {
