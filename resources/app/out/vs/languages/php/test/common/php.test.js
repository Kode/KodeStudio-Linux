 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/common/modes', 'vs/editor/test/common/modesUtil', 'vs/languages/html/common/html', 'vs/languages/css/common/css', 'vs/languages/php/common/php.contribution', 'vs/languages/html/common/html.contribution', 'vs/languages/javascript/common/javascript.contribution', 'vs/languages/css/common/css.contribution'], function (require, exports, Modes, modesUtil, html_1, css_1) {
    suite('Syntax Highlighting - PHP', function () {
        var wordDefinition;
        var assertWords = modesUtil.assertWords;
        var tokenizationSupport;
        var assertOnEnter;
        setup(function (done) {
            modesUtil.load('php').then(function (mode) {
            ...
            modesUtil.executeTests(tokenizationSupport, [
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 7, type: 'number.php' },
                            { startIndex: 8, type: 'metatag.php' },
                            { startIndex: 10, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 11, type: html_1.htmlTokenTypes.getTag('abc') },
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 1, type: html_1.htmlTokenTypes.getTag('abc') },
                            ...
                            { startIndex: 13, type: 'metatag.php' },
                            { startIndex: 15, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 16, type: html_1.htmlTokenTypes.getTag('abc') },
                            { startIndex: 19, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close }
                        ] }],
                // html/js/php/html
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 1, type: html_1.htmlTokenTypes.getTag('abc') },
                            { startIndex: 4, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            { startIndex: 5, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 6, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 12, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            ...
                            { startIndex: 23, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
                            { startIndex: 25, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 31, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Close },
                            { startIndex: 32, type: 'metatag.php' },
                            ...
                            { startIndex: 43, type: html_1.htmlTokenTypes.getTag('abc') },
                            { startIndex: 46, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close }
                        ] }],
                // html/js/php/js/
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 49, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            ...
                            { startIndex: 60, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
                            { startIndex: 62, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 68, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Close }
                        ] }],
                // Multiline test
                [{
                        line: '<html>',
                        tokens: [
                            { startIndex: 0, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 1, type: html_1.htmlTokenTypes.getTag('html') },
                            { startIndex: 5, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close }
                        ] }, {
                        line: '<style><?="div"?>{ color:blue; }</style>',
                        tokens: [
                            { startIndex: 0, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 1, type: html_1.htmlTokenTypes.getTag('style') },
                            { startIndex: 6, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            { startIndex: 7, type: 'metatag.php' },
                            { startIndex: 10, type: 'string.php' },
                            { startIndex: 15, type: 'metatag.php' },
                            { startIndex: 17, type: 'punctuation.bracket.css' },
                            { startIndex: 18, type: '' },
                            { startIndex: 19, type: css_1.cssTokenTypes.TOKEN_PROPERTY + '.css' },
                            ...
                            { startIndex: 32, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
                            { startIndex: 34, type: html_1.htmlTokenTypes.getTag('style') },
                            { startIndex: 39, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Close }
                        ] }, {
                        line: '<style><?="div"?>{ color:blue; }</style>',
                        tokens: [
                            { startIndex: 0, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                ...
                [{
                        ...
                        tokens: [
                            ...
                            { startIndex: 1, type: html_1.htmlTokenTypes.getTag('html') },
                            { startIndex: 5, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            { startIndex: 6, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 7, type: html_1.htmlTokenTypes.getTag('style') },
                            { startIndex: 12, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            { startIndex: 13, type: 'metatag.php' },
                            { startIndex: 16, type: 'string.php' },
                            ...
                            { startIndex: 25, type: '' },
                            { startIndex: 26, type: css_1.cssTokenTypes.TOKEN_PROPERTY + '.css' },
                            { startIndex: 31, type: 'punctuation.css' },
                            { startIndex: 32, type: css_1.cssTokenTypes.TOKEN_VALUE + '.css' },
                            { startIndex: 36, type: 'punctuation.css' },
                            { startIndex: 37, type: '' },
                            { startIndex: 38, type: 'punctuation.bracket.css' },
                            { startIndex: 39, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
                            { startIndex: 41, type: html_1.htmlTokenTypes.getTag('style') },
                            { startIndex: 46, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Close },
                            { startIndex: 47, type: html_1.htmlTokenTypes.DELIM_COMMENT, bracket: Modes.Bracket.Open },
                            { startIndex: 51, type: 'metatag.php' },
                            { startIndex: 54, type: 'string.php' },
                            { startIndex: 68, type: 'metatag.php' },
                            { startIndex: 70, type: html_1.htmlTokenTypes.DELIM_COMMENT, bracket: Modes.Bracket.Close },
                            { startIndex: 73, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Open },
                            { startIndex: 74, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 80, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
                            ...
                            { startIndex: 137, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
                            { startIndex: 139, type: html_1.htmlTokenTypes.getTag('script') },
                            { startIndex: 145, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Close },
                            { startIndex: 146, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Open },
                            { startIndex: 148, type: html_1.htmlTokenTypes.getTag('html') },
                            { startIndex: 152, type: html_1.htmlTokenTypes.DELIM_END, bracket: Modes.Bracket.Close },
                ...
                [{
                        line: '<!--c--><?',
                        tokens: [
                            { startIndex: 0, type: html_1.htmlTokenTypes.DELIM_COMMENT, bracket: Modes.Bracket.Open },
                            { startIndex: 4, type: html_1.htmlTokenTypes.COMMENT },
                            { startIndex: 5, type: html_1.htmlTokenTypes.DELIM_COMMENT, bracket: Modes.Bracket.Close },
                            { startIndex: 8, type: 'metatag.php' }
                        ] }],
                [{
                        line: '<script>//<?',
                        tokens: [
                            ...
                            { startIndex: 7, type: html_1.htmlTokenTypes.DELIM_START, bracket: Modes.Bracket.Close },
...
//# sourceMappingURL=php.test.js.map