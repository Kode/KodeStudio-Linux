 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/json/common/jsonWorker', 'vs/editor/common/services/resourceServiceImpl', 'vs/platform/instantiation/common/instantiationService', 'vs/editor/common/model/mirrorModel', 'vs/base/common/uri', 'vs/base/common/winjs.base', 'vs/editor/test/common/modesTestUtils'], function (require, exports, assert, jsonworker, resourceService, instantiationService, mirrorModel, uri_1, WinJS, modesUtil) {
