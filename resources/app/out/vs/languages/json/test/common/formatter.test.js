 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/common/editorCommon', 'vs/editor/common/core/range', 'vs/editor/common/model/model', 'vs/editor/test/common/modesTestUtils', 'vs/languages/json/common/features/jsonFormatter', 'vs/editor/common/model/mirrorModel', 'assert'], function (require, exports, EditorCommon, range_1, model_1, ModesTestUtils, Formatter, MirrorModel, assert) {
    suite('JSON - formatter', function () {
        function format(unformatted, expected, insertSpaces) {
            ...
            var model = new model_1.Model(unformatted, mockMode);
