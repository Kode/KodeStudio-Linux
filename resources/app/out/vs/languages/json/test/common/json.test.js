 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/common/modes', 'vs/editor/test/common/modesUtil', 'vs/languages/json/common/features/jsonTokenTypes', 'vs/languages/json/common/json.contribution'], function (require, exports, Modes, modesUtil, jsonTokenTypes) {
    suite('JSON - tokenization', function () {
        var tokenizationSupport;
        var assertOnEnter;
        setup(function (done) {
            modesUtil.load('json').then(function (mode) {
