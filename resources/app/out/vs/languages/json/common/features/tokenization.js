 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/base/common/json', 'vs/editor/common/modes', 'vs/languages/json/common/features/jsonTokenTypes'], function (require, exports, json, Modes, jsonTokenTypes) {
    ...
    function tokenize(mode, comments, line, state, offsetDelta, stopAtOffset) {
        ...
        while (true) {
            var offset = offsetDelta + scanner.getPosition(), bracket = Modes.Bracket.None, type = '';
            kind = scanner.scan();
