 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/nls', 'vs/platform/configuration/common/configurationRegistry', 'vs/platform/platform', 'vs/editor/common/modes/modesRegistry'], function (require, exports, nls, ConfigurationRegistry, Platform, modesExtensions) {
