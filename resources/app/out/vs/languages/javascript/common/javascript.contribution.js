 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/nls', 'vs/base/common/flags', 'vs/platform/platform', 'vs/platform/configuration/common/configurationRegistry', 'vs/editor/common/modes/languageExtensionPoint', 'vs/languages/typescript/common/options'], function (require, exports, nls, env, platform, ConfigurationRegistry, languageExtensionPoint_1, Options) {
    var defaults = Options.javaScriptOptions;
    if (!env.enableTypeScriptServiceModeForJS) {
        languageExtensionPoint_1.LanguageExtensions.registerCompatMode({
            id: 'javascript',
            extensions: ['.js', '.es6'],
            firstLine: '^#!.*\\bnode',
            filenames: ['jakefile'],
