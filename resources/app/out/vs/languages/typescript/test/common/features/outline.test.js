 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/base/common/uri', 'vs/languages/typescript/common/features/outline', 'vs/languages/typescript/common/lib/typescriptServices', 'vs/languages/typescript/test/common/features/utils'], function (require, exports, assert, uri_1, outline, ts, utils) {
    suite('TS - outline', function () {
        function assertOutline(code, callback) {
            var host = new utils.LanguageServiceHost().add('a', code);
            var elements = outline.compute(ts.createLanguageService(host, ts.createDocumentRegistry()), uri_1.default.parse('a'));
            try {
                callback(elements);
            }
            catch (e) {
