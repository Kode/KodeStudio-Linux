 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/typescript/common/js/rewriting', 'vs/languages/typescript/common/js/importAndExportRewriter', 'vs/languages/typescript/common/js/globalVariableRewriter', 'vs/languages/typescript/common/js/requireRewriter', 'vs/languages/typescript/common/js/defineRewriter'], function (require, exports, assert, javaScriptRewriter, importAndExportRewriter, globalVariableRewriter, RequireRewriter, DefineRewriter) {
    suite('JS* - JavaScript Rewriter', function () {
        function assertTranslation(before, expected) {
...
//# sourceMappingURL=javaScriptRewriter.test.js.map