 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/typescript/common/js/rewriting', 'vs/languages/typescript/common/js/requireRewriter'], function (require, exports, assert, rewriting, RequireRewriter) {
    suite('JS* - Require Rewriter', function () {
...
//# sourceMappingURL=requireRewriter.test.js.map