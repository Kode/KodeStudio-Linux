 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/languages/typescript/common/js/textEdits'], function (require, exports, assert, textEdits) {
    suite('JS* - TextEdits', function () {
        function assertApply(edits, value, expected) {
        ...
        test('TextSpan - before, after, equal, contains, overlaps', function () {
        ...
        test('Edit - length & delta length', function () {
        ...
        test('Edit - apply & undo (small)', function () {
            var value = 'HalliHallo', edits = [new textEdits.Edit(7, 2, ''), new textEdits.Edit(2, 3, 'a')];
            var result = textEdits.apply(edits, value), undoResult = textEdits.apply(result.undoEdits, result.value);
...
//# sourceMappingURL=textEdits.test.js.map