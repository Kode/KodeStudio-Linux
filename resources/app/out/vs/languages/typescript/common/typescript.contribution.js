 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/nls', 'vs/base/common/flags', 'vs/platform/platform', 'vs/editor/common/modes/modesRegistry', 'vs/platform/configuration/common/configurationRegistry', 'vs/languages/typescript/common/options', 'vs/css!./typescript'], function (require, exports, nls, env, platform, modesExtensions, ConfigurationRegistry, options) {
    var defaults = options.typeScriptOptions;
