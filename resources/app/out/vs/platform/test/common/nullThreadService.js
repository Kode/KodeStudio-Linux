...
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/platform/thread/common/abstractThreadService', 'vs/platform/instantiation/common/instantiationService', 'vs/platform/thread/common/thread'], function (require, exports, winjs, abstractThreadService, instantiationService, thread_1) {
    var NullThreadService = (function (_super) {
        ...
        NullThreadService.prototype.MainThread = function (obj, methodName, target, params) {
        ...
        NullThreadService.prototype.Everywhere = function (obj, methodName, target, params) {
            return target.apply(obj, params);
        };
        NullThreadService.prototype.ensureWorkers = function () {
            // Nothing to do
        };
        ...
        NullThreadService.prototype._registerAndInstantiatePluginHostActor = function (id, descriptor) {
            return this._getOrCreateLocalInstance(id, descriptor);
        };
        NullThreadService.prototype._registerPluginHostActor = function (id, actor) {
