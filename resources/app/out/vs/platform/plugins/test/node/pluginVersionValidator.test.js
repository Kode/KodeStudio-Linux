 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/platform/plugins/node/pluginVersionValidator'], function (require, exports, assert, pluginVersionValidator_1) {
    suite('Plugin Version Validator', function () {
        test('isValidVersionStr', function () {
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.0-dev'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.0'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.1'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.100'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.11.0'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('x.x.x'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.x.x'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.0'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.x'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('^0.10.0'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('*'), true);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.x.x.x'), false);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10'), false);
            assert.equal(pluginVersionValidator_1.isValidVersionStr('0.10.'), false);
        });
        test('parseVersion', function () {
            function assertParseVersion(version, hasCaret, majorBase, majorMustEqual, minorBase, minorMustEqual, patchBase, patchMustEqual, preRelease) {
                var actual = pluginVersionValidator_1.parseVersion(version);
                var expected = {
                    hasCaret: hasCaret,
                    majorBase: majorBase,
        ...
        test('normalizeVersion', function () {
            function assertNormalizeVersion(version, majorBase, majorMustEqual, minorBase, minorMustEqual, patchBase, patchMustEqual) {
                var actual = pluginVersionValidator_1.normalizeVersion(pluginVersionValidator_1.parseVersion(version));
                var expected = {
                    majorBase: majorBase,
                    majorMustEqual: majorMustEqual,
                    minorBase: minorBase,
        ...
        test('isValidVersion', function () {
            function testIsValidVersion(version, desiredVersion, expectedResult) {
                var actual = pluginVersionValidator_1.isValidVersion(version, desiredVersion);
        ...
        test('isValidExtensionVersion', function () {
            function testExtensionVersion(version, desiredVersion, isBuiltin, hasMain, expectedResult) {
                ...
                var reasons = [];
                var actual = pluginVersionValidator_1.isValidExtensionVersion(version, desc, reasons);
...
//# sourceMappingURL=pluginVersionValidator.test.js.map