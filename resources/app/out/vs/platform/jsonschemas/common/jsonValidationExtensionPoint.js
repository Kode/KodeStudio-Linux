...
define(["require", "exports", 'vs/nls', 'vs/platform/plugins/common/pluginsRegistry', 'vs/platform/platform', 'vs/base/common/uri', 'vs/platform/jsonschemas/common/jsonContributionRegistry', 'vs/base/common/strings', 'vs/base/common/paths', 'vs/platform/instantiation/common/instantiation'], function (require, exports, nls, pluginsRegistry_1, platform_1, uri_1, JSONContributionRegistry, strings, paths, instantiation_1) {
    var schemaRegistry = platform_1.Registry.as(JSONContributionRegistry.Extensions.JSONContribution);
    var configurationExtPoint = pluginsRegistry_1.PluginsRegistry.registerExtensionPoint('jsonValidation', {
    ...
    var JSONValidationExtensionPoint = (function () {
        function JSONValidationExtensionPoint(modeService) {
