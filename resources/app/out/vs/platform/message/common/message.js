...
define(["require", "exports", 'vs/nls', 'vs/base/common/winjs.base', 'vs/base/common/severity', 'vs/platform/instantiation/common/instantiation', 'vs/base/common/actions'], function (require, exports, nls, winjs_base_1, severity_1, instantiation_1, actions_1) {
    exports.CloseAction = new actions_1.Action('close.message', nls.localize('close', "Close"), null, true, function () { return winjs_base_1.Promise.as(true); });
    exports.CancelAction = new actions_1.Action('close.message', nls.localize('cancel', "Cancel"), null, true, function () { return winjs_base_1.Promise.as(true); });
