...
define(["require", "exports", 'vs/nls', 'vs/base/common/eventEmitter', 'vs/editor/common/core/range', 'vs/editor/common/core/selection', 'vs/editor/common/core/position', 'vs/editor/common/commands/replaceCommand', 'vs/editor/common/controller/oneCursor', 'vs/editor/common/controller/handlerDispatcher', 'vs/editor/common/controller/cursorCollection', 'vs/editor/common/editorCommon', 'vs/base/common/errors', 'vs/base/common/lifecycle'], function (require, exports, nls, eventEmitter_1, range_1, selection_1, position_1, replaceCommand_1, oneCursor_1, handlerDispatcher_1, cursorCollection_1, EditorCommon, Errors, lifecycle_1) {
    var RevealTarget;
    ...
    var Cursor = (function (_super) {
        ...
        Cursor.prototype.dispose = function () {
            this.modelUnbinds = lifecycle_1.disposeAll(this.modelUnbinds);
            this.model = null;
        ...
        Cursor.prototype._registerHandlers = function () {
            ...
            handlersMap[H.CursorWordLeft] = function (ctx) { return _this._moveWordLeft(false, ctx); };
            handlersMap[H.CursorWordLeftSelect] = function (ctx) { return _this._moveWordLeft(true, ctx); };
            ...
            handlersMap[H.CursorWordRight] = function (ctx) { return _this._moveWordRight(false, ctx); };
            handlersMap[H.CursorWordRightSelect] = function (ctx) { return _this._moveWordRight(true, ctx); };
            ...
            handlersMap[H.DeleteWordLeft] = function (ctx) { return _this._deleteWordLeft(ctx); };
            handlersMap[H.DeleteRight] = function (ctx) { return _this._deleteRight(ctx); };
            handlersMap[H.DeleteWordRight] = function (ctx) { return _this._deleteWordRight(ctx); };
        ...
        Cursor.prototype._moveWordLeft = function (inSelectionMode, ctx) {
            return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.moveWordLeft(oneCursor, inSelectionMode, oneCtx); });
        };
        ...
        Cursor.prototype._moveWordRight = function (inSelectionMode, ctx) {
            return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.moveWordRight(oneCursor, inSelectionMode, oneCtx); });
        };
        ...
        Cursor.prototype._word = function (inSelectionMode, ctx) {
            this.cursors.killSecondaryCursors();
            return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.word(oneCursor, inSelectionMode, ctx.eventData.position, ctx.eventData.preference || 'none', oneCtx); });
        };
        Cursor.prototype._lastCursorWord = function (ctx) {
            ...
            this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) {
                if (oneCursor === lastAddedCursor) {
                    return oneCursor_1.OneCursorOp.word(oneCursor, true, ctx.eventData.position, ctx.eventData.preference || 'none', oneCtx);
                }
                return false;
            });
            ctx.shouldReveal = false;
        ...
        Cursor.prototype._replacePreviousChar = function (ctx) {
            var text = ctx.eventData.text;
            return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.replacePreviousChar(oneCursor, text, oneCtx); });
        };
        ...
        Cursor.prototype._paste = function (ctx) {
            ...
            if (distributedPaste) {
                return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.paste(oneCursor, distributedPaste[cursorIndex], false, oneCtx); });
            }
            else {
        ...
        Cursor.prototype._deleteWordLeft = function (ctx) {
            return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.deleteWordLeft(oneCursor, oneCtx); }, false, false);
        };
        ...
        Cursor.prototype._deleteWordRight = function (ctx) {
            return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.deleteWordRight(oneCursor, oneCtx); }, false, false);
        };
