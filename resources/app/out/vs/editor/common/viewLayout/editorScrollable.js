...
define(["require", "exports", 'vs/base/common/eventEmitter'], function (require, exports, eventEmitter_1) {
    var EditorScrollable = (function (_super) {
        ...
        EditorScrollable.prototype._emitInternalSizeEvent = function () {
            this.emit(EditorScrollable._INTERNAL_SIZE_CHANGED_EVENT);
        };
        EditorScrollable.prototype.addInternalSizeChangeListener = function (listener) {
            return this.addListener2(EditorScrollable._INTERNAL_SIZE_CHANGED_EVENT, listener);
        };
        // ------------ events
        EditorScrollable._SCROLL_EVENT = 'scroll';
        EditorScrollable._INTERNAL_SIZE_CHANGED_EVENT = 'internalSizeChanged';
