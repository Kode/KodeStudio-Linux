 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/common/services/resourceService', 'vs/base/common/async', 'vs/base/common/lifecycle'], function (require, exports, resourceService_1, async_1, lifecycle_1) {
    ...
    var ValidationHelper = (function () {
        function ValidationHelper(resourceService, callback, filter, validationDelay) {
            var _this = this;
            if (validationDelay === void 0) { validationDelay = 500; }
            this._toDispose = [];
