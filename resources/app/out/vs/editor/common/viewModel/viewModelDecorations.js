...
define(["require", "exports", 'vs/editor/common/core/range', 'vs/editor/common/editorCommon'], function (require, exports, range_1, EditorCommon) {
    ...
    var ViewModelDecorations = (function () {
        ...
        ViewModelDecorations.prototype.getDecorationsResolver = function (startLineNumber, endLineNumber) {
        ...
        ViewModelDecorations.prototype._createDecorationsResolver = function (startLineNumber, endLineNumber) {
            ...
            return {
                ...
                getInlineDecorations: function (lineNumber) {
