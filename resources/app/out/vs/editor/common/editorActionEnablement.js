...
define(["require", "exports", 'vs/editor/common/editorCommon', 'vs/base/common/lifecycle'], function (require, exports, EditorCommon, lifecycle_1) {
    (function (Behaviour) {
    ...
    var InternalEnablementState = (function (_super) {
        ...
        function InternalEnablementState(_behaviour, editor) {
            ...
            if (this._behaviour & Behaviour.TextFocus) {
                this._callOnDispose.push(this.editor.addListener2(EditorCommon.EventType.EditorTextFocus, function () { return _this._updateTextFocus(true); }));
                this._callOnDispose.push(this.editor.addListener2(EditorCommon.EventType.EditorTextBlur, function () { return _this._updateTextFocus(false); }));
            }
            if (this._behaviour & Behaviour.WidgetFocus) {
                this._callOnDispose.push(this.editor.addListener2(EditorCommon.EventType.EditorFocus, function () { return _this._updateWidgetFocus(true); }));
                this._callOnDispose.push(this.editor.addListener2(EditorCommon.EventType.EditorBlur, function () { return _this._updateWidgetFocus(false); }));
            }
            if (this._behaviour & Behaviour.Writeable) {
                this._callOnDispose.push(this.editor.addListener2(EditorCommon.EventType.ConfigurationChanged, function (e) { return _this._update(); }));
            }
        }
        ...
        InternalEnablementState.prototype.dispose = function () {
            ...
            lifecycle_1.disposeAll(this._callOnDispose);
        };
    ...
    var DescentEnablementState = (function (_super) {
        ...
        function DescentEnablementState(behaviour, editor, _action) {
            ...
            if (behaviour & Behaviour.UpdateOnModelChange) {
                this._callOnDispose.push(this.editor.addListener(EditorCommon.EventType.ModelChanged, function () { return _this.reset(); }));
                this._callOnDispose.push(this.editor.addListener(EditorCommon.EventType.ModelModeChanged, function () { return _this.reset(); }));
                this._callOnDispose.push(this.editor.addListener(EditorCommon.EventType.ModelModeSupportChanged, function () { return _this.reset(); }));
            }
            if (behaviour & Behaviour.UpdateOnCursorPositionChange) {
                this._callOnDispose.push(this.editor.addListener(EditorCommon.EventType.CursorPositionChanged, function () { return _this.reset(); }));
            }
        }
