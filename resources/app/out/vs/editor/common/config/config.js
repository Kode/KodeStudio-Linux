 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/platform/keybinding/common/keybindingsRegistry', 'vs/platform/keybinding/common/keybindingService', 'vs/platform/editor/common/editor', 'vs/editor/common/services/codeEditorService', 'vs/editor/common/editorCommon', 'vs/base/common/keyCodes'], function (require, exports, keybindingsRegistry_1, keybindingService_1, editor_1, codeEditorService_1, EditorCommon, keyCodes_1) {
