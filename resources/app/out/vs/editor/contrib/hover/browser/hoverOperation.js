 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/base/common/async', 'vs/base/common/errors'], function (require, exports, Schedulers, Errors) {
    ...
    var HoverOperation = (function () {
        function HoverOperation(computer, success, error, progress) {
            ...
            this._firstWaitScheduler = new Schedulers.RunOnceScheduler(function () { return _this._triggerAsyncComputation(); }, this._getHoverTimeMillis() / 2);
            this._secondWaitScheduler = new Schedulers.RunOnceScheduler(function () { return _this._triggerSyncComputation(); }, this._getHoverTimeMillis() / 2);
            this._loadingMessageScheduler = new Schedulers.RunOnceScheduler(function () { return _this._showLoadingMessage(); }, 3 * this._getHoverTimeMillis());
        ...
        HoverOperation.prototype._triggerAsyncComputation = function () {
            ...
            if (this._computer.computeAsync) {
                ...
                }).done(null, function () { return _this._onError; });
            }
            else {
