...
define(["require", "exports", 'vs/nls', 'vs/base/common/winjs.base', './hoverOperation', './hoverWidgets', 'vs/base/browser/htmlContentRenderer', 'vs/editor/common/modes/textToHtmlTokenizer', 'vs/editor/common/core/range', '../common/hover', 'vs/css!vs/base/browser/ui/progressbar/progressbar'], function (require, exports, nls, winjs_base_1, HoverOperation, HoverWidget, htmlContentRenderer_1, textToHtmlTokenizer_1, range_1, hover_1) {
    var ModesContentComputer = (function () {
        ...
        ModesContentComputer.prototype.computeAsync = function () {
            ...
            if (!hover_1.ExtraInfoRegistry.has(model)) {
    ...
    var ModesContentHoverWidget = (function (_super) {
        ...
        function ModesContentHoverWidget(editor) {
            var _this = this;
            _super.call(this, ModesContentHoverWidget.ID, editor);
            this._computer = new ModesContentComputer(this._editor);
            this._highlightDecorations = [];
            this._isChangingDecorations = false;
            this._hoverOperation = new HoverOperation.HoverOperation(this._computer, function (result) { return _this._withResult(result, true); }, null, function (result) { return _this._withResult(result, false); });
        }
        ...
        ModesContentHoverWidget.prototype.startShowingAt = function (range) {
            if (this._lastRange) {
            ...
            messages.forEach(function (msg) {
                ...
                if (msg.htmlContent && msg.htmlContent.length > 0) {
                    msg.htmlContent.forEach(function (content) {
                        container.appendChild(htmlContentRenderer_1.renderHtml(content, undefined, function (modeId, value) {
                            var mode;
                            var model = _this._editor.getModel();
                            if (!model.isDisposed()) {
                                mode = model.getMode();
                            }
                            return textToHtmlTokenizer_1.tokenizeToHtmlContent(value, model.getMode());
                        }));
                    });
                }
                else {
    ...
    })(HoverWidget.ContentHoverWidget);
