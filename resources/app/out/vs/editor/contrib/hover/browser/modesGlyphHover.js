...
define(["require", "exports", './hoverOperation', './hoverWidgets'], function (require, exports, HoverOperation, HoverWidget) {
    ...
    var ModesGlyphHoverWidget = (function (_super) {
        ...
        function ModesGlyphHoverWidget(editor) {
            ...
            this._hoverOperation = new HoverOperation.HoverOperation(this._computer, function (result) { return _this._withResult(result); }, null, function (result) { return _this._withResult(result); });
        }
