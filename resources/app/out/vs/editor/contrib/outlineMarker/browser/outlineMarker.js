...
define(["require", "exports", 'vs/base/common/lifecycle', 'vs/base/common/async', 'vs/base/common/errors', 'vs/editor/common/editorCommon', 'vs/editor/browser/editorBrowserExtensions', 'vs/editor/common/core/range', 'vs/platform/instantiation/common/instantiation', 'vs/css!./outlineMarker'], function (require, exports, lifecycle, schedulers, errors, EditorCommon, editorBrowserExtensions_1, range_1, instantiation_1) {
    ...
    var OutlineMarkerContribution = (function () {
        function OutlineMarkerContribution(editor, ns) {
            var _this = this;
            this._editor = editor;
        ...
        OutlineMarkerContribution = __decorate([
