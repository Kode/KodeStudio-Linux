...
define(["require", "exports", 'vs/base/common/collections', 'vs/base/common/strings', 'vs/editor/common/editorCommon', 'vs/editor/common/editorCommonExtensions', 'vs/editor/common/core/range', 'vs/editor/common/core/selection', 'vs/platform/keybinding/common/keybindingService', 'vs/base/common/keyCodes', 'vs/editor/common/core/editOperation'], function (require, exports, Collections, Strings, EditorCommon, editorCommonExtensions_1, range_1, selection_1, keybindingService_1, keyCodes_1, editOperation_1) {
    ...
    var SnippetController = (function () {
        ...
        SnippetController._getAdaptedSnippet = function (editor, model, snippet, typeRange) {
    ...
    editorCommonExtensions_1.CommonEditorRegistry.registerEditorCommand('leaveSnippet', weight, { primary: keyCodes_1.KeyCode.Escape }, true, exports.CONTEXT_SNIPPET_MODE, function (ctx, editor, args) {
