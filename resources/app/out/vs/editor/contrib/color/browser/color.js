...
define(["require", "exports", 'vs/base/common/lifecycle', 'vs/base/common/async', 'vs/base/browser/dom', 'vs/base/common/errors', 'vs/base/common/strings', 'vs/editor/common/editorCommon', 'vs/editor/common/editorCommonExtensions', 'vs/platform/instantiation/common/instantiation', 'vs/css!./color'], function (require, exports, lifecycle, schedulers, dom, errors, strings, EditorCommon, editorCommonExtensions_1, instantiation_1) {
    ...
    var ColorContribution = (function () {
        function ColorContribution(editor, ns) {
            var _this = this;
            ...
            this._decorationsChangedScheduler = new schedulers.RunOnceScheduler(function () { return _this.onDecorationsChanged(); }, 250);
