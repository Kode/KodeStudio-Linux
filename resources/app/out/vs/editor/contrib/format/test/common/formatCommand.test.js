 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/core/range', 'vs/editor/test/common/commands/commandTestUtils', 'vs/editor/contrib/format/common/formatCommand', 'vs/editor/common/core/selection', 'vs/editor/common/model/model'], function (require, exports, assert, range_1, TU, formatCommand_1, selection_1, model_1) {
    ...
    suite('FormatCommand', function () {
        function testFormatCommand(lines, selection, edits, expectedLines, expectedSelection) {
            TU.testCommand(lines, null, selection, function (sel) { return new formatCommand_1.EditOperationsCommand(edits, sel); }, expectedLines, expectedSelection);
        }
        test('no-op', function () {
            testFormatCommand([
                'some text',
