 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/test/common/commands/commandTestUtils', 'vs/editor/test/common/testModes', 'vs/editor/contrib/comment/common/blockCommentCommand', 'vs/editor/common/core/selection'], function (require, exports, commandTestUtils_1, testModes_1, blockCommentCommand_1, selection_1) {
    function testBlockCommentCommand(lines, selection, expectedLines, expectedSelection) {
        var mode = new testModes_1.CommentMode({ lineCommentTokens: ['!@#'], blockCommentStartToken: '<0', blockCommentEndToken: '0>' });
