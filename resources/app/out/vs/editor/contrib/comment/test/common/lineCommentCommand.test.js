 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/test/common/commands/commandTestUtils', 'vs/editor/test/common/testModes', 'vs/editor/contrib/comment/common/lineCommentCommand', 'vs/editor/common/core/selection'], function (require, exports, assert, TU, ModelModes, LineCommentCommand, selection_1) {
    suite('Editor Contrib - Line Comment Command', function () {
        function testLineCommentCommand(lines, selection, expectedLines, expectedSelection) {
            ...
            TU.testCommand(lines, mode, selection, function (sel) { return new LineCommentCommand.LineCommentCommand(sel, 4, LineCommentCommand.Type.Toggle); }, expectedLines, expectedSelection);
        }
