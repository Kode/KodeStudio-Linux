...
define(["require", "exports", 'vs/nls', 'vs/base/common/winjs.base', 'vs/base/common/errors', 'vs/base/browser/dom', 'vs/base/parts/tree/browser/treeImpl', 'vs/base/parts/tree/browser/treeDefaults', 'vs/editor/browser/editorBrowser', 'vs/editor/common/editorCommon', 'vs/css!./quickFix'], function (require, exports, nls, winjs_base_1, Errors, dom, TreeImpl, TreeDefaults, EditorBrowser, EditorCommon) {
    var $ = dom.emmet;
    ...
    var QuickFixSelectionWidget = (function () {
        function QuickFixSelectionWidget(editor, telemetryService, onShown, onHidden) {
            ...
            this.listenersToRemove.push(this.editor.addListener(EditorCommon.EventType.CursorSelectionChanged, function (e) {
                if (_this.isActive) {
        ...
        QuickFixSelectionWidget.prototype.setModel = function (newModel) {
            ...
            this.modelListenersToRemove.push(this.model.addListener('loading', function (e) {
                if (!_this.isActive) {
                    timer = _this.telemetryService.start('QuickFixSelectionWidgetLoadingTime');
                    _this.isLoading = true;
                    _this.isAuto = !!e.auto;
                    if (!_this.isAuto) {
                        loadingHandle = setTimeout(function () {
                            dom.removeClass(_this.domnode, 'empty');
                            _this.tree.setInput(QuickFixSelectionWidget.LOADING_MESSAGE).done(null, Errors.onUnexpectedError);
                            _this.updateWidgetHeight();
                            _this.show();
                        }, 50);
                    }
            ...
            this.modelListenersToRemove.push(this.model.addListener('suggest', function (e) {
                ...
                dom.removeClass(_this.domnode, 'empty');
                _this.tree.setInput(fixes).done(null, Errors.onUnexpectedError);
            ...
            this.modelListenersToRemove.push(this.model.addListener('empty', function (e) {
                ...
                if (e.auto) {
                    ...
                    if (_this.shouldShowEmptyList) {
                        dom.removeClass(_this.domnode, 'empty');
                        _this.tree.setInput(QuickFixSelectionWidget.NO_SUGGESTIONS_MESSAGE).done(null, Errors.onUnexpectedError);
                        _this.updateWidgetHeight();
                        _this.show();
                    }
                    else {
