 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/base/common/event', 'vs/base/common/errors', 'vs/base/common/strings', 'vs/editor/common/editorCommon', 'vs/editor/contrib/snippet/common/snippet', 'vs/base/common/lifecycle', '../common/suggest'], function (require, exports, winjs_base_1, event_1, errors_1, strings_1, EditorCommon, snippet_1, lifecycle_1, suggest_1) {
    ...
    var SuggestModel = (function () {
        function SuggestModel(editor) {
            ...
            this.context = null;
            this.toDispose = [];
            this.toDispose.push(this.editor.addListener2(EditorCommon.EventType.ConfigurationChanged, function () { return _this.onEditorConfigurationChange(); }));
            this.toDispose.push(this.editor.addListener2(EditorCommon.EventType.CursorSelectionChanged, function (e) { return _this.onCursorChange(e); }));
            this.toDispose.push(this.editor.addListener2(EditorCommon.EventType.ModelChanged, function () { return _this.cancel(); }));
        ...
        SuggestModel.prototype.onCursorChange = function (e) {
            ...
            if (!suggest_1.SuggestRegistry.has(this.editor.getModel())) {
                return;
            }
        ...
        SuggestModel.prototype.trigger = function (auto, triggerCharacter, retrigger, groups) {
            ...
            groups = groups || suggest_1.SuggestRegistry.orderedGroups(model);
            if (groups.length === 0) {
                return;
            }
            ...
            this.requestPromise = suggest_1.suggest(model, position, triggerCharacter, groups).then(function (all) {
                ...
                _this.raw = all;
                _this.incomplete = all.reduce(function (r, s) { return r || s.reduce(function (r, s) { return r || s.incomplete; }, false); }, false);
