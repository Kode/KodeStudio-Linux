...
define(["require", "exports", 'assert', 'vs/editor/test/common/mocks/mockCodeEditor', 'vs/editor/common/core/range', 'vs/editor/common/core/position', 'vs/editor/contrib/find/common/findController', 'vs/editor/common/core/editOperation'], function (require, exports, assert, mockCodeEditor_1, range_1, position_1, findController_1, editOperation_1) {
    ...
    suite('FindController', function () {
        ...
        test('issue #1857: F3, Find Next, acts like "Find Under Cursor"', function () {
            mockCodeEditor_1.withMockCodeEditor([
                ...
                var startFindAction = new findController_1.StartFindAction({ id: '', label: '' }, editor, null);
                var nextMatchFindAction = new findController_1.NextMatchFindAction({ id: '', label: '' }, editor, null);
