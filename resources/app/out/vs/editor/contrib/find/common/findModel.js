 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/common/editorCommon', 'vs/base/common/strings', './replaceAllCommand', 'vs/base/common/lifecycle', 'vs/base/common/async', 'vs/editor/common/core/range', 'vs/editor/common/core/position', 'vs/editor/common/commands/replaceCommand', './findDecorations'], function (require, exports, EditorCommon, Strings, replaceAllCommand_1, lifecycle_1, async_1, range_1, position_1, replaceCommand_1, findDecorations_1) {
    exports.FIND_IDS = {
    ...
    var FindModelBoundToEditorModel = (function () {
        ...
        FindModelBoundToEditorModel.prototype._moveToPrevMatch = function (before, isRecursed) {
            ...
            var nextMatch = model.findPreviousMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord);
            if (!nextMatch) {
        ...
        FindModelBoundToEditorModel.prototype.getReplaceString = function (matchedString) {
            ...
            var regexp = Strings.createRegExp(this._state.searchString, this._state.isRegex, this._state.matchCase, this._state.wholeWord);
