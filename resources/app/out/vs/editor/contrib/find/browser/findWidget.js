...
define(["require", "exports", 'vs/nls', 'vs/base/common/errors', 'vs/base/browser/dom', 'vs/base/browser/ui/inputbox/inputBox', 'vs/base/browser/ui/findinput/findInput', 'vs/editor/browser/editorBrowser', 'vs/editor/common/editorCommon', 'vs/editor/contrib/find/common/findModel', 'vs/base/common/keyCodes', 'vs/base/browser/ui/widget', 'vs/css!./findWidget'], function (require, exports, nls, Errors, DomUtils, inputBox_1, findInput_1, EditorBrowser, EditorCommon, findModel_1, keyCodes_1, widget_1) {
    ...
    var FindWidget = (function (_super) {
        ...
        function FindWidget(codeEditor, controller, state, contextViewProvider, keybindingService) {
            ...
            this._register(this._codeEditor.addListener2(EditorCommon.EventType.ConfigurationChanged, function (e) {
                if (e.readOnly) {
            ...
            this._register(this._codeEditor.addListener2(EditorCommon.EventType.CursorSelectionChanged, function () {
                if (_this._isVisible) {
        ...
        FindWidget.prototype._onStateChanged = function (e) {
            ...
            if (e.searchString || e.matchesCount) {
                ...
                var showMatchesCount = (this._state.searchString.length > 0);
                var matchesCount = String(this._state.matchesCount);
                var matchesCountTitle = '';
        ...
        FindWidget.prototype._reveal = function (animate) {
            ...
            if (!this._isVisible) {
                ...
                this._updateButtons();
                setTimeout(function () {
                    DomUtils.addClass(_this._domNode, 'visible');
                    if (!animate) {
                        DomUtils.addClass(_this._domNode, 'noanimation');
                        setTimeout(function () {
                            DomUtils.removeClass(_this._domNode, 'noanimation');
                        }, 200);
                    }
                }, 0);
        ...
        FindWidget.prototype._onFindInputKeyDown = function (e) {
            ...
            switch (e.asKeybinding()) {
                case keyCodes_1.CommonKeybindings.ENTER:
                    this._codeEditor.getAction(findModel_1.FIND_IDS.NextMatchFindAction).run().done(null, Errors.onUnexpectedError);
                    e.preventDefault();
                    return;
                case keyCodes_1.CommonKeybindings.SHIFT_ENTER:
                    this._codeEditor.getAction(findModel_1.FIND_IDS.PreviousMatchFindAction).run().done(null, Errors.onUnexpectedError);
                    e.preventDefault();
                    return;
        ...
        FindWidget.prototype._buildFindPart = function () {
            ...
            this._prevBtn = this._register(new SimpleButton({
                ...
                className: 'previous',
                onTrigger: function () {
                    _this._codeEditor.getAction(findModel_1.FIND_IDS.PreviousMatchFindAction).run().done(null, Errors.onUnexpectedError);
                },
            ...
            this._nextBtn = this._register(new SimpleButton({
                ...
                className: 'next',
                onTrigger: function () {
                    _this._codeEditor.getAction(findModel_1.FIND_IDS.NextMatchFindAction).run().done(null, Errors.onUnexpectedError);
                },
                onKeyDown: function (e) { }
            }));
        ...
        FindWidget.prototype._buildReplacePart = function () {
            ...
            this._register(DomUtils.addStandardDisposableListener(this._replaceInputBox.inputElement, 'keydown', function (e) { return _this._onReplaceInputKeyDown(e); }));
            // Replace one button
