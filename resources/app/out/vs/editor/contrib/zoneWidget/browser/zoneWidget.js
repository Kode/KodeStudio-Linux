...
define(["require", "exports", 'vs/base/browser/dom', 'vs/base/common/objects', 'vs/base/common/eventEmitter', 'vs/editor/common/editorCommon', 'vs/css!./zoneWidget'], function (require, exports, domUtils, Objects, Events, EditorCommon) {
    var defaultOptions = {
        showArrow: true,
        showFrame: true,
        frameColor: '',
    ...
    var ZoneWidget = (function (_super) {
        ...
        function ZoneWidget(editor, options) {
            ...
            this.listenersToRemove.push(this.editor.addListener(EditorCommon.EventType.EditorLayout, function (info) {
        ...
        ZoneWidget.prototype.showImpl = function (where, heightInLines) {
            ...
            var viewZoneDomNode = document.createElement('div'), arrow = document.createElement('div'), lineHeight = this.editor.getConfiguration().lineHeight, containerHeight = heightInLines * lineHeight, arrowHeight = 0, frameThickness = 0;
