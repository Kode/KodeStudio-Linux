...
define(["require", "exports", 'vs/base/common/collections', 'vs/base/common/strings', 'vs/base/common/uuid', 'vs/base/common/eventEmitter', 'vs/base/common/winjs.base', 'vs/base/common/paths', 'vs/editor/common/core/range'], function (require, exports, collections, strings, uuid, eventsEmitter, winjs_base_1, paths_1, range_1) {
    var EventType;
    (function (EventType) {
    ...
    var FilePreview = (function () {
        ...
        FilePreview.prototype._getOffsetFromPosition = function (line, column) {
    ...
    var Model = (function (_super) {
        ...
        function Model(references, editorService) {
            var _this = this;
            _super.call(this, [
            ...
            references.forEach(function (reference) {
                var hash = Model._hash(reference);
                if (!seen[hash]) {
                    seen[hash] = true;
        ...
        Object.defineProperty(Model.prototype, "currentReference", {
            get: function () {
        ...
        Model.prototype.nextReference = function (reference) {
        ...
        Model.prototype.findReference = function (resource, position) {
        ...
        Model._hash = function (reference) {
