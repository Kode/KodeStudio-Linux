 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/viewLayout/editorScrollable'], function (require, exports, assert, EditorScrollable) {
    suite('Editor ViewLayout - EditorScrollable', function () {
        function assertScrollState(scrollable, scrollTop, scrollLeft, width, height, scrollWidth, scrollHeight) {
        ...
        test('EditorScrollable', function () {
...
//# sourceMappingURL=editorScrollable.test.js.map