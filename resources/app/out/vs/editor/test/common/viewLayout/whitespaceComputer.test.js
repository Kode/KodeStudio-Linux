 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/viewLayout/whitespaceComputer'], function (require, exports, assert, WhitespaceComputer) {
    suite('Editor ViewLayout - WhitespaceComputer', function () {
        test('WhitespaceComputer', function () {
        ...
        test('WhitespaceComputer findInsertionIndex', function () {
            var makeArray = function (size, fillValue) {
                var r = [];
        ...
        test('WhitespaceComputer changeAfterLineNumberForWhitespace & getFirstWhitespaceIndexAfterLineNumber', function () {
            var whitespaceComputer = new WhitespaceComputer.WhitespaceComputer();
        ...
        test('WhitespaceComputer Bug', function () {
            var whitespaceComputer = new WhitespaceComputer.WhitespaceComputer();
            var a = whitespaceComputer.insertWhitespace(0, 0, 1);
            var b = whitespaceComputer.insertWhitespace(7, 0, 1);
            assert.equal(whitespaceComputer.getIdForWhitespaceIndex(0), a); // 0
...
//# sourceMappingURL=whitespaceComputer.test.js.map