 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/viewLayout/verticalObjects'], function (require, exports, assert, VerticalObjects) {
    suite('Editor ViewLayout - VerticalObjects', function () {
        test('VerticalObjects 1', function () {
        ...
        test('VerticalObjects 2', function () {
            var verticalObjects = new VerticalObjects.VerticalObjects();
        ...
        test('VerticalObjects getLineNumberAtOrAfterVerticalOffset', function () {
            var verticalObjects = new VerticalObjects.VerticalObjects();
            verticalObjects.replaceLines(10);
        ...
        test('VerticalObjects getCenteredLineInViewport', function () {
            var verticalObjects = new VerticalObjects.VerticalObjects();
            verticalObjects.replaceLines(10);
            var a = verticalObjects.insertWhitespace(6, 0, 10);
            // 10 lines
            ...
            assert.equal(verticalObjects.getCenteredLineInViewport(0, 16, 1), 7);
        ...
        test('VerticalObjects getLinesViewportData 1', function () {
            var verticalObjects = new VerticalObjects.VerticalObjects();
            verticalObjects.replaceLines(10);
        ...
        test('VerticalObjects getLinesViewportData 2 & getWhitespaceViewportData', function () {
            var verticalObjects = new VerticalObjects.VerticalObjects();
            verticalObjects.replaceLines(10);
            var a = verticalObjects.insertWhitespace(6, 0, 100);
        ...
        test('VerticalObjects getWhitespaceAtVerticalOffset', function () {
            var verticalObjects = new VerticalObjects.VerticalObjects();
            verticalObjects.replaceLines(10);
            var a = verticalObjects.insertWhitespace(6, 0, 100);
            var b = verticalObjects.insertWhitespace(7, 0, 50);
...
//# sourceMappingURL=verticalObjects.test.js.map