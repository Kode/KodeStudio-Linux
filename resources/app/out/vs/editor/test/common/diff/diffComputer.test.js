 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/diff/diffComputer'], function (require, exports, assert, DiffComputer) {
    ...
    function lineChangeEqual(change, expectedChange) {
