 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/model/textModel', 'vs/editor/common/core/range', 'vs/editor/common/core/position'], function (require, exports, assert, TextModel, Range, Position) {
    function testGuessIndentation(expectedInsertSpaces, expectedTabSize, text, msg) {
    ...
    function guessesTabs(expectedTabSize, text, msg) {
        testGuessIndentation(false, expectedTabSize, text, msg);
    }
    function guessesSpaces(expectedTabSize, text, msg) {
    ...
    suite('Editor Model - TextModel', function () {
        ...
        test('modifyPosition', function () {
            ...
            assert.throws(function () { return m.modifyPosition(new Position.Position(1, 2), 17); });
            assert.throws(function () { return m.modifyPosition(new Position.Position(1, 2), 100); });
            assert.throws(function () { return m.modifyPosition(new Position.Position(1, 2), -2); });
            assert.throws(function () { return m.modifyPosition(new Position.Position(1, 2), -100); });
            assert.throws(function () { return m.modifyPosition(new Position.Position(2, 2), -100); });
            assert.throws(function () { return m.modifyPosition(new Position.Position(2, 9), -18); });
        });
    });
});
