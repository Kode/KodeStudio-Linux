 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'assert', 'vs/editor/common/editorCommon', 'vs/editor/common/model/mirrorModel', 'vs/editor/test/common/modesTestUtils'], function (require, exports, assert, EditorCommon, MirrorModel, modesUtil) {
    ...
    ;
    function contentChangedFlushEvent(detail) {
        return {
    ...
    function contentChangedLinesDeletedEvent(fromLineNumber, toLineNumber) {
        return {
    ...
    function contentChangedLinesInsertedEvent(fromLineNumber, toLineNumber, detail) {
        return {
    ...
    function contentChangedLineChanged(lineNumber, detail) {
        return {
    ...
    function mirrorModelEvents(contentChanged) {
        return {
            propertiesChanged: null,
            contentChanged: contentChanged
        };
    }
    suite('Editor Model - MirrorModel', function () {
        var mirrorModel;
        setup(function () {
        ...
        test('get line start /flush event/', function () {
            assert.equal(mirrorModel.getLineStart(2), 6);
            assert.equal(mirrorModel.getLineStart(3), 12);
        ...
        test('get position from offset', function () {
        ...
        test('get (all/unique) words', function () {
        ...
        test('word at/until pos', function () {
        ...
        test('words with ranges', function () {
    ...
    suite('Editor Model - MirrorModel Eventing', function () {
        var mirrorModel;
        setup(function () {
        ...
        test('delete single line', function () {
        ...
        test('delete multiple lines', function () {
        ...
        test('delete all lines', function () {
        ...
        test('add single lines', function () {
        ...
        test('add multiple lines', function () {
            assert.equal(mirrorModel.getLineContent(1), 'line one');
...
//# sourceMappingURL=mirrorModel.test.js.map