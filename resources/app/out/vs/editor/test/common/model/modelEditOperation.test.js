 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/core/range', 'vs/editor/common/model/model'], function (require, exports, assert, Range, Model) {
    suite('Editor Model - Model Edit Operation', function () {
        ...
        function createSingleEditOp(text, positionLineNumber, positionColumn, selectionLineNumber, selectionColumn) {
            ...
            var range = new Range.Range(selectionLineNumber, selectionColumn, positionLineNumber, positionColumn);
            return {
                identifier: {
                    major: 0,
                    minor: 0
