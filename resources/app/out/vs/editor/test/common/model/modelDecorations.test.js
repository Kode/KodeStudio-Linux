 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/editorCommon', 'vs/editor/common/core/position', 'vs/editor/common/core/range', 'vs/editor/common/model/model', 'vs/editor/common/core/editOperation'], function (require, exports, assert, EditorCommon, position_1, range_1, Model, editOperation_1) {
    // --------- utils
    ...
    suite('Editor Model - Model Decorations', function () {
        ...
        test('decorations emit event on add', function () {
            ...
            thisModel.addListener(EditorCommon.EventType.ModelDecorationsChanged, function (e) {
                listenerCalled++;
