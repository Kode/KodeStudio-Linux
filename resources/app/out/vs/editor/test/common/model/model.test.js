 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/model/model', 'vs/editor/common/core/position', 'vs/editor/common/core/range', 'vs/editor/test/common/testModes', 'vs/editor/common/editorCommon', 'vs/editor/common/core/editOperation'], function (require, exports, assert, Model, position_1, range_1, ModelModes, EditorCommon, editOperation_1) {
    // --------- utils
    ...
    function positionEqual(position, lineNumber, column) {
        assert.deepEqual(position, new position_1.Position(lineNumber, column));
    }
    ...
    suite('Editor Model - Model', function () {
        ...
        test('model insert empty text does not trigger eventing', function () {
            thisModel.addListener(EditorCommon.EventType.ModelContentChanged, function (e) {
        ...
        test('setValue eventing', function () {
            var listenerCalls = 0;
            thisModel.addOneTimeListener(EditorCommon.EventType.ModelContentChanged, function (e) {
                listenerCalls++;
