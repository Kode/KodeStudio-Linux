 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/viewModel/prefixSumComputer'], function (require, exports, assert, PrefixSumComputer) {
    suite('Editor ViewModel - PrefixSumComputer', function () {
        test('PrefixSumComputer', function () {
            var indexOfResult = {
                index: 0,
                remainder: 0
            };
