 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/common/viewModel/characterHardWrappingLineMapper', 'vs/editor/common/editorCommon'], function (require, exports, assert, CharacterHardWrappingLineMapper, EditorCommon) {
    ...
    function safeGetOutputPositionOfInputOffset(mapper, inputOffset, result) {
        if (!mapper) {
