...
define(["require", "exports", 'assert', 'vs/editor/common/modes', 'vs/editor/common/modes/supports', 'vs/editor/common/modes/abstractState', 'vs/editor/test/common/modesTestUtils', 'vs/base/common/lifecycle'], function (require, exports, assert, modes, supports, abstractState_1, modesTestUtils_1, lifecycle_1) {
    ...
    var SwitchingMode = (function () {
        ...
        SwitchingMode.prototype.getId = function () {
            return this._id;
        };
        SwitchingMode.prototype.toSimplifiedMode = function () {
            return this;
        };
    ...
    suite('Editor Modes - Tokenization', function () {
        ...
        test('One embedded over multiple lines 2 with handleEvent', function () {
            ...
            supports.handleEvent(modesTestUtils_1.createLineContext('abc (def', lineTokens), 0, function (mode, context, offset) {
            ...
            supports.handleEvent(modesTestUtils_1.createLineContext('abc (def', lineTokens), 6, function (mode, context, offset) {
