...
define(["require", "exports", 'vs/editor/common/viewLayout/linesLayout', 'vs/editor/common/viewModel/viewEventHandler', 'vs/editor/browser/viewLayout/scrollManager', 'vs/editor/common/viewLayout/editorScrollable', 'vs/editor/common/editorCommon'], function (require, exports, linesLayout_1, viewEventHandler_1, scrollManager_1, editorScrollable_1, EditorCommon) {
    var LayoutProvider = (function (_super) {
        ...
        LayoutProvider.prototype.changeWhitespace = function (id, newHeight) {
            return this.linesLayout.changeWhitespace(id, newHeight);
        };
        LayoutProvider.prototype.changeAfterLineNumberForWhitespace = function (id, newAfterLineNumber) {
