...
define(["require", "exports", 'vs/base/common/platform', 'vs/base/browser/browser', 'vs/base/browser/dom', 'vs/editor/browser/config/elementSizeObserver', 'vs/editor/common/config/commonEditorConfig', 'vs/base/common/event', 'vs/base/common/lifecycle'], function (require, exports, Env, Browser, DomUtils, elementSizeObserver_1, commonEditorConfig_1, event_1, lifecycle_1) {
    ...
    var CSSBasedConfiguration = (function (_super) {
        ...
        CSSBasedConfiguration._actualReadConfiguration = function (styling) {
            ...
            var maxDigitWidth = 0, typicalHalfwidthCharacterWidth = 0, typicalFullwidthCharacterWidth = 0;
            for (var i = 0, len = CSSBasedConfiguration._USUAL_CHARS.length; i < len; i++) {
        ...
        CSSBasedConfiguration._USUAL_CHARS = '0123456789' + CSSBasedConfiguration._HALF_WIDTH_TYPICAL + CSSBasedConfiguration._FULL_WIDTH_TYPICAL;
        return CSSBasedConfiguration;
    })(lifecycle_1.Disposable);
    var Configuration = (function (_super) {
        __extends(Configuration, _super);
        function Configuration(options, referenceDomElement, indentationGuesser) {
            var _this = this;
            if (referenceDomElement === void 0) { referenceDomElement = null; }
            if (indentationGuesser === void 0) { indentationGuesser = null; }
            this._elementSizeObserver = new elementSizeObserver_1.ElementSizeObserver(referenceDomElement, function () { return _this._onReferenceDomElementSizeChanged(); });
            _super.call(this, options, indentationGuesser);
