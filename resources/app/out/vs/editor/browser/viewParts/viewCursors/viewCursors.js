...
define(["require", "exports", 'vs/base/browser/browser', 'vs/editor/browser/viewParts/viewCursors/viewCursor', 'vs/editor/browser/view/viewPart', 'vs/editor/browser/editorBrowser', 'vs/css!./viewCursors'], function (require, exports, Browser, viewCursor_1, viewPart_1, EditorBrowser) {
    var RenderType;
    (function (RenderType) {
    ...
    var ViewCursors = (function (_super) {
        ...
        ViewCursors.prototype._getClassName = function () {
            var result = EditorBrowser.ClassNames.VIEW_CURSORS_LAYER;
            var extraClassName;
        ...
        ViewCursors.prototype._render = function (ctx) {
            var _this = this;
            ...
            this._requestModificationFrame(function () {
                _this._primaryCursor.render(ctx);
                for (var i = 0, len = _this._secondaryCursors.length; i < len; i++) {
                    _this._secondaryCursors[i].render(ctx);
                }
            });
        };
