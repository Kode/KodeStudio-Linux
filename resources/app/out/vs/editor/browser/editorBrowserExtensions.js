 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/platform/platform'], function (require, exports, Platform) {
    var EditorBrowserRegistry;
    (function (EditorBrowserRegistry) {
        // --- Editor Contributions
        function registerEditorContribution(ctor) {
            Platform.Registry.as(Extensions.EditorContributions).registerEditorBrowserContribution(ctor);
        }
        EditorBrowserRegistry.registerEditorContribution = registerEditorContribution;
        function getEditorContributions() {
            return Platform.Registry.as(Extensions.EditorContributions).getEditorBrowserContributions();
        }
