 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/standalone-languages/objective-c', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, languageDef, T) {
    var Bracket = {
        Open: 1,
        Close: -1
    };
...
//# sourceMappingURL=objective-c.test.js.map