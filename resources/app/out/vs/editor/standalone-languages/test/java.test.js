 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/editor/standalone-languages/java', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, assert, languageDef, T) {
    var Bracket = {
        Open: 1,
        Close: -1
    };
    ...
    suite('java', function () {
        test('word definition', function () {
            ...
            assert.deepEqual('public static void main(String[] args) {'.match(wordDefinition), ['public', 'static', 'void', 'main', 'String', 'args']);
            assert.deepEqual('g.drawOval(10,10, 330, 100); @SuppressWarnings("unchecked")'.match(wordDefinition), ['g', 'drawOval', '10', '10', '330', '100', '@SuppressWarnings', 'unchecked']);
            assert.deepEqual('Socket client_socket = listen_socket.accept();'.match(wordDefinition), ['Socket', 'client_socket', 'listen_socket', 'accept']);
        });
    });
});
//# sourceMappingURL=java.test.js.map