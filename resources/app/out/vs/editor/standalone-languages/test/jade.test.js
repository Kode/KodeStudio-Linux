 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/standalone-languages/jade', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, languageDef, T) {
    var Bracket = {
        Open: 1,
        Close: -1
    };
...
//# sourceMappingURL=jade.test.js.map