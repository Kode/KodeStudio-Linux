 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/standalone-languages/swift', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, languageDef, T) {
    var Bracket = {
        Open: 1,
        Close: -1
    };
    T.testTokenization('swift', languageDef.language, [
        ...
        [{
                ...
                tokens: [
                    { startIndex: 0, type: '', bracket: 0 },
                    { startIndex: 4, type: 'comment.swift', bracket: 0 },
                    { startIndex: 28, type: '', bracket: 0 },
...
//# sourceMappingURL=swift.test.js.map