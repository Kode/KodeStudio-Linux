 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/editor/standalone-languages/coffee', 'vs/editor/standalone-languages/test/testUtil'], function (require, exports, languageDef, T) {
    var Bracket = {
        Open: 1,
        Close: -1
    };
    T.testOnEnter('coffeescript', languageDef.language, function (assertOnEnter) {
