...
define("vs/workbench/workbench.main.nls.zh-tw", {
	...
	"vs/base/browser/ui/resourceviewer/resourceViewer": [
		"抱歉，不支援播放音訊檔案。",
		"抱歉，不支援播放視訊檔案。",
		"檔案為二進位檔、非常大或使用不支援的文字編碼，所以無法顯示於編輯器中。",
	],
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"控制選取範圍是否有圓角",
		"控制編輯器是否會捲動到最後一行之後",
		"控制編輯器會在幾個字元後換行至下一行。將此項目設為 0 會開啟檢視區寬度換行",
	...
	"vs/editor/contrib/accessibility/browser/accessibility": [
		...
		"在此編輯器中按 Tab 鍵會將焦點移至下一個可設定焦點的元素。目前無法透過按鍵繫結關係觸發命令 {0}。",
		"因為 editor.experimentalScreenReader 設定索引鍵的緣故，所以已開啟實驗螢幕助讀程式支援。",
		"此工作階段的實驗螢幕助讀程式支援已開啟。按 {0} 可切換此行為。",
		"此工作階段的實驗螢幕助讀程式支援已開啟。目前無法透過按鍵繫結關係觸發命令 {0}。",
		"實驗螢幕助讀程式支援已關閉。請按 {0} 以針對此工作階段加以開啟，或將 editor.experimentalScreenReader 設定為 True 以針對所有工作階段加以開啟。",
		"實驗螢幕助讀程式支援已關閉。目前無法透過按鍵繫結關係觸發命令 {0}。請將 editor.experimentalScreenReader 設定為 True，以針對所有工作階段加以開啟。",
	...
	"vs/platform/extensions/common/extensionsRegistry": [
		...
		"VS Code 擴充功能的發行者。",
		"VS Code 擴充功能的啟動事件。",
		"其它擴充功能的相依性。擴充功能識別碼一律為 ${publisher}.${name}。例如: vscode.csharp。",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"控制重新啟動後重新開啟資料夾的方式。選取 [無] 永不重新開啟資料夾，選取 [一] 重新開啟最近一個使用的資料夾，或選取 [全部] 重新開啟上一個工作階段的所有資料夾。",
		"調整視窗的縮放比例。原始大小為 0，而且每個向上增量 (例如 1) 或向下增量 (例如 -1) 代表放大或縮小 20%。您也可以輸入小數，更細微地調整縮放比例。",
		"更新組態",
		"設定要從中接收更新的更新頻道。變更後需要重新啟動。",
	],
	...
	"vs/workbench/electron-browser/update": [
		...
		"{0} 重新啟動後將會更新。",
		"目前沒有可用的更新。",
		"{0} 的這個版本已過期且無法自動更新。請手動下載並安裝最新版本。",
		"下載最新的",
		"版本資訊",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"偵錯已繼續。",
		"偵錯已停止。",
		"未從識別碼為 {0} 的偵錯配接器取得執行緒。",
		"請為您的應用程式設定啟動組態檔。",
		"不支援設定的偵錯類型 \'{0}\'。",
		"在 launch.json 中遺漏選取組態的屬性 \'type\'。",
		"執行 preLaunchTask \'{0}\' 時偵測到的錯誤。",
		"執行 preLaunchTask \'{0}\' 時偵測到的錯誤。",
	...
	"vs/workbench/parts/debug/node/rawDebugSession": [
		...
		"未針對 \'{0}\' 偵錯安裝擴充功能。",
		"無法從 {0} 啟動偵錯配接器。",
		"在路徑 {0} 中找不到 DebugAdapter bin 資料夾。",
		"{0}。正在停止偵錯配接器。",
		"偵錯配接器處理序已意外終止",
	],
	...
	"vs/workbench/parts/files/browser/editors/fileEditorInput": [
		...
		"抱歉，我們無法儲存您的變更",
		"衝突",
		"因為變更與磁碟上的版本衝突，所以無法儲存",
	],
	"vs/workbench/parts/files/browser/editors/textFileEditor": [
		"文字檔編輯器",
		"建立檔案",
		"很抱歉，但是檔案太大，無法在編輯器中開啟。",
		"資料夾 \'{0}\' 在目前開啟的根資料夾外，而且無法在此執行個體中開啟。",
		"{0}。文字檔編輯器。",
		"文字檔編輯器。",
	],
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"目前的分支 \'{0}沒有設定上游分支。",
		"目前的分支 \'{0}\' 是最新狀態。",
		"同步處理之前請先認可、復原或隱藏您的變更。",
		"目前分支 \'{0}\' 在 \'{3}\' 之後有 {1} 個認可，之前有 {2} 個認可。",
		"目前分支 \'{0}\' 在 \'{3}\' 之後有 {1} 個認可，之前有 {2} 個認可。",
		"目前分支 \'{0}\' 在 \'{3}\' 之後有 {1} 個認可，之前有 {2} 個認可。",
		"目前分支 \'{0}\' 在 \'{3}\' 之後有 {1} 個認可，之前有 {2} 個認可。",
		"復原上次認可",
	...
	"vs/workbench/parts/markdown/common/markdownEditorModel": [
		"無法開啟 \'{0}\' 以轉譯 Markdown。請確定檔案存在且是有效的 Markdown 檔案。",
	],
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"開啟符號 (依名稱)",
		"搜尋組態",
		"設定 Glob 模式以排除搜尋中的檔案和資料夾。請從 file.exclude 設定繼承所有 Glob 模式。",
		"要符合檔案路徑的 Glob 模式。設為 True 或 False 可啟用或停用模式。",
		"在相符檔案同層級上額外的檢查。請使用 $(basename) 作為相符檔案名稱的變數。",
	],
	...
	"vs/workbench/services/themes/node/themeService": [
		"提供 textmate 色彩佈景主題。",
		"如 UI 中所示的色彩佈景主題標籤。",
		"基礎佈景主題會定義編輯器的色彩: \'vs\' 是淺色色彩佈景主題，\'vs-dark\' 是深色色彩佈景主題。",
		"tmTheme 檔案的路徑。此路徑是擴充功能資料夾的相對路徑，而且一般為 \'./themes/themeFile.tmTheme\'。",
		"擴充點 `{0}` 必須是陣列。",
		"`contributes.{0}.path` 中的預期字串。提供的值: {1}",
		"要包含在擴充功能資料夾 ({2}) 中的預期 `contributes.{0}.path` ({1})。這可能會使擴充功能無法移植。",
		"無法載入 {0}",
		"剖析 JSON 佈景主題檔案 {0} 時發生問題",
		"剖析 plist 檔案時發生問題: {0}",
	],
	"vs/workbench/services/thread/electron-browser/threadService": [
		"延伸主機未於 10 秒內開始，可能在第一行就已停止，並需要偵錯工具才能繼續。",
		"擴充功能主機 10 秒內未啟動，可能發生問題。",
		"延伸主機發生錯誤: {0}",
		"延伸主機意外終止。請重新載入視窗以復原。",
		"重新載入視窗",
	]
