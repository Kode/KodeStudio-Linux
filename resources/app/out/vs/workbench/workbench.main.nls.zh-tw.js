...
define("vs/workbench/workbench.main.nls.zh-tw", {
	...
	"vs/workbench/browser/actions/openSettings": [
		...
		"將設定放入您的設定檔中加以覆寫。",
		"如需最常使用的設定，請參閱 http://go.microsoft.com/fwlink/?LinkId=808995。",
		"預設值",
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"偵錯",
		"允許在任何檔案設定中斷點",
		"自動於偵錯工作階段結束時開啟 Explorer Viewlet",
	],
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"要求組態的類型。可以是 [啟動] 或 [附加]。",
		"會隨這項「複合」組態啟動的組態。只在此組態的類型為「複合」採用。",
		"偵錯工作階段啟動前要執行的工作。",
		"內部偵錯主控台的控制項行為。",
		"Windows 特定的啟動設定屬性。",
		"OS X 特定的啟動設定屬性。",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"控制是否在終端機中啟用連字字型。",
		"控制終端機的字型大小 (以像素為單位)，預設為 editor.fontSize 的值。",
