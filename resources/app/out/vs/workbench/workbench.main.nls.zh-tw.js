...
define("vs/workbench/workbench.main.nls.zh-tw", {
	...
	"vs/platform/actions/electron-browser/menusExtensionPoint": [
		...
		"\'{0}\' 為必要屬性，且其類型必須是 \'string\' 或 \'object\'",
		"屬性 \'{0}\' 為強制項目且必須屬於 `string` 類型",
		"\'{0}\' 與 \'{1}\' 為必要屬性，且其類型必須是 \'string\'",
		"所要執行命令的識別碼",
		"UI 中用以代表命令的標題",
		"(選用) UI 中用以將命令分組的分類字串",
	...
	"vs/platform/markers/common/problemMatcher": [
		...
		"問題之位置的符合群組索引。有效的位置模式為: (line)、(line,column) 和 (startLine,startColumn,endLine,endColumn)。如果省略，則會假設 (line,column)。",
		"問題之行的符合群組索引。預設為 2",
		"問題行中字元的符合群組索引。預設為 3",
		"問題之結尾行的符合群組索引。預設為未定義",
		"問題之結尾行字元的符合群組索引。預設為未定義",
		...
		"錯誤: 沒有識別碼為 {0} 的樣式。",
		"錯誤: 樣式屬性參考了空的識別碼。",
		"錯誤: 樣式屬性 {0} 不是有效的樣式變數名稱。",
		"問題比對器必須同時定義監控的開始模式和結束模式。",
		"錯誤: 字串 {0} 不是有效的規則運算式。\n",
		"用來查看偵測背景工作開始或結束的正規表達式.",
		"檔案名稱的符合群組索引。可以省略。",
		"所提供或預先定義之模式的名稱",
		"問題模式或所提供或預先定義之問題模式的名稱。如有指定基底，即可發出。",
		"要使用之基底問題比對器的名稱。",
		...
		"定義問題模式中所回報檔案名稱的解譯方式。",
		"偵測後台任務中匹配程序模式的開始與結束.",
		"如果設置為 True，背景監控程式在工作啟動時處於主動模式。這相當於符合起始樣式的行。",
		"如果於輸出中相符，則會指示背景程式開始。",
		"如果於輸出中相符，則會指示背景程式結束。",
		"關注屬性已被淘汰，請改用背景取代。",
		"追蹤匹配程序的開始與結束。",
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"用 Tab 鍵移動焦點",
		"偵測到螢幕助讀程式",
		"若您不打算使用螢幕助讀程式，請將設定 `editor.accessibilitySupport` 變更為 \"off\"。",
		"停用協助工具模式",
		"移至行",
		"縮排",
		"選取編碼",
	...
	"vs/workbench/browser/parts/quickopen/quickopen": [
		"移至檔案...",
		"在 Quick Open 中導覽至下一項",
		"在 Quick Open 中導覽至上一項",
		"在 Quick Open 中選取下一個",
		"在 Quick Open 中選取上一個",
	],
	...
	"vs/workbench/common/theme": [
		"使用中之索引標籤的背景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"非使用中之索引標籤的背景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"用以分隔索引標籤彼此的框線。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"使用中的群組內，使用中之索引標籤的前景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"使用中的群組內，非使用中之索引標籤的前景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"非使用中的群組內，使用中之索引標籤的前景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"非使用中的群組內，非使用中之索引標籤的前景色彩。索引標籤是編輯器在編輯器區域中的容器。同一個編輯器群組中的多個索引標籤可以同時開啟。可能會有多個編輯器群組。",
		"編輯器群組的背景色彩。編輯器群組是編輯器的容器。當拖曳編輯器群組時會顯示背景色彩。",
		"當索引標籤啟用的時候編輯器群組標題的背景色彩。編輯器群組是編輯器的容器。",
		"當索引標籤啟用時，編輯器群組標題的框線色彩。編輯器群組是編輯器的容器。",
		"當索引標籤禁用的時候編輯器群組標題的背景顏色。編輯器群組是編輯器的容器。",
		"用以分隔多個編輯器群組彼此的色彩。編輯器群組是編輯器的容器。",
		"拖拉編輯器時的背景顏色,可設置透明度讓內容穿透顯示.",
		"面板的前景色彩。面板會顯示在編輯器區域的下方，其中包含諸如輸出與整合式終端機等檢視。",
		"面板頂端用以分隔編輯器的邊框色彩。面板會顯示在編輯器區域的下方，其中包含諸如輸出與整合式終端機等檢視。",
		"使用中之面板標題的標題色彩。面板會顯示在編輯器區域的下方，其中包含諸如輸出與整合式終端機等檢視。",
		"非使用中之面板標題的標題色彩。面板會顯示在編輯器區域的下方，其中包含諸如輸出與整合式終端機等檢視。",
		"使用中之面板標題的框線色彩。面板會顯示在編輯器區域的下方，其中包含諸如輸出與整合式終端機等檢視。",
		"狀態列的前景色彩。狀態列會顯示在視窗的底部。",
		"當未開啟任何資料夾時，狀態列的前景色彩。狀態列會顯示在視窗的底部。",
		"標準狀態列的背景色彩。狀態列會顯示在視窗的底部。",
		"當未開啟任何資料夾時，狀態列的背景色彩。狀態列會顯示在視窗的底部。",
		"用以分隔資訊看板與編輯器的狀態列框線色彩。狀態列會顯示在視窗的底部。",
		...
		"按下滑鼠按鈕時，狀態列項目的背景色彩。狀態列會顯示在視窗的底部。",
		"動態顯示時，狀態列項目的背景色彩。狀態列會顯示在視窗的底部。",
		"狀態列突出項目的背景顏色。突出項目比狀態列的其他項目更顯眼，用於表示重要性更高。狀態列會顯示在視窗的底部。",
		"狀態列突出項目暫留時的背景顏色。突出項目比狀態列的其他項目更顯眼，用於表示重要性更高。狀態列會顯示在視窗的底部。",
		"活動列背景的色彩。活動列會顯示在最左側或最右側，並可切換不同的提要欄位檢視。",
		"活動列的前背景色彩(例如用於圖示)。此活動列會顯示在最左側或最右側，讓您可以切換提要欄位的不同檢視。",
		"用以分隔提要欄位的活動列框線色彩。此活動列會顯示在最左側或最右側，讓您可以切換提要欄位的不同檢視。",
		"拖拉活動徽章項目時的色彩.顏色可設置透明度讓原活動徽章可穿透顯示.活動徽章列表會出現在最左側或最右側並允許切換不同的檢視.",
		"活動通知徽章的背景色彩。此活動列會顯示在最左側或最右側，讓您可以切換提要欄位的不同檢視。",
		"活動通知徽章的前背景色彩。此活動列會顯示在最左側或最右側，讓您可以切換提要欄位的不同檢視。",
		"提要欄位的背景色彩。提要欄位是檢視 (例如 Explorer 與搜尋) 的容器。",
		"側欄的前景顏色.側欄包含Explorer與搜尋.",
		"用以分隔編輯器的側邊提要欄位框線色彩。該提要欄位是檢視 (例如 Explorer 及搜尋) 的容器。",
		"提要欄位標題的前景色彩。提要欄位是檢視 (例如 Explorer 與搜尋) 的容器。",
		...
		"提要欄位區段標頭的背景色彩。提要欄位是檢視 (例如 Explorer 與搜尋) 的容器。",
		"提要欄位區段標頭的前景色彩。提要欄位是檢視 (例如 Explorer 與搜尋) 的容器。",
		"作用中視窗之標題列的前景。請注意，目前只有 macOS 支援此色彩。",
		"非作用中視窗之標題列的前景。請注意，目前只有 macOS 支援此色彩。",
		"作用中視窗之標題列的背景。請注意，目前只有 macOS 支援此色彩。",
		"非作用中視窗之標題列的背景。請注意，目前只有 macOS 支援此色彩。",
		"標題列框線色彩。請注意，目前只有 macOS 支援此色彩。",
		"通知的前景色彩。通知從視窗的上方滑入。",
		"通知的背景色彩。通知從視窗的上方滑入。",
		"通知按鈕的背景色彩。通知會從視窗上方滑入。",
		"游標停留時通知按鈕的背景色彩。通知會從螢幕上方滑入。",
		"通知按鈕的前景色彩。通知會從螢幕上方滑入。",
		"通知資訊的背景色彩。通知會從螢幕上方滑入。",
		"通知資訊的前景色彩。通知會從螢幕上方滑入。",
		"通知警告的背景色彩。通知會從螢幕上方滑入。",
		"通知警告的前景色彩。通知會從螢幕上方滑入。",
		"通知錯誤的背景色彩。通知會從螢幕上方滑入。",
		"通知錯誤的前景色彩。通知會從螢幕上方滑入。",
	],
	"vs/workbench/electron-browser/actions": [
		"關閉編輯器",
		"關閉視窗",
		"關閉工作區",
		"此執行個體中目前沒有開啟的工作區可以關閉。",
		"開新視窗",
		"切換全螢幕",
		"切換功能表列",
		"切換開發人員工具",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"Workspaces",
		"開發人員",
		"控制已開啟的編輯器是否應顯示在索引標籤中。",
		"控制編輯器的索引標籤關閉按鈕位置，或在設為 \'off\' 時將其停用。",
		"控制開啟的編輯器是否搭配圖示顯示。這需要同時啟用圖示佈景主題。",
		"控制已開啟的編輯器是否顯示為預覽。預覽編輯器會重複使用到被保留 (例如按兩下或進行編輯) 為止。",
		"控制透過 Quick Open 所開啟的編輯器是否顯示為預覽。預覽編輯器會重複使用到被保留 (例如按兩下或進行編輯) 為止。",
		"控制要在何處開啟編輯器。選取 [左] 或 [右] 在目前使用中編輯器的左側或右側開啟編輯器。選取 [先] 或 [後] 從目前使用中編輯器另外開啟編輯器。",
		"控制編輯器是否要在任何顯示的群組開啟時，在其中顯示。若啟用此選項，已經開啟的編輯器將會繼續顯示，而不會在目前使用中的編輯器群組中再開啟一次。請注意，有一些情況會忽略此設定，例如當強制編輯器在特定群組中開啟，或強制編輯器在目前使用中的群組旁開啟等情況。",
		"控制是否要保留在命令選擇區歷程記錄中最近所使用的命令數目。設定為 0 以停用命令歷程記錄。",
		"控制下次開啟命令選擇區時，最後鍵入的輸入是否應該還原。",
		"控制是否在 Quick Open 失去焦點時自動關閉。",
		"控制開啟設定時是否也會開啟顯示所有預設設定的編輯器。",
		"控制項資訊看板的位置。可顯示於 Workbench 的左方或右方。",
		"控制 Workbench 底端狀態列的可視性。",
		"控制活動列在 workbench 中的可見度。",
		"控制顯示檔案的編輯器是否應在其他處理序刪除或重新命名該檔案時自動關閉。若停用此選項，當發生前述狀況時，編輯器會保持開啟，並呈現已變更的狀態。請注意，從應用程式內刪除一律會關閉編輯器，但已變更的檔案在資料未儲存前一律不會關閉。",
		...
		"禁用字體平滑.文字將會顯示鋸齒狀與鋒利的邊緣.",
		"利用三指水平撥動在開啟的檔案間瀏覽。",
		"工作台",
		"檔案會在新視窗中開啟",
		"檔案會在開啟了檔案資料夾的視窗，或在上一個使用中的視窗中開啟",
		"除非從擴充座或 Finder 中開啟，否則檔案會在開啟了檔案資料夾的視窗，或在上一個使用中的視窗中開啟 (僅限 macOS)",
		...
		"資料夾會在新視窗中開啟",
		"資料夾會取代上一個使用中的視窗",
		"除非已從應用程式內挑選了資料夾 (例如透過 [檔案] 功能表)，否則資料夾會在新視窗中開啟",
		"控制資料夾應在新視窗中開啟或取代上一個使用中的視窗。\n- default: 除非已從應用程式內挑選資料夾 (例如，透過 [檔案] 功能表)，否則會在新視窗開啟\n- on: 資料夾會在新視窗開啟\n- off: 資料夾會取代上一個使用中視窗\n請注意，在某些情況下會略過此設定 (例如，使用了 -new-window 或 -reuse-window 命令列選項時)。",
		"重新開啟所有視窗。",
		"重新開啟所有資料夾。空白工作區將不會還原。",
		"重新開啟上一個使用中的視窗。",
		"一律不重新開啟視窗。永遠從空白的視窗開始。",
		...
		"在螢幕中央開啟新視窗。",
		"以相同於上一個使用中之視窗的維度開啟新視窗。",
		"開啟並最大化新視窗。",
		"在全螢幕模式下開啟新視窗。",
		"控制當至少一個視窗已打開的情況下開啟新視窗的維度。根據預設，新視窗會以小型維度在畫面中央開啟。設為 \'inherit\' 時，視窗的維度會和最後開啟的視窗相同。設為 \'maximized\' 時，視窗會開到最大，若設為 \'fullscreen\' 則全螢幕開啟。",
		...
		"只在全螢幕模式時隱藏功能表。",
		"一律顯示功能表，即使在全螢幕模式時亦然。",
		"隱藏功能表，但可經由 Alt 鍵加以顯示。",
		"一律隱藏功能表。",
		"控制功能表列的可見度。[切換] 設定表示會隱藏功能表列，按一下 Alt 鍵則會顯示。除非視窗是全螢幕，否則預設會顯示功能表列。",
		"啟用後可以利用Alt快捷鍵打開主選單.關閉記憶選單將Alt快捷鍵綁定至替代的命令區塊.",
		"若啟用，如果 Windows 使用高對比佈景主題，就會自動變更為高對比佈景主題，切換掉 Windows 高對比佈景主題時則變更為深色佈景主題。",
		"調整視窗標題列的外觀。變更需要完整重新啟動才會套用。",
		"啟用 macOS Sierra 視窗索引標籤。請注意需要完全重新啟動才能套用變更，並且完成設定後原始索引標籤將會停用自訂標題列樣式。",
		"視窗",
		"Zen Mode",
		"控制開啟 Zen Mode 是否也會將 Workbench 轉換為全螢幕模式。",
		"控制開啟 Zen Mode 是否也會隱藏 Workbench 索引標籤。",
		"控制開啟 Zen Mode 是否也會隱藏 Workbench 底部的狀態列。",
		"控制開啟 Zen Mode 是否也會隱藏 Workbench 左方的活動列。",
		"控制視窗如果在 Zen Mode 下結束，是否應還原為 Zen Mode。",
	],
	...
	"vs/workbench/parts/codeEditor/electron-browser/accessibility": [
		"現在請將設定 `editor.accessibilitySupport` 變更為 \'on\'。",
		"現在請開啟 VS Code 協助工具文件頁面。",
		"感謝您試用 VS Code 的協助工具選項。",
		"狀態:",
		"若要將編輯器為螢幕助讀程式的使用方式設定為永久地最佳化，現在請按 Command+E。",
		"若要將編輯器為螢幕助讀程式的使用方式設定為永久地最佳化，現在請按 Control+E。",
		"編輯器已設定為使用平台 API 以偵測螢幕助讀程式附加，但是目前的執行階段不支援。",
		"編輯器已自動偵測到螢幕助讀程式附加。",
		"編輯器已設定為自動偵測螢幕助讀程式附加，但目前的實際狀況卻不是如此。",
		"編輯器已為螢幕助讀程式的使用方式設定為永久地更新 - 您可以藉由編輯設定 `editor.accessibilitySupport` 以變更這項設定。",
		"編輯器已設定為不會為螢幕助讀程式的使用方式進行最佳化。",
		...
		"現在請按 Command+H 以開啟具有更多與協助工具相關 VS Code 資訊的瀏覽器視窗。",
		"現在請按 Control+H 以開啟具有更多與協助工具相關 VS Code 資訊的瀏覽器視窗。",
	...
	"vs/workbench/parts/codeEditor/electron-browser/languageConfiguration/languageConfigurationExtensionPoint": [
		...
		"必須符合樣式 `/^([gimuy]+)$/`",
		"語言的縮排設定。",
		"若有符合此模式的行，則其後的所有行都應縮排一次，直到符合另一條規則為止。",
		"適用於 increaseIndentPattern 的 RegExp 模式。",
		"適用於 increaseIndentPattern 的 RegExp 旗標。",
		"必須符合樣式 `/^([gimuy]+)$/`",
		"若有符合此模式的行，則其後的所有行都應取消縮排一次，直到符合另一條規則為止。",
		"適用於 decreaseIndentPattern 的 RegExp 模式。",
		"適用於 decreaseIndentPattern 的 RegExp 旗標。",
		"必須符合樣式 `/^([gimuy]+)$/`",
		"若有符合此模式的行，則**僅有下一行**應縮排一次，直到符合另一條規則為止。",
		"適用於 indentNextLinePattern 的 RegExp 模式。",
		"適用於 indentNextLinePattern 的 RegExp 旗標。",
		"必須符合樣式 `/^([gimuy]+)$/`",
		"若有符合此模式的行，則不應該變更其縮排，並且不使用其他規則比對。",
		"適用於 unIndentedLinePattern 的 RegExp 模式。",
		"適用於 unIndentedLinePattern 的 RegExp 旗標。",
		"必須符合樣式 `/^([gimuy]+)$/`",
	],
	...
	"vs/workbench/parts/codeEditor/electron-browser/wordWrapMigration": [
		...
		"不要再顯示",
		"開啟設定",
		"設定 [editor.wrappingColumn] 已標示為即將淘汰，將改為 [editor.wordWrap]。",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"在運算式評估為 true 時中斷。按 \'Enter\' 鍵接受，按 \'esc\' 鍵取消。",
		"程式只有在此條件為 true 時才會在此停止。請按 Enter 鍵接受，或按 Esc 鍵取消。",
		"符合叫用次數條件時中斷。按 \'Enter\' 鍵接受，按 \'esc\' 鍵取消。",
		"程式只會在符合叫用次數時於此處停止。按 Enter 鍵接受，或按 Escape 鍵取消。",
		"運算式",
		"叫用次數",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"在偵錯時於編輯器以內嵌方式顯示變數值",
		"控制是否應隱藏浮點偵錯動作列",
		"全域偵錯啟動組態。應當做在工作區之間共用的 \'launch.json\' 替代方案使用",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugConfigurationManager": [
		...
		"可將偵錯延伸模組視為「預設偵錯工具」的語言清單。",
		"如有指定，VS Code 會呼叫此命令以決定偵錯配接器的可執行檔路徑及要傳遞的引數。",
		"如有指定，VS Code 會為以此延伸模組為目標的「偵錯」或「執行」動作呼叫此命令。",
		"用於在 \'launch.json\' 中新增組態的程式碼片段。",
		...
		"啟動",
		"此檔案格式的版本。",
		"組態清單。請使用 IntelliSense 新增新的組態或編輯現有的組態。",
		"複合的清單。每個複合都參考將會同時啟動的多重組態。",
		"複合的名稱。顯示於啟動組態下拉式功能表。",
		"將會作為此複合一部份而啟動之組態的名稱。",
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"已新增中斷點，行 {0}，檔案 {1}",
		"已移除中斷點，行 {0}，檔案 {1}",
		"複合必須設有 \"configurations\" 屬性，才能啟動多個組態。",
		"\'launch.json\' 中遺漏組態 \'{0}\'。",
		"不支援設定的偵錯類型 \'{0}\'。",
		"遺漏所選啟動設定的屬性 \'type\'。",
		...
		"仍要偵錯",
		"無法對使用中的檔案偵錯。請確認檔案已儲存在磁碟上，而且您已經為該檔案類型安裝偵錯延伸模組。",
		"請為您的應用程式設定啟動組態檔。{0}",
		"找不到 preLaunchTask \'{0}\'。",
	],
	...
	"vs/workbench/parts/debug/electron-browser/replViewer": [
		"第一次評估會擷取物件狀態",
		"變數 {0} 具有值 {1}，「讀取、求值、輸出」迴圈，偵錯",
		"運算式 {0} 具有值 {1}，「讀取、求值、輸出」迴圈，偵錯",
		"{0}，「讀取、求值、輸出」迴圈，偵錯",
		"輸出變數 {0} 具有值 {1}，「讀取、求值、輸出」迴圈，偵錯",
	],
	"vs/workbench/parts/debug/electron-browser/statusbarColorProvider": [
		"對程式執行偵錯時狀態列的背景色彩。狀態列會顯示在視窗的底部",
		"對程式執行偵錯時狀態列的前景色彩。狀態列會顯示在視窗的底部",
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"無法判斷偵錯配接器 \'{0}\' 的可執行檔。",
		"組態的類型。",
		"無法辨識此偵錯類型.請確認已有安裝並啟用相對應的偵錯擴充功能.",
		"\"node2\" 已不再支援，請改用 \"node\"，並將 \"protocol\" 屬性設為 \"inspector\"。",
		"組態的名稱; 出現在啟動組態下拉式功能表中。",
		"要求組態的類型。可以是 [啟動] 或 [附加]。",
		"僅限偵錯延伸模組開發: 如果指定了連接埠，VS Code 會嘗試連線至以伺服器模式執行的偵錯配接器",
		"偵錯工作階段啟動前要執行的工作。",
		"Windows 特定的啟動設定屬性。",
		"OS X 特定的啟動設定屬性。",
		"Linux 特定的啟動設定屬性。",
		"\'env.\'、\'config.\' 及 \'command.\' 已標示為即將淘汰，請改用 \'env:\'、\'config:\' 及 \'command:\'。",
	],
	...
	"vs/workbench/parts/extensions/browser/extensionsActions": [
		...
		"重新載入",
		"重新載入以更新",
		"要重新載入此視窗以啟動已更新的延伸模組 \'{0}\' 嗎?",
		"重新載入以啟動",
		"要重新載入此視窗以啟動延伸模組 \'{0}\' 嗎?",
		"重新載入以停用",
		"要重新載入此視窗以停用延伸模組 \'{0}\' 嗎?",
		"重新載入以停用",
		"要重新載入此視窗以停用已解除安裝的延伸模組 \'{0}\' 嗎?",
		"重新載入視窗(&&R)",
		"顯示擴充功能",
		"安裝擴充功能",
		...
		"設定建議的延伸模組 (工作區)",
		"只有在工作區資料夾中才能使用建議。",
		"無法在 \'.vscode\' 資料夾 ({0}) 中建立 \'extensions.json\' 檔案。",
		"內建",
		"停用所有已安裝的延伸模組",
		"停用此工作區的所有已安裝延伸模組",
		"啟用所有已安裝的延伸模組",
		"啟用此工作區的所有已安裝延伸模組",
		"突出的動作延伸模組按鈕背景色彩 (例如，[安裝] 按鈕)。",
		"突出的動作延伸模組按鈕前景色彩 (例如，[安裝] 按鈕)。",
		"突出的動作延伸模組按鈕背景暫留色彩 (例如，[安裝] 按鈕)。",
	],
	"vs/workbench/parts/extensions/browser/extensionsQuickOpen": [
		"按 Enter 即可管理您的擴充功能。",
		"按 Enter 即可在 Marketplace 中搜尋 \'{0}\'。",
		"輸入擴充功能名稱",
	],
	"vs/workbench/parts/extensions/common/extensionsFileTemplate": [
		"擴充功能",
		"擴充功能的建議清單。擴充功能的識別碼一律為 \'${publisher}.${name}\'。例如: \'vscode.csharp\'。",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsUtils": [
		"要停用其他按鍵對應 ({0})，以避免按鍵繫結關係間的衝突嗎?",
		"是",
		"否",
		"目前已內建 Better Merge 延伸模組，安裝的延伸模組已停用並且可以移除。",
		"解除安裝",
		"稍後",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsViewlet": [
		...
		"排序依據: 評等",
		"排序依據: 名稱",
		"Marketplace 傳回 \'ECONNREFUSED\'。請檢查 \'http.proxy\' 設定。",
		"擴充功能",
		"{0} 過期的擴充功能",
	],
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		...
		"無法停用延伸模組 \'{0}\'。\'{1}\' 及 \'{2}\' 延伸模組相依於此項。",
		"無法停用延伸模組 \'{0}\'。\'{1}\'、\'{2}\' 及其他延伸模組相依於此項。",
		"您要安裝 \'{0}\' 延伸模組嗎?",
		"安裝",
		"取消",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"移至垃圾筒(&&M)",
		"刪除(&&D)",
		"您要刪除的資料夾中 1 個檔案有未儲存的變更。要繼續嗎?",
		"您要刪除的資料夾中 {0} 個檔案有未儲存的變更。要繼續嗎?",
		"您要刪除的檔案有未儲存的變更。要繼續嗎?",
		"如果您不儲存變更，這些變更將會遺失。",
		"您確定要刪除 \'{0}\' 及其內容嗎?",
		"您確定要刪除 \'{0}\' 嗎?",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"讀取與寫入檔案時要使用的預設字元集編碼。",
		"如有啟用，將會在開啟檔案時，嘗試猜測字元集編碼",
		"預設結尾斷行字元.LF使用 \\n , CRLF使用\\r\\n  ",
		"若啟用，將在儲存檔案時修剪尾端空白。",
		"啟用時，請在儲存檔案時在其結尾插入最後一個新行。",
		"已變更的檔案一律不會自動儲存。",
		"已變更的檔案會在設定的 \'files.autoSaveDelay\' 之後自動儲存。",
		"已變更的檔案會在編輯器失去焦點時自動儲存。",
		"已變更的檔案會在視窗失去焦點時自動儲存。",
		"控制已變更之檔案的自動儲存。接受的值: \'{0}\'、\'{1}、\'{2}\' (編輯器失去焦點)、\'{3}\' (視窗失去焦點)。若設為 \'{4}\'，可以在 \"files.autoSaveDelay\" 中設定延遲。",
		"控制要自動儲存已變更之檔案前必須經過的延遲時間 (毫秒)。僅當 \'files.autoSave\' 設為 \"{0}\" 時才適用。",
		"設定檔案路徑的 Glob 模式已將其自檔案監看排除。模式必須符合絕對路徑 (例如使用 ** 或完整路徑前置詞以正確相符)。必須先重新開機才能變更這項設定。若是發生 Code 在啟動時取用大量 CPU 時間的情況，可以排除較大的資料夾以降低起始負載。",
		"停用 Hot Exit。",
		"Hot Exit 將會在關閉應用程式時觸發，也就是在 Windows/Linux 上關閉上一個視窗，或是觸發 workbench.action.quit 命令 (命令選擇區、按鍵繫結關係、功能表) 時觸發。具有備份的所有視窗都會在下次啟動時還原。",
		"當應用程式關閉時會觸發 Hot Exit，也就是說，當在 Windows/Linux 上關閉最後一個視窗，或是觸發 workbench.action.quit 命令 (命令選擇區、按鍵繫結關係及功能表) 時會觸發，同時也針對所有開啟資料夾的視窗，不論其是否為最後一個視窗也會觸發。下次啟動時會還原所有未開啟資料夾的視窗。若要將資料夾視窗還原到關機前的狀態，請將 \"window.restoreWindows\" 設定為 \"all\"。",
		"控制是否讓不同工作階段記住未儲存的檔案，並允許在結束編輯器時跳過儲存提示。",
		"使用新的實驗性檔案監看員。",
		"指派給新檔案的預設語言模式。",
		"編輯器",
		"在儲存時設定檔案格式。格式器必須處於可用狀態、檔案不得自動儲存，且編輯器不得關機。",
		"檔案總管",
		"[開放式編輯器] 窗格中顯示的編輯器數目。將其設定為 0 以隱藏窗格。",
		"控制 [開放式編輯器] 區段的高度是否應依元素數目動態調整。",
	...
	"vs/workbench/parts/markers/common/messages": [
		...
		"({0}, {1})",
		"發生 {1} 個問題的 {0}",
		"{0} 產生的錯誤: 在行 {2} 與字元 {3} 的 {1}",
		"錯誤: 在行 {1} 與字元 {2} 的 {0}",
		"{0} 產生的警告: 在行 {2} 與字元 {3} 的 {1}",
		"警告: 在行 {1} 與字元 {2} 的 {0}",
		"{0} 產生的資訊: 在行 {2} 與字元 {3} 的 {1}",
		"資訊: 在行 {1} 與字元 {2} 的 {0}",
		"{0} 產生的問題: 在行 {2} 與字元 {3} 的 {1}",
		"問題: 在行 {1} 與字元 {2} 的 {0}",
		"顯示錯誤和警告",
	],
	...
	"vs/workbench/parts/performance/electron-browser/performance.contribution": [
		"偵測到啟動速度慢",
		"抱歉! 先前的啟動速度過慢。請重新啟動 \'{0}\' 並啟用剖析功能，同時將設定檔提供給我們，我們將努力提升啟動的品質。",
		"已成功建立設定檔。",
		"請建立問題，並手動附加下列檔案:\n{0}",
		"建立問題並重新啟動",
		"重新啟動",
		"感謝您的協助",
		"需要重新啟動才能夠繼續使用\'{0}‘.再次感謝您的回饋.",
		"重新啟動",
	],
	"vs/workbench/parts/preferences/browser/keybindingWidgets": [
		"按下所需按鍵組合及 ENTER。ESCAPE 可取消。",
		"同步到",
	],
	"vs/workbench/parts/preferences/browser/keybindingsEditor": [
		...
		"顯示衝突",
		"複製",
		"編輯按鍵繫結關係時發生錯誤 \'{0}\'。請開啟 \'keybindings.json\' 檔案加以檢查。",
		"Command",
		"按鍵繫結關係",
		"來源",
		"當",
	...
	"vs/workbench/parts/preferences/browser/preferencesRenderers": [
		...
		"無法寫入設定.請開啟使用者設定並修正檔案中的錯誤/警告後再試一次.",
		...
		"在設定中取代",
		"複製到設定",
		"這項設定必須是使用者設定。若要設定工作區的 PHP，請開啟 PHP 檔案並按一下狀態列中的 [PHP 路徑]。",
		"這項設定必須是使用者設定。",
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"要符合檔案路徑的 Glob 模式。設為 True 或 False 可啟用或停用模式。",
		"在相符檔案同層級上額外的檢查。請使用 $(basename) 作為相符檔案名稱的變數。",
		"控制是否要在文字搜尋中使用 ripgrep",
		"控制在搜尋新的工作區時，是否要根據預設使用 .gitignore 及 .ignore 檔案。",
		"設定以將全域符號搜尋的結果納入 Quick Open 的檔案結果中。",
	],
	...
	"vs/workbench/parts/search/browser/searchResultsView": [
		...
		"資料夾 {2} 的檔案 {1} 中有 {0} 個相符，搜尋結果",
		"根據文字({3})在({2})欄位列表中將({1})替代為文字{{0}}",
		"根據文字({2})並在({1})欄位列表中找到符合({0})的項目",
	],
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"已將 {1} 個檔案中的 {0} 個相符項目取代為 \'{2}\'。",
		"已取代 {1} 個檔案中的 {0} 個相符項目。",
		"要將 {1} 個檔案中的 {0} 個相符項目取代為 \'{2}\' 嗎?",
		"要取代 {1} 個檔案中的 {0} 個相符項目嗎?",
		"要將 {1} 個檔案中的 {0} 個相符項目取代為 \'{2}\' 嗎?",
		"要取代 {1} 個檔案中的 {0} 個相符項目嗎?",
		"要將 {1} 個檔案中的 {0} 個相符項目取代為 \'{2}\' 嗎?",
		"要取代 {1} 個檔案中的 {0} 個相符項目嗎?",
	...
	"vs/workbench/parts/snippets/electron-browser/TMSnippets": [
		...
		"程式碼片段 \"{0}\" 很可能會混淆 snippet-variables 及 snippet-placeholders。如需詳細資料，請參閱 https://code.visualstudio.com/docs/editor/userdefinedsnippets#_snippet-syntax。",
	],
	...
	"vs/workbench/parts/snippets/electron-browser/snippets.contribution": [
		...
		"程式碼片段內容。請使用 \'$1\', \'${1:defaultText}\' 以定義游標位置，並使用 \'$0\' 定義最終游標位置。將 \'${varName}\' and \'${varName:defaultText}\' 插入變數值，例如 \'This is file: $TM_FILENAME\'。",
		"程式碼片段描述。",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchemaCommon": [
		...
		"已被取代。請改用 isBackground。",
		"執行的工作是否保持運作且正在監看檔案系統。",
		"執行的工作是否保持運作且正在背景執行。",
		"是否在 VS Code 有執行中工作的狀態下關閉時提示使用者。",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v1": [
		"組態的版本號碼",
		"執行器已結束支援.請參考官方執行器屬性",
		"定義工作是否作為處理序執行，以及輸出會顯示在輸出視窗或終端機內。",
		"Windows 特定命令組態",
		"Mac 特定命令組態",
		"Linux 特定命令組態",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		"指定此命令是殼層命令或外部程式。如果省略，預設為 False。",
		"已淘汰屬性 isShellCommand。請改為在 [選項] 中使用型別屬性及殼層屬性。此外也請參閱 1.14 版本資訊。",
		"此工作相依的另一個工作。",
		"此工作相依的其他工作。",
		"設定面板，用於呈現工作的輸出並讀取其輸入。",
		"控制是否會將執行的命令回應給面板。預設為 true。",
		"控制面板是否要接受焦點。預設為 true。若設定為 true，也會使顯示面板。",
		"控制是否要顯示執行工作的面板。預設為 [永遠]。",
		"控制面板是否會在工作之間共用、專屬於此工作或是在每個回合建立一個新的面板。",
		"已淘汰終端機屬性。請改用簡報",
		"該工作的執行群組。",
		"定義此工作在群組中是否為預設工作。",
		"將工作標記為預設組建工作。",
		"將工作標記為預設測試工作。",
		"將工作標記為組建工作，並且能使用 [執行組建工作] 命令存取。",
		"將工作標記為組建工作，並且能使用 [執行測試工作] 命令存取。",
		"指派工作到沒有群組",
		"定義工作屬於哪個執行群組。支援將 「組建」新增到組建群組，以及將「測試」新增到測試群組。",
		"定義工作是作為處理序或殼層中的命令執行。預設為處理序。",
		"組態版本號碼",
		"用以參考在 launch.json 或 dependsOn 子句中工作的使用者定義識別碼。",
		"工作的標籤",
		"工作的名稱",
		"已淘汰工作的名稱屬性。請改用標籤屬性。",
		"執行的工作是否保持運作且正在背景執行。",
		...
		"要使用的問題比對器。可以是字串或問題比對器定義，或是字串和問題比對器陣列。",
		"要自訂的工作類型",
		"已淘汰自訂屬性。請參閱 1.14 版本資訊，以了解如何遷移到新的工作自訂方法",
		"已淘汰屬性 showOutput。請改用簡報屬性中的顯示屬性。此外也請參閱 1.14 版本資訊。",
		"已淘汰屬性 echoCommand。請改用簡報屬性中的回應屬性。此外也請參閱 1.14 版本資訊。 ",
		...
		"已淘汰屬性 isBuildCommand。請改用群組屬性。此外也請參閱 1.14 版本資訊。",
		"已淘汰屬性 isTestCommand。請改用群組屬性。此外也請參閱 1.14 版本資訊。",
		"The property suppressTaskName is deprecated. Inline the command with its arguments into the task instead. See also the 1.14 release notes.",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"顯示執行中的工作",
		"工作",
		"變更工作執行引擎需要重新啟動 VS Code。已略過變更。",
		"未定義任何建置工作。請使用 \'isBuildCommand\' 標記 tasks.json 檔案中的工作。",
		"未定義任何組建工作，請在 tasks.json 檔案中將工作標記為 \'build\' 群組。",
		"未定義任何建置工作。請使用 \'isTestCommand\' 標記 tasks.json 檔案中的工作。",
		"未定義任何測試工作，請在 tasks.json 檔案中將工作標記為 \'test\' 群組。",
		"找不到所要求要執行的工作 {0}。",
		"Continue without scanning the task output",
		"永不掃描工作輸出",
		"深入了解掃描工作輸出",
		"Select for which kind of errors and warnings to scan the task output",
		"當前的工作組態存在錯誤.請更正錯誤再執行工作.",
		"定義了很多建置工作於tasks.json.執行第一個.",
		...
		"已有工作在執行。請先終止該工作，然後再執行其他工作。",
		"無法終止再重新啟動工作 {0}",
		"錯誤: 提供的工作組態具有驗證錯誤而無法使用。請先更正這些錯誤。",
		"錯誤: tasks.json 檔案的內容具有語法錯誤。請更正錯誤，再執行工作\n",
		"有一個工作正在執行。要終止工作嗎?",
		"終止工作(&&T)",
		"啟動的工作已不存在。如果工作繁衍的背景處理序結束，VS Code 可能會產生孤立的處理序。若要避免此情況，請啟動有等候旗標的最後一個背景處理序。",
		"仍要結束(&&E)",
		"終止工作",
		...
		"偵測到的工作",
		"正在擷取組建工作...",
		"找不到任何組建工作。請按一下 [設定組建工作] 以加以定義。",
		"請選取要執行的組建工作",
		"正在擷取測試工作...",
		"找不到任何測試工作。請按一下 [設定測試執行器] 以加以定義。",
		"請選取要執行的測試工作",
		"目前沒有執行中的工作。",
		"請選取要終止的工作",
		"啟動的處理序已不存在。如果工作繁衍的背景工作結束，VS Code 可能會產生孤立的處理序。",
		"無法終止執行中的工作",
		"沒有任何要重新啟動的工作。",
		"請選取要重新啟動的工作",
		"已經將 {0} 標記為預設組建工作。",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"警告: 只有在終端機中執行工作時才支援殼層組態。",
		"錯誤: 宣告範圍中的問題比對器必須有名稱:\n{0}\n",
		"警告: 定義的問題比對器未知。支援的類型為 string | ProblemMatcher | (string | ProblemMatcher)[]。\n{0}\n",
		"錯誤: problemMatcher 參考無效: {0}\n",
		"錯誤: 工作組態必須具有型別屬性。將會忽略該組態。\n{0}\n",
		"錯誤: 未將工作宣告為自訂工作。將會忽略該組態。\n{0}\n",
		"錯誤: 工作必須提供 taskName 屬性。即將忽略此工作。\n{0}\n",
		"警告: 工作 \'{0}\' 是殼層命令，但命令名稱或其中一個引數有的未逸出的空格。若要確保命令列正確引述，請將引數合併到命令中。",
		"錯誤: 工作 \'{0}\' 未指定命令與 dependsOn 屬性。將會略過該工作。其定義為: \n{1}",
		"錯誤: 工作 \'{0}\' 未定義命令。即將略過該工作。其定義為:\n{1}",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"在 Windows 終端機上時要使用的命令列引數。",
		"如有設定，這會防止在終端機內按滑鼠右鍵時顯示操作功能表，而是在有選取項目時複製、沒有選取項目時貼上。",
		"控制終端機的字型家族，預設為 editor.fontFamily 的值。",
		"控制是否在終端機中啟用連字字型。",
		"控制終端機的字型大小 (以像素為單位)。",
		"控制終端機的行高，此數字會乘上終端機字型大小，以取得以像素為單位的實際行高。",
		"是否要在終端機內啟用粗體文字。此動作需要終端機殼層的支援。",
		"控制終端機資料指標是否閃爍。",
		"控制終端機資料指標的樣式。",
		"控制終端機保留在其緩衝區中的行數上限。",
		"控制是否在終端機啟動時設定地區設定變數，這在 OS X 上預設為 true，在其他平台則為 false。",
		"終端機啟動位置的明確起始路徑，這會用作殼層處理序的目前工作目錄 (cwd)。當根目錄不是方便的 cwd 時，這在工作區設定中特別好用。",
		"當有使用中的終端機工作階段時，是否要在結束時確認。",
		"一組命令識別碼，其按鍵繫結關係將不會傳送到殼層，而會一律由 Code 處理。這讓通常由殼層取用的按鍵繫結關係，在使用上與未聚焦於終端機時行為相同，例如 Ctrl+P 可啟動 Quick Open。",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalService": [
		"您可以選取 [自訂] 按鈕變更預設的終端機殼層。",
		"自訂",
		"取消",
		"確定，不要再顯示",
		"請選取所需的終端機殼層。您之後可以在設定中變更此選擇",
		"仍有一個使用中的終端機工作階段。要予以終止嗎?",
		"目前共有 {0} 個使用中的終端機工作階段。要予以終止嗎?",
		"是",
		"取消",
	],
	...
	"vs/workbench/parts/views/browser/viewsExtensionPoint": [
		...
		"屬性 \'{0}\' 為強制項目且必須屬於 `string` 類型",
		"屬性 `{0}` 可以省略或必須屬於 `string` 類型",
		"檢視的識別碼。請使用此識別碼透過 `vscode.window.registerTreeDataProviderForView` API 登錄資料提供者。並藉由將 `onView:${id}` 事件登錄至 `activationEvents` 以觸發啟用您的延伸模組。",
		"使用人性化顯示名稱.",
		"必須為 true 以顯示此檢視的條件",
		"提供意見給編輯者",
		"檔案總管檢視",
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"從命令選擇區快速存取及搜尋命令 ({0})",
		"介面概觀",
		"使用視覺覆疊效果強調顯示 UI 的主要元件",
		"Interactive Playground",
		"嘗試使用逐步解說短片中的一些基本編輯器功能",
	],
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage": [
		...
		"Atom",
		"支援功能{0}已被安裝。",
		"{0} 的其他支援安裝完成後，將會重新載入此視窗。",
		"正在安裝 {0} 的其他支援...",
		"找不到ID為{1}的{0}支援功能.",
		"已安裝 {0} 鍵盤快速鍵。",
		"{0} 鍵盤快速鍵安裝完成後，將會重新載入此視窗。",
		"正在安裝 {0} 鍵盤快速鍵...",
		"找不到識別碼為 {1} 的 {0} 鍵盤快速鍵。",
		"歡迎使用",
		"透過路徑 {1} 開啟資料夾 {0}",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		...
		"無法寫入設定.請開啟**使用者設定**並修正錯誤/警告後再試一次.",
		"無法寫入設定.請開啟**工作區設定**並修正檔案中的錯誤/警告後再試一次.",
		"無法寫入設定,因為檔案已變更.請儲存**使用者設定**後再試一次",
		"無法寫入設定,因檔案已變更.請儲存**工作區設定**後再試一次.",
		"使用者設定",
		"工作區設定",
		"Folder Settings",
	],
	"vs/workbench/services/configuration/node/jsonEditingService": [
		"無法寫入檔案.請開啟檔案並修正錯誤/警告後再試一次.",
		"無法寫入檔案,因為檔案已變更.請儲存檔案後再試一次",
	],
	...
	"vs/workbench/services/keybinding/common/keybindingEditing": [
		"因為檔案已變更，所以無法寫入。請儲存按鍵繫結檔案，然後再試一次。",
		"無法寫入按鍵繫結關係。請開啟「按鍵繫結檔案」更正其中的錯誤/警告，然後再試一次。",
		"無法寫入按鍵繫結關係。**按鍵繫結關係檔案** 包含了類型不是 Array 的物件。請開啟檔案加以清除，然後再試一次。",
		"將您的按鍵組合放入此檔案中以覆寫預設值",
	],
	"vs/workbench/services/keybinding/electron-browser/keybindingService": [
		...
		"屬性 `{0}` 可以省略或必須屬於 `string` 類型",
		"觸發按鍵繫結關係時所要執行命令的識別碼。",
		"按鍵或按鍵順序 (以加號分隔按鍵並以空格分隔順序，例如 Ctrl+O 及 Ctrl+L L 進行同步選取)。",
		"Mac 特定按鍵或按鍵順序。",
		"Linux 特定按鍵或按鍵順序。",
		"Windows 特定按鍵或按鍵順序。",
		"按鍵為使用中時的條件。",
		...
		"要傳遞至命令加以執行的引數。",
		"鍵盤",
		"控制按下按鍵時的分派邏輯 (使用 \'keydown.code\' (建議使用) 或 \'keydown.keyCode\')。",
	],
	...
	"vs/workbench/services/textMate/electron-browser/TMSyntax": [
		...
		"`contributes.{0}.embeddedLanguages` 中的值無效。必須是從範圍名稱到語言的物件對應。提供的值: {1}",
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"tmTheme 檔案的路徑 (相對於目前檔案)。",
		"反白顯示語法時的色彩",
	],
	"vs/workbench/services/themes/common/fileIconThemeSchema": [
		"展開資料夾的資料夾圖示。展開資料夾圖示是選擇性的。如果未設定，即顯示為資料夾定義的圖示。",
		"摺疊資料夾的資料夾圖示，如果未設定 folderExpanded，就也是展開資料夾的圖示。",
		"預設檔案圖示，顯示於所有不符合任何副檔名、檔案名稱或語言識別碼的檔案。",
		"建立資料夾名稱與圖示的關聯。物件索引鍵為資料夾名稱，但不包括任何路徑區段。不允許任何圖樣或萬用字元。資料夾名稱比對不區分大小寫。",
		"關聯的圖示定義識別碼。",
		"針對展開的資料夾建立資料夾名稱與圖示的關聯。物件索引鍵為資料夾名稱，但不包括任何路徑區段。不允許任何圖樣或萬用字元。資料夾名稱比對不區分大小寫。",
		"關聯的圖示定義識別碼。",
		"建立副檔名與圖示的關聯。物件索引鍵為副檔名。副檔名為檔案名稱的最後一個區段，在最後一個點之後 (不包括點) 。比較副檔名時不區分大小寫。",
		"關聯的圖示定義識別碼。",
		"建立檔案名稱與圖示的關聯。物件索引鍵為完整檔案名稱，但不包括任何路徑區段。檔案名稱可以包含點和副檔名。不允許任何圖樣或萬用字元。檔案名稱比對不區分大小寫。",
		"關聯的圖示定義識別碼。",
		"關聯語言與圖示。物件索引鍵為語言貢獻點中定義的語言識別碼。",
		"關聯的圖示定義識別碼。",
		"用在圖示定義中的字型。",
		"字型識別碼。",
		"字型位置。",
		...
		"字型樣式。",
		"字型預設大小。",
		"建立檔案與圖示關聯時可使用的所有圖示描述。",
		"圖示定義。物件索引鍵為定義識別碼。",
		"使用 SVG 或 PNG 時: 影像路徑。路徑相對於圖示集檔案。",
		"使用字符字型時: 字型中要使用的字元。",
		"使用字符字型時: 要使用的色彩。",
		"使用字型時: 文字字型的字型大小 (百分比)。如果未設定，預設為字型定義中的大小。",
		"使用字型時: 字型識別碼。如果未設定，預設為第一個字型定義。",
		"以淺色色彩佈景主題顯示檔案圖示的選擇性關聯。",
		"以高對比色彩佈景主題顯示檔案圖示的選擇性關聯。",
	],
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		"剖析 JSON 佈景主題檔案時發生問題: {0}",
		"剖析彩色佈景主題檔案 {0} 時出現問題。屬性 \'settings\' 不是 \'object\' 類型。",
		"剖析彩色佈景主題檔案 {0} 時出現問題。屬性 \'tokenColors\' 應為指定顏色的陣列，或為通往文字配對佈景主題檔案的路徑",
		"剖析 tmTheme 檔案 {0} 時出現問題。\'settings\' 不是陣列。",
		"剖析 tmTheme 檔案 {0} 時發生問題",
		"載入 tmTheme 檔案 {0} 時發生問題: {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		"Contributes textmate color themes.",
		"用在使用者設定中的圖示佈景主題識別碼。",
		"如 UI 中所示的彩色佈景主題標籤。",
		"基底佈景主題定義編輯器的色彩: \'vs\' 是淺色佈景主題，\'vs-dark\' 是深色佈景主題。\'hc-black\' 是深色高對比佈景主題。",
		"tmTheme 檔案的路徑。此路徑是擴充功能資料夾的相對路徑，通常為 \'./themes/themeFile.tmTheme\'。",
		"Contributes file icon themes.",
		"用在使用者設定中的圖示佈景主題識別碼。",
		"以 UI 顯示的圖示佈景主題標籤。",
		"圖示佈景主題定義檔案。路徑相對於擴充功能資料夾，通常為 \'./icons/awesome-icon-theme.json\'。",
		"已將新的佈景主題設定新增到使用者設定。備份位於 {0}。",
		"Unable to load {0}: {1}",
		...
		"Extension point `{0}` must be an array.",
		"`contributes.{0}.path` 中的預期字串。提供的值: {1}",
		"`contributes.{0}.id` 中的預期字串。提供的值: {1}",
		"要包含在擴充功能資料夾 ({2}) 中的預期 `contributes.{0}.path` ({1})。這可能會使擴充功能無法移植。",
		"Unable to load {0}",
		...
		"依目前選擇的彩色佈景主題覆寫顏色",
		"此設定不再為實驗性，且已被重新命名為 \'workbench.colorCustomizations\'",
		"改用\'workbench.colorCustomizations\'",
