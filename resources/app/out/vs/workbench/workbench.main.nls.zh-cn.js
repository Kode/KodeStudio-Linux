...
define("vs/workbench/workbench.main.nls.zh-cn", {
	...
	"vs/platform/actions/electron-browser/menusExtensionPoint": [
		...
		"属性“{0}”可以被省略，否则其类型必须为“string”",
		"属性“{0}”可以被省略，否则其类型必须为“string”",
		"属性“{0}”可以被省略，否则其类型必须为“string”",
		"要执行的命令的标识符。该命令必须在 \"commands\" 部分中声明",
		...
		"属性“{0}”为必需且其类型必须为“字符串”或“对象”",
		"属性“{0}”是必要属性，其类型必须是“string”",
		"属性“{0}”和“{1}`”为必需且其类型必须为“字符串”",
		"要执行的命令的标识符",
		"在 UI 中依据其表示命令的标题",
		"(可选)类别字符串按命令在 UI 中分组",
		...
		"抱歉，目前仅有“editor/title”菜单的“navigation”组支持 alt 命令",
	],
	...
	"vs/platform/markers/common/problemMatcher": [
		...
		"错误: 描述未定义所有者:\n{0}\n",
		"错误: 描述未定义文件位置:\n{0}\n",
		"信息：未知严重性 {0}。有效值为“error”、“warning”和“info”。\n",
		"错误: 标识符为 {0} 的模式不存在。",
		"错误: 模式属性引用空标识符。",
		"错误: 模式属性 {0} 是无效的模式变量名。",
		...
		"如果设置为 true，则会在任务开始时激活后台监控。这相当于发出与 beginPattern 匹配的行。",
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"按 Tab 移动焦点",
		"检测到屏幕阅读器",
		"如果你没有使用屏幕阅读器，请将设置中的“editor.accessibilitySupport”改为“off”。",
		"禁用辅助功能模式",
		"转到行",
		"缩进",
		"选择编码",
	...
	"vs/workbench/common/theme": [
		...
		"非活动组中活动选项卡的前景色。在编辑器区域，选项卡是编辑器的容器。可在一个编辑器组中打开多个选项卡。可以有多个编辑器组。",
		"非活动组中非活动选项卡的前景色。在编辑器区域，选项卡是编辑器的容器。可在一个编辑器组中打开多个选项卡。可以有多个编辑器组。",
		"编辑器组的背景颜色。编辑器组是编辑器的容器。此颜色在拖动编辑器组时显示。",
		"启用选项卡时编辑器组标题的背景颜色。编辑器组是编辑器的容器。",
		"选项卡启用时编辑器组标题的边框颜色。编辑器组是编辑器的容器。",
		"禁用选项卡时编辑器组标题的背景颜色。编辑器组是编辑器的容器。",
		"将多个编辑器组彼此分隔开的颜色。编辑器组是编辑器的容器。",
		"拖动编辑器时的背景颜色。此颜色应有透明度，以便编辑器内容能透过背景。",
		"面板的背景色。面板显示在编辑器区域下方，可包含输出和集成终端等视图。",
		"分隔到编辑器的顶部面板边框色。面板显示在编辑器区域下方，可包含输出和集成终端等视图。",
		"活动面板的标题颜色。面板显示在编辑器区域下方，并包含输出和集成终端等视图。",
		"非活动面板的标题颜色。面板显示在编辑器区域下方，并包含输出和集成终端等视图。",
		"活动面板的边框颜色。面板显示在编辑器区域下方，包含输出和集成终端等视图。",
		"状态栏前景色。状态栏显示在窗口底部。",
		...
		"状态栏突出显示项的背景颜色。突出显示项比状态栏中的其他条目更显眼，表明其重要性更高。状态栏显示在窗口底部。",
		"状态栏突出显示项在悬停时的背景颜色。突出显示项比状态栏中的其他条目更显眼，表明其重要性更高。状态栏显示在窗口底部。",
		"活动栏背景色。活动栏显示在最左侧或最右侧，并允许在侧边栏的视图间切换。",
		"活动栏前景色(例如用于图标)。活动栏显示在最左侧或最右侧，并允许在侧边栏的视图间切换。",
		"活动栏分隔侧边栏的边框颜色。活动栏显示在最左侧或最右侧，并可以切换侧边栏的视图。",
		"活动栏项在被拖放时的反馈颜色。此颜色应有透明度，以便活动栏条目能透过此颜色。活动栏显示在最左侧或最右侧，并允许在侧边栏视图之间切换。",
		...
		"侧边栏节标题的背景颜色。侧边栏是资源管理器和搜索等视图的容器。",
		"侧边栏节标题的前景色。侧边栏包括资源管理器、搜索等视图。",
		"窗口处于活动状态时的标题栏前景色。请注意，该颜色当前仅在 macOS 上受支持。",
		"窗口处于非活动状态时的标题栏前景色。请注意，该颜色当前仅在 macOS 上受支持。",
		"窗口处于活动状态时的标题栏背景色。请注意，该颜色当前仅在 macOS 上受支持。",
		"窗口处于非活动状态时的标题栏背景色。请注意，该颜色当前仅在 macOS 上受支持。",
		"标题栏边框颜色。请注意，该颜色当前仅在 macOS 上受支持。",
		"通知前景色。通知从窗口顶部滑入。",
		"通知背颜色。通知从窗口顶部滑入。",
		"通知按钮背景色。通知从窗口顶部滑入。",
		"悬停时的通知按钮背景色。通知从窗口顶部滑入。",
		"通知按钮前景色。通知从窗口顶部滑入。",
		"消息通知背景色。通知从窗口顶部滑入。",
		"消息通知前景色。通知从窗口顶部滑入。",
		"警告通知背颜色。通知从窗口顶部滑入。",
	...
	"vs/workbench/electron-browser/actions": [
		...
		"工作区",
		"文件",
		"选择并打开(按住 Cmd 键在新窗口中打开) ",
		"选择并打开(按住 Ctrl 键在新窗口中打开)",
		"从最近打开中删除",
		"打开最近的文件…",
		"快速打开最近的文件…",
		"关闭通知消息",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"控制命令面板中保留最近使用命令的数量。设置为 0 则禁用命令历史记录。",
		...
		"重新打开所有窗口。",
		"重新打开所有文件夹。空工作区将不会被恢复。",
		"重新打开上一个活动窗口。",
		"永远不重新打开窗口。总是以一个空窗口启动。",
	...
	"vs/workbench/parts/codeEditor/electron-browser/accessibility": [
		"正在更改“editor.accessibilitySupport”设置为“on”。",
		"正在打开 VS Code 辅助功能文档页面。",
		...
		"编辑器自动检测到已附加屏幕阅读器。",
		"编辑器被配置为自动检测是否附加了屏幕阅读器，当前未检测到。",
		"编辑器被配置为对屏幕阅读器的使用进行永久优化 — 你可以编辑设置中的“editor.accessibilitySupport”以改变此行为。",
		"编辑器被配置为不对屏幕阅读器的使用进行优化。",
		"在当前编辑器中按 Tab 会将焦点移动到下一个可聚焦的元素。按 {0} 来切换此行为。",
		"在当前编辑器中按 Tab 会将焦点移动到下一个可聚焦的元素。当前无法通过键绑定触发命令 {0}。",
		"在当前编辑器中按 Tab 将插入制表符。按 {0} 来切换此行为。",
	...
	"vs/workbench/parts/codeEditor/electron-browser/languageConfiguration/languageConfigurationExtensionPoint": [
		...
		"必须匹配模式“/^([gimuy]+)$/”。",
		"如果一行文本匹配此模式，则之后所有内容都应被取消缩进一次（直到匹配其他规则）。",
	...
	"vs/workbench/parts/extensions/browser/extensionsActions": [
		...
		"启用所有已安装的扩展",
		"启用此工作区的所有已安装的扩展",
		"扩展中突出操作的按钮背景色（比如 安装按钮）。",
		"扩展中突出操作的按钮前景色（比如 安装按钮）。",
		"扩展中突出操作的按钮被悬停时的颜色（比如 安装按钮）。",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsUtils": [
		"禁用其他键映射 ({0}) 以避免键绑定之间的冲突？",
		"是",
		"否",
		"现已内置 Better Merge 扩展。此扩展已被安装并禁用，且能被卸载。",
		"卸载",
		"稍后",
	],
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"控制在多少毫秒后自动保存更改过的文件。仅在“files.autoSave”设置为“{0}”时适用。",
		"配置文件路径的 glob 模式以从文件监视排除。模式必须在绝对路径上匹配(例如 ** 前缀或完整路径需正确匹配)。更改此设置需要重启。如果在启动时遇到 Code 消耗大量 CPU 时间，则可以排除大型文件夹以减少初始加载。",
		"禁用热退出。",
		"应用程序关闭时将触发热退出。在 Windows/Linux 上关闭最后一个窗口或触发 workbench.action.quit 命令（命令托盘、键绑定、菜单）会引起应用程序关闭。下次启动时将还原所有已备份的窗口。",
		"应用程序关闭时将触发热退出。在 Windows/Linux 上关闭最后一个窗口、触发 workbench.action.quit 命令（命令托盘、键绑定、菜单）会引起应用程序关闭。对于任何有文件夹打开的窗口，则不论该窗口是否是最后一个窗口。下次启动时将还原所有未打开文件夹的窗口。若要还原打开有文件夹的窗口，请将“window.restoreWindows”设置为“all”。",
		...
		"按名称的字母顺序排列文件和目录。目录显示在文件前。",
		"按名称的字母顺序排列文件和目录。两者穿插显示。",
		"按名称的字母顺序排列文件和目录。文件显示在目录前。",
		"按扩展名的字母顺序排列文件和目录。目录显示在文件前。",
		"按最后修改日期降序排列文件和目录。目录显示在文件前。",
		"控制文件和目录在资源管理器中的排列方式。",
	],
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"比较",
		"{0} (on disk) ↔ {1} (in {2}) - 解决保存的冲突",
		"使用右侧编辑器工具栏的操作来**撤消**你的更改或用你的更改来**覆盖**磁盘上的内容",
	],
	...
	"vs/workbench/parts/performance/electron-browser/performance.contribution": [
		"检测到启动缓慢",
		"抱歉，出现了启动缓慢的情况。请重启“{0}”并启用分析，将分析文件与我们共享，我们会努力提高启动速度。",
		"已成功创建描述文件。",
		"请创建问题并手动附加以下文件：\n{0}",
		"创建问题并重启",
		"重启",
	...
	"vs/workbench/parts/preferences/browser/keybindingsEditor": [
		...
		"显示冲突",
		"复制",
		"编辑键绑定时发生错误“{0}”。请打开 \"keybindings.json\" 文件并检查。",
		"命令",
		"键绑定",
		"源",
		"何时",
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"控制在新工作区中搜索时是否默认使用 .gitignore 和 .ignore 文件。",
	...
	"vs/workbench/parts/search/browser/searchResultsView": [
		...
		"已找到 {0} 个匹配项",
		"已找到 {0} 个匹配项",
		"根目录 {1} 中找到 {0} 个匹配，搜索结果",
		"文件夹 {2} 的文件 {1} 中有 {0} 个匹配项，搜索结果",
		"在第 {2} 列替换词组 {0} 为 {1}，同行文本为 {3}",
		"在第 {1} 列找到词组 {0}，同行文本为 {2}",
	],
	...
	"vs/workbench/parts/snippets/electron-browser/TMSnippets": [
		...
		"“{0}”代码片段很可能混淆了片段变量和片段占位符。有关详细信息，请访问 https://code.visualstudio.com/docs/editor/userdefinedsnippets#_snippet-syntax。",
	],
	...
	"vs/workbench/parts/snippets/electron-browser/snippets.contribution": [
		...
		"代码片段的内容。使用“$1”和“${1:defaultText}”定义光标位置，使用“$0”定义最终光标位置。使用“${varName}”和“${varName:defaultText}”插入变量值，例如“这是文件：$TM_FILENAME”。",
		"代码片段描述。",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v1": [
		"配置的版本号",
		"此 runner 已完成使命。请使用官方 runner 属性",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		...
		"将任务标记为可通过“运行测试任务”命令访问的测试任务。",
		"将任务分配为没有组",
		"定义此任务属于的执行组。它支持 \"build\" 以将其添加到生成组，也支持 \"test\" 以将其添加到测试组。",
		"定义任务是被作为进程运行还是在 shell 中作为命令运行。默认作为进程运行。",
		"配置的版本号。",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"当前 tasks.json 中定义了多个生成任务。正在执行第一个。\n",
		"任务 \"{0}\" 已激活并处于后台模式。若要终止任务，请选择“任务”菜单中的“终止任务...”。",
		"任务 \"{0}\" 已处于活动状态。若要终止任务，请选择“任务”菜单中的“终止任务...”。",
		...
		"检测到的任务",
		"正在获取生成任务...",
		"未能找到生成任务。按“配置生成任务”来定义一个。",
		"选择要运行的生成任务",
		"正在获取测试任务...",
		"未能找到测试任务。按“配置任务运行程序”来定义一个。",
		"选择要运行的测试任务",
		"当前没有任务在运行。",
		"选择要终止的任务",
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"错误: 任务必须提供 type 属性。将忽略该任务。\n{0}\n",
		"错误: 任务未声明为自定义任务。将忽略配置。\n{0}\n",
		...
		"错误: 任务“{0}”未定义命令。将忽略该任务。其定义为:\n{1}",
		"任务版本 2.0.0 不支持全局操作系统特定任务。请将他们转换为含有操作系统特定命令的任务。受影响的任务有:\n{0}",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminalService": [
		"可通过选择“自定义”按钮来更改默认的终端 shell。",
		"自定义",
		"取消",
		"好，永不再显示",
		"选择首选的终端 shell，你可稍后在设置中进行更改",
		"存在一个活动的终端会话，是否要终止此会话?",
		"存在 {0} 个活动的终端会话，是否要终止这些会话?",
		"是",
		"取消",
	],
	...
	"vs/workbench/parts/views/browser/viewsExtensionPoint": [
		...
		"属性“{0}”是必需的，其类型必须是“string”",
		"属性“{0}”可以省略，否则其类型必须是 \"string\"",
		"视图的标识符。使用标识符通过“vscode.window.registerTreeDataProviderForView” API 注册数据提供程序。同时将“onView:${id}”事件注册到“activationEvents”以激活你的扩展。",
		"人类可读的视图名称。将会被显示",
		"显示此视图必须为真的条件",
		"向编辑器提供视图",
		"资源管理器视图",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		...
		"文件已变更，因此无法写入设置。请先保存 **用户设置** 文件，然后重试。",
		"文件已变更，因此无法写入设置。请先保存 **工作区设置** 文件，然后重试。",
		"用户设置",
		"工作区设置",
		"文件夹设置",
	],
	...
	"vs/workbench/services/keybinding/common/keybindingEditing": [
		"无法写入，因为文件已更新。请保存**键绑定**文件，然后重试。",
		"无法写入键绑定。请打开*键绑定文件***以更正文件中的错误/警告，然后重试。",
		"无法写入键绑定。**键绑定文件**具有不是数组类型的对象。请打开文件进行清理，然后重试。",
		"将键绑定放入此文件中以覆盖默认值",
	],
	"vs/workbench/services/keybinding/electron-browser/keybindingService": [
		...
		"属性“{0}”可以省略，或者其类型必须是“字符串”",
		"要在触发键绑定时运行的命令的标识符。",
		"按键或按键序列。用加号分隔按键，用空格分隔序列。例如，Ctrl+O 和 Ctrl+L L（连续按键）。",
		"Mac 特定的键或键序列。",
		"Linux 特定的键或键序列。",
		"Windows 特定的键或键序列。",
		"键处于活动状态时的条件。",
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"分析 tmTheme 文件时出现问题：{0}",
		"分析 tmTheme 文件 {0} 时出现问题：{1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		...
		"扩展点“{0}”必须是一个数组。",
		"“contributes.{0}.path”中应为字符串。提供的值: {1}",
		"“contributes.{0}.id”中应为字符串。提供的值: {1}",
		"“contributes.{0}.path”({1})应包含在扩展的文件夹({2})内。这可能会使扩展不可移植。",
		"Unable to load {0}",
		...
		"文件图标主题未知或未安装。",
		"覆盖当前所选颜色主题的颜色。",
		"该设置不再是实验性设置，并已重命名为“workbench.colorCustomizations”",
