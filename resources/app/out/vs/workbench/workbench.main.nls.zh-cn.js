...
define("vs/workbench/workbench.main.nls.zh-cn", {
	...
	"vs/base/browser/ui/resourceviewer/resourceViewer": [
		"抱歉，不支持音频文件播放。",
		"抱歉，不支持视频文件播放。",
		"文件无法在编辑器中显示，因为它是二进制文件、非常大或使用不支持的文本编码。",
	],
	...
	"vs/editor/contrib/accessibility/browser/accessibility": [
		...
		"在此编辑器中按 Tab 会将焦点移动到下一个可聚焦的元素。当前无法通过键绑定触发命令 {0}。",
		"实验屏幕阅读器支持因 editor.experimentalScreenReader 设置键而开启。",
		"为此对话开启实验屏幕阅读器支持。通过按 {0} 切换此行为。",
		"为此对话开启了实验屏幕阅读器支持。当前无法通过键绑定触发命令 {0}。",
		"实验屏幕阅读器支持已关闭。通过按 {0} 为此对话开启它或通过将 editor.experimentalScreenReader 设置配置为 true 为所有对话开启它。",
		"实验屏幕阅读器支持已关闭。当前无法通过键绑定触发命令 {0}。通过将 editor.experimentalScreenReader 设置配置为 true 为所有对话开启它。",
	...
	"vs/platform/jsonschemas/common/jsonContributionRegistry": [
		...
		"属性名称到属性名称数组或架构的映射。属性名称数组指的是键中的属性名称。这取决于为保证有效而显示在对象中的数组中的属性。如果该值是一个架构，则该架构仅应用于该对象(如果键中的属性存在于对象上)。",
		"一组有效的文字值",
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"自动检测",
		"选择语言模式",
		"你可以将文件名配置为 **files.associations** 部分中的语言关联。该更改可能需要重启才能在已打开的文件上生效。",
		"更改缩进",
		"此时没有处于活动状态的文本编辑器",
		"活动代码编辑器为只读模式。",
		"更改视图",
	...
	"vs/workbench/electron-browser/update": [
		...
		"{0} 将在重启后更新。",
		"当前没有可用的更新。",
		"此版本的 {0} 已过时，无法自动更新。请手动下载并安装最新版本。",
		"下载最新",
		"发行说明",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"只有当此条件为 true 时行 {0} 上的断点才将停止。按 Enter 以接受或按 Esc 以取消。",
		"为行 {0} 键入断点条件。只有当此条件为 true 时，程序才会在此处停止。按 Enter 以接受或按 Esc 以取消。",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"已继续调试。",
		"已停止调试。",
		"未从 ID 为 {0} 的调试适配器获取线程。",
		"请设置应用程序的启动配置文件。",
		"配置的类型“{0}”不受支持。",
		"launch.json 中的所选配置缺少属性 \"type\"。",
		"运行 preLaunchTask“{0}”时检测到错误。",
		"运行 preLaunchTask“{0}”时检测到错误。",
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"请求配置类型。可以是“启动”或“附加”。",
		"调试会话开始前要运行的任务。",
		"相对路径不再自动转换为绝对路径。请考虑使用 ${workspaceRoot} 作为前缀。",
	],
	...
	"vs/workbench/parts/debug/node/rawDebugSession": [
		...
		"没有为“{0}”调试安装扩展。",
		"无法从 {0} 启动调试适配器。",
		"路径 {0} 上找不到 DebugAdapter bin 文件夹。",
		"{0}。正在停止调试适配器。",
		"调试适配器进程已意外终止",
	],
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"默认行尾字符。",
		"启用后，将在保存文件时剪裁尾随空格。",
		"控制已更新文件的自动保存。接受的值:“{0}”、“{1}”、“{2}”。如果设置为“{3}”，则可在 \"files.autoSaveDelay\" 中配置延迟。",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"使用本地更改并覆盖磁盘内容",
		"磁盘上的文件内容已更改，比较编辑器的左侧已刷新。请再次审查和解析。",
		"放弃本地更改，还原为磁盘上的内容",
	],
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"当前分支“{0}”是最新的。",
		"同步前，请提交、撤销或存储你的更改。",
		"当前分支“{0}”是“{3}”之后的 {1} 个提交和之前的 {2} 个提交。",
		"当前分支“{0}”是“{3}”之后的 {1} 个提交和之前的 {2} 个提交。",
		"当前分支“{0}”是“{3}”之后的 {1} 个提交和之前的 {2} 个提交。",
		"当前分支“{0}”是“{3}”之后的 {1} 个提交和之前的 {2} 个提交。",
		"撤消上次提交",
	...
	"vs/workbench/parts/markdown/common/markdownEditorModel": [
		"无法打开“{0}”进行 Markdown 呈现。请确保文件存在并且是有效的 Markdown 文件。",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"问题位置的匹配组索引。有效的位置模式为(line)、(line,column)和(startLine,startColumn,endLine,endColumn)。如果省略了，将使用行和列。",
		"问题行的匹配组索引。默认值为 2",
		"问题列的匹配组索引。默认值为 3",
		"问题结束行的匹配组索引。默认为未定义",
		"问题结束列的匹配组索引。默认为未定义",
	...
	"vs/workbench/services/themes/node/themeService": [
		"用于 textmate 颜色主题。",
		"颜色主题的标签在 UI 中的显示形式。",
		"定义编辑器周围颜色的基主题: \"vs\" 是浅色主题，\"vs-dark\" 是深色主题。",
		"tmTheme 文件的路径。该路径相对于扩展文件夹，通常为 \"./themes/themeFile.tmTheme\"。",
		"扩展点“{0}”必须是数组。 ",
		"“contributes.{0}.path”中应为字符串。提供的值: {1}",
		"“contributes.{0}.path”({1})应包含在扩展的文件夹({2})内。这可能会使扩展不可移植。",
		"无法加载 {0}",
		"在分析 JSON 主题文件 {0} 时出现问题",
		"问题分析 plist 文件: {0}",
	],
