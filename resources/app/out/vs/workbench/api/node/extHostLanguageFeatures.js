...
define(["require", "exports", 'vs/editor/common/modes/modesFilters', 'vs/base/common/winjs.base', 'vs/base/common/lifecycle', 'vs/platform/thread/common/thread', 'vs/editor/common/core/range', 'vs/workbench/api/node/extHostTypeConverters', 'vs/workbench/api/node/extHostTypes', 'vs/workbench/api/node/extHostDocuments', 'vs/platform/markers/common/markers', 'vs/workbench/api/node/extHostCommands', 'vs/editor/contrib/goToDeclaration/common/goToDeclaration', 'vs/editor/contrib/hover/common/hover', 'vs/editor/contrib/wordHighlighter/common/wordHighlighter', 'vs/editor/contrib/referenceSearch/common/referenceSearch', 'vs/editor/contrib/quickFix/common/quickFix', 'vs/editor/contrib/quickOpen/common/quickOpen', 'vs/workbench/parts/search/common/search', 'vs/editor/contrib/rename/common/rename', 'vs/editor/contrib/format/common/format', 'vs/editor/contrib/codelens/common/codelens', 'vs/editor/contrib/parameterHints/common/parameterHints', 'vs/editor/contrib/suggest/common/suggest', 'vs/base/common/async'], function (require, exports, modesFilters_1, winjs_base_1, lifecycle_1, thread_1, range_1, TypeConverters, extHostTypes_1, extHostDocuments_1, markers_1, extHostCommands_1, goToDeclaration_1, hover_1, wordHighlighter_1, referenceSearch_1, quickFix_1, quickOpen_1, search_1, rename_1, format_1, codelens_1, parameterHints_1, suggest_1, async_1) {
    // --- adapter
    ...
    var CodeLensAdapter = (function () {
        ...
        CodeLensAdapter.prototype.findCodeLensSymbols = function (resource) {
            ...
            if (entry && entry.version === version) {
                return entry.data.then(function (cached) { return cached.symbols; });
            }
            ...
            return newCodeLensData.then(function (newCached) {
                if (entry) {
