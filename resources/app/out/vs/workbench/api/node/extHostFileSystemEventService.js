...
define(["require", "exports", 'vs/platform/files/common/files', 'vs/platform/thread/common/thread', 'vs/base/common/event', './extHostTypes', 'vs/platform/event/common/event', 'vs/base/common/async', 'vs/base/common/glob', 'vs/platform/instantiation/common/instantiation'], function (require, exports, files_1, thread_1, event_1, extHostTypes_1, event_2, async_1, glob_1, instantiation_1) {
    ...
    var ExtHostFileSystemEventService = (function () {
        function ExtHostFileSystemEventService(ns) {
        ...
        ExtHostFileSystemEventService = __decorate([
            thread_1.Remotable.PluginHostContext('ExtHostFileSystemEventService'),
