 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/base/common/strings', 'vs/base/common/uri', 'vs/base/common/platform', 'vs/workbench/parts/output/common/outputWorker', 'vs/workbench/test/browser/servicesTestUtils'], function (require, exports, assert, strings_1, uri_1, platform_1, outputWorker_1, servicesTestUtils_1) {
    function toOSPath(p) {
        if (platform_1.isMacintosh || platform_1.isLinux) {
            return strings_1.replaceAll(p, '\\', '/');
        }
        return p;
    }
