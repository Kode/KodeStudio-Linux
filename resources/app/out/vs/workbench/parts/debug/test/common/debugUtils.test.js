 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", 'vs/workbench/parts/debug/common/debug', 'assert'], function (require, exports, debug, assert) {
    suite('Debug - Utils', function () {
        test('formatPII', function () {
