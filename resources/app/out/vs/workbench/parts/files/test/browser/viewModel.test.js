...
define(["require", "exports", 'assert', 'vs/base/common/types', 'vs/base/common/platform', 'vs/base/common/uri', 'vs/base/common/paths', 'vs/workbench/parts/files/browser/fileActions', 'vs/workbench/parts/files/common/files', 'vs/workbench/parts/files/common/explorerViewModel'], function (require, exports, assert, types_1, platform_1, uri_1, paths_1, fileActions_1, files_1, explorerViewModel_1) {
    ...
    suite('Files - View Model', function () {
        test("Properties", function () {
            ...
            var s = createStat("/path/to/stat", "sName", true, true, 8096, d, "text/plain");
        ...
        test("Add and Remove Child, check for hasChild", function () {
            var d = new Date().getTime();
            var s = createStat("/path/to/stat", "sName", true, false, 8096, d, "text/plain");
            var s2 = createStat("/path/to/stat2", "sName2", false, false, 8096, d, "text/plain");
            var child1 = createStat("/path/to/stat/foo", "foo", true, false, 8096, d, "text/plain");
            var child2 = createStat("/path/to/stat/bar.html", "bar", false, false, 8096, d, "text/html");
            var child3 = createStat("/path/to/stat/bar.html", "bar", false, false, 8096, d, "text/html");
            var child4 = createStat("/otherpath/to/other/otherbar.html", "otherbar.html", false, false, 8096, d, "text/html");
        ...
        test("Move", function () {
            var d = new Date().getTime();
            var s1 = createStat("/", "/", true, false, 8096, d, "text/plain");
            var s2 = createStat("/path", "path", true, false, 8096, d, "text/plain");
            var s3 = createStat("/path/to", "to", true, false, 8096, d, "text/plain");
            var s4 = createStat("/path/to/stat", "stat", false, false, 8096, d, "text/plain");
            s1.addChild(s2);
            s2.addChild(s3);
            s3.addChild(s4);
            assert.throws(function () {
            ...
            var leaf = createStat("/leaf", "leaf", true, false, 8096, d, "text/plain");
            var leafC1 = createStat("/leaf/folder", "folder", true, false, 8096, d, "text/plain");
            var leafCC2 = createStat("/leaf/folder/index.html", "index.html", true, false, 8096, d, "text/html");
        ...
        test("Rename", function () {
            ...
            var s2 = createStat("/path", "path", true, false, 8096, d, "text/plain");
            var s3 = createStat("/path/to", "to", true, false, 8096, d, "text/plain");
            var s4 = createStat("/path/to/stat", "stat", true, false, 8096, d, "text/plain");
            var s5 = createStat("/path/to/stat", "stat", true, false, 8096, d, "text/plain");
            assert.throws(function () {
                s2.rename(null);
            });
            assert.throws(function () {
            ...
            s2.addChild(s3);
            s3.addChild(s4);
            var s2renamed = createStat("/otherpath", "otherpath", true, true, 8096, d, "text/plain");
            s2.rename(s2renamed);
            ...
            var s4renamed = createStat("/otherpath/to/statother.js", "statother.js", true, false, 8096, d, "text/javascript");
            s4.rename(s4renamed);
        ...
        test("Find", function () {
            ...
            var s4 = createStat("/path/to/stat", "stat", true, false, 8096, d, "text/plain");
            var child1 = createStat("/path/to/stat/foo", "foo", true, false, 8096, d, "text/plain");
            var child2 = createStat("/path/to/stat/foo/bar.html", "bar.html", false, false, 8096, d, "text/html");
            s1.addChild(s2);
            s2.addChild(s3);
            s3.addChild(s4);
            s4.addChild(child1);
        ...
        test("Validate File Name (For Create)", function () {
            var d = new Date().getTime();
            var s = createStat("/path/to/stat", "sName", true, true, 8096, d, "text/plain");
            var sChild = createStat("/path/to/stat/alles.klar", "alles.klar", true, true, 8096, d, "text/plain");
            s.addChild(sChild);
