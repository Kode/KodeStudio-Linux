    ...
    function exec(child, encoding) {
        ...
        return winjs_base_1.TPromise.join([
            ...
            new winjs_base_1.TPromise(function (c) {
                ...
                once(child.stdout, 'close', function () { return c(iconv.decode(Buffer.concat(buffers), encoding)); });
            }),
            new winjs_base_1.TPromise(function (c) {
                var buffers = [];
                on(child.stderr, 'data', function (b) { return buffers.push(b); });
                once(child.stderr, 'close', function () { return c(iconv.decode(Buffer.concat(buffers), encoding)); });
            })
