        ...
        ChangesView.prototype.getSecondaryActions = function () {
            ...
            if (!this.secondaryActions) {
                this.secondaryActions = [
                    ...
                    new ActionBar.Separator(),
                    new Actions.Action('show.gitOutput', nls.localize('showOutput', "Show Git Output"), null, true, function () { return _this.outputService.showOutput('Git'); })
                ];
