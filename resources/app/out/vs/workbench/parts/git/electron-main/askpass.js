...
define("vs/nls!vs/base/common/errors",['vs/nls', 'vs/nls!vs/workbench/parts/git/electron-main/askpass'], function(nls, data) { return nls.create("vs/base/common/errors", data); });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define("vs/workbench/parts/git/electron-main/askpass", ["require", "exports", 'vs/base/node/service.net', 'fs'], function (require, exports, service_net_1, fs) {
    'use strict';
