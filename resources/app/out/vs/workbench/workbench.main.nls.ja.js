...
define("vs/workbench/workbench.main.nls.ja", {
	...
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		...
		"アダプター {0} は、起動構成で指定されている変数 {1} を反映していません。",
	...
	"vs/workbench/parts/emmet/node/emmet.contribution": [
		"Emmet の構成",
		"これをオンにすると、TAB キーを押したときに Emmet の省略形が展開されます。",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"更新",
		"有効",
		"この拡張機能を有効にするには、VS Code のこのウィンドウを再起動する必要があります。\n\n続行しますか?",
		"今すぐ再起動",
		"拡張機能を表示する",
		"Install Extensions",
		"インストール済みの拡張機能の表示",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"{0} - ディスク上 ↔ {1} 内",
		"{0} - 保存時の競合の解決",
		"[元に戻す] を選択して変更を破棄するか、または [上書き] を選択してディスクの内容を変更内容に置き換えてください",
		"上書き",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"端末が Windows で使用するシェルのパス。",
		"端末のフォント ファミリを制御します。既定値は editor.fontFamily になります。",
		"端末でフォントの合字が有効かどうかを制御します。",
		"端末のフォント サイズを制御します。既定値は editor.fontSize になります。",
		"端末の行の高さを制御します。既定値は標準になります。",
