...
define("vs/workbench/workbench.main.nls.ja", {
	...
	"vs/platform/environment/node/argv": [
		"`--goto` モードの引数は `FILE(:LINE(:COLUMN))` の形式にする必要があります。",
		...
		"--list-extension の使用時に、インストール済みの拡張機能のバージョンを表示します。",
		"拡張機能をインストールします。",
		"拡張機能をアンインストールします。",
	...
	"vs/workbench/browser/actions/openSettings": [
		...
		"設定ファイル内に設定を挿入して、設定を上書きします。",
		"最もよく使用される設定については、http://go.microsoft.com/fwlink/?LinkId=808995 をご覧ください。",
		"既定の設定",
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"デバッグ セッションの終わりに Explorer ビューレットを自動的に開く",
	],
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"この \"コンポジット\" 構成の一部として起動される構成。この構成の種類が \"コンポジット\" の場合にのみ有効です。",
		"デバッグ セッションの開始前に実行するタスク。",
		"内部デバッグ コンソールの動作を制御します。",
		"Windows 固有の起動構成の属性。",
		"OS X 固有の起動構成の属性。",
		"Linux 固有の起動構成の属性。",
		"相対パスが絶対パスに自動的に変換されなくなります。${workspaceRoot} をプレフィックスとして使用することを考慮してください。",
	],
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		"デバッグ アダプターを提供します。",
		"このデバッグ アダプターの一意識別子。",
		"このデバッグ アダプターの表示名。",
		"これらの言語に対してブレークポイントを許可します。",
		"言語の一覧。",
		...
		"デバッグの種類 \'{0}\' は既に登録されており、属性 \'{1}\' があります、属性 \'{1}\' は無視されます。",
		"環境の選択",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"今すぐ再度読み込む",
		"読み込んでアクティブにする",
		"このウィンドウを再度読み込んで \'{0}\' 拡張機能をアクティブにしますか?",
		"読み込んで有効にする",
		"このウィンドウを再度読み込んで \'{0}\' 拡張機能を有効にしますか?",
		"読み込んで無効にする",
		"このウィンドウを再度読み込んで \'{0}\' 拡張機能を無効にしますか?",
		"読み込んで非アクティブ化する",
		"このウィンドウを再度読み込んで \'{0}\' 拡張機能を非アクティブ化しますか?",
		"すべての拡張機能を更新します",
		"拡張機能を表示する",
		"拡張機能のインストール",
		"インストール済みの拡張機能の表示",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsWorkbenchService": [
		"\'{0}\' は正常にインストールされました。有効にするには再起動してください。",
		"今すぐ再起動",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"名前変更",
		"名前変更",
		"保存されていない変更がある 1 個のファイルを含むフォルダーの名前を変更します。続行しますか?",
		"保存されていない変更がある {0} 個のファイルを含むフォルダーの名前を変更します。続行しますか?",
		...
		"保存されていない変更がある {0} 個のファイルを含むフォルダーを削除します。続行しますか?",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"ディスク上のファイルの内容が変更され、比較エディターの左側が最新の情報に更新されました。確認して再度解決してください。",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"ステージング解除",
		"すべてステージング解除",
		"チェック アウトできません。まず作業をコミットまたはステージングしてください。",
		"ステージング済みをコミット",
		"コミットしてステージング (サインオフ)",
		"Commit",
		"コミット メッセージ",
		...
		"すべてコミット",
		"ステージング済みをコミット",
		"プルできません。まず作業をコミットまたはステージングしてください。",
		"Git リモートで認証が失敗しました。",
		"Git リモートで認証が失敗しました。",
		"プッシュ先...",
	...
	"vs/workbench/parts/markers/common/messages": [
		...
		"({0}, {1})",
		"{0} (問題あり {1})",
		"{0}: {1} によって生成されたエラー (行 {2}、列 {3})",
		"エラー: {0} (行 {1}、列 {2})",
		"{0}: {1} によって生成された警告 (行 {2}、列 {3})",
		"警告: {0} (行 {1}、列 {2})",
		"{0}: {1} によって生成された情報 (行 {2}、列 {3})",
		"情報: {0} (行 {1}、列 {2})",
		"{0}: {1} によって生成された問題 (行 {2}、列 {3})",
		"問題: {0} (行 {1}、列 {2})",
		"エラーと警告",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"問題の列の一致グループ インデックス。既定は 3 です",
		"問題の最終行の一致グループ インデックス。既定は undefined です",
		"問題の最終列の一致グループ インデックス。既定は undefined です",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"端末のフォント サイズをピクセル単位で制御します。既定では editor.fontSize の値になります。",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		...
		"開いているフォルダーがないため、設定を書き込めきません。最初にフォルダーを開いてから、もう一度お試しください。",
