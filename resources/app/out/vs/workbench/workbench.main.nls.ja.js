...
define("vs/workbench/workbench.main.nls.ja", {
	...
	"vs/base/browser/ui/resourceviewer/resourceViewer": [
		"オーディオ ファイルの再生はサポートされていません。",
		"ビデオ ファイルの再生はサポートされていません。",
		"このファイルはバイナリか、非常に大きいか、またはサポートされていないテキスト エンコードを使用しているため、エディターで表示できません。",
	],
	...
	"vs/editor/common/commonCodeEditor": [
		"スクリーン リーダーを使用している場合、{0} を押してください。",
	],
	"vs/editor/common/config/commonEditorConfig": [
		...
		"エディターで次の行に折り返される文字数を制御します。これを 0 に設定すると、ビューポートの幅での折り返しが有効になります",
	...
	"vs/editor/contrib/accessibility/browser/accessibility": [
		...
		"このエディターで Tab キーを押すと、次のフォーカス可能な要素にフォーカスを移動します。コマンド {0} は、キー バインドでは現在トリガーできません。",
		"editor.experimentalScreenReader 設定キーによって、実験用スクリーン リーダーのサポートがオンになっています。",
		"実験用スクリーン リーダーのサポートがこのセッションではオンになっています。{0} を押すと、この動作を切り替えます。",
		"実験用スクリーン リーダーのサポートがこのセッションではオンになっています。コマンド {0} は、キー バインドでは現在トリガーできません。",
		"実験用スクリーン リーダーのサポートがオフになっています。{0} を押してこのセッションでオンにするか、editor.experimentalScreenReader 設定を true に構成して、すべてのセッションでオンになるようにしてください。",
		"実験用スクリーン リーダーのサポートがオフになっています。コマンド {0} は、キー バインドでは現在トリガーできません。editor.experimentalScreenReader 設定を true に構成して、すべてのセッションでオンになるようにしてください。",
	...
	"vs/editor/node/textMate/TMSnippets": [
		"TextMate のスニペットを提供します。",
		"このスニペットの提供先の言語 ID です。",
	...
	"vs/languages/html/common/html.contribution": [
		...
		"末尾に改行を入れます。",
		"先頭に改行を 1 つ入れるタグを、コンマで区切って列挙します。\'null\' は、既定値の \"head, body, /html\" を表します。",
	],
	...
	"vs/platform/actions/common/actionsService": [
		...
		"実行するコマンドの識別子",
		"コマンドが UI に表示されるタイトルです。",
		"(省略可能) コマンド別のカテゴリ文字列が UI でグループ分けされています",
	...
	"vs/platform/extensions/common/extensionsRegistry": [
		...
		"他の拡張機能に対する依存関係。拡張機能の ID は常に ${publisher}.${name} です。例: vscode.csharp。",
	...
	"vs/platform/extensions/node/extensionValidator": [
		...
		"`engines.vscode` ({0}) で指定されたバージョンが十分に特定されていません。1.0.0 より後の vscode バージョンの場合は、少なくとも想定されているメジャー バージョンを定義してください。例 ^1.10.0、1.10.x、1.x.x、2.x.x など。",
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"自動検出",
		"言語モードの選択",
		"**files.associations** セクションで、ファイル名と言語の関連付けを構成できます。既に開いているファイルにこの変更を適用するには、再起動が必要な場合があります。",
		"インデントの変更",
		"現在アクティブなテキスト エディターはありません",
	...
	"vs/workbench/browser/parts/quickopen/quickOpenController": [
		...
		"最近開いたもの",
		"一致する項目はありません",
		"このクイック オープン ハンドラーは現在のコンテキストでは使用できません",
	],
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"再起動後にフォルダーを再度開かれている方法を制御します。[なし] を選択するとフォルダーを再度開くことはありません。[1 つ] を選択すると最後に作業したフォルダーを再度開きます。[すべて] を選択すると前回のセッションのフォルダーすべてを再度開きます。",
		...
		"更新構成",
		"更新プログラムの受信元の更新チャネルを構成します。変更後に再起動が必要です。",
	],
	...
	"vs/workbench/electron-browser/update": [
		...
		"{0} は再起動後に更新されます。",
		"現在入手可能な更新はありません。",
		"このバージョンの {0} は古くなっていて自動的に更新できません。手動で最新のバージョンをダウンロードしてインストールしてください。",
		"最新ファイルをダウンロード",
		"リリース ノート",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"行 {0} のブレークポイントは、この条件が true の場合のみ停止します。\'Enter\' を押して受け入れるか \'Esc\' を押して取り消します。",
		"行 {0} に対するブレークポイント条件を入力します。この条件が true の場合のみプログラムはこの位置で停止します。Enter を押して受け入れるか Esc を押して取り消します。",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"デバッグは続行されました。",
		"デバッグは停止されました。",
		"ID が {0} のデバッグ アダプターからスレッドを取得できませんでした。",
		"アプリケーションの起動構成ファイルをセットアップしてください。",
		"構成されているデバッグの種類 \'{0}\' はサポートされていません。",
		"選択された構成のプロパティ \'type\' が launch.json にありません。",
		"preLaunchTask \'{0}\' の実行中にエラーが検出されました。",
		"preLaunchTask \'{0}\' の実行中にエラーが検出されました。",
	...
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		...
		"起動構成",
		"このファイル形式のバージョン。",
		"構成の一覧。新しい構成を追加したり、既存の構成を編集したります。",
	...
	"vs/workbench/parts/debug/node/rawDebugSession": [
		...
		"DebugAdapter bin フォルダーがパス {0} にありません。",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"今すぐ再起動",
		"拡張機能のアンインストール",
		"\'{0}\' をアンインストールしてもよろしいですか?",
		"\'{0}\' は正常にアンインストールされました。非アクティブ化するには再起動してください。",
		"今すぐ再起動",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsQuickOpen": [
		...
		"{0} は 1 回ダウンロードされました。",
		"{0} は {1} 回ダウンロードされました。",
		"入力してインストール済み拡張機能の一覧を絞り込みます",
		"拡張機能が見つかりません",
		"入力してギャラリーの拡張機能の一覧を絞り込みます",
		"拡張機能が見つかりません",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsWidgets": [
		...
		"拡張機能 ({0} 個の問題)",
		"拡張機能 ({0} 個をインストール中...)",
		"拡張機能 (1 つの更新プログラムが利用可能)",
		"拡張機能 ({0} 個の更新プログラムが利用可能)",
		"拡張機能",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsWorkbenchExtension": [
		...
		"古くなった拡張機能の更新",
		"拡張機能のおすすめの表示",
		"拡張機能は正常にインストールされました。有効にするには再起動してください。",
		"{0} は正常にインストールされました。有効にするには再起動してください。",
		"今すぐ再起動",
	],
	...
	"vs/workbench/parts/files/browser/editors/fileEditorInput": [
		...
		"変更を保存できません",
		"競合",
		"ディスク上のバージョンと競合しているので変更を保存できません",
	],
	"vs/workbench/parts/files/browser/editors/textFileEditor": [
		"テキスト ファイル エディター",
		"ファイルの作成",
		"申し訳ありませんが、ファイルが大きすぎてエディター内で開くことができません。",
		"フォルダー \'{0}\' は現在開いているルート フォルダーの外にあり、このインスタンスでは開くことができません。",
		"{0}。テキスト ファイル エディター。",
		"テキスト ファイル エディター。",
	],
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"前の作業ファイルを開く",
		"作業ファイルが現在ありません。",
		"アクティブ ファイルを作業ファイルに追加する",
		"まずファイルを開いてから作業ファイルに追加してください",
		"作業ファイルにフォーカス",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"ダーティ ファイルの自動保存を制御します。有効な値: \"{0}\"、\"{1}\"、\"{2}\"。\"{3}\" に設定すると、\"files.autoSaveDelay\" で遅延を構成できます。",
		...
		"ファイル エクスプローラー構成",
		"スクロールバーなしで表示される作業ファイルの最大数。",
		"作業ファイル セクションの高さを要素数に合わせて動的に調整するかどうか制御します。",
		"名前で作業ファイルを開く",
		"名前で作業ファイルを開く",
		"ファイル",
	],
	...
	"vs/workbench/parts/files/common/editors/textFileEditorModel": [
		"\'{0}\' の保存に失敗しました: {1}",
		"ファイル変更リスナーから予期しないエラーがスローされました。リスナーの種類: {0}",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"同期しています...",
		"デタッチ モードで同期できません。",
		"現在のブランチ \'{0} にはアップストリームのブランチが構成されていません。",
		"現在のブランチ \'{0}\' は最新の状態です。",
		"同期する前に変更をコミットする、元に戻す、または格納します。",
		"現在のブランチ \'{0}\' は、{1} 個のコミットの後で、\'{3}\' から {2} 個のコミットの前です。",
		"現在のブランチ \'{0}\' は、{1} 個のコミットの後で、\'{3}\' から {2} 個のコミットの前に位置しています。",
		"現在のブランチ \'{0}\' は、{1} 個のコミットの後で、\'{3}\' から {2} 個のコミットの前です。",
		"現在のブランチ \'{0}\' は、{1} 個のコミットの後で、\'{3}\' から {2} 個のコミットの前です。",
		"前回のコミットを元に戻す",
		"チェックアウト",
	...
	"vs/workbench/parts/markdown/browser/markdownActions": [
		"プレビューの切り替え",
		"まずマークダウン ファイルを開いてからプレビューを表示します。",
		"プレビューを横に表示",
		"まずマークダウン ファイルを開いてからプレビューを表示します。",
		"プレビューを開く",
		"プレビューを開く",
	...
	"vs/workbench/parts/markdown/common/markdownEditorModel": [
		"マークダウンのレンダリングのために \'{0}\' を開くことができません。ファイルが存在しており、有効なマークダウン ファイルであることを確認してください。",
	],
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"名前でシンボルを開く",
		"検索構成",
		"検索結果でファイルとフォルダーを除外するために glob パターンを構成します。file.exclude 設定からすべての glob パターンを継承します。",
		"ファイル パスの照合基準となる glob パターン。これを true または false に設定すると、パターンがそれぞれ有効/無効になります。",
	...
	"vs/workbench/parts/tasks/node/processRunnerDetector": [
		...
		"名前 \'{0}\' のビルド タスクが検出されしました。",
		"名前 \'{0}\' のテスト タスクが検出されしました。",
	],
	"vs/workbench/parts/tasks/node/processRunnerSystem": [
		"構成されているビルド タスクがありません。",
	...
	"vs/workbench/services/themes/node/themeService": [
		...
		"UI で表示される配色テーマのラベル。",
		"エディターの枠の色を定義する基本テーマ。\'vs\' は明色のテーマで、\'vs-dark\' は暗色のテーマです。",
		"tmTheme ファイルのパス。拡張機能フォルダーに対する相対パスで、通常 \'./themes/themeFile.tmTheme\' です。",
		"拡張点 `{0}` は配列でなければなりません。",
		"`contributes.{0}.path` に文字列が必要です。提供された値: {1}",
		"拡張機能のフォルダー ({2}) の中に `contributes.{0}.path` ({1}) が含まれている必要があります。これにより拡張を移植できなくなる可能性があります。",
		"{0} を読み込めません",
		"JSON テーマ ファイルの解析中に問題が起きました: {0}",
