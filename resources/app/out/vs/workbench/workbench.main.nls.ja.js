 ...
 *--------------------------------------------------------*/
define("vs/workbench/workbench.main.nls.ja", {
	...
	"vs/base/browser/ui/resourceviewer/resourceViewer": [
		"{0}x{1} {2}",
		"画像が非常に大きいため、エディターに表示されません。 ",
		"外部のプログラムを使用して画像を開きますか?",
		"このファイルはバイナリか、非常に大きいか、またはサポートされていないテキスト エンコードを使用しているため、エディターに表示されません。",
		"{0}B",
		"{0}KB",
		"{0}MB",
		"{0}GB",
	...
	"vs/platform/actions/electron-browser/menusExtensionPoint": [
		"メニュー項目は配列にする必要があります",
		"`{0}` プロパティは必須で、`string` 型でなければなりません",
		"`{0}` プロパティは省略するか、`string` 型にする必要があります",
		"`{0}` プロパティは省略するか、`string` 型にする必要があります",
		"`{0}` プロパティは省略するか、`string` 型にする必要があります",
		"実行するコマンドの識別子。コマンドは \'commands\' セクションで宣言する必要があります",
		"実行する別のコマンドの識別子。コマンドは \'commands\' セクションで宣言する必要があります",
		"この項目を表示するために満たす必要がある条件",
		"このコマンドが属するグループ",
		"メニュー項目をエディターに提供します",
		"コマンド パレット",
		"エディターのタイトル メニュー",
		...
		"エディターのタブのコンテキスト メニュー",
		"デバッグの呼び出し履歴のコンテキスト メニュー",
		"ソース管理のタイトル メニュー",
		"ソース管理リソース グループのコンテキスト メニュー",
		"ソース管理リソース状態のコンテキスト メニュー",
		"提供されたビューのタイトル メニュー",
		"提供されたビュー項目のコンテキスト メニュー",
		"空でない値が必要です。",
		"`{0}` プロパティは必須で、`string` 型でなければなりません",
		"`icon` プロパティは省略できます。指定する場合には、文字列または `{dark, light}` などのリテラルにする必要があります",
		"`{0}` プロパティは必須で、`string` または `object` の型でなければなりません",
		"`{0}` プロパティは必須で、`string` 型でなければなりません",
		"プロパティの `{0}` と `{1}` は必須で、`string` 型でなければなりません",
		"実行するコマンドの識別子",
		"コマンドが UI に表示される際のタイトル",
		"(省略可能) コマンド別のカテゴリ文字列が UI でグループ分けされます",
		"(省略可能) UI でコマンドを表すためのアイコン。ファイル パス、またはテーマ設定可能な構成のいずれかです",
		"ライト テーマが使用される場合のアイコン パス",
		"ダーク テーマが使用される場合のアイコン パス",
		"コマンド パレットにコマンドを提供します。",
		"コマンド `{0}` が `commands` セクションで複数回出現します。",
		"`{0}` は有効なメニュー識別子ではありません",
		"メニュー項目が、\'commands\' セクションで定義されていないコマンド `{0}` を参照しています。",
		"メニュー項目が、\'commands\' セクションで定義されていない alt コマンド `{0}` を参照しています。",
		"メニュー項目において、既定と alt コマンドが同じコマンドを参照しています",
		"申し訳ございません。現在、alt コマンドをサポートしているのは \'editor/title\' メニューの \'navigation\' グループのみです",
	],
	...
	"vs/platform/integrity/node/integrityServiceImpl": [
		...
		"今後は表示しない",
		"詳細情報",
		"{0} インストールが壊れている可能性があります。再インストールしてください。",
	],
	"vs/platform/jsonschemas/common/jsonValidationExtensionPoint": [
		"JSON スキーマ構成を提供します。",
		"一致するファイル パターン、たとえば \"package.json\" または \"*.launch\" です。",
		"スキーマ URL (\'http:\', \'https:\') または拡張機能フォルダーへの相対パス (\'./\') です。",
		"\'configuration.jsonValidation\' は配列でなければなりません",
		"\'configuration.jsonValidation.fileMatch\' が定義されていなければなりません",
		"\'configuration.jsonValidation.url\' は、URL または相対パスでなければなりません",
		"\'configuration.jsonValidation.url\' は正しくない相対 URL です: {0}",
		"\'configuration.jsonValidation.url\' は、\'http:\'、\'https:\'、または拡張機能にあるスキーマを参照する \'./\' で始まる必要があります",
	],
	...
	"vs/platform/markers/common/problemMatcher": [
		"ループ プロパティは、最終行マッチャーでのみサポートされています。",
		"問題パターンに正規表現がありません。",
		"問題のパターンが正しくありません。少なくとも、ファイル、メッセージと行、またはロケーション一致グループがなければなりません。",
		"エラー: 文字列 {0} は、有効な正規表現ではありません。\n",
		"出力のエラー、警告、または情報を検索する正規表現。",
		"ファイル名の一致グループ インデックス。省略すると、1 が使用されます。",
		"問題の場所の一致グループ インデックス。有効な場所のパターンは (line)、(line,column)、(startLine,startColumn,endLine,endColumn) です。省略すると、 (line,column) が想定されます。",
		"問題の行の一致グループ インデックス。既定は 2 です",
		"問題の行の文字の一致グループ インデックス。既定は 3 です",
		"問題の最終行の一致グループ インデックス。既定は undefined です",
		"問題の最終行の文字の一致グループ インデックス。既定は undefined です",
		"問題の重大度の一致グループ インデックス。既定は undefined です",
		"問題のコードの一致グループ インデックス。既定は undefined です",
		"メッセージの一致グループ インデックス。省略した場合、場所を指定すると既定は 4 で、場所を指定しないと既定は 5 です。",
		"複数行マッチャー ループは、このパターンが一致する限りループで実行されるかどうかを示します。複数行パターン内の最後のパターンでのみ指定できます。",
		"問題パターンの名前。",
		"The name of the problem multi line problem pattern.",
		"実際のパターン。",
		"問題パターンを提供",
		"無効な問題パターンです。パターンは無視されます。",
		"無効な問題パターンです。パターンは無視されます。",
		"エラー: 説明を問題マッチャーに変換することができません:\n{0}\n",
		"エラー: 説明に有効な問題パターンが定義されていません:\n{0}\n",
		"エラー: 説明に所有者が定義されていません:\n{0}\n",
		"エラー: 説明にファイルの場所が定義されていません:\n{0}\n",
		"情報: 不明な重大度 {0}。有効な値は、error、warning、info です。\n",
		"エラー: 識別子 {0} のパターンは存在しません。",
		"エラー: パターン プロパティが空の識別子を参照しています。",
		"エラー: パターン プロパティ {0} は有効なパターン変数名ではありません。",
		"問題マッチャーは、ウォッチ対象の開始パターンと終了パターンの両方を定義する必要があります。",
		"エラー: 文字列 {0} は、有効な正規表現ではありません。\n",
		"バックグラウンド タスクの開始または終了を検出する正規表現。",
		"ファイル名の一致グループ インデックス。省略できます。",
		"提供されたか事前定義された問題パターンの名前",
		"A problem pattern or the name of a contributed or predefined problem pattern. Can be omitted if base is specified.",
		"使用する基本問題マッチャーの名前。",
		"Code 内の問題の所有者。base を指定すると省略できます。省略して base を指定しない場合、既定は \'external\' になります。",
		"キャプチャされた問題の既定の重大度。パターンが重要度の一致グループを定義していない場合に使用されます。",
		"テキスト ドキュメントで報告された問題が、開いているドキュメントのみ、閉じられたドキュメントのみ、すべてのドキュメントのいずれに適用されるかを制御します。",
		"問題パターンで報告されたファイル名を解釈する方法を定義します。",
		"バックグラウンド タスクでアクティブなマッチャーの開始と終了を追跡するパターン。",
		"true に設定すると、タスクの開始時にバックグラウンド モニターがアクティブ モードになります。これは beginPattern と一致する行の発行と同等です。",
		"出力内で一致すると、バックグラウンド タスクの開始が通知されます。",
		"出力内で一致すると、バックグラウンド タスクの終了が通知されます。",
		"watching プロパティは使用されなくなりました。代わりに background をご使用ください。",
		"監視パターンの開始と終了を追跡するマッチャー。",
		"true に設定すると、タスクの開始時にウォッチャーがアクティブ モードになります。これは beginPattern と一致する行の発行と同等です。",
		"出力内で一致すると、ウォッチ中のタスクの開始が通知されます。",
		"出力内で一致すると、ウォッチ中のタスクの終了が通知されます。",
		"このプロパティは非推奨です。代わりに watching プロパティをご使用ください。",
		"ファイル ウォッチでトリガーされた ウォッチ対象タスクの実行が開始されたことを伝達する正規表現。",
		"このプロパティは非推奨です。代わりに watching プロパティをご使用ください。",
		"ウォッチ対象タスクの実行が終了したことを伝達する正規表現。",
		"これを参照するのに使用する問題マッチャーの名前。",
		"問題マッチャーの判読できるラベル。",
		"問題マッチャーを提供",
		"Microsoft コンパイラの問題",
		"Less の問題",
	...
	"vs/workbench/browser/actions/workspaceActions": [
		...
		"選択(&&S)",
		"ワークスペースのフォルダーを選択",
		"複数のフォルダーを開くには、ウィンドウの再読み込みが必要です。",
		"ワークスペースにフォルダーを追加...",
		"追加(&&A)",
		"ワークスペースにフォルダーを追加",
		"ワークスペースからフォルダーを削除",
		"名前を付けてワークスペースを保存...",
		"最初に保存するためのワークスペースを開いてください。",
		"ワークスペースを保存するには、ウィンドウの再読み込みが必要です。",
		"保存(&&S)",
		"ワークスペースを保存",
		"ワークスペースを開く...",
		"新しいワークスペース...",
	...
	"vs/workbench/browser/parts/editor/editor.contribution": [
		...
		"横並びエディター",
		"最初のグループのエディターを表示する",
		"2 番目のグループでエディターを表示する",
		"3 番目のグループのエディターを表示する",
		"開いているエディターをすべて表示する",
		"表示",
	],
	"vs/workbench/browser/parts/editor/editorActions": [
		...
		"2 つのグループのエディターを結合",
		"エディター グループ間で移動する",
		"アクティブなエディター グループにフォーカス",
		"最初のエディター グループにフォーカス",
		"2 番目のエディター グループにフォーカス",
		"3 番目のエディター グループにフォーカス",
		"前のグループにフォーカス",
		"次のグループにフォーカス",
		"横に並べて開く",
		"エディターを閉じる",
		...
		"エディター グループを右側に移動する",
		"他のエディター グループを最小化する",
		"エディター グループの幅を等間隔に設定する",
		"エディター グループを最大化してサイドバーを非表示にする",
		"エディターを保持",
		"次のエディターを開く",
		"以前のエディターを開く",
		"グループ内で次のエディターを開く",
		...
		"エディターをグループに表示する",
		"すべてのエディターを表示する",
		"グループ内の最近使用したエディターのうち前のエディターを開く",
	...
	"vs/workbench/browser/parts/editor/editorCommands": [
		"タブまたはグループ別にアクティブ エディターを移動する",
		"アクティブ エディターの Move 引数",
		"引数プロパティ:\n\t\t\t\t\t\t* \'to\': 引数プロパティ\n\t\t\t\t\t\t* \'by\': 移動に使用する単位を指定する文字列値。タブ別またはグループ別。\n\t\t\t\t\t\t* \'value\': 移動する位置数と絶対位置を指定する数値。\n\t\t\t\t\t",
		"コマンド **{0}** は削除されました。代わりに **{1}** を使用できます",
		"ショートカット キーの構成",
	],
	...
	"vs/workbench/browser/parts/editor/editorPicker": [
		"{0}、エディター グループの選択",
		"グループ: {0}",
		"グループ内に一致する開いているエディターがありません",
		"グループ内で開いているエディターの一覧は現在、空です",
		"一致する開いているエディターがありません",
		"開いているエディターの一覧は現在、空です",
	],
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"タブによるフォーカスの移動",
		"スクリーン リーダーを検出しました",
		"スクリーン リーダーを使用しない場合、`editor.accessibilitySupport` を \"off\" にしてください。",
		"アクセシビリティ モードを無効にする",
		"行へ移動",
		"インデント",
		"エンコードの選択",
		...
		"スペース: {0}",
		"タブのサイズ: {0}",
		"\'{0}\' の Marketplace の拡張機能を検索する ...",
		"言語モードの変更",
		"現在アクティブなテキスト エディターはありません",
		"({0}) - 構成済みの言語",
		"({0})",
		"言語 (識別子)",
		"\'{0}\' 言語ベース設定を構成します...",
	...
	"vs/workbench/browser/parts/quickopen/quickOpenController": [
		...
		"選べるエントリがありません",
		"\'?\' と入力すると、ここで実行できる処理に関するヘルプが表示されます",
		"最近開いたもの",
		"最近開いたもの",
		"一致する項目はありません",
		"この Quick Open ハンドラーは現在のコンテキストでは使用できません",
		"{0}、最近開いたもの",
		"履歴から削除",
		"履歴から削除するエディター エントリを選ぶ",
	],
	...
	"vs/workbench/common/theme": [
		...
		"非アクティブ グループ内のアクティブ タブの前景色。タブはエディター領域におけるエディターのコンテナーです。1 つのエディター グループで複数のタブを開くことができます。エディター グループを複数にすることもできます。",
		"非アクティブ タブの前景色。タブはエディター領域におけるエディターのコンテナーです。1 つのエディター グループで複数のタブを開くことができます。エディター グループを複数にすることもできます。",
		...
		"タブが有効な場合の エディター グループ タイトル ヘッダーの境界線色。エディター グループはエディターのコンテナーです。",
		...
		"フォルダーが開いていないときのステータス バーの前景色。ステータス バーはウィンドウの下部に表示されます。",
		"標準ステータス バーの背景色。ステータス バーはウィンドウの下部に表示されます。",
		"フォルダーが開いていないときのステータス バーの背景色。ステータス バーはウィンドウの下部に表示されます。",
		"サイドバーとエディターを隔てるステータス バーの境界線色。ステータス バーはウィンドウの下部に表示されます。",
		"フォルダーを開いていないときにサイドバーとエディターを隔てるワークスペースのステータス バーの境界線の色。ステータス バーはウィンドウの下部に表示されます。 ",
		...
		"サイド バーの前景色。サイド バーは、エクスプローラーや検索などのビューが入るコンテナーです。",
		"エディターとの区切りを示すサイド バーの境界線の色。サイド バーは、エクスプローラーや検索などのビューが入るコンテナーです。",
		"サイド バーのタイトルの前景色。サイド バーは、エクスプローラーや検索などのビューが入るコンテナーです。",
		"サイド バーのセクションのドラッグ アンド ドロップ フィードバックの色。サイド バーのセクションが最後まで輝くために、色は透過である必要があります。サイド バーはエクスプローラーや検索のようなビューのコンテナーです。",
		"サイド バーのセクション ヘッダーの背景色。サイド バーは、エクスプローラーや検索などのビューが入るコンテナーです。",
		"サイド バーのセクション ヘッダーの前景色。サイド バーは、エクスプローラーや検索などのビューが入るコンテナーです。",
		...
		"タイトル バーの境界線色。現在、この色は macOS でのみサポートされているのでご注意ください。",
		"通知の前景色。通知はウィンドウの上部からスライド表示します。",
		"通知の背景色。通知はウィンドウの上部からスライド表示します。",
		"通知ボタンの背景色。通知はウィンドウの上部からスライド表示します。",
		"ホバー時の通知ボタンの背景色。通知はウィンドウの上部からスライド表示します。",
		"通知ボタンの前景色。通知はウィンドウの上部からスライド表示します。",
		"情報通知の背景色。通知はウィンドウの上部からスライド表示します。",
		"情報通知の前景色。通知はウィンドウの上部からスライド表示します。",
		"警告通知の背景色。通知はウィンドウの上部からスライド表示します。",
		"警告通知の前景色。通知はウィンドウの上部からスライド表示します。",
		"エラー通知の背景色。通知はウィンドウの上部からスライド表示します。",
		"エラー通知の前景色。通知はウィンドウの上部からスライド表示します。",
	],
	"vs/workbench/electron-browser/actions": [
		"エディターを閉じる",
		"ウィンドウを閉じる",
		"ワークスペースを閉じる",
		"このインスタンスで現在開いているワークスペースがないので、閉じられません。",
		"新しいウィンドウ",
		"全画面表示の切り替え",
		"メニュー バーの切り替え",
		"開発者ツールの切り替え",
		...
		"ワークスペース",
		"ファイル",
		"開くものを選択 (Cmd キーを押しながら新しいウィンドウで開く)",
		"開くものを選択 (Ctrl キーを押しながら新しいウィンドウで開く)",
		"最近開いた項目から削除",
		"最近開いた項目…",
		"最近使用したものを開く...",
		"通知メッセージを閉じる",
	...
	"vs/workbench/electron-browser/extensionHost": [
		"拡張機能ホストが 10 秒以内に開始されませんでした。先頭行で停止している可能性があり、続行するにはデバッガーが必要です。",
		"拡張機能ホストが 10 秒以内に開始されませんでした。問題が発生している可能性があります。",
		"拡張機能ホストからのエラー: {0}",
		"開発者ツール",
		"拡張機能ホストが予期せずに終了しました。回復するには、ウィンドウを再度読み込んでください。",
	],
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"サブピクセル方式でフォントを滑らかにします。ほとんどの非 Retina ディスプレイでもっとも鮮明なテキストを提供します。",
		"サブピクセルとは対照的に、ピクセルのレベルでフォントを滑らかにします。フォント全体がより細く見えるようになります。",
		"フォントのスムージングを無効にします。テキストをぎざぎざな尖ったエッジで表示します。",
		"3 本の指で横方向にスワイプすると、開いているファイル間を移動できます。",
		"ワークベンチ",
		"新しいウィンドウでファイルを開きます",
		"ファイルのフォルダーが開かれていたウィンドウまたは最後のアクティブ ウィンドウでファイルを開きます",
		"ファイルのフォルダーが開かれていたウィンドウでファイルを開くか、Dock または Finder を使用して開く場合以外は最後のアクティブ ウィンドウでファイルを開きます (macOS のみ)",
		...
		"新しいウィンドウでフォルダーを開きます",
		"フォルダーは、最後のアクティブ ウィンドウで開きます",
		"フォルダーがアプリケーション内から (たとえば、[ファイル] メニューから) 選択された場合を除いて、新しいウィンドウでフォルダーを開きます",
		...
		"すべてのウィンドウを再度開きます。",
		"すべてのフォルダーを再度開きます。空のワークスペースは復元されません。",
		"最後にアクティブだったウィンドウを再び開きます。",
		"ウィンドウ再度開きません。常に空のウィンドウで開始します。",
		"再起動後にワークスペースを再度開く方法を制御します。\'none\' を選択すると常に空のワークスペースで開始します。\'one\' を選択すると最後に使用したウィンドウを再度開きます。\'folders\' を選択すると開かれていたフォルダーとすべてのウィンドウを再度開きます。\'all\' を選択すると前回のセッションのすべてのウィンドウを再度開きます。",
		...
		"新しいウィンドウを画面の中央に開きます。",
		"新しいウィンドウを、最後にアクティブだったウィンドウと同じサイズで開きます。",
		"新しいウィンドウを最大化した状態で開きます。",
		"新しいウィンドウを全画面表示モードで開きます。",
		...
		"メニューは全画面表示モードの場合にのみ非表示です。",
		"全画面表示モードの場合も含めて、常にメニューが表示されます。",
		"メニューは非表示ですが、Alt キーを押すと表示できます。",
		"メニューは常に非表示です。",
		"メニュー バーの表示/非表示を制御します。\'切り替え\' 設定は Alt キーを 1 回押すとメニュー バーの表示/非表示が切り替わることを意味します。既定では、ウィンドウが全画面表示の場合を除き、メニュー バーは表示されます。",
		"有効にすると、Alt キー ショートカットを使用してメイン メニューを開くことができます。ニーモニックを無効にすると、これらの Alt キー ショートカットをエディター コマンドの代わりにバインドできます。",
		"有効にすると、Windows でハイ コントラスト テーマが使用されている場合にはハイ コントラスト テーマに自動的に変更され、Windows のハイ コントラスト テーマから切り替えられている場合にはダーク テーマに自動的に変更されます。",
		"ウィンドウのタイトル バーの外観を調整します。変更を適用するには、完全に再起動する必要があります。",
		"macOS Sierra ウィンドウ タブを有効にします。この変更を適用するには完全な再起動が必要であり、ネイティブ タブでカスタムのタイトル バー スタイルが構成されていた場合はそれが無効になることに注意してください。",
		"ウィンドウ",
		"Zen Mode",
	...
	"vs/workbench/node/extensionPoints": [
		"{0} を解析できません: {1}。",
		"ファイル {0} を読み取れません: {1}。",
		"{0} または {1} を解析できませんでした: {2}。",
		"ファイル {0} を読み取れません: {1}。",
		"キー {0} のメッセージが見つかりませんでした。",
	],
	"vs/workbench/parts/cli/electron-browser/cli.contribution": [
		"PATH 内に \'{0}\' コマンドをインストールします",
		"このコマンドは使用できません",
		"シェル コマンド \'{0}\' が PATH に正常にインストールされました。",
		"管理者特権でシェル コマンドをインストールできるように、Code が \'osascript\' のプロンプトを出します",
		"OK",
		"\'/usr/local/bin\' を作成できません。",
		"キャンセル",
		"中止されました",
		"\'{0}\' コマンドを PATH からアンインストールします",
		"このコマンドは使用できません",
		"シェル コマンド \'{0}\' が PATH から正常にアンインストールされました。",
		"シェル コマンド",
	],
	"vs/workbench/parts/codeEditor/electron-browser/accessibility": [
		"現在 `editor.accessibilitySupport` 設定を \'on\' に変更しています。",
		"現在 VS Code のアクセシビリティ ドキュメントページを開いています。",
		"VS Code のアクセシビリティ オプションをご利用いただき、ありがとうございます。",
		"ステータス:",
		"スクリーン リーダーで使用するためにエディターを永続的に最適化するように設定するには、Command + E を押してください。",
		"スクリーン リーダーで使用するためにエディターを永続的に最適化するように設定するには、Control + E を押してください。",
		"エディターは、プラットフォーム API を使用してスクリーン リーダーがいつ接続されたかを検出するように設定されていますが、現在のランタイムはこれをサポートしていません。",
		"エディターはスクリーン リーダーの接続を自動検出しました。",
		"エディターは、スクリーン リーダーが接続されると自動的に検出するように構成されていますが、今回は検出できませんでした。",
		"エディターはスクリーン リーダーで使用するために永続的に最適化されるように設定されています。これは `editor.accessibilitySupport` の設定を編集することで変更できます。",
		"エディターはスクリーン リーダー向けに最適化しないように構成されています。",
		...
		"command + H キーを押して、ブラウザー ウィンドウを今すぐ開き、アクセシビリティに関連する他の VS Code 情報を確認します。",
	...
	"vs/workbench/parts/codeEditor/electron-browser/languageConfiguration/languageConfigurationExtensionPoint": [
		...
		"右角かっこまたは文字列シーケンス。",
		"コメント記号を定義します。",
		"ブロック コメントのマーク方法を定義します。",
		"ブロック コメントを開始する文字シーケンス。",
		"ブロック コメントを終了する文字シーケンス。",
		"行コメントを開始する文字シーケンス。",
		"インデントを増減する角かっこを定義します。",
		"角かっこのペアを定義します。左角かっこが入力されると、右角かっこが自動的に挿入されます。",
		"自動ペアが無効なスコープの一覧を定義します。",
		"選択文字列を囲むときに使用できる角かっこのペアを定義します。",
		"言語のための単語の定義。",
		"言葉の照合に使用する正規表現パターン。",
		"言葉の照合に使用する正規表現フラグ。",
		"`/^([gimuy]+)$/` パターンに一致する必要があります。",
		"言語のインデント設定。",
		"ある行がこのパターンと一致する場合は、それ以降のすべての行を一度インデントする必要があります (別のルールが一致するまで) 。",
		"increaseIndentPattern に使用する正規表現パターン。",
		"increaseIndentPattern に使用する正規表現フラグ。",
		"`/^([gimuy]+)$/` パターンに一致する必要があります。",
		"ある行がこのパターンに一致する場合は、それ以降のすべての行は一度アンインデントする必要があります (別のルールが一致するまで) 。",
		"decreaseIndentPattern に使用する正規表現パターン。",
		"decreaseIndentPattern に使用する正規表現フラグ。",
		"`/^([gimuy]+)$/` パターンに一致する必要があります。",
		"ある行がこのパターンと一致する場合は、**次の行のみ** を一度インデントする必要があります。",
		"indentNextLinePattern に使用する正規表現パターン。",
		"indentNextLinePattern に使用する正規表現フラグ。",
		"`/^([gimuy]+)$/` パターンに一致する必要があります。",
		"ある行がこのパターンと一致する場合は、そのインデントを変更してはならず、他のルールに対して評価してもなりません。",
		"unIndentedLinePattern に使用する正規表現パターン。",
		"unIndentedLinePattern に使用する正規表現フラグ。",
		"`/^([gimuy]+)$/` パターンに一致する必要があります。",
	],
	...
	"vs/workbench/parts/codeEditor/electron-browser/wordWrapMigration": [
		...
		"今後は表示しない",
		"設定を開く",
		"設定 \'editor.wrappingColumn\' は使用されなくなりました。\'editor.wordWrap\' を使用してください。",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"式が true と評価される場合に中断します。\'Enter\' を押して受け入れるか \'Esc\' を押して取り消します。",
		"この条件が true の場合にのみプログラムはこの位置で停止します。Enter を押して受け入れるか、Esc を押して取り消します。",
		"ヒット カウント条件が満たされる場合に中断します。\'Enter\' を押して受け入れるか \'Esc\' を押して取り消します。",
		"ヒット カウントが満たされる場合にのみプログラムはこの位置で停止します。Enter を押して受け入れるか、Esc を押して取り消します。",
		"式",
		"ヒット カウント",
	],
	...
	"vs/workbench/parts/debug/browser/debugActions": [
		"{0} を開く",
		"\'launch.json\' を構成または修正してください",
		"高度なデバッグ構成を行うには、最初にフォルダーを開いてください。",
		"デバッグの開始",
		"デバッグなしで開始",
		"選択してデバッグを開始",
		"再起動",
	...
	"vs/workbench/parts/debug/browser/debugEditorModelManager": [
		"無効なブレークポイント",
		"未確認のブレークポイント",
		"未確認のブレークポイント。ファイルは変更されているので、デバッグ セッションを再起動してください。",
		"このデバッグの種類では、条件付きブレークポイントはサポートされていません。",
	],
	"vs/workbench/parts/debug/browser/debugQuickOpen": [
		"{0}、デバッグ",
		"実行する起動構成の名前を入力してください。",
		"一致するデバッグ構成はありません",
		"デバッグ構成が見つかりません。\'launch.json\' ファイルを作成してください。",
	],
	...
	"vs/workbench/parts/debug/common/debug": [
		"内部デバッグ コンソールの動作を制御します。",
	],
	"vs/workbench/parts/debug/common/debugModel": [
		"使用できません",
		"デバッグ セッションを開始して評価してください",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugConfigurationManager": [
		...
		"このデバッグ アダプターの一意識別子。",
		"このデバッグ アダプターの表示名。",
		"デバッグ アダプター プログラムへのパス。絶対パスか拡張機能フォルダーへの相対パスです。",
		"アダプターに渡すオプションの引数。",
		"プログラム属性が実行可能でなく、ランタイムが必要な場合のオプション ランタイム。",
		"オプションのランタイム引数。",
		"`launch.json` 内の対話型の変数 (例: ${action.pickProcess}) からコマンドへマッピングしています。",
		"初期 \'launch.json\' を生成するための構成。",
		"デバッグ拡張機能が \"既定のデバッガー\" とされる言語の一覧。",
		"指定されている場合、VS Code はこのコマンドを呼び出し、デバッグ アダプターの実行可能パスと、渡す引数を決定します。",
		"VS Code が指定されている場合、この拡張機能を対象とする \"デバッグ\" または \"実行\" アクションにこのコマンドが呼び出されます。",
		"\'launch.json\' に新しい構成を追加するためのスニペット。",
		"\'launch.json\' を検証するための JSON スキーマ構成。",
		"Windows 固有の設定。",
		"Windows で使用されるランタイム。",
		"OS X 固有の設定。",
		"OSX で使用されるランタイム。",
		...
		"起動",
		"このファイル形式のバージョン。",
		"構成の一覧。IntelliSense を使用して、新しい構成を追加したり、既存の構成を編集したります。",
		"複合の一覧。各複合は、同時に起動される複数の構成を参照します。",
		"複合の名前。起動構成のドロップダウン メニューに表示されます。",
		"この複合の一部として開始される構成の名前。",
		"デバッグ アダプター \'type\' は省略不可で、\'string\' 型でなければなりません。",
		"環境の選択",
		"\'launch.json\' ファイルを \'.vscode\' フォルダー ({0}) 内に作成できません。",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		"このオブジェクトのプリミティブ値のみ表示されます。",
		"デバッグは一時停止されました、理由 {0}、{1} {2}",
		"デバッグは開始されました。",
		"デバッグは停止されました。",
		"ブレークポイントを追加しました。行 {0}、ファイル {1}",
		"ブレークポイントを削除しました。行 {0}、ファイル {1}",
		"複合構成を開始するには、複合に \"configurations\" 属性が設定されている必要があります。",
		"構成 \'{0}\' が \'launch.json\' 内にありません。",
		"構成されているデバッグの種類 \'{0}\' はサポートされていません。",
		"選択された起動構成のプロパティ \'type\' がありません。",
		"preLaunchTask \'{0}\' の実行中にビルド エラーが検出されました。",
		"preLaunchTask \'{0}\' の実行中にビルド エラーが検出されました。",
		"preLaunchTask \'{0}\' が終了コード {1} で終了しました。",
		"このままデバッグを続ける",
		"アクティブ ファイルをデバッグできません。ファイルがディスクに保存されており、そのファイル タイプのデバッグ拡張機能がインストールされていることを確認してください。",
		"アプリケーションの起動構成ファイルをセットアップしてください。{0}",
		"preLaunchTask \'{0}\' が見つかりませんでした。",
	],
	"vs/workbench/parts/debug/electron-browser/debugViewer": [
		...
		"実行しています",
		"スタック フレームをさらに読み込む",
		"スレッド {0}、呼び出しスタック、デバッグ",
		"スタック フレーム {0} 行 {1} {2}、呼び出しスタック、デバッグ",
		"新しい変数値を入力する",
		"範囲 {0}、変数、デバッグ",
		"{0} 値 {1}、変数、デバッグ",
		"ウォッチ対象の式",
		...
		"中断対象の関数",
		"関数ブレークポイントを入力します",
		"このデバッグの種類では関数ブレークポイントはサポートされていません",
		"ブレークポイント行 {0} {1}、ブレークポイント、デバッグ",
		"関数ブレークポイント {0}、ブレークポイント、デバッグ",
		"例外ブレークポイント {0}、ブレークポイント、デバッグ",
	],
	...
	"vs/workbench/parts/debug/electron-browser/rawDebugSession": [
		"詳細情報",
		"デバッグ アダプターを {0} から起動できません。",
		"デバッグ アダプターを起動できません。",
		"{0}。デバッグ アダプターを停止しています。",
		"デバッグ アダプター プロセスが予期せず終了しました",
	],
	"vs/workbench/parts/debug/electron-browser/repl": [
		"Read Eval Print Loop パネル",
		"前の履歴",
		"次の履歴",
		"REPL での入力を反映",
		"デバッグ: コンソールをすべてコピーする",
	...
	"vs/workbench/parts/debug/electron-browser/replViewer": [
		...
		"変数 {0} に値 {1} があります、Read Eval Print Loop、デバッグ",
		"式 {0} に値 {1} があります、Read Eval Print Loop、デバッグ",
		"{0}、Read Eval Print Loop、デバッグ",
		"出力変数 {0} に値 {1} があります、Read Eval Print Loop、デバッグ",
	],
	"vs/workbench/parts/debug/electron-browser/statusbarColorProvider": [
		"プログラムをデバッグしているときのステータス バーの背景色。ステータス バーはウィンドウの下部に表示されます",
		"プログラムをデバッグしているときのステータス バーの前景色。ステータス バーはウィンドウの下部に表示されます",
		"プログラムをデバッグしているときのサイドバーおよびエディターを隔てるステータス バーの境界線の色。ステータス バーはウィンドウの下部に表示されます",
	],
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		"デバッグ アダプターの実行可能ファイル \'{0}\' がありません。",
		"デバッグ アダプター \'{0}\' の実行可能ファイルを判別できません。",
		"構成の種類。",
		"デバッグの種類は認識されませんでした。対応するデバッグの拡張機能がインストールされており、有効になっていることを確認してください。",
		"\"node2\" はサポートされていません。代わりに \"node\" を使用し、\"protocol\" 属性を \"inspector\" に設定してください。",
		"構成の名前。起動構成のドロップダウン メニューに表示されます。",
		"構成の要求の種類。\"launch\" または \"attach\" です。",
		"デバッグ拡張機能の開発のみ。ポートが指定の VS Code の場合、サーバー モードで実行中のデバッグ アダプターへの接続が試行されます。",
		"デバッグ セッションの開始前に実行するタスク。",
		"Windows 固有の起動構成の属性。",
		"OS X 固有の起動構成の属性。",
		"Linux 固有の起動構成の属性。",
		"\'env.\'、\'config.\'、\'command.\' は使用されていません。代わりに、\'env:\'、\'config:\'、\'command:\' を使用してください。",
	],
	...
	"vs/workbench/parts/extensions/browser/extensionsActions": [
		...
		"再読み込み",
		"再読み込みして更新する",
		"このウィンドウを再読み込みして、更新済みの拡張機能 \'{0}\' をアクティブ化しますか?",
		"再読み込みしてアクティブにする",
		"このウィンドウを再度読み込んで、拡張機能 \'{0}\' をアクティブ化しますか?",
		"再読み込みして非アクティブ化する",
		"このウィンドウを再読み込みして、拡張機能 \'{0}\' を非アクティブ化しますか?",
		"再読み込みして非アクティブ化する",
		"このウィンドウを再度読み込んで、アンインストール済みの拡張機能 \'{0}\' を非アクティブ化しますか?",
		"ウィンドウの再読み込み(&&R)",
		"拡張機能を表示する",
		"拡張機能のインストール",
		"有効な拡張機能の表示",
		...
		"人気の拡張機能の表示",
		"お勧めの拡張機能を表示",
		"ワークスペースのおすすめの拡張機能を表示",
		"推奨のキーマップを表示する",
		"キーマップ",
		"言語の拡張機能を表示",
		"言語の拡張機能",
		"お勧めの拡張機能の構成 (ワークスペース)",
		"推奨事項はワークスペース フォルダーでのみ利用可能です。",
		"\'.vscode\' ファルダー ({0}) 内に \'extensions.json\' ファイルを作成できません。",
		"ビルトイン",
		"インストール済みのすべての拡張機能を無効にする",
		"このワークスペースのインストール済みの拡張機能をすべて無効にする",
		"インストール済みの拡張機能をすべて有効にする",
		"このワークスペースのインストール済みの拡張機能をすべて有効にする",
		"際立っているアクション拡張機能のボタンの背景色（例: インストールボタン）。",
		"際立っているアクション拡張機能のボタンの前景色（例: インストールボタン）。",
		"際立っているアクション拡張機能のボタンのホバー背景色（例: インストールボタン）。",
	],
	"vs/workbench/parts/extensions/browser/extensionsQuickOpen": [
		"拡張機能を管理するには Enter キーを押してください。",
		"マーケットプレース内で \'{0}\' を検索するには、Enter キーを押してください。",
		"拡張機能名を入力してください",
	],
	"vs/workbench/parts/extensions/common/extensionsFileTemplate": [
		"拡張機能",
		"拡張機能のおすすめ候補の一覧。拡張機能の ID は常に \'${publisher}.${name}\' です。例: \'vscode.csharp\'。",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		"拡張機能フォルダーを開く",
		"VSIX からのインストール...",
		"拡張機能が正常にインストールされました。有効にするには再起動します。",
		"今すぐ再度読み込む",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsUtils": [
		"キーバインド間の競合を回避するために、他のキーマップ ({0}) を無効にしますか?",
		"はい",
		"いいえ",
		"拡張機能 Better Merge は現在ビルトインです。インストール済みの拡張機能は無効化され、アンインストールできます。",
		"アンインストール",
		"後続",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsViewlet": [
		...
		"並べ替え: 評価",
		"並べ替え: 名前",
		"Marketplace が \'ECONNREFUSED\' を返しました。\'http.proxy\' 設定を確認してください。",
		"拡張機能",
		"{0} 古くなった拡張機能",
	],
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		"\'{0}\' を有効にするとその依存関係も有効になります。続行しますか?",
		"はい",
		"いいえ",
		"\'{0}\' のみ、またはその依存関係も無効にしますか?",
		"限定",
		"すべて",
		"キャンセル",
		"拡張機能 \'{0}\' を無効にできません。これに拡張機能 \'{1}\' が依存しています。",
		"拡張機能 \'{0}\' を無効にできません。これに拡張機能 \'{1}\' と \'{2}\' が依存しています。",
		"拡張機能 \'{0}\' を無効にできません。これに拡張機能 \'{1}\'、\'{2}\'、その他が依存しています。",
		"\'{0}\' 拡張機能をインストールしますか?",
		"インストール",
		"キャンセル",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"新しいファイル",
		"新しいフォルダー",
		"フォルダー内にファイルやフォルダーを作成するには、フォルダーをまず開く必要があります。",
		"無題の新規ファイル",
		"新しいファイル",
		"新しいフォルダー",
		"新しいファイル",
		...
		"ゴミ箱に移動(&&M)",
		"削除(&&D)",
		"保存されていない変更がある 1 個のファイルを含むフォルダーを削除します。続行しますか?",
		"保存されていない変更があるファイルを {0} 個含むフォルダーを削除します。続行しますか?",
		"保存されていない変更があるファイルを削除します。続行しますか?",
		"保存しないと変更内容が失われます。",
		"\'{0}\' とその内容を削除しますか?",
		"\'{0}\' を削除しますか?",
		"ごみ箱から復元できます。",
		"ゴミ箱から復元できます。",
		"\'{0}\' とその内容を完全に削除してもよろしいですか?",
		"\'{0}\' を完全に削除してもよろしいですか?",
		"このアクションは元に戻すことができません。",
		"完全に削除",
		"削除",
		"ファイルのインポート",
		"保存先のフォルダーに同じ名前のファイルまたはフォルダーが既に存在します。置き換えてもよろしいですか?",
		"このアクションは元に戻すことができません。",
		"置換(&&R)",
		"コピー",
		"貼り付け",
		...
		"比較対象の選択",
		"アクティブ ファイルを比較しています...",
		"比較対象として、以前に開いたファイルを選択する",
		"選択されたファイルを \'{0}\' と比較できません。",
		"まずファイルを開いてから別のファイルと比較してください",
		"\'{0}\' と比較",
		"ファイルの比較",
		"最新の情報に更新",
		"保存",
		...
		"ダーティ ファイルを保存",
		"ファイルを元に戻す",
		"開いているエディターのビューにフォーカスする",
		"ファイル エクスプローラーにフォーカスを置く",
		"アクティブ ファイルをサイド バーに表示",
		"エクスプローラーでファイルを表示するには、ファイルをまず開く必要があります",
		"エクスプローラーのフォルダーを折りたたむ",
		"エクスプローラーを最新表示する",
		"ファイルを開く...",
		"新しいウィンドウでアクティブ ファイルを開く",
		"まずファイルを開いてから新しいウィンドウで開きます",
		"エクスプローラーで表示します",
		"Finder で表示します",
		"このアイテムのフォルダーを開く",
		"Windows エクスプローラーでアクティブ ファイルを表示する",
		"Finder でアクティブ ファイルを表示する",
		"アクティブ ファイルを含んでいるフォルダーを開く",
		"パスのコピー",
		"アクティブ ファイルのパスのコピー",
		"ファイルまたはフォルダーの名前を指定する必要があります。",
		"**{0}** というファイルまたはフォルダーはこの場所に既に存在します。別の名前を指定してください。",
		"名前 **{0}** がファイル名またはフォルダー名として無効です。別の名前を指定してください。",
		"名前 **{0}** のパスが長すぎます。名前を短くしてください。",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"ファイル パスの照合基準となる glob パターン。これを true または false に設定すると、パターンがそれぞれ有効/無効になります。",
		"一致するファイルの兄弟をさらにチェックします。一致するファイル名の変数として $(basename) を使用します。",
		...
		"ダーティ ファイルを自動的に保存することはしません。",
		"\'files.autoSaveDelay\' で構成された時間の経過後に、ダーティ ファイルを自動的に保存します。",
		"エディターがフォーカスを失った時点で、ダーティ ファイルを自動的に保存します。",
		"ウィンドウがフォーカスを失った時点で、ダーティ ファイルを自動的に保存します。",
		"ダーティ ファイルの自動保存を制御します。有効な値: \'{0}\'、\'{1}\'、\'{2}\' (エディターがフォーカスを失います)、\'{3}\' (ウィンドウがフォーカスを失います)。\'{4}\' に設定すると、\'files.autoSaveDelay\' で遅延を構成できます。",
		"ダーティ ファイルの自動保存の遅延をミリ秒単位で制御します。\'files.autoSave\' が \'{0}\' に設定されている場合のみ適用されます",
		...
		"Hot Exit を無効にします。",
		"アプリケーションが閉じると (Windows/Linux で最後のウィンドウが閉じるとき、または workbench.action.quit コマンドがトリガーされるとき (コマンド パレット、キー バインド、メニュー))、Hot Exit がトリガーされます。バックアップされているすべてのウィンドウは、次の起動時に復元されます。",
		"アプリケーションが閉じると (Windows/Linux で最後のウィンドウが閉じるとき、または workbench.action.quit コマンドがトリガーするとき (コマンド パレット、キー バインド、メニュー))、Hot Exit がトリガーされます。また、フォルダーが開かれているウィンドウについても、それが最後のウィンドウかどうかに関係なく、Hot Exit がトリガーされます。フォルダーが開かれていないウィンドウはすべて、次回の起動時に復元されます。フォルダーのウィンドウをシャットダウン前と同じ状態に復元するには、\"window.restoreWindows\" を \"all\" に設定します。",
		...
		"ファイルとディレクトリをアルファベット順に名前で並び替えます。ディレクトリはファイルの前に表示されます。",
		"ファイルとディレクトリをアルファベット順に名前で並び替えます。ファイルはディレクトリと混交して表示されます。",
		"ファイルとディレクトリをアルファベット順に名前で並び替えます。ファイルはディレクトリの前に表示されます。",
		"ファイルとディレクトリをアルファベット順に拡張子で並び替えます。ディレクトリはファイルの前に表示されます。",
		"ファイルとディレクトリを降順に最終更新日で並び替えます。ディレクトリはファイルの前に表示されます。",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"上書き",
		"再試行",
		"\'{0}\' の保存に失敗しました。ファイルが書き込み禁止になっています。[上書き] を選択して保護を解除してください。",
		"\'{0}\' の保存に失敗しました: {1}",
		"\'{0} の保存に失敗しました。ディスクの内容の方が新しくなっています。[比較] をクリックしてご使用のバージョンをディスク上のバージョンと比較してください。",
		"比較",
		"{0} (ディスク上) ↔ {1} ({2} 内) - 保存の競合を解決",
		"右側のエディター ツール バーの操作で、変更を [元に戻す] か、ディスクの内容を変更内容で [上書き] します",
	],
	...
	"vs/workbench/parts/files/browser/views/explorerViewer": [
		"ファイル名を入力します。Enter キーを押して確認するか、Esc キーを押して取り消します。",
		"{0}、ファイル エクスプローラー",
		"\'{0}\' は保存先フォルダーに既に存在します。置き換えてもよろしいですか。",
		"このアクションは元に戻すことができません。",
		"置換(&&R)",
	],
	...
	"vs/workbench/parts/markers/common/messages": [
		...
		"問題",
		"ファイル別にグループ化した問題",
		"現時点で問題はワークスペースで検出されていません。",
		"指定されたフィルター条件による結果はありません",
		"問題のフィルター処理",
		"種類またはテキストでフィルター処理",
		"エラー",
		"警告",
		...
		"({0}, {1})",
		"{0} (問題あり {1})",
		"{0}: {1} によって生成されたエラー (行 {2}、文字 {3})",
		"エラー: {0} (行 {1}、文字 {2})",
		"{0}: {1} によって生成された警告 (行 {2}、文字 {3})",
		"警告: {0} (行 {1}、文字 {2})",
		"{0}: {1} によって生成された情報 (行 {2}、文字 {3})",
		"情報: {0} (行 {1}、文字 {2})",
		"{0} によって生成された問題: {1} (行 {2}、文字 {3})",
		"問題: {0} (行 {1}、文字 {2})",
		"エラーと警告の表示",
	],
	...
	"vs/workbench/parts/performance/electron-browser/performance.contribution": [
		"スタートアップの遅延が検出されました",
		"スタートアップが遅かったとのこと、申し訳ございません。プロファイルを有効にして、\'{0}\' を再起動し、プロファイルを共有してください。スタートアップの改善のために参考にさせていただきます。",
		"プロファイルが正常に作成されました。",
		"案件を作成し、手動で次のファイルを添付してください:\\n{0}",
		"問題を作成して再起動",
		"再起動",
		"ご協力いただき、ありがとうございます。",
		"\'{0}\' を引き続き使用するには、最後の再起動が必要です。 改めてあなたの貢献に感謝します。",
		"再起動",
	],
	"vs/workbench/parts/preferences/browser/keybindingWidgets": [
		"任意のキーの組み合わせを押し、Enter キーを押します。キャンセルするには Esc キーを押してください。",
		"次へのコード:",
	],
	"vs/workbench/parts/preferences/browser/keybindingsEditor": [
		...
		"競合の表示",
		"コピー",
		"キー バインドの編集中にエラー \'{0}\' が発生しました。\'keybindings.json\' ファイルを開いてご確認ください。",
		"コマンド",
		"キー バインド",
		"ソース",
		"タイミング",
	...
	"vs/workbench/parts/preferences/browser/keybindingsEditorContribution": [
		...
		"現在のキーボード レイアウトで示すと **{0}** です。(US 標準: **{1}**)",
		"現在のキーボード レイアウトで示すと **{0}** です。",
	],
	...
	"vs/workbench/parts/preferences/browser/preferencesRenderers": [
		...
		"設定を置換",
		"設定にコピー",
		"この設定はユーザー設定でなければなりません。ワークスペースのために PHP を構成するには、PHP ファイルを開き、ステータス バーの [PHP パス] をクリックします。",
		"この設定はユーザー設定でなければなりません。",
	...
	"vs/workbench/parts/preferences/browser/preferencesService": [
		"ワークスペースの設定を作成するには、まずフォルダーを開いてください",
	...
	"vs/workbench/parts/quickopen/browser/commandsHandler": [
		...
		"{0}、{1}、コマンド",
		"{0}、コマンド",
		"コマンド \'{0}\' はここからは実行できません。",
		"コマンド \'{0}\' は現在のコンテキストでは無効です。",
		"最近使用したもの",
		"その他のコマンド",
		"{0}: {1}",
		"{0}: {1}",
	...
	"vs/workbench/parts/quickopen/browser/gotoSymbolHandler": [
		...
		"一致するシンボルはありません。",
		"シンボルが見つかりません",
		"入力すると現在アクティブなエディターのシンボルが絞り込まれます。",
		"ファイルのシンボル情報がありません",
		"まずテキスト ファイルを開いてからシンボルへ移動します",
	],
	...
	"vs/workbench/parts/search/browser/searchResultsView": [
		...
		"一致する項目が {0} 件見つかりました",
		"一致する項目が {0} 件見つかりました",
		"{1} フォルダー ルート内で {0} 件の一致、検索結果",
		"フォルダー {2} のファイル {1} 内で {0} 件の一致、検索結果",
		"テキスト {3} の {2} 列目の {0} を {1} に置換します",
		"テキスト {2} の {1} 列目に {0} が見つかりました",
	],
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"すべて置換",
		"置換",
		"{1} 個のファイルで {0} 件の出現箇所を \'{2}\' に置換しました。",
		"{1} 個のファイルで {0} 件の出現箇所を置換しました。",
		"{1} 個のファイルで {0} 件の出現箇所を \'{2}\' に置換しました。",
		"{1} 個のファイルで {0} 件の出現箇所を置換しました。",
		"{1} 個のファイルで {0} 件の出現箇所を \'{2}\' に置換しました。",
		"{1} 個のファイルで {0} 件の出現箇所を置換しました。",
		...
		"{1} 個のファイルに {0} 件の結果",
		"{1} 個のファイルに {0} 件の結果",
		"まだフォルダーを開いていません。開いているファイルのみを検索しています - ",
		"フォルダーを開く",
	],
	"vs/workbench/parts/search/browser/searchWidget": [
		...
		"検索",
		"置換: 置換用語を入力し、Enter を押してプレビューするか、Escape を押してキャンセルします",
		"置換",
		"この式はすべてに一致します",
	],
	...
	"vs/workbench/parts/snippets/electron-browser/TMSnippets": [
		"スニペットを提供します。",
		"このスニペットの提供先の言語識別子です。",
		"スニペット ファイルのパス。拡張機能フォルダーの相対パスであり、通常 \'./snippets/\' で始まります。",
		"`contributes.{0}.language` で不明な言語です。提供された値: {1}",
		"`contributes.{0}.path` に文字列が必要です。提供された値: {1}",
		"拡張機能のフォルダー ({2}) の中に `contributes.{0}.path` ({1}) が含まれている必要があります。これにより拡張を移植できなくなる可能性があります。",
		"スニペット \"{0}\" は、スニペット変数とスニペット プレースホルダーを混乱させる可能性が非常にあります。詳細については https://code.visualstudio.com/docs/editor/userdefinedsnippets#_snippet-syntax をご覧ください。",
	],
	...
	"vs/workbench/parts/snippets/electron-browser/snippets.contribution": [
		...
		"空のスニペット",
		"ユーザー スニペット構成",
		"intellisense でスニペットを選択するときに使用するプレフィックス",
		"スニペットのコンテンツです。カーソルの位置を定義するには \'$1\', \'${1:defaultText}\' を使用し、最後のカーソルの位置には \'$0\' を使用します。\'${varName}\' と \'${varName:defaultText}\' を使用すると変数値を挿入します。例: \'This is file: $TM_FILENAME\'.",
		"スニペットについての記述。",
	],
	...
	"vs/workbench/parts/tasks/common/taskDefinitionRegistry": [
		"実際のタスクの種類",
		"タスクの種類の追加プロパティ",
		"タスクの種類を構成するのに必要な \'taskType\' プロパティがありません",
		"タスクの種類を提供",
	],
	"vs/workbench/parts/tasks/common/taskTemplates": [
		".NET Core ビルド コマンドの実行",
		"ビルド ターゲットを実行",
		"任意の外部コマンドを実行する例",
		"共通の maven コマンドを実行する",
	],
	"vs/workbench/parts/tasks/electron-browser/jsonSchemaCommon": [
		"追加のコマンド オプション",
		"実行されるプログラムまたはスクリプトの現在の作業ディレクトリ。省略すると、Code の現在のワークスペースのルートが使用されます。",
		"実行されるプログラムまたはシェルの環境。省略すると、親プロセスの環境が使用されます。",
		"使用するシェルを構成します。",
		"使用するシェル。",
		"シェル引数。",
		"実行されるコマンド。外部プログラムかシェル コマンドです。",
		"このタスクの起動時にコマンドに渡される引数。",
		"タスクの名前",
		"実行されるコマンド。外部プログラムかシェル コマンドです。",
		"このタスクの起動時にコマンドに渡される引数。",
		"Windows 固有のコマンド構成",
		"Mac 固有のコマンド構成",
		"Linux 固有のコマンド構成",
		"タスク名を引数としてコマンドに追加するかどうかを制御します。省略すると、グローバルに定義された値が使用されます。",
		"実行中のタスクの出力が表示されるかどうかを制御します。省略すると、グローバルに定義された値が使用されます。",
		"実行されるコマンドが出力にエコーされるかどうかを制御します。既定は false です。",
		"使用しないでください。代わりに isBackground をご使用ください。",
		"実行済みのタスクが維持され、ファイル システムをウォッチしているかどうか。",
		"実行済みのタスクが維持され、バッググラウンドで実行されているかどうか。",
		"タスクの実行中に VS Code を閉じるときにユーザーにダイアログを表示するかどうか。",
		"このタスクを Code の既定のビルド コマンドにマップします。",
		"このタスクを Code の既定のテスト コマンドにマップします。",
		"使用する問題マッチャー。1 つの文字列または問題マッチャー定義か、文字列と問題マッチャーの配列です。",
		"実行されるコマンド。外部プログラムかシェル コマンドです。",
		"さらにコマンドに渡される引数。",
		"実行中のタスクの出力が表示されるかどうかを制御します。省略すると、\'always\' が使用されます。",
		"使用しないでください。代わりに isBackground をご使用ください。",
		"実行済みのタスクが維持され、ファイル システムをウォッチしているかどうか。",
		"実行済みのタスクが維持され、バッググラウンドで実行されているかどうか。",
		"バックグラウンド タスクの実行中に VS Code を閉じる時に、ユーザーに対してプロンプトが表示されるかどうか。",
		"実行されるコマンドが出力にエコーされるかどうかを制御します。既定は false です。",
		"タスク名を引数としてコマンドに追加するかどうかを制御します。既定は false です。",
		"引数がタスクであることを示すプレフィックス。",
		"使用する問題マッチャー。1 つの文字列または問題マッチャー定義か、文字列と問題マッチャーの配列です。",
		"タスクの構成。普通は外部タスク ランナーで既に定義されているタスクのエンリッチメントです。",
	],
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v1": [
		"構成のバージョン番号",
		"ランナーが新しくなります。正式なランナープロパティーを使用してください",
		"タスクをプロセスとして実行して、出力が出力ウィンドウまたは端末内に表示されるかどうかを定義します。",
		"Windows 固有のコマンド構成",
		"Mac 固有のコマンド構成",
		"Linux 固有のコマンド構成",
		"コマンドがシェル コマンドか外部プログラムかを指定します。省略すると、既定は false になります。",
	],
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		"コマンドがシェル コマンドか外部プログラムかを指定します。省略すると、既定は false になります。",
		"isShellCommand プロパティは使用されていません。代わりに、タスクの type プロパティとオプションの shell プロパティをご使用ください。また 1.14 リリース ノートをご確認ください。",
		"このタスクが依存している別のタスク。",
		"このタスクが依存している他の複数のタスク。",
		"タスクの出力の表示と入力の読み取りに使用するようにパネルを構成します。",
		"実行されたコマンドがパネルにエコーされるかどうかを制御します。既定は trueです。",
		"パネルがフォーカスされるかどうかを制御します。既定は false です。true に設定した場合、パネルも表示されます。",
		"タスクを実行しているパネルを表示するかどうかを制御します。既定は \"always\" です。",
		"タスク間でパネルを共有するか、またはこのタスクで占有するか、実行ごとに新しいパネルを作成するかどうかを制御します。",
		"terminal プロパティは非推奨です。代わりに presentation をご使用ください",
		"タスクの実行グループ。",
		"このタスクがグループ内の既定のタスクであるかどうかを定義します。",
		"このタスクを既定のビルド タスクとしてマークします。",
		"このタスクを既定のテスト タスクとしてマークします。",
		"タスクを \'Run Build Task\' (ビルド タスクの実行) コマンドを介してアクセス可能なビルド タスクとしてマークします。",
		"タスクを \'Run Test Task\' (テスト タスクの実行) コマンドを介してアクセス可能なテスト タスクとしてマークします。",
		"タスクをグループに割り当てない",
		"このタスクが属する実行グループを定義します。ビルド グループに追加する \"build\" とテスト グループに追加する \"test\" をサポートしています。",
		"タスクをプロセスとして実行するか、またはシェル内部でコマンドとして実行するかどうかを定義します。既定は process です。",
		"構成のバージョン番号",
		"launch.json または dependsOn 句のタスクを参照するユーザー定義の識別子。",
		"タスクのラベル",
		"タスクの名前",
		"タスクの name プロパティは非推奨です。代わりに label プロパティをご使用ください。",
		"実行済みのタスクが維持され、バッググラウンドで実行されているかどうか。",
		"タスクの実行中に VS Code を閉じるときにユーザーにダイアログを表示するかどうか。",
		"使用する問題マッチャー。1 つの文字列または問題マッチャー定義か、文字列と問題マッチャーの配列です。",
		"カスタマイズするタスクの種類",
		"customize プロパティは非推奨です。新しいタスクのカスタマイズ方法に移行する方法については 1.14 リリース ノートをご確認ください。",
		"showOutputプロパティは非推奨です。代わりに presentation プロパティ内の reveal プロパティを使用してください。また 1.14 リリース ノートをご確認ください。",
		"echoCommand プロパティは使用されていません。代わりに presentation プロパティ内の echo プロパティを使用してください。また 1.14 リリース ノートをご確認ください。",
		"suppressTaskName プロパティは非推奨です。代わりに、その引数を含むコマンドをタスクにインライン展開してください。1.14 リリース ノートも参照してください。",
		"isBuildCommand プロパティは非推奨です。代わりに group プロパティを使用してください。また 1.14 リリース ノートをご確認ください。",
		"isTestCommand プロパティは非推奨です。代わりに group プロパティを使用してください。また 1.14 リリース ノートをご確認ください。",
		"suppressTaskName プロパティは非推奨です。代わりに、その引数を含むコマンドをタスクにインライン展開してください。1.14 リリース ノートも参照してください。",
		"taskSelector プロパティは非推奨です。代わりに、その引数を含むコマンドをタスクにインライン展開してください。1.14 リリース ノートも参照してください。",
		"Windows 固有のコマンド構成",
		"Mac 固有のコマンド構成",
		"Linux 固有のコマンド構成",
	],
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"タスク ランナーを選択",
		"{0} のタスクを自動検出",
		"タスク システムの自動検出が失敗しました。既定のテンプレートを使用しています。詳細については、タスク出力を参照してください",
		"タスク システムの自動検出でエラーが発生しました。詳細については、タスク出力を参照してください。",
		"\'.vscode\' フォルダー内に \'tasks.json\' ファイルを作成できません。詳細については、タスク出力を参照してください。",
		"タスク ランナーの構成",
		"ビルド タスクを構成します",
		"閉じる",
		"ターミナルの表示",
		...
		"実行中のタスクを表示",
		"タスク",
		"タスク実行エンジンを変更するには VS Code の再起動が必要です。変更は無視されます。",
		"ビルド タスクが定義されていません。tasks.json ファイルでタスクに \'isBuildCommand\' というマークを付けてください。",
		"ビルド タスクが定義されていません。tasks.json ファイルでタスクに \'build\' グループとしてマークを付けてください。",
		"テスト タスクが定義されていません。tasks.json ファイルでタスクに \'isTestCommand\' というマークを付けてください。",
		"テスト タスクが定義されていません。tasks.json ファイルでタスクに \'test\' グループとしてマークを付けてください。",
		"実行が要求されたタスク {0} が見つかりません。",
		"タスクの出力をスキャンせずに続行",
		"Never scan the task output",
		"Learn more about scanning the task output",
		"スキャンするタスク出力のエラーと警告の種類を選択",
		"現在のタスクの構成にはエラーがあります。タスクをカスタマイズする前にエラーを修正してください。",
		"tasks.json で複数のビルド タスクが定義されています。最初のタスクのみを実行します。\\n",
		"\'{0}\' タスクは既にバックグラウンド モードでアクティブです。タスクを終了するにはタスク メニューから `タスクの終了...` を使用します。",
		"\'{0}\' タスクは既にアクティブです。タスクを終了するにはタスク メニューから`タスクの終了...` を使用してください。 ",
		"既に実行中のタスクがあります。まずこのタスクを終了してから、別のタスクを実行してください。",
		"タスク {0} を終了して再開できませんでした",
		"エラー: 指定したタスク構成に検証エラーがあり、使用できません。最初にエラーを修正してください。",
		"エラー: tasks.json ファイルの内容に構文エラーがあります。訂正してからタスクを実行してください。\n",
		"実行中のタスクがあります。終了しますか?",
		"タスクの終了(&&T)",
		"起動したタスクは既に存在しません。タスクを起動したバックグラウンド プロセスが VS コードで終了すると、プロセスが孤立することがあります。これを回避するには、待機フラグを設定して最後のバックグラウンド プロセスを開始します。",
		"常に終了(&&E)",
		"タスクの終了",
		"タスクの実行中にエラーが発生しました。詳細については、タスク ログを参照してください。",
		"タスクはワークスペース フォルダーでのみ利用可能です。",
		"最近使用したタスク",
		"構成済みのタスク",
		"検出されたタスク",
		...
		"実行するビルド タスクを選択",
		"テスト タスクをフェッチしています...",
		"テスト タスクが見つかりません。定義するには \'Configure Build Task\' (タスク ランナーの構成) を押してください。",
		"実行するテスト タスクを選択してください",
		"現在実行中のタスクはありません。",
		"終了するタスクを選択",
		"起動したプロセスは既に存在しません。タスクを起動したバックグラウンド タスクが VS コードで終了すると、プロセスが孤立することがあります。",
		"実行中のタスクの終了に失敗しました",
		"再起動するタスクがありません。",
		"再起動するタスクを選択してください",
		"{0} は既に既定のビルド タスクとしてマークされています。",
		"既定のビルド タスクとして使用するタスクを選択",
		"{0} は既に既定のテスト タスクとしてマークされています。",
		"既定のテスト タスクとして使用するタスクを選択",
		"実行中のタスクはありません。",
		"実行中のタスクはありません。",
		"出力を表示するタスクを選択",
		"タスク ログの表示",
	...
	"vs/workbench/parts/tasks/electron-browser/terminalTaskSystem": [
		"タスクの実行中に不明なエラーが発生しました。詳細については、タスク出力ログを参照してください。",
		"タスク - {0}",
		"端末はタスクで再利用されます、閉じるには任意のキーを押してください。",
		"UNC ドライブでシェル コマンドを実行できません。",
		"問題マッチャー {0} は解決できませんでした。マッチャーは無視されます",
	],
	"vs/workbench/parts/tasks/node/processRunnerDetector": [
		"gulp --tasks-simple が実行されましたがタスクの一覧は表示されませんでした。npm install を実行しましたか?",
		"jake --tasks が実行されましたがタスクの一覧は表示されませんでした。npm install を実行しましたか?",
		"システムに Gulp がインストールされていません。npm install -g gulp を実行してインストールしてください。",
		"システムに Jake がインストールされていません。npm install -g jake を実行してインストールしてください。",
		"システムに Grunt がインストールされていません。npm install -g grunt を実行してインストールしてください。",
		"プログラム {0} が見つかりませんでした。メッセージは {1} です",
		"名前 \'{0}\' のビルド タスクが検出されました。",
		"名前 \'{0}\' のテスト タスクが検出されました。",
	],
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		"警告: options.cwd は、string 型でなければなりません。値 {0} を無視します",
		"エラー: コマンド引数は文字列の配列でなければなりません。指定された値:\n{0}",
		"警告: シェル構成がサポートされるのは、ターミナルでタスクを実行している場合のみです。",
		"エラー: 宣言スコープ内の問題マッチャーに次の名前がなければなりません:\n{0}\n",
		"警告: 定義されている問題マッチャーが不明です。サポートされている型は string | ProblemMatcher | (string | ProblemMatcher)[] です。\n{0}\n",
		"エラー: 正しくない problemMatcher 参照 {0}\n",
		"エラー: タスクの構成には type プロパティが必要です。この構成は無視されます。\n{0}\n",
		"エラー: タスクがカスタム タスクとして定義されていません。この構成は無視されます。\n{0}\n",
		"エラー: タスクが taskName プロパティを提供しなければなりません。このタスクは無視されます。\n{0}\n",
		"警告: タスク \'{0}\' はシェル コマンドです。コマンド名または引数の 1 つに、エスケープされていないスペースが含まれています。コマンド ラインの引用が正しく解釈されるように、引数をコマンドにマージしてください。",
		"エラー: タスク \'{0}\' は、コマンドも dependsOn プロパティも指定していません。このタスクは無視されます。定義は次のとおりです:\n{1}",
		"エラー: タスク \'{0}\' はコマンドを定義していません。このタスクは無視されます。定義は次のとおりです:\n{1}",
		"バージョン 2.0.0 のタスクでは、OS に固有のグローバル タスクはサポートされません。OS に固有のコマンドを使用したタスクに変換してください。影響を受けるタスクは次のとおりです。\n{0}",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		"開いているすべてのターミナルを表示",
		"統合ターミナル",
		"ターミナルが Linux で使用するシェルのパス。",
		"Linux のターミナルで使用するコマンド ライン引数。",
		"ターミナルが OS X で使用するシェルのパス。",
		...
		"設定している場合、ターミナル内で右クリックしたときにコンテキスト メニューを表示させず、選択範囲がある場合はコピー、選択範囲がない場合は貼り付けの操作を行います。",
		"端末のフォント ファミリを制御します。既定値は editor.fontFamily になります。",
		"ターミナルでフォントの合字が有効かどうかを制御します。",
		...
		"OS X のターミナルで使用される VS Code のプロセスに追加される環境変数を持つオブジェクト",
		"Linux のターミナルで使用される VS Code のプロセスに追加される環境変数を持つオブジェクト",
		"Windows のターミナルで使用される VS Code のプロセスに追加される環境変数を持つオブジェクト",
		"ターミナル",
		"ターミナル",
		"表示",
	],
	"vs/workbench/parts/terminal/electron-browser/terminalActions": [
		...
		"アクティブなターミナルに貼り付け",
		"既定のシェルの選択",
		"アクティブなターミナルで選択したテキストを実行",
		"アクティブなファイルをアクティブなターミナルで実行",
		"ターミナルで実行できるのは、ディスク上のファイルのみです",
		"ターミナル インスタンスの切り替え",
		"下にスクロール (行)",
		"スクロール ダウン (ページ)",
		"一番下にスクロール",
		...
		"一番上にスクロール",
		"クリア",
		"ワークスペースでシェルを構成することを許可する",
		"ワークスペースでシェルを構成することを許可しない",
		"名前変更",
		"ターミナルの名前を入力してください",
		"検索ウィジェットにフォーカスする",
		"検索ウィジェットを非表示にする",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalService": [
		"カスタマイズ ボタンを選択して、既定のターミナル シェルを変更できます。",
		"カスタマイズする",
		"キャンセル",
		"OK、今後は表示しない",
		"優先するターミナル シェルを選択します。これは後で設定から変更できます",
		"アクティブなターミナル セッションが 1 つあります。中止しますか?",
		"アクティブなターミナル セッションが {0} 個あります。中止しますか?",
		"はい",
		"キャンセル",
	],
	"vs/workbench/parts/themes/electron-browser/themes.contribution": [
		"配色テーマ",
		"その他の配色テーマをインストール...",
		"配色テーマの選択 (上/下キーでプレビュー可能)",
		"ファイル アイコンのテーマ",
		"その他のファイル アイコンのテーマをインストール...",
		"なし",
		"ファイル アイコンを無効にする",
		"アイコン テーマの設定で問題が発生しました: {0}",
		"ファイル アイコンのテーマを選択します",
		"現在の設定から配色テーマを生成する",
		"基本設定",
		"Developer",
	...
	"vs/workbench/parts/trust/electron-browser/unsupportedWorkspaceSettings.contribution": [
		"このワークスペースには、ユーザー設定でのみ設定可能な設定が含まれています。({0})",
		"ワークスペース設定を開く",
		"詳細情報",
		"無視",
	],
	...
	"vs/workbench/parts/update/electron-browser/update": [
		...
		"リリース ノートの表示",
		"今すぐダウンロード",
		"{0} v{1} へようこそ! リリース ノートを確認しますか?",
		"ライセンス条項が変更されました。内容をご確認ください。",
		"ライセンスの閲覧",
		"今後は表示しない",
	...
	"vs/workbench/parts/views/browser/viewsExtensionPoint": [
		...
		" `{0}`  プロパティは必須で、`string` 型でなければなりません",
		"`{0}` プロパティは省略するか、`string` 型にする必要があります",
		"ビューの識別子。`vscode.window.registerTreeDataProviderForView` API を介してデータ プロバイダーを登録するには、これを使用します。また、`onView:${id}` イベントを `activationEvents` に登録することによって、拡張機能のアクティブ化をトリガーするためにも使用できます。",
		"ビューの判読できる名前。表示されます",
		"このビューを表示するために満たす必要がある条件",
		"ビューをエディターに提供します",
		"エクスプローラー ビュー",
		"デバッグ ビュー",
		"`{0}` は有効なビューの場所ではありません",
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"カスタマイズする",
		"ツールと言語",
		"{0} と {1} のサポートをインストールする ",
		"その他",
		"キーボード ショートカットをインストールします",
		"{0} と {1} のキーボード ショートカットをインストール",
		"その他",
		"配色テーマ",
		"エディターとコードの外観を自由に設定します",
		"学ぶ",
		"すべてのコマンドの検索と実行",
		"コマンド パレットからコマンドを検索してすばやくアクセスします ({0})",
		"インターフェイスの概要",
		"UI の主要コンポーネントを解説した視覚オーバーレイを表示します",
		"対話型プレイグラウンド",
		"エディターの基本機能を簡潔なチュートリアルで体験します",
	],
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage": [
		...
		"Sublime",
		"Atom",
		"{0} のサポートは既にインストールされています。",
		"{0} に追加のサポートをインストールしたあと、ウィンドウが再度読み込まれます。",
		"{0} に追加のサポートをインストールしています...",
		"ID {1} のサポート {0} は見つかりませんでした。",
		"キーボード ショートカット {0} は既にインストールされています。",
		"キーボード ショートカット {0} をインストールした後、ウィンドウが再度読み込まれます。",
		"{0} のキーボード ショートカットをインストールしています...",
		"ID {1} のキーボード ショートカット {0} は見つかりませんでした。",
		"ようこそ",
		"パス {1} のフォルダー {0} を開く",
		",",
		"{0} キーマップをインストールする",
		"{0} に追加のサポートをインストールする",
		"{0} キーマップは既にインストールされています",
		"{0} のサポートは既にインストールされています",
		"OK",
		"詳細",
		"キャンセル",
		"ウェルカム ページのボタンの背景色。",
		"ウェルカム ページのボタンのホバー背景色。",
	],
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		...
		"設定を書き込めません。**User Settings** を開いて、ファイル内のエラー/警告を修正してからもう一度お試しください。",
		"設定を書き込めません。**Workspace Settings** を開いて、ファイル内のエラー/警告を修正してからもう一度お試しください。",
		"ファイルが変更されているため、設定を書き込めません。**User Settings** ファイルを保存してから、もう一度お試しください。",
		"ファイルが変更されているため、設定を書き込めません。**Workspace Settings** ファイルを保存してから、もう一度お試しください。",
		"ユーザー設定",
		"ワークスペースの設定",
		"Folder Settings",
	],
	"vs/workbench/services/configuration/node/jsonEditingService": [
		"ファイルに書き込めません。ファイルを開いて、ファイル内のエラー/警告を修正してからもう一度お試しください。",
		"ファイルがダーティ状態でありファイルに書き込めません。ファイルを保存してからもう一度お試しください。",
	],
	...
	"vs/workbench/services/files/electron-browser/fileService": [
		"Microsoft .NET Framework 4.5 が必要です。リンクに移動してインストールしてください。",
		".NET Framework 4.5 をダウンロードします",
		"今後は表示しない",
		"\'{0}\' をごみ箱に移動できませんでした",
	],
	"vs/workbench/services/files/node/fileService": [
		"ファイルのリソース ({0}) が無効です",
		"ファイルがディレクトリです ({0})",
		"ファイルは次の時点以後に変更されていません:",
		"開くファイルが大きすぎます",
		"ファイルはバイナリのようなので、テキストとして開くことができません",
		"ファイルが見つかりません ({0})",
		"移動/コピーできません。移動/コピー先にファイルが既に存在します。",
		"移動/コピーできません。ファイルが含まれるフォルダーが置き換わることになります。",
		"フォルダーをワークスペース内にコピーできません。個々のファイルを選択してコピーしてください。",
		"開くファイルが大きすぎます",
		"ファイルは次の時点以後に更新されました:",
		"ファイルは読み取り専用です",
	],
	"vs/workbench/services/keybinding/common/keybindingEditing": [
		...
		"キー バインドを書き込めません。**キー バインド ファイル**を開いて、ファイル内のエラー/警告を修正してからもう一度お試しください。",
		"キー バインドを書き込めません。**キー バインド ファイル**には、配列型ではないオブジェクトが存在します。クリーン アップするファイルを開いてからもう一度お試しください。",
		"既定値を上書きするには、このファイル内にキー バインドを挿入します",
	],
	"vs/workbench/services/keybinding/electron-browser/keybindingService": [
		...
		"`{0}` プロパティは省略するか、`string` 型にする必要があります",
		"`{0}` プロパティは省略するか、`string` 型にする必要があります",
		"キー バインドのトリガー時に実行するコマンドの識別子。",
		"キーまたはキー シーケンス (キーは + で区切り、シーケンスはスペースで区切る。例: Ctrl+O や Ctrl+L L のようにキーを同時に押す)。",
		"Mac 固有のキーまたはキー シーケンス。",
		"Linux 固有のキーまたはキー シーケンス。",
		"Windows 固有のキーまたはキー シーケンス。",
		"キーがアクティブの場合の条件。",
		"キー バインドを提供します。",
		"正しくない `contributes.{0}`: {1}",
		"他に使用できるコマンドは次のとおりです: ",
		"キー バインドの構成",
		"キーまたはキー シーケンス (スペースで区切る) を押します",
		"実行するコマンドの名前",
		"キーがアクティブの場合の条件。",
		"実行するコマンドに渡す引数。",
		"キーボード",
	...
	"vs/workbench/services/mode/common/workbenchModeService": [
		...
		"`contributes.{0}` が無効です。配列が必要です。",
		"`contributes.{0}` に対する空の値",
		"`{0}` プロパティは必須で、`string` 型でなければなりません",
		"`{0}` プロパティを省略するか、`string[]` 型にする必要があります",
		"`{0}` プロパティを省略するか、`string[]` 型にする必要があります",
		"`{0}` プロパティを省略するか、`string` 型にする必要があります",
		"`{0}` プロパティを省略するか、`string` 型にする必要があります",
		"`{0}` プロパティを省略するか、`string[]` 型にする必要があります",
	...
	"vs/workbench/services/textMate/electron-browser/TMGrammars": [
		"TextMate トークナイザーを提供します。",
		"この構文の提供先の言語識別子です。",
		"tmLanguage ファイルにより使用される TextMate スコープ名。",
		"tmLanguage ファイルのパス。拡張機能フォルダーの相対パスであり、通常 \'./syntaxes/\' で始まります。",
		"この文法に言語が埋め込まれている場合は、言語 ID に対するスコープ名のマップ。",
		"この文法が挿入される言語の範囲名の一覧。",
	],
	"vs/workbench/services/textMate/electron-browser/TMSyntax": [
		"`contributes.{0}.language` で不明な言語です。提供された値: {1}",
		"`contributes.{0}.scopeName` には文字列が必要です。提供された値: {1}",
		"`contributes.{0}.path` に文字列が必要です。提供された値: {1}",
		"`contributes.{0}.injectTo` の値が無効です。言語の範囲名の配列である必要があります。指定された値: {1}",
		"`contributes.{0}.embeddedLanguages` の値が無効です。スコープ名から言語へのオブジェクト マップである必要があります。指定された値: {1}",
		"拡張機能のフォルダー ({2}) の中に `contributes.{0}.path` ({1}) が含まれている必要があります。これにより拡張を移植できなくなる可能性があります。",
		"この言語に対して TM 文法は登録されていません。",
	],
	"vs/workbench/services/textfile/common/textFileEditorModel": [
		"ファイルがダーティです。まず保存してから、別のエンコードで再度開いてください。",
		"\'{0}\' の保存に失敗しました: {1}",
	],
	"vs/workbench/services/textfile/common/textFileService": [
		"ファイルをバックアップできませんでした (エラー: {0})。ファイルを保存しなおして終了してください。",
	],
	"vs/workbench/services/textfile/electron-browser/textFileService": [
		"{0} に加えた変更を保存しますか?",
		"次の {0} ファイルに対する変更を保存しますか?",
		"...1 つの追加ファイルが表示されていません",
		"...{0} 個の追加ファイルが表示されていません",
		"すべて保存(&&S)",
		"保存(&&S)",
		"保存しない(&&N)",
		"キャンセル",
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"tmTheme ファイルへのパス (現在のファイルとの相対パス)",
		"構文の強調表示をする色",
	],
	"vs/workbench/services/themes/common/fileIconThemeSchema": [
		"折りたたんだフォルダーのフォルダー アイコン。展開したフォルダー アイコンは省略可能です。設定していない場合は、フォルダーに定義したアイコンが表示されます。",
		"折りたたんだフォルダー、または folderExpanded が設定されていない場合は展開したフォルダーのフォルダー アイコン。",
		"どの拡張子、ファイル名、または言語 ID とも一致しないファイルすべてに表示される既定のファイル アイコン。",
		"フォルダー名をアイコンに関連付けます。オブジェクト キーはフォルダー名ですが、パスの部分は含みません。パターンやワイルドカードは使用できません。フォルダー名の一致では大文字と小文字を区別しません。",
		"関連付けのためのアイコン定義の ID。",
		"フォルダー名を展開したフォルダーのアイコンに関連付けます。オブジェクト キーはフォルダー名ですが、パスの部分は含みません。パターンやワイルドカードは使用できません。フォルダー名の一致では大文字と小文字を区別しません。",
		"関連付けのためのアイコン定義の ID。",
		"ファイル拡張子をアイコンに関連付けます。オブジェクト キーはファイル拡張子名です。拡張子名は、最後のドットに続くファイル名の最後の部分です (ドットは含みません)。拡張子の比較は大文字と小文字が区別しないで行われます。",
		"関連付けのためのアイコン定義の ID。",
		"ファイル名をアイコンに関連付けます。オブジェクト キーは完全なファイル名ですが、パスの部分は含みません。ファイル名にはドットおよび可能なファイル拡張子が含まれる場合があります。パターンやワイルドカードは使用できません。ファイル名の一致では大文字と小文字を区別しません。",
		"関連付けのためのアイコン定義の ID。",
		"言語をアイコンに関連付けます。オブジェクト キーは言語のコントリビューション ポイントで定義された言語 ID です。",
		"関連付けのためのアイコン定義の ID。",
		"アイコンの定義に使用されるフォント。",
		"フォントの ID。",
		"フォントの場所。",
		"現在のアイコン テーマ ファイルへのフォントの相対パス。",
		"フォントの書式。",
		"フォントの太さ。",
		"フォント スタイル。",
		"フォントの既定サイズ。",
		"ファイルをアイコンに関連付けるときに使用できるすべてのアイコンの説明です。",
		"アイコンの定義です。オブジェクト キーは定義の ID です。",
		"SVG または PNG を使用する場合: イメージへのパス。アイコン設定ファイルへの相対パスです。",
		"グリフ フォントを使用する場合: 使用するフォントの文字。",
		"グリフ フォントを使用する場合: 使用する色。",
		"フォントを使用する場合: テキスト フォントに対するフォントサイズの割合。設定されていない場合、既定値はフォント定義のサイズになります。",
		"フォントを使用する場合: フォントの ID。設定されていない場合、既定値は最初のフォント定義になります。",
		"明るい配色テーマでのファイル アイコンの任意の関連付け。",
		"ハイ コントラスト配色テーマでのファイル アイコンの任意の関連付け。",
	],
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		"JSON テーマ ファイルの解析中に問題が発生しました: {0}",
		"配色テーマ ファイルの解析中に問題が発生しました: {0}。\'colors\' プロパティは \'object\' 型ではありません。",
		"配色テーマ ファイルの解析中に問題が発生しました: {0}。\'tokenColors\' プロパティは、配色を指定する配列か、TextMate テーマファイルへのパスでなければなりません",
		"tmTheme ファイルの解析中に問題が発生しました: {0}。\'settings\' は配列ではありません。",
		"tmTheme ファイルの解析中に問題が発生しました: {0}",
		"tmTheme ファイル {0} の読み込み中に問題が発生しました: {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		"TextMate の配色テーマを提供します。",
		"ユーザー設定で使用されるアイコン テーマの ID。",
		"UI で表示される配色テーマのラベル。",
		"エディターの周囲の色を定義する基本テーマ: \'vs\' は明るい色のテーマで、\'vs-dark\' は濃い色のテーマです。\'hc-black\' は濃い色のハイ コントラストのテーマです。",
		"tmTheme ファイルのパス。拡張機能フォルダーに対する相対パスで、通常 \'./themes/themeFile.tmTheme\' です。",
		"Contributes file icon themes.",
		"ユーザー設定で使用されるアイコン テーマの ID。",
		"UI に表示されるアイコン テーマのラベル。",
		"アイコン テーマの定義ファイルのパス。このパスは拡張フォルダーの相対パスであり、通常は \'./icons/awesome-icon-theme.json\' です。",
		"ユーザー設定に新しいテーマの設定が追加されました。{0} に利用可能なバックアップがあります。",
		"Unable to load {0}: {1}",
		...
		"Extension point `{0}` must be an array.",
		"`contributes.{0}.path` に文字列が必要です。提供された値: {1}",
		"`contributes.{0}.id` に文字列が必要です。提供された値: {1}",
		"拡張機能のフォルダー ({2}) の中に `contributes.{0}.path` ({1}) が含まれている必要があります。これにより拡張を移植できなくなる可能性があります。",
		"Unable to load {0}",
		...
		"この設定はもう試験的なものではなく、名前が \'workbench.colorCustomizations\' に変更されています",
		"代わりに \'workbench.colorCustomizations\' を使用してください",
