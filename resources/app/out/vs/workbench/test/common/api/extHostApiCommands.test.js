...
define(["require", "exports", 'assert', 'vs/base/common/errors', 'vs/base/common/uri', 'vs/base/common/winjs.base', 'vs/workbench/api/node/extHostTypes', 'vs/editor/common/model/model', './testThreadService', 'vs/platform/instantiation/common/instantiationService', 'vs/platform/markers/common/markerService', 'vs/platform/markers/common/markers', 'vs/platform/thread/common/thread', 'vs/platform/keybinding/common/keybindingService', 'vs/platform/keybinding/common/keybindingsRegistry', 'vs/editor/common/services/modelService', 'vs/workbench/api/node/extHostLanguageFeatures', 'vs/workbench/api/node/extHostApiCommands', 'vs/workbench/api/node/extHostCommands', 'vs/workbench/api/node/extHostDocuments'], function (require, exports, assert, errors_1, uri_1, winjs_base_1, types, model_1, testThreadService_1, instantiationService_1, markerService_1, markers_1, thread_1, keybindingService_1, keybindingsRegistry_1, modelService_1, extHostLanguageFeatures_1, extHostApiCommands_1, extHostCommands_1, extHostDocuments_1) {
    ...
    suite('ExtHostLanguageFeatureCommands', function () {
        ...
        test('Suggest, back and forth', function (done) {
            ...
            threadService.sync().then(function () {
                commands.executeCommand('vscode.executeCompletionItemProvider', model.getAssociatedResource(), new types.Position(0, 4)).then(function (values) {
                    try {
                        assert.equal(values.length, 4);
