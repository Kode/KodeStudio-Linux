 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/base/common/errors', 'vs/base/common/uri', 'vs/workbench/api/node/extHostTypes', 'vs/editor/common/model/model', './testThreadService', 'vs/platform/instantiation/common/instantiationService', 'vs/platform/markers/common/markerService', 'vs/platform/markers/common/markers', 'vs/platform/thread/common/thread', 'vs/workbench/api/node/extHostLanguageFeatures', 'vs/workbench/api/node/extHostCommands', 'vs/workbench/api/node/extHostDocuments', 'vs/editor/contrib/quickOpen/common/quickOpen', 'vs/editor/contrib/codelens/common/codelens', 'vs/editor/contrib/goToDeclaration/common/goToDeclaration', 'vs/editor/contrib/hover/common/hover', 'vs/editor/contrib/wordHighlighter/common/wordHighlighter', 'vs/editor/contrib/referenceSearch/common/referenceSearch', 'vs/editor/contrib/quickFix/common/quickFix', 'vs/workbench/parts/search/common/search', 'vs/editor/contrib/rename/common/rename', 'vs/editor/contrib/parameterHints/common/parameterHints', 'vs/editor/contrib/suggest/common/suggest', 'vs/editor/contrib/format/common/format'], function (require, exports, assert, errors_1, uri_1, types, model_1, testThreadService_1, instantiationService_1, markerService_1, markers_1, thread_1, extHostLanguageFeatures_1, extHostCommands_1, extHostDocuments_1, quickOpen_1, codelens_1, goToDeclaration_1, hover_1, wordHighlighter_1, referenceSearch_1, quickFix_1, search_1, rename_1, parameterHints_1, suggest_1, format_1) {
    var defaultSelector = { scheme: 'far' };
    var model = new model_1.Model([
        'This is the first line',
        'This is the second line',
        'This is the third line',
    ].join('\n'), undefined, uri_1.default.parse('far://testing/file.a'));
    var extHost;
    var mainThread;
    var disposables = [];
    var threadService;
    ...
    suite('ExtHostLanguageFeatures', function () {
        suiteSetup(function () {
            var instantiationService = instantiationService_1.create();
            threadService = new testThreadService_1.TestThreadService(instantiationService);
            instantiationService.addSingleton(markers_1.IMarkerService, new markerService_1.MarkerService(threadService));
        ...
        test('DocumentSymbols, register/deregister', function (done) {
            assert.equal(quickOpen_1.OutlineRegistry.all(model).length, 0);
            ...
            threadService.sync().then(function () {
                assert.equal(quickOpen_1.OutlineRegistry.all(model).length, 1);
                d1.dispose();
                threadService.sync().then(function () {
                    done();
                });
        ...
        test('Suggest, order 2/3', function (done) {
            ...
            setTimeout(function () {
                ...
                threadService.sync().then(function () {
                    suggest_1.suggest(model, { lineNumber: 1, column: 1 }, ',').then(function (value) {
                        assert.equal(value.length, 2);
                        var first = value[0][0], second = value[1][0];
                        assert.equal(first.suggestions.length, 1);
