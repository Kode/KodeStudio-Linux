...
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/base/common/eventEmitter', 'vs/base/common/paths', 'vs/base/common/uri', 'vs/platform/telemetry/browser/mainTelemetryService', 'vs/workbench/common/storage', 'vs/platform/lifecycle/common/baseLifecycleService', 'vs/base/common/types', 'vs/platform/configuration/common/configuration', 'vs/platform/storage/common/storage', 'vs/workbench/services/editor/common/editorService', 'vs/workbench/services/quickopen/common/quickOpenService', 'vs/workbench/services/part/common/partService', 'vs/workbench/services/workspace/common/contextService', 'vs/platform/event/common/event', 'vs/workbench/services/untitled/common/untitledEditorService', 'vs/platform/message/common/message', 'vs/platform/request/common/baseRequestService', 'vs/platform/telemetry/common/telemetry', 'vs/workbench/browser/parts/editor/editor.contribution'], function (require, exports, winjs_base_1, EventEmitter, Paths, uri_1, MainTelemetryService, Storage, LifecycleService, Types, configuration_1, storage_1, WorkbenchEditorService, QuickOpenService, PartService, WorkspaceContextService, event_1, untitledEditorService_1, message_1, baseRequestService_1, telemetry_1) {
    ...
    var TestTelemetryService = (function () {
        function TestTelemetryService() {
            this.serviceId = telemetry_1.ITelemetryService;
        }
        TestTelemetryService.prototype.getSessionId = function () {
            return null;
        };
        TestTelemetryService.prototype.getMachineId = function () {
            return null;
        };
        TestTelemetryService.prototype.getInstanceId = function () {
            return null;
        };
        TestTelemetryService.prototype.getTelemetryInfo = function () {
            return winjs_base_1.TPromise.as(null);
        };
        TestTelemetryService.prototype.log = function (eventName, data) { };
        TestTelemetryService.prototype.publicLog = function (eventName, data) { };
        TestTelemetryService.prototype.start = function (name, data, isPublic) {
            return null;
        };
        TestTelemetryService.prototype.getAppendersCount = function () {
            return -1;
        };
        TestTelemetryService.prototype.getAppenders = function () {
            return [];
        };
        TestTelemetryService.prototype.addTelemetryAppender = function (appender) { };
        TestTelemetryService.prototype.removeTelemetryAppender = function (appender) { };
        TestTelemetryService.prototype.dispose = function () { };
        TestTelemetryService.prototype.setInstantiationService = function (instantiationService) { };
        return TestTelemetryService;
    })();
    exports.TestTelemetryService = TestTelemetryService;
    ...
    var TestRequestService = (function (_super) {
        ...
        function TestRequestService(workspace) {
            if (workspace === void 0) { workspace = exports.TestWorkspace; }
            _super.call(this, new TestContextService(), new MainTelemetryService.MainTelemetryService());
        }
    ...
    exports.TestFileService = {
        ...
        updateContent: function (res) {
            return winjs_base_1.Promise.timeout(1).then(function () {
                return {
                    resource: res,
                    etag: 'index.txt',
                    mime: 'text/plain',
