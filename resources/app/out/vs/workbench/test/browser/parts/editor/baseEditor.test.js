...
define(["require", "exports", 'assert', 'vs/workbench/browser/parts/editor/baseEditor', 'vs/workbench/common/editor', 'vs/platform/instantiation/common/instantiationService', 'vs/platform/platform', 'vs/platform/instantiation/common/descriptors', 'vs/workbench/common/editor/stringEditorInput', 'vs/platform/telemetry/common/telemetry', 'vs/platform/telemetry/common/nullTelemetryService', 'vs/base/common/mime'], function (require, exports, assert, baseEditor_1, editor_1, InstantiationService, Platform, descriptors_1, stringEditorInput_1, telemetry_1, nullTelemetryService_1, mime) {
    ...
    suite("Workbench BaseEditor", function () {
        test("BaseEditor API", function (done) {
            var e = new MyEditor("id", new nullTelemetryService_1.NullTelemetryService());
        ...
        test("Editor Input Action Contributor", function () {
            ...
            assert(contributor.hasActions({ editor: new MyEditor("id", new nullTelemetryService_1.NullTelemetryService()), input: inst.createInstance(stringEditorInput_1.StringEditorInput, 'fake', '', '', mime.MIME_TEXT, false), position: 0 }));
            var actionsFirst = contributor.getActions({ editor: new MyEditor("id", new nullTelemetryService_1.NullTelemetryService()), input: inst.createInstance(stringEditorInput_1.StringEditorInput, 'fake', '', '', mime.MIME_TEXT, false), position: 0 });
            ...
            var actions = contributor.getActions({ editor: new MyEditor("id", new nullTelemetryService_1.NullTelemetryService()), input: input, position: 0 });
            ...
            actions = contributor.getActions({ editor: new MyOtherEditor("id2", new nullTelemetryService_1.NullTelemetryService()), input: input, position: 0 });
            assert(actions[0] !== actionsFirst[0]);
            assert(actions[1] !== actionsFirst[1]);
            assert(actions[0].input === input);
            assert(actions[1].input === input);
            ...
            actions = contributor.getActions({ editor: new MyEditor("id3", new nullTelemetryService_1.NullTelemetryService()), input: myInput, position: 0 });
