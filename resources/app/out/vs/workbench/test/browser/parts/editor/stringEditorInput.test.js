 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/base/common/winjs.base', 'vs/base/common/uri', 'vs/workbench/common/editor/stringEditorInput', 'vs/workbench/common/editor/logEditorInput', 'vs/workbench/common/editor/resourceEditorInput', 'vs/workbench/test/browser/servicesTestUtils', 'vs/platform/instantiation/common/instantiationService', 'vs/editor/test/common/servicesTestUtils'], function (require, exports, assert, winjs_base_1, uri_1, stringEditorInput_1, logEditorInput_1, resourceEditorInput_1, servicesTestUtils_1, InstantiationService, servicesTestUtils_2) {
    suite("Workbench - StringEditorInput", function () {
        ...
        test("Input.matches() - StringEditorInput", function () {
            var inst = InstantiationService.create({});
            var promise = winjs_base_1.Promise.as("value");
        ...
        test("LogEditorInput", function () {
            var inst = InstantiationService.create({});
            var logEditorInput = inst.createInstance(logEditorInput_1.LogEditorInput, "name", 'description', "value\nvalue\nvalue", "mime", false);
            var logEditorInput2 = inst.createInstance(logEditorInput_1.LogEditorInput, "name", 'description', "value\nvalue\nvalue", "mime", false);
            var stringEditorInput = inst.createInstance(stringEditorInput_1.StringEditorInput, "name", 'description', "value", "mime", false);
        ...
        test("ResourceEditorInput", function (done) {
            ...
            var model = modelService.createModel('function test() {}', modeService.getOrCreateMode('text'), resource);
