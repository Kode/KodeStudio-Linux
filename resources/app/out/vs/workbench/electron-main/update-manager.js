...
define(["require", "exports", 'fs', 'path', 'events', 'electron', 'vs/base/common/platform', 'vs/workbench/electron-main/env', 'vs/workbench/electron-main/storage', 'vs/workbench/electron-main/settings', 'vs/workbench/electron-main/win32/auto-updater.win32', 'vs/workbench/electron-main/lifecycle'], function (require, exports, fs, path, events, electron, platform, env, storage, settings, auto_updater_win32_1, lifecycle_1) {
    ...
    var UpdateManager = (function (_super) {
        ...
        UpdateManager.getUpdateChannel = function () {
            var channel = settings.manager.getValue('update.channel');
            if (!channel) {
                channel = storage.getItem('updateChannel'); // TODO@Ben this should be removed after a couple of versions
                if (!channel) {
        ...
        UpdateManager.DEFAULT_UPDATE_CHANNEL = 'stable';
