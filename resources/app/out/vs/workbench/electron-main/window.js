 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'path', 'os', 'electron', 'vs/base/common/winjs.base', 'vs/base/common/platform', 'vs/base/common/objects', 'vs/workbench/electron-main/env', 'vs/workbench/electron-main/storage'], function (require, exports, path, os, electron_1, winjs_base_1, platform, objects, env, storage) {
    (function (WindowMode) {
        ...
        VSCodeWindow.prototype.registerListeners = function () {
            ...
            this._win.webContents.on('did-finish-load', function () {
                ...
                if (_this.pendingLoadConfig) {
                    ...
                    delete _this.pendingLoadConfig;
                }
