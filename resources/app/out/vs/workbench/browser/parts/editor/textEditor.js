...
define(["require", "exports", 'vs/base/common/objects', 'vs/base/common/errors', 'vs/editor/browser/widget/codeEditorWidget', 'vs/workbench/common/constants', 'vs/workbench/common/events', 'vs/workbench/common/memento', 'vs/workbench/browser/parts/editor/baseEditor', 'vs/editor/common/config/commonEditorConfig', 'vs/editor/common/editorCommon', 'vs/workbench/services/workspace/common/contextService', 'vs/platform/theme/common/themes', 'vs/platform/storage/common/storage', 'vs/platform/configuration/common/configuration', 'vs/platform/event/common/event', 'vs/platform/instantiation/common/instantiation', 'vs/platform/message/common/message', 'vs/platform/telemetry/common/telemetry', 'vs/workbench/services/editor/common/editorService', 'vs/editor/common/services/modeService', 'vs/css!./media/texteditor'], function (require, exports, objects, errors, codeEditorWidget_1, constants_1, events_1, memento_1, baseEditor_1, commonEditorConfig_1, editorCommon_1, contextService_1, themes_1, storage_1, configuration_1, event_1, instantiation_1, message_1, telemetry_1, editorService_1, modeService_1) {
    ...
    var BaseTextEditor = (function (_super) {
        ...
        function BaseTextEditor(id, telemetryService, _instantiationService, _contextService, _storageService, _messageService, configurationService, _eventService, _editorService, _modeService) {
            var _this = this;
            ...
            this.toUnbind.push(this._eventService.addListener(storage_1.StorageEventType.STORAGE, function (e) { return _this.onPreferencesChanged(e); }));
        ...
        BaseTextEditor.prototype.onPreferencesChanged = function (e) {
        ...
        BaseTextEditor.prototype.getCodeEditorOptions = function () {
            var baseOptions = {
                ...
                theme: this._storageService.get(constants_1.Preferences.THEME, storage_1.StorageScope.GLOBAL, themes_1.DEFAULT_THEME_ID)
            };
        ...
        BaseTextEditor.prototype.createEditor = function (parent) {
            ...
            // Configuration
            this.configurationService.loadConfiguration().then(function (config) {
                _this.applyConfiguration(config);
