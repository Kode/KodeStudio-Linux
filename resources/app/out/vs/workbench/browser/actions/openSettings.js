...
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/nls', 'vs/base/common/uri', 'vs/base/common/network', 'vs/base/common/labels', 'vs/platform/platform', 'vs/base/common/actions', 'vs/workbench/common/actionRegistry', 'vs/workbench/common/editor/stringEditorInput', 'vs/platform/configuration/common/model', 'vs/workbench/services/editor/common/editorService', 'vs/workbench/services/workspace/common/contextService', 'vs/platform/configuration/common/configuration', 'vs/platform/editor/common/editor', 'vs/platform/files/common/files', 'vs/platform/message/common/message', 'vs/platform/keybinding/common/keybindingService', 'vs/platform/actions/common/actions', 'vs/platform/instantiation/common/instantiation', 'vs/base/common/keyCodes'], function (require, exports, winjs_base_1, nls, uri_1, network, labels, platform_1, actions_1, actionRegistry_1, stringEditorInput_1, model_1, editorService_1, contextService_1, configuration_1, editor_1, files_1, message_1, keybindingService_1, actions_2, instantiation_1, keyCodes_1) {
            ...
            return this.fileService.resolveContent(resource, { acceptTextOnly: true }).then(null, function (error) {
                if (error.fileOperationResult === files_1.FileOperationResult.FILE_NOT_FOUND) {
                    return _this.fileService.updateContent(resource, contents).then(null, function (error) {
                        return winjs_base_1.Promise.wrapError(new Error(nls.localize('fail.createSettings', "Unable to create '{0}' ({1}).", labels.getPathLabel(resource, _this.contextService), error)));
                    });
                }
    ...
    var OpenGlobalSettingsAction = (function (_super) {
        ...
        function OpenGlobalSettingsAction() {
        ...
        OpenGlobalSettingsAction.prototype.run = function (event) {
            ...
            if (this.configurationService.hasWorkspaceConfiguration()) {
                var hide = this.messageService.show(message_1.Severity.Info, {
                ...
                setTimeout(function () { return hide(); }, 10000 /* hide after 10 seconds */);
            }
            // Open settings
    ...
    var DefaultSettingsInput = (function (_super) {
        ...
        DefaultSettingsInput.prototype.getResource = function () {
            return uri_1.default.create(network.schemas.inMemory, 'defaults', '/settings.json'); // URI is used to register JSON schema support
        };
    ...
    var DefaultKeybindingsInput = (function (_super) {
        ...
        DefaultKeybindingsInput.prototype.getResource = function () {
            return uri_1.default.create(network.schemas.inMemory, 'defaults', '/keybindings.json'); // URI is used to register JSON schema support
        };
