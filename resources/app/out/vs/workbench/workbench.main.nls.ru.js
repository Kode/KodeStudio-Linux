...
define("vs/workbench/workbench.main.nls.ru", {
	...
	"vs/editor/contrib/indentation/common/indentation": [
		...
		"Переключить управляющие символы",
	],
	...
	"vs/editor/node/textMate/TMSyntax": [
		...
		"Сопоставление имени области и идентификатора языка, если грамматика содержит встроенные языки.",
	...
	"vs/platform/environment/node/argv": [
		"Аргументы в режиме \"--goto\" должны быть в формате \"ФАЙЛ(:СТРОКА(:СТОЛБЕЦ))\".",
	...
	"vs/platform/markers/common/problemMatcher": [
		"Ошибка: недопустимое описание problemMatcher. В сопоставителе должны определяться по крайней мере шаблон, владелец и расположение файла. Проблемный сопоставитель:\n{0}\n",
		...
		"Свойство loop поддерживается только в многострочных сопоставителях.",
		"В шаблоне проблемы отсутствует регулярное выражение.",
	...
	"vs/workbench/browser/actions/openSettings": [
		...
		"Открытая в настоящий момент папка содержит параметры рабочей области, которые могут переопределять пользовательские параметры",
		...
		"Редактор параметров по умолчанию",
		"Параметры",
	],
	...
	"vs/workbench/browser/parts/editor/binaryDiffEditor": [
		"Средство просмотра двоичных различий",
		"Сравнение двоичных файлов с недвоичными в настоящее время не поддерживается",
		"{0} ↔ {1}",
	],
	...
	"vs/workbench/electron-browser/actions": [
		...
		"Выберите окно",
		"Закрыть папку",
		"В настоящий момент в этом экземпляре нет открытой папки, которую можно было бы закрыть.",
		"Новое окно",
		"Полноэкранный режим",
		...
		"папки",
		"файлы",
		"Выбрать путь (удерживайте клавишу CMD, чтобы открыть в новом окне)",
		"Выбрать папку для открытия (удерживайте клавишу CTRL, чтобы открыть ее в новом окне)",
		"Закрыть уведомления",
	...
	"vs/workbench/electron-browser/shell": [
		...
		"Общий процесс неожиданно завершился. Чтобы восстановить его, перезагрузите окно.",
	],
	...
	"vs/workbench/parts/cli/electron-browser/cli.contribution": [
		...
		"Удалите псевдоним, содержащий ссылку на \"{0}\", из \"{1}\" (строка {2}) и повторите это действие.",
		"Изменить \"{0}\"",
		"Перед тем как продолжить, удалите псевдоним \"{0}\" из \"{1}\".",
		"Продолжить",
		"Отмена",
		...
		"Редактору Code необходимо изменить команду оболочки \"{0}\". Сделать это сейчас?",
		"Изменить сейчас",
		"Позже",
		"Помните, что вы всегда можете выполнить действие \"{0}\" из палитры команд.",
		"Команда оболочки",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"Прервать выполнение, если выражение равно true. Нажмите клавишу ВВОД, чтобы принять, или ESC для отмены.",
		"Выполнение программы прервется в этом месте, только если условие выполнится. Нажмите клавишу ВВОД для принятия или ESC для отмены.",
		"Прервать при определенном количестве обращений. Нажмите клавишу ВВОД, чтобы принять, или ESC для отмены.",
		"Выполнение программы прервется в этом месте, только если достигнуто определенное количество обращений. Нажмите клавишу ВВОД для принятия или ESC для отмены.",
		"Выражение",
	...
	"vs/workbench/parts/debug/browser/debugActions": [
		...
		"Включить или отключить точку останова",
	...
	"vs/workbench/parts/debug/browser/debugEditorModelManager": [
		...
		"Непроверенная точка останова. Файл был изменен, перезапустите сеанс отладки.",
		"Условные точки останова не поддерживаются этим типом отладки",
	],
	"vs/workbench/parts/debug/browser/debugViewlet": [
		"В настоящее время нет открытой папки.",
		"Чтобы начать отладку, откройте папку.",
	],
	"vs/workbench/parts/debug/common/debugModel": [
		"Неизвестный источник",
		"Чтобы произвести вычисление, начните сеанс отладки",
		"Неизвестное расположение стека",
		"Для этого объекта показаны только значения-примитивы.",
	],
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		"Показать отладочные сведения",
		"Консоль отладки",
		"Отладка",
		"Консоль отладки",
		"Просмотреть",
		...
		"Ошибка при отладке",
		"Отладка",
		"Разрешает задание точки останова в любом файле",
		"Автоматически открывать мини-приложение проводника в конце сеанса отладки",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugHover": [
		"Отладка при наведении",
	],
	"vs/workbench/parts/debug/electron-browser/debugService": [
		"Отладка началась.",
		"Отладка была приостановлена, причина {0}, {1} {2}",
		"Отладка остановилась.",
		"Добавлена точка останова: строка {0}, файл {1}",
		"Удалена точка останова: строка {0}, файл {1}",
		"Настройте файл конфигурации запуска для вашего приложения.",
		"Настроенный тип отладки \"{0}\" не поддерживается.",
		"Отсутствует свойство \"type\" для выбранной конфигурации запуска.",
		"При выполнении предварительной задачи \"{0}\" обнаружены ошибки.",
		"При выполнении предварительной задачи \"{0}\" обнаружена ошибка.",
		"Выполнение предварительной задачи \"{0}\" завершено с кодом выхода {1}.",
		"Принудительная отладка",
		"Процесс адаптера отладки неожиданно завершился",
		"Не удалось найти задачу preLaunchTask \"{0}\".",
		"Выполняется задача {0}. Невозможно запустить предварительную задачу {1}.",
		"Источник {0} недоступен.",
	],
	"vs/workbench/parts/debug/electron-browser/debugViewer": [
		...
		"приостановлено",
		"выполняется",
		"Загрузить больше кадров стека",
		"Поток {0}, стек вызовов, отладка",
		"Кадр стека {0}, строка {1} {2}, стек вызовов, отладка",
		"Введите новое значение переменной",
		"Область {0}, переменные, отладка",
		"{0} значение {1}, переменные, отладка",
		"Выражение с контрольным значением",
		"Введите выражение контрольного значения",
		"{0} значение {1}, контрольное значение, отладка",
		"{0} значение {1}, контрольное значение, отладка",
		"Функция, в которой производится останов",
		"Введите точку останова в функции",
		"Точки останова функций не поддерживаются в этом типе отладки",
		"Строка точки останова {0} {1}, точки останова, отладка",
		"Точка останова в функции {0}, точки останова, отладка",
		"Точка останова в исключении {0}, точки останова, отладка",
	],
	"vs/workbench/parts/debug/electron-browser/debugViews": [
		...
		"Отладка выражений контрольных значений",
		"Раздел стека вызовов",
		"Приостановлено {0}",
		"Стек вызовов",
		"Отладка стека вызовов",
		"Раздел точек останова",
		"Точки останова",
		"Отладка точек останова",
	],
	...
	"vs/workbench/parts/debug/electron-browser/rawDebugSession": [
		"Подробнее",
		"Расширение для отладки \"{0}\" не установлено.",
		"Не удается запустить адаптер отладки из \"{0}\".",
		"Не найден исполняемый файл \"{0}\" адаптера отладки.",
		"{0}. Адаптер отладки останавливается.",
		"Процесс адаптера отладки неожиданно завершился",
	],
	"vs/workbench/parts/debug/electron-browser/repl": [
		"Панель read–eval–print loop",
		"Журнал — назад",
		"Журнал — далее",
		"Прием входных данных REPL",
	],
	"vs/workbench/parts/debug/electron-browser/replViewer": [
		...
		"Переменная \"{0}\" имеет значение \"{1}\", read–eval–print loop, отладка",
		"Выражение \"{0}\" имеет значение \"{1}\", read–eval–print loop, отладка",
		"{0}, read–eval–print loop, отладка",
		"Выходная переменная \"{0}\" имеет значение \"{1}\", read–eval–print loop, отладка",
	],
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"Запросите тип конфигурации. Возможные типы: \"запуск\" и \"подключение\".",
		"Конфигурации, которые будут запущены в рамках этой \"составной\" конфигурации. Учитываются, только если тип конфигурации — \"composite\".",
		"Задача, выполняемая перед началом сеанса отладки.",
		"Управляет поведением внутренней консоли отладки.",
		"Атрибуты конфигурации запуска для Windows.",
		"Атрибуты конфигурации запуска для OS X.",
		"Атрибуты конфигурации запуска для Linux.",
		"Относительные пути больше не будут автоматически преобразовываться в абсолютные. Рекомендуем использовать префикс ${workspaceRoot}.",
	],
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		"Добавляет адаптеры отладки.",
		"Уникальный идентификатор этого адаптера отладки.",
		"Отображаемое имя этого адаптера отладки.",
		"Разрешить точки останова для этих языков.",
		"Список языков.",
		"Путь к программе адаптера отладки. Путь указывается либо как абсолютный, либо относительно папки расширения.",
		"Необязательные аргументы для передачи адаптеру.",
		"Дополнительная среда выполнения, используемая в том случае, если атрибут program не указывает на исполняемый файл, но среда выполнения требуется.",
		"Аргументы дополнительной среды выполнения.",
		"Сопоставление интерактивных переменных (например, ${action.pickProcess}) в \"launch.json\" для команды.",
		"Конфигурации для создания первоначального файла launch.json.",
		"Конфигурации схемы JSON для проверки launch.json.",
		"Параметры, связанные с Windows.",
		"Среда выполнения, используемая для Windows.",
		"Параметры, связанные с OS X.",
		"Среда выполнения, используемая для OS X.",
		"Параметры, связанные с Linux.",
		"Среда выполнения, используемая для Linux.",
		"Добавляет точки останова.",
		"Разрешить точки останова для этого языка.",
		"Запустить",
		"Версия этого формата файла.",
		"Список конфигураций. Добавьте новые конфигурации или измените существующие с помощью IntelliSense.",
		"Параметр type адаптера отладки не может быть опущен и должен иметь тип string.",
		"Тип отладки \"{0}\" уже зарегистрирован и имеет атрибут \"{1}\". Атрибут \"{1}\" игнорируется.",
		"Выбор среды",
	...
	"vs/workbench/parts/emmet/node/actions/editPoints": [
		"Emmet: предыдущая точка изменения",
		"Emmet: следующая точка изменения",
	],
	"vs/workbench/parts/emmet/node/actions/evaluateMath": [
		"Emmet: вычисление математического выражения",
	],
	...
	"vs/workbench/parts/emmet/node/actions/incrementDecrement": [
		"Emmet: увеличение значения на 0,1",
		"Emmet: увеличение значения на 1",
		"Emmet: увеличение значения на 10",
		"Emmet: уменьшение значения на 0,1",
		"Emmet: уменьшение значения на 1",
		"Emmet: уменьшение значения на 10",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionTipsService": [
		"Рекомендуется установить расширение \"{0}\".",
	...
	"vs/workbench/parts/extensions/electron-browser/extensions.contribution": [
		...
		"Установить расширения из коллекции",
		"Расширение",
		"Просмотреть",
		"Расширения",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"Перезагрузка для активации",
		"Перезагрузить это окно, чтобы активировать расширение \"{0}\"?",
		"Перезагрузка для включения",
		"Перезагрузить это окно, чтобы включить расширение \"{0}\"?",
		"Перезагрузка для отключения",
		"Перезагрузить это окно, чтобы отключить расширение \"{0}\"?",
		"Перезагрузка для деактивации",
		"Перезагрузить это окно, чтобы деактивировать расширение \"{0}\"?",
		...
		"Встроенное",
		"Отключить все",
		"Отключить все (рабочая область)",
		"Включить все",
		"Включить все (рабочая область)",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsQuickOpen": [
		...
		"Нажмите клавишу ВВОД для поиска \"{0}\" в Marketplace.",
		"Введите имя расширения",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsViewlet": [
		"Поиск расширений в Marketplace",
		"Сортировать по: числу установок",
		"Сортировать по: рейтинг",
		"Порядок сортировки: ↑",
		"Порядок сортировки: ↓",
		"Расширений не найдено.",
		"Marketplace вернул значение \"ECONNREFUSED\". Проверьте параметр \"http.proxy\".",
		"Расширения",
		"Устаревшие расширения: {0}",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsWidgets": [
		"Отключено",
		"Отключено (рабочая область)",
		"Установлено",
		"Включено",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsWorkbenchService": [
		"Расширение \"{0}\" успешно установлено. Чтобы включить его, выполните перезапуск.",
		"Перезапустить",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"Переименовать",
		"Переименовать",
		"Вы переименовываете папку с несохраненными изменениями в одном файле. Вы хотите продолжить?",
		"Вы переименовываете папку с несохраненными изменениями в нескольких файлах ({0}). Вы хотите продолжить?",
		"Вы переименовываете файл с несохраненными изменениями. Вы хотите продолжить?",
		...
		"Выберите запись журнала редактора для сравнения",
		...
		"Фокус на проводнике",
		"Показать активный файл в обозревателе",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"Управляет автоматическим сохранением измененных файлов. Допустимые значения: \"{0}\", \"{1}\", \"{2}\" (редактор теряет фокус) и \"{3}\" (окно теряет фокус). Если задано значение \"{4}\", можно настроить задержку в \"files.autoSaveDelay\".",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"Сравнить",
		"{0} (на диске) ↔ в {1} (в {2})",
		"Разрешить конфликт сохранения",
		"Используйте команды на панели инструментов для **отмены** изменений или **перезаписи** содержимого на диске",
		"Использовать локальные изменения и перезаписать содержимое на диске",
		"Содержимое файла на диске изменилось, и левая часть редактора сравнения обновилась. Проверьте данные и устраните проблему.",
		"Отменить локальные изменения и вернуться к содержимому на диске",
	],
	...
	"vs/workbench/parts/files/browser/views/explorerViewer": [
		...
		"{0}, Проводник",
		"Вы перемещаете папку с несохраненными изменениями в одном файле. Вы хотите продолжить?",
		"Вы перемещаете папку с несохраненными изменениями в нескольких файлах ({0}). Вы хотите продолжить?",
		"Вы перемещаете файл с несохраненными изменениями. Вы хотите продолжить?",
		"Если не сохранить изменения, они будут утеряны.",
		"&&Переместить",
	...
	"vs/workbench/parts/files/electron-browser/electronFileActions": [
		...
		"Отобразить в средстве поиска",
		"Открыть содержащую папку",
		"Отобразить активный файл в проводнике",
		"Отобразить активный файл в средстве поиска",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"Инициализация",
		"Обновить",
		"Промежуточно сохранить",
		"Промежуточно сохранить все",
		"Действительно отменить все изменения?",
		"Имеются изменения в файле ({0}), промежуточное сохранение которых не выполнено.\n\nЭто действие необратимо!",
		"Имеются изменения в файлах ({0}), промежуточное сохранение которых не выполнено.\n\nЭто действие необратимо!",
		"&&Отменить изменения",
		...
		"Очистить",
		"Очистить все",
		"Отменить промежуточное сохранение",
		"Отменить промежуточное сохранение всего",
		"Не удается извлечь. Сначала нужно зафиксировать работу или промежуточно сохранить ее.",
		"Зафиксировать промежуточно сохраненные изменения",
		"Зафиксировать промежуточные элементы (завершено)",
		"Commit",
		...
		"Зафиксировать все",
		"Зафиксировать промежуточно сохраненные изменения",
		"Не удается запросить. Сначала нужно зафиксировать работу или промежуточно сохранить ее.",
		"Сбой аутентификации для команды git remote.",
		"Сбой аутентификации для команды git remote.",
		"Отправить в:",
		"Выберите удаленный компьютер, на который следует отправить ветвь \"{0}\":",
		"Сбой аутентификации для команды git remote.",
		"Опубликовать",
		"Действительно опубликовать \"{0}\" в \"{1}\"?",
		"&&Опубликовать",
		"Выберите удаленный сервер, на котором нужно опубликовать ветвь \"{0}\":",
		"Сбой аутентификации для команды git remote.",
		"Это действие отправляет фиксации в \"{0}\" и извлекает их из этого расположения.",
	...
	"vs/workbench/parts/git/browser/gitActions.contribution": [
		"Переключиться в представление изменений",
		"Переключиться в представление редактора",
		"Промежуточное сохранение",
		"Отменить промежуточное сохранение",
		"Промежуточно сохранить выделенные строки",
		"Отменить промежуточное сохранение выбранных строк",
		"Открыть изменение",
		"Открыть файл",
		"GIT",
	],
	"vs/workbench/parts/git/browser/gitQuickOpen": [
		...
		"Удаленная ветвь в {0}",
		"Тег в {0}",
		"Ветвь {0} уже является текущей ветвью",
		"{0}, ветвь GIT",
		"Создать ветвь {0}",
		"Нет других ветвей",
		"Укажите допустимое имя ветви",
	],
	"vs/workbench/parts/git/browser/gitServices": [
		"Невозможно открыть этот ресурс GIT.",
		"{0} (index) ↔ {1}",
		"{0} — изменения в индексе",
		"{0} ← {1}",
		"{0} — переименовано — изменения в индексе",
		"{0} (HEAD) ↔ {1}",
		"{0} — изменения в рабочем дереве",
		"{0} (объединить) ↔ {1}",
		"{0} — объединить изменения",
		"Вероятно, у вас установлен GIT {0}. Код лучше всего работает с GIT >=2.0.0.",
		"Скачать",
		"Больше не показывать",
		"Настройте ваши имя пользователя и электронную почту GIT.",
		"GIT {0}",
		"Перед сохранением необходимо сначала разрешить необъединенные изменения.",
		"Показать выходные данные",
		"Отмена",
		"Ошибка при выполнении операции GIT. Проверьте выходные данные или используйте консоль для проверки состояния репозитория.",
		"{0} (index)",
		"{0} — изменения в индексе",
		"{0} ({1})",
		"{0} — изменения в {1}",
	...
	"vs/workbench/parts/git/browser/gitWidgets": [
		...
		"GIT недоступен в этой рабочей области.",
	],
	"vs/workbench/parts/git/browser/gitWorkbenchContributions": [
		"Состояние выполнения GIT",
	...
	"vs/workbench/parts/git/browser/views/changes/changesView": [
		...
		"Рекомендуется, чтобы первая строка фиксации была короче 50 символов. Используйте новые строки для дополнительных сведений.",
	...
	"vs/workbench/parts/html/browser/webview": [
		"Разработчик: средства веб-представления",
	],
	...
	"vs/workbench/parts/markers/common/messages": [
		...
		"({0}, {1})",
		"{0} с проблемами ({1})",
		"Ошибка, созданная {0}: {1} в строке {2} и столбце {3}",
		"Ошибка: {0} в строке {1} и столбце {2}",
		"Предупреждение, созданное {0}: {1} в строке {2} и столбце {3}",
		"Предупреждение: {0} в строке {1} и столбце {2}",
		"Сообщение, созданное {0}: {1} в строке {2} и столбце {3}",
		"Сообщение: {0} в строке {1} и столбце {2}",
		"Проблема, созданная {0}: {1} в строке {2} и столбце {3}",
		"Проблема: {0} в строке {1} и столбце {2}",
	...
	"vs/workbench/parts/search/browser/replaceService": [
		"{0} ↔ {1} (предварительный просмотр замены)",
	],
	...
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"Заменены совпадения ({0}) на {2} в следующем числе файлов: {1}.",
		"Удалено вхождений в файлах ({1}): {0}.",
		"Заменить все",
		"Заменить совпадения ({0}) на \"{2}\" в следующем числе файлов: {1}?",
		"Удалить вхождения ({0}) в файлах ({1})?",
		"Заменить",
		"Результаты поиска",
		"{0}, когда {1}",
	...
	"vs/workbench/parts/snippets/electron-browser/snippets.contribution": [
		...
		"Выберите язык для фрагмента.",
		"Не удалось создать {0}.",
		"Параметры",
		"Пустой фрагмент",
		"Настройка фрагмента пользователя",
		"Префикс, используемый при выборе фрагмента в Intellisense.",
		"Содержимое фрагмента. Используйте \"${id}\", \"${id:label}\", \"${1:label}\" для переменных и \"$0\", \"$1\" для положений курсора",
		"Описание фрагмента.",
	],
	...
	"vs/workbench/parts/tasks/common/taskTemplates": [
		"Компилирует проект TypeScript",
		"Компилирует проект TypeScript в режиме наблюдения",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"Выполнить задачу повторной сборки",
		...
		"Средство запуска задач не настроено.",
		"Допустимое средство запуска задач не настроено. Поддерживаемые средства запуска задач: \"служба\" и \"программа\".",
		"Задача уже активна и находится в режиме наблюдения.",
		"В настоящий момент есть активная выполняющаяся задача. Завершите ее, прежде чем выполнять другую задачу.",
		...
		"Индекс группы сопоставления для расположения проблемы. Допустимые шаблоны расположения: (строка), (строка,столбец) и (начальная_строка,начальный_столбец,конечная_строка,конечный_столбец). Если индекс не указан, предполагается строка и столбец.",
		"Индекс группы сопоставления для строки проблемы. Значение по умолчанию — 2.",
		"Индекс группы сопоставления для столбца проблемы. Значение по умолчанию — 3",
		"Индекс группы сопоставления для конечной строки проблемы. По умолчанию не определен.",
		"Индекс группы сопоставления для конечного столбца проблемы. По умолчанию не определен.",
		...
		"Регулярное выражение для обнаружения начала или конца задачи наблюдения.",
		...
		"Шаблон проблемы или имя предварительно определенного шаблона проблемы. Можно опустить, если указан элемент base.",
		...
		"Имя задачи",
		"Дополнительные аргументы, передаваемые в команду при вызове этой задачи.",
		...
		"Конфигурация сборки, относящаяся к Windows",
		"Конфигурация сборки для Mac",
		"Конфигурация сборки для Linux",
	],
	"vs/workbench/parts/tasks/node/processRunnerConfiguration": [
		"Ошибка: не указано допустимое имя команды.",
		"Ошибка: аргументы команды должны представлять собой массив строк. Указанное значение:\n{0}",
		"Предупреждение: глобальные сопоставители и задачи нельзя использовать вместе. Глобальные сопоставители игнорируются.",
		"Предупреждение: options.cwd должен иметь тип string. Игнорируется значение {0}\n",
	...
	"vs/workbench/parts/tasks/node/processRunnerSystem": [
		"Нет задач, помеченных как задача сборки в tasks.json. Пометьте задачу с помощью флага \"isBuildCommand\".",
		"Задача тестирования не настроена.",
		"В предоставленной конфигурации задачи есть ошибки проверки. Подробности см. в журнале выходных данных задач.",
		"Задача для выполнения не найдена.",
		...
		"Не удалось запустить внешнюю программу {0} {1}.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"Путь оболочки, который используется терминалом в Windows. При работе с оболочкой, поставляемой с Windows (cmd, PowerShell или Bash на Ubuntu), укажите C:\\Windows\\sysnative вместо C:\\Windows\\System32 для использования 64-разрядных версий.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalInstance": [
		"Невозможно скопировать выделение в терминале, когда терминал не имеет фокуса",
	...
	"vs/workbench/parts/themes/electron-browser/themes.contribution": [
		"Цветовая тема",
		"Проблема с загрузкой темы: {0}",
		"Выберите цветовую тему",
		"Тема значка файла",
		"Нет",
		"Отключить значки файлов",
		"Проблема при загрузке темы значка: {0}",
	...
	"vs/workbench/parts/update/electron-browser/update": [
		...
		"Условия использования лицензии изменились, ознакомьтесь с ними.",
		"Прочитать условия лицензии",
		"Ежедневные сборки и выпуски для участников программы предварительной оценки.",
		"Подробнее",
		"Больше не показывать",
	...
	"vs/workbench/parts/watermark/browser/watermark": [
		...
		"Добавить курсоры выше или ниже",
		"Терминал",
		"свободный",
	],
	"vs/workbench/services/configuration/node/configurationEditingService": [
		"Не удается выполнить запись в файл конфигурации (неизвестный ключ)",
		"Не удается выполнить запись в файл конфигурации (недопустимый целевой объект).",
		"Не удается записать параметры, так как нет открытых папок. Откройте папку и повторите попытку.",
		"Не удается выполнить запись параметров. Откройте файл **User Settings**, чтобы разрешить ошибки и предупреждения в файле, и повторите попытку.",
		"Не удается выполнить запись параметров. Откройте файл **Workspace Settings**, чтобы разрешить ошибки и предупреждения в файле, и повторите попытку.",
		"Не удается выполнить запись параметров, так как файл изменен. Сохраните файл **User Settings** и повторите попытку.",
		"Не удается выполнить запись параметров, так как файл изменен. Сохраните файл **Workspace Settings** и повторите попытку.",
	],
	"vs/workbench/services/configurationResolver/node/configurationResolverService": [
		"Интерактивная переменная {0} не предоставляется, но указана в конфигурации.",
	],
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		"Добавляет цветовые схемы TextMate.",
		...
		"Точка расширения \"{0}\" должна быть массивом.",
		"В contributes.{0}.path требуется строка. Указанное значение: {1}.",
		...
		"Проблемы при анализе файла значков файлов: {0}",
		"Не удается загрузить {0}.",
		"Возникли проблемы при анализе файла JSON THEME: {0}.",
		"Проблемы при анализе файла PLIST: {0}.",
