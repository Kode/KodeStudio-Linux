...
define("vs/workbench/workbench.main.nls.ru", {
	...
	"vs/workbench/browser/parts/editor/editorActions": [
		...
		"Фокус на группу редакторов слева",
		"Фокус на группу редакторов в центре",
		"Фокус на группу редакторов справа",
		...
		"Показать редакторы в левой группе",
		"Показать редакторы в центральной группе",
		"Показать редакторы в правой группе",
	...
	"vs/workbench/parts/execution/electron-browser/terminal.contribution": [
		"Конфигурация внешнего терминала",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"Путь оболочки, который используется терминалом в Windows.",
		...
		"Определяет размер шрифта для терминала, значение по умолчанию — editor.fontSize.",
		"Определяет высоту строки терминала, значение по умолчанию — \"нормальная\".",
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"Базовая схема, определяющая цвета оформления редактора: \"vs\" — светлая цветовая схема, \"vs-dark\" — темная цветовая схема.",
	...
	"vs/workbench/services/thread/electron-browser/threadService": [
		...
		"Узел расширения не запустился спустя 10 секунд. Возможно, произошла ошибка.",
