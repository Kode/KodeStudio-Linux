...
define("vs/workbench/workbench.main.nls.ru", {
	...
	"vs/base/browser/ui/resourceviewer/resourceViewer": [
		"Воспроизведение аудиофайлов не поддерживается.",
		"Воспроизведение видеофайлов не поддерживается.",
		"Не удается отобразить файл в редакторе, так как он двоичный, очень большой или использует неподдерживаемую кодировку текста.",
	],
	...
	"vs/editor/common/commonCodeEditor": [
		"Если используется средство чтения с экрана, нажмите {0}.",
	],
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Определяет число символов, после которых текст будет перенесен на следующую строку. Если этот параметр имеет значение 0, используется перенос по ширине окна просмотра.",
	...
	"vs/editor/contrib/accessibility/browser/accessibility": [
		...
		"При нажатии клавиши TAB в этом редакторе фокус ввода переместится на следующий элемент, допускающий получение фокуса ввода. Команду {0} в настоящее время нельзя выполнить с помощью настраиваемого сочетания клавиш.",
		"Поддержка экспериментального средства чтения с экрана включена в соответствии с параметром editor.experimentalScreenReader.",
		"Поддержка экспериментального средства чтения с экрана включена для этого сеанса. Чтобы отключить или снова включить ее, нажмите клавишу {0}.",
		"Поддержка экспериментального средства чтения с экрана включена для этого сеанса. Команду {0} в настоящее время нельзя выполнить с помощью настраиваемого сочетания клавиш.",
		"Поддержка экспериментального средства чтения с экрана отключена. Чтобы включить ее для этого сеанса, нажмите клавишу {0}. Чтобы включить ее для всех сеансов, задайте для параметра editor.experimentalScreenReader значение true.",
		"Поддержка экспериментального средства чтения с экрана отключена. Команду {0} в настоящее время нельзя выполнить с помощью настраиваемого сочетания клавиш. Чтобы включить поддержку для всех сеансов, задайте для параметра editor.experimentalScreenReader значение true.",
	...
	"vs/platform/actions/common/actionsService": [
		...
		"(Необязательно.) Строка категории, в которую группируется команда в пользовательском интерфейсе",
	...
	"vs/platform/theme/common/themes": [
		"Светлая (Visual Studio)",
		"Темная (Visual Studio)",
	...
	"vs/workbench/browser/actions/toggleSidebarPosition": [
		"Изменить положение боковой панели",
		"Просмотреть",
	],
	...
	"vs/workbench/browser/actions/triggerEditorActions": [
		"Разделить редактор",
		"Перемещение между открытыми редакторами",
		"Перейти к редактору слева",
		"Перейти к боковому редактору",
		"Перейти к правому редактору",
		"Перейти к следующему редактору слева",
		"Перейти к следующему редактору справа",
		"Открыть сбоку",
		"Закрыть все редакторы",
		"Закрыть другие редакторы",
		"Переместить активный редактор влево",
		"Переместить активный редактор вправо",
		"Свернуть другие редакторы",
		"Одинаковая ширина окон редакторов",
		"Развернуть активный редактор и скрыть боковую панель",
		"Просмотреть",
	],
	...
	"vs/workbench/browser/actions/triggerQuickOpen": [
		"Перейти к файлу...",
		"Журнал навигации",
		"Перейти к следующему элементу в окне быстрого открытия",
		"Перейти к предыдущему элементу в окне быстрого открытия",
	],
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"Настроенный язык",
		"языки",
		"Настройка сопоставлений файлов...",
		"Настройка сопоставлений файлов для \"{0}\"...",
		"Автоматическое обнаружение",
		"Выберите языковой режим",
		"Вы можете настроить имя файла для сопоставления языка из раздела **files.associations**. Чтобы изменения вступили в силу в открытых файлах, может потребоваться перезагрузка.",
		"Изменить отступ",
		"В данный момент нет активного текстового редактора",
	...
	"vs/workbench/browser/parts/quickopen/quickOpenController": [
		...
		"Этот обработчик быстрого открытия нельзя использовать в текущем контексте",
	],
	...
	"vs/workbench/electron-browser/darwin/cli.contribution": [
		"Установить путь к команде \"code\" в PATH",
		...
		"Удалить путь к команде \"code\" из PATH",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"Настройте канал обновления, из которого будете получать обновления. После изменения значения необходимо выполнить перезапуск.",
	],
	...
	"vs/workbench/electron-browser/update": [
		...
		"Эта версия {0} устарела, и ее автоматическое обновление невозможно. Скачайте и установите последнюю версию вручную.",
		"Скачать последнюю версию",
		"Заметки о выпуске",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"Точка останова в строке {0} сработает, только если это условие выполнится. Нажмите клавишу ВВОД для принятия или ESCAPE для отмены.",
		"Введите условие точки останова для строки {0}. Выполнение программы прервется в этом месте, только если условие выполнится. Нажмите клавишу ВВОД для принятия или ESCAPE для отмены.",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"Отладка: условная точка останова",
		"Отладка: вычисление",
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"Отладка продолжилась.",
		"Отладка остановилась.",
		"От адаптера отладки с идентификатором {0} не был получен поток.",
		"Настройте файл конфигурации запуска для вашего приложения.",
		"Настроенный тип отладки \"{0}\" не поддерживается.",
		"Отсутствует свойство type для выбранной конфигурации в launch.json.",
	...
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		...
		"Список конфигураций. Добавьте новые конфигурации или измените существующие.",
	...
	"vs/workbench/parts/debug/node/rawDebugSession": [
		...
		"Папка корзины DebugAdapter не найдена по пути {0}.",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"Расширение \"{0}\" было успешно установлено. Чтобы включить его, выполните перезапуск.",
		"Перезагрузка",
		"Удалить расширение",
		"Действительно удалить \"{0}\"?",
		"Расширение \"{0}\" было успешно удалено. Чтобы отключить его, выполните перезапуск.",
		"Перезагрузка",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsQuickOpen": [
		...
		"Установить сейчас",
		"{0} устанавливается...",
		"{0}, {1}, средство выбора расширений",
		"{0} еще не скачивалось.",
		"{0} скачано один раз.",
		"{0} скачано раз: {1}.",
		"Введите, чтобы ограничить список установленных расширений",
		"Расширений не найдено",
		"Введите, чтобы ограничить список расширений из коллекции",
		"Расширений не найдено",
		"Введите, чтобы ограничить список устаревших расширений",
		"Устаревших расширений не найдено",
		"Нет рекомендуемых расширений",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsWidgets": [
		"Расширения (1 ошибка)",
		"Расширения (ошибок: {0})",
		"Расширения (установка {0}...)",
		"Расширения (1 обновление доступно)",
		"Расширения (доступно обновлений: {0})",
		"Расширения",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsWorkbenchExtension": [
		"Показать локальные расширения",
		"Установить расширения из коллекции",
		"Обновить устаревшие расширения",
		"Показать рекомендуемые расширения",
		"Расширения были успешно установлены. Чтобы включить их, выполните перезапуск.",
		"Расширение {0} было успешно установлено. Чтобы включить его, выполните перезапуск.",
		"Перезагрузка",
	],
	"vs/workbench/parts/extensions/node/extensionsService": [
		...
		"Отсутствуют сведения о коллекции",
	...
	"vs/workbench/parts/files/browser/editors/fileEditorInput": [
		...
		"Изменение",
		"В файл внесены изменения...",
		"Сохранение...",
		"В настоящее время сохраняются изменения...",
		"Ошибка при сохранении",
		"К сожалению, возникли сложности при сохранении изменений",
		"Конфликт",
		"Невозможно сохранить изменения, так как они конфликтуют с версией на диске",
	],
	"vs/workbench/parts/files/browser/editors/textFileEditor": [
		"Редактор текстовых файлов",
		"Создать файл",
		"К сожалению, файл слишком велик, чтобы его можно было открыть в редакторе.",
		"Папка \"{0}\" находится вне открытой в настоящий момент корневой папки, поэтому ее нельзя открыть в этом экземпляре.",
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"Переименовать",
		"Переименовать",
		"В данный момент файл \"{0}\" сохраняется, повторите попытку позднее.",
		"Создать файл",
		"Создать папку",
		"Создать файл",
		"Создать папку",
		...
		"Закрыть файл",
		"В настоящее время нет открытого файла, который можно было бы закрыть.",
		"Закрыть другие файлы",
		"Закрыть все файлы",
		"Открыть следующий рабочий файл",
		"В настоящее время нет рабочих файлов.",
		"Открыть предыдущий рабочий файл",
		"В настоящее время нет рабочих файлов.",
		"Добавить активный файл в рабочие файлы",
		"Чтобы добавить файл в рабочие файлы, сначала откройте его.",
		"Фокус на рабочие файлы",
		"Фокус на проводнике",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"Максимальное число рабочих файлов, отображаемых до появления полосы прокрутки.",
		"Управляет тем, будет ли высота раздела рабочих файлов динамически адаптироваться к количеству элементов.",
		"Открыть рабочий файл по имени",
		"Открыть рабочий файл по имени",
		"Файлы",
	],
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"Сравнить",
		"{0} — на диске ↔ в {1}",
		"{0} — разрешение конфликта сохранения",
	...
	"vs/workbench/parts/files/browser/workingFilesPicker": [
		"{0}, средство выбора рабочих файлов",
		"рабочие файлы",
		"Не найдено соответствующих рабочих файлов",
		"Список рабочих файлов в настоящее время пуст",
	],
	"vs/workbench/parts/files/common/editors/textFileEditorModel": [
		"Не удалось сохранить \"{0}\": {1}",
		"Непредвиденная ошибка создана прослушивателем изменений файлов следующего типа: {0}",
	...
	"vs/workbench/parts/files/electron-browser/textFileServices": [
		...
		"Сохранить изменения в указанные ниже файлы?",
		"&&Сохранить все",
		"&&Сохранить",
		"&&Не сохранять",
		"Отмена",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"Синхронизация",
		"Идет синхронизация...",
		"Нельзя выполнить синхронизацию в отключенном режиме.",
		"Для текущей ветви \"{0}\" не настроена восходящая ветвь.",
		"Текущая ветвь \"{0}\" обновлена.",
		"Зафиксируйте, отмените или создайте временную копию изменений перед синхронизацией.",
		"Текущая ветвь \"{0}\" находится на {1} фиксаций до и {2} фиксаций после \"{3}\".",
		"Текущая ветвь \"{0}\" находится на {1} фиксаций до и {2} фиксаций после \"{3}\".",
		"Текущая ветвь \"{0}\" находится на {1} фиксаций до и {2} фиксаций после \"{3}\".",
		"Текущая ветвь \"{0}\" находится на {1} фиксаций до и {2} фиксаций после \"{3}\".",
	...
	"vs/workbench/parts/markdown/browser/markdownActions": [
		...
		"Для предварительного просмотра сначала откройте файл Markdown.",
		"Открыть область предварительного просмотра сбоку",
		"Для предварительного просмотра сначала откройте файл Markdown.",
	...
	"vs/workbench/parts/markdown/common/markdownEditorModel": [
		"Не удается открыть \"{0}\" для обработки Markdown. Убедитесь в том, что файл существует и что он является допустимым файлом Markdown.",
	],
	...
	"vs/workbench/parts/quickopen/browser/gotoSymbolHandler": [
		...
		"К сожалению, у нас нет символьной информации для файла",
	...
	"vs/workbench/parts/quickopen/browser/markersHandler": [
		"[{0}] {1}",
		"{0}({1},{2})",
		"{0}, ошибки и предупреждения",
		"Введите, чтобы уменьшить число ошибок и предупреждений",
		"Нет соответствующих ошибок и предупреждений",
		"Нет ошибок и предупреждений",
		"Показать ошибки и предупреждения",
	],
	"vs/workbench/parts/quickopen/browser/quickopen.contribution": [
		"Показать ошибки или предупреждения",
		"Показать ошибки и предупреждения",
		...
		"Перейти к символу",
		"Перейти к символу",
		"Перейти к символу по категории",
		"Показать справку",
	],
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"Поиск",
		"Просмотреть",
		"Открыть файлы и символы по имени",
	...
	"vs/workbench/services/themes/node/themeService": [
		"Добавляет цветовые темы TextMate.",
		"Метка цветовой темы, отображаемая в пользовательском интерфейсе.",
		"Базовая тема, определяющая цвета оформления редактора: \"vs\" — светлая цветовая тема, \"vs-dark\" — темная цветовая тема.",
		"Путь к файлу tmTheme. Путь указывается относительно папки расширения и обычно начинается с \"./themes/themeFile.tmTheme\".",
		"Точка расширения \"{0}\" должна быть массивом.",
		"В contributes.{0}.path требуется строка. Указанное значение: {1}",
		"contributes.{0}.path ({1}) должен был быть включен в папку расширения ({2}). Это может сделать расширение непереносимым.",
		"Не удается загрузить {0}",
		"Возникли проблемы при анализе THEME-файла JSON: {0}",
		"Проблемы при анализе PLIST-файла: {0}",
	],
	"vs/workbench/services/thread/electron-browser/threadService": [
		"Узел расширения не был запущен в течение 10 секунд. Возможно, он был остановлен в первой строке, а для продолжения требуется отладчик.",
		"Узел расширения не запустился через 10 секунд. Возможно, имеется проблема.",
		"Ошибка от узла расширения: {0}",
		"Узел расширения неожиданно завершил работу. Загрузите окно повторно для восстановления.",
		"Перезагрузить окно",
	]
});