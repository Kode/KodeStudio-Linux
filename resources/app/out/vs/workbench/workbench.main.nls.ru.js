...
define("vs/workbench/workbench.main.nls.ru", {
	...
	"vs/workbench/common/theme": [
		...
		"Цвет переднего плана активной вкладки в неактивной группе. Вкладки — это контейнеры для редакторов в области редактора. В одной группе редакторов можно открыть несколько вкладок. Может присутствовать несколько групп редакторов.",
		"Цвет переднего плана неактивной вкладки в неактивной группе. Вкладки — это контейнеры для редакторов в области редактора. В одной группе редакторов можно открыть несколько вкладок. Может присутствовать несколько групп редакторов.",
	...
	"vs/workbench/parts/debug/browser/debugEditorActions": [
		...
		"Отладка: точка останова столбца",
		"Добавить точку останова столбца",
	...
	"vs/workbench/parts/debug/browser/debugQuickOpen": [
		"Отладка: {0}",
		"Введите имя используемой конфигурации запуска.",
		"Нет соответствующих конфигураций отладки.",
		"Конфигурации отладки не найдены. Создайте файл \"launch.json\".",
	],
	"vs/workbench/parts/debug/browser/exceptionWidget": [
		"Цвет границ мини-приложения исключений.",
		"Цвет фона мини-приложения исключений.",
		"Возникло исключение: {0}",
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"Определяет, следует ли скрыть всплывающую панель действий отладки.",
		"Глобальная конфигурация запуска отладки. Должна использоваться в качестве альтернативы для конфигурации \"launch.json\", которая является общей для рабочих пространств",
	],
	"vs/workbench/parts/debug/electron-browser/debugCommands": [
		"Перед расширенной настройкой отладки откройте папку.",
	],
	"vs/workbench/parts/debug/electron-browser/debugConfigurationManager": [
		...
		"Список языков, для которых расширение отладки может считаться \"отладчиком по умолчанию\".",
		"Если задано, VS Code будет вызывать эту команду, чтобы определить путь к исполняемому файлу адаптера отладки и передаваемые аргументы.",
		"Если задано, VS Code будет вызывать эту команду для действий \"отладка\" или \"запуск\", предназначенных для этого расширения.",
		...
		"Имя составного объекта. Отображается в раскрывающемся меню запуска конфигурации.",
		"Имена конфигураций, которые будут запущены как часть этого составного объекта.",
	...
	"vs/workbench/parts/debug/electron-browser/debugEditorContribution": [
		...
		"Удалить точку останова из столбца {0}",
		"Удалить точку останова из строки",
		"Изменить точки останова",
		"Изменить точку останова в столбце {0}",
		"Изменить точку останова в строке",
		"Включить или отключить точки останова",
		"Отключить точку останова в столбце {0}",
		"Отключить точку останова в строке",
		"Включить точку останова в столбце {0}",
		"Включить точку останова в строке",
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"Для составного элемента должен быть задан атрибут configurations для запуска нескольких конфигураций.",
		"Конфигурация \"{0}\" отсутствует в launch.json.",
		...
		"Нельзя выполнить отладку активного файла. Убедитесь, что файл сохранен на диске и установлено расширение отладки для этого типа файла.",
		"Настройте файл конфигурации запуска для вашего приложения. {0}",
	...
	"vs/workbench/parts/debug/electron-browser/terminalSupport": [
		"отлаживаемый объект",
		"Интегрированный терминал недоступен.",
	],
	"vs/workbench/parts/debug/node/debugAdapter": [
		"Исполняемый файл адаптера отладки \"{0}\" не существует.",
		"Невозможно определить исполняемый файл для адаптера отладки \"{0}\".",
		"Тип конфигурации.",
		"Не удается распознать тип отладки. Убедитесь, что соответствующее расширение отладки установлено и включено.",
		"Значение \"node2\" больше не поддерживается; используйте \"node\" и задайте для атрибута \"protocol\" значение \"inspector\".",
	...
	"vs/workbench/parts/extensions/electron-browser/extensions.contribution": [
		...
		"Игнорировать рекомендации по расширениям",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsUtils": [
		...
		"Да",
		"Нет",
		"В текущую версию встроено средство слияния с лучшей функциональностью. Установленное расширение было отключено и не может быть удалено.",
		"Удаление",
		"Позже",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"Show Running Tasks",
		"Задачи",
		"Чтобы изменить подсистему выполнения задач, нужно перезапустить VS Code. Изменение игнорируется.",
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"Нет последних папок.",
		"Справка",
		"Список сочетаний клавиш в печатном виде",
		"Вступительные видео",
		"Советы и рекомендации",
		...
		"Настроить",
		"Средства и языки",
		"Установить поддержку для {0} и {1}",
		"Еще",
		"Установка сочетаний клавиш",
		"Настроить сочетания клавиш для {0} и {1}",
		"Другие",
		"Цветовая тема",
		"Настройте редактор и код удобным образом.",
		"Подробнее",
		"Найти и выполнить все команды.",
		"Быстро обращайтесь к командам и выполняйте поиск по командам с помощью палитры команд ({0})",
		"Общие сведения об интерфейсе",
		"Используйте визуальное наложение с выделением основных компонентов пользовательского интерфейса.",
		"Интерактивная площадка",
		"Опробуйте основные функции редактора в ходе краткого пошагового руководства.",
	],
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage": [
		...
		"Sublime",
		"Atom",
		"Поддержка {0} уже добавлена.",
		"После установки дополнительной поддержки для {0} окно будет перезагружено.",
		"Установка дополнительной поддержки для {0}...",
		"Не удается найти поддержку для {0} с идентификатором {1}.",
		"Сочетания клавиш {0} уже установлены.",
		"Окно перезагрузится после установки сочетаний клавиш {0}.",
		"Устанавливаются сочетания клавиш {0}...",
		"Не удалось найти сочетания клавиш {0} с идентификатором {1}.",
		"Добро пожаловать",
		"Открыть папку {0} с путем {1}",
		",",
		"Установить раскладку клавиатуры {0}",
		"Установить дополнительную поддержку для {0}",
		"Раскладка клавиатуры {0} уже установлена",
		"Поддержка {0} уже установлена",
		"ОК",
		"Подробности",
		"Отмена",
		"Цвет фона кнопок на странице приветствия.",
		"Цвет фона при наведении указателя для кнопок на странице приветствия.",
	],
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage.contribution": [
		"Рабочее место",
		"Запустить без редактора.",
		"Откройте страницу приветствия (по умолчанию).",
	...
	"vs/workbench/parts/welcome/walkThrough/electron-browser/walkThroughPart": [
		...
		"Цвет фона встроенных редакторов для интерактивных площадок.",
	],
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"Путь к файлу tmTheme (по отношению к текущему файлу)",
	...
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		...
		"Ошибка при анализе файла цветовой темы: {0}. Свойство \'tokenColors\' должно содержать массив цветов или путь к текстовому файлу цветовой темы",
