 ...
 *--------------------------------------------------------*/
define("vs/workbench/electron-browser/workbench.main.nls.ko", {
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"편집기 탭에 표시 가능한 닫기 단추가 있어야 하는지 여부를 제어합니다.",
		...
		"사용하도록 설정한 경우 창 제목에 열린 파일의 전체 경로가 표시됩니다.",
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"여러 구성을 시작하려면 복합에 \"configurationNames\" 특성 집합이 있어야 합니다.",
	...
	"vs/workbench/parts/debug/electron-browser/replViewer": [
		...
		"{0} 변수에 {1} 값이 있습니다. read–eval–print loop, 디버그",
		"{0} 식에 {1} 값이 있습니다. read–eval–print loop, 디버그",
		"{0}, read–eval–print loop, 디버그",
		"출력 변수 {0}에 값 {1}이(가) 있습니다. read–eval–print loop, 디버그",
	],
	...
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		...
		"사용되지 않음: debugServer를 구성 내부로 이동하세요.",
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"사이드바에 사용자 지정 트리 탐색기 뷰렛을 적용합니다.",
		"vscode.workspace.registerTreeExplorerNodeProvider를 통해 등록된 공급자를 식별하는 데 사용된 고유 ID",
		"사용자 지정 트리 탐색기를 렌더링하는 데 사용되는 사람이 읽을 수 있는 문자열",
		"작업 막대에서 뷰렛 아이콘에 대한 경로",
		"{0} 표시",
		"보기",
	],
	...
	"vs/workbench/parts/explorers/browser/treeExplorerService": [
		"ID가 {providerId}인 등록된 TreeExplorerNodeProvider가 없습니다.",
	],
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		"키 바인딩 간 충돌을 피하기 위해 다른 키 맵을 사용하지 않도록 설정할까요?",
		"예",
		"아니요",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"이름 바꾸기",
		"이름 바꾸기",
		"1개 파일에 저장되지 않은 변경 내용이 있는 폴더의 이름을 바꾸려고 합니다. 계속하시겠습니까?",
		"{0}개 파일에 저장되지 않은 변경 내용이 있는 폴더의 이름을 바꾸려고 합니다. 계속하시겠습니까?",
		"저장되지 않은 변경 내용이 있는 파일의 이름을 바꾸려고 합니다. 계속하시겠습니까?",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"더티 파일을 자동으로 저장할 때까지의 지연(ms)을 제어합니다. \"files.autoSave\"를 \"{0}\"(으)로 설정한 경우에만 적용됩니다.",
		"파일 감시에서 제외할 파일 경로의 GLOB 패턴을 구성하세요. 이 설정을 변경하려면 다시 시작해야 합니다. 시작 시 Code에서 CPU 시간을 많이 차지하면 대용량 폴더를 제외하여 초기 로드를 줄일 수 있습니다.",
		"다시 시작 후 저장되지 않은 파일을 복원하는지 여부를 제어합니다. 사용하도록 선택하면 편집기를 종료할 때 저장할지 묻는 메시지가 표시되지 않습니다.",
		"편집기",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"{0}(디스크에 있음) ↔ {1}({2}에 있음)",
		"저장 충돌 해결",
		"편집기 도구 모음의 작업을 사용하여 변경 내용을 **실행 취소**하거나 디스크의 콘텐츠를 변경 내용으로 **덮어쓰기**",
		"로컬 변경 사용 및 디스크 콘텐츠 덮어쓰기",
		"로컬 변경을 취소하고 디스크의 콘텐츠로 되돌리기",
	],
	...
	"vs/workbench/parts/files/browser/views/explorerViewer": [
		...
		"{0}, 파일 탐색기",
		"1개 파일에 저장되지 않은 변경 내용이 있는 폴더를 이동하려고 합니다. 계속하시겠습니까?",
		"{0}개 파일에 저장되지 않은 변경 내용이 있는 폴더를 이동하려고 합니다. 계속하시겠습니까?",
		"저장되지 않은 변경 내용이 있는 파일을 이동하려고 합니다. 계속하시겠습니까?",
		"변경 내용을 저장하지 않은 경우 변경 내용이 손실됩니다.",
		"이동(&&M)",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"스테이징 취소",
		"모두 스테이징 취소",
		"체크 아웃할 수 없습니다. 먼저 작업을 커밋하거나 스태시하세요.",
		"스테이징된 항목 커밋",
		"스테이징된 항목 커밋(로그오프됨)",
		"Commit",
		"커밋 메시지",
		...
		"모두 커밋",
		"스테이징된 항목 커밋",
		"끌어올 수 없습니다. 먼저 작업을 커밋하거나 스태시하세요.",
	...
	"vs/workbench/parts/git/browser/gitWorkbenchContributions": [
		...
		"항상 대규모 리포지토리가 Code로 관리되도록 허용합니다.",
	...
	"vs/workbench/parts/git/browser/views/changes/changesViewer": [
		...
		"충돌: 양쪽에서 추가",
		"충돌: 양쪽에서 수정",
		"{1} 폴더에 있는 {0} 파일의 상태는 {2}입니다. Git",
		"스테이징된 변경 내용, Git",
		"변경, Git",
		"병합, Git",
	],
	"vs/workbench/parts/git/browser/views/disabled/disabledView": [
		"Git가 설정에서 사용하지 않도록 지정되어 있습니다.",
	],
	"vs/workbench/parts/git/browser/views/empty/emptyView": [
		"이 작업 영역에는 아직 Git 소스 제어가 적용되지 않습니다.",
		"Git 리포지토리 초기화",
	],
	"vs/workbench/parts/git/browser/views/gitless/gitlessView": [
		"터미널 프롬프트에 {3}을(를) 입력하여 {0}과(와) 함께 설치하거나 {1}에서 다운로드하거나 {2} 명령줄 개발자 도구를 설치할 수 있습니다.",
		"{0}에서 설치하거나 {1}에서 다운로드할 수 있습니다.",
		"{0}에서 다운로드할 수 있습니다.",
		"{0}에서 다운로드할 수 있습니다.",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"작업이 이미 활성 상태이며 감시 모드입니다. 작업을 종료하려면 `F1 > 작업 종료`를 사용하세요.",
	...
	"vs/workbench/parts/tasks/node/processRunnerSystem": [
		"tasks.json에 빌드 작업으로 표시된 작업이 없습니다. 작업을 \'isBuildCommand\'로 표시하세요.",
		"구성된 테스트 작업이 없습니다.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"터미널이 Windows에서 사용하는 셸의 경로입니다. Windows와 함께 제공되는 셸을 사용하는 경우(cmd, PowerShell 또는 Ubuntu의 Bash) 64비트 버전을 사용하려면 C:\\Windows\\System32보다 C:\\Windows\\sysnative가 더 좋습니다.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalInstance": [
		"터미널에 포커스가 없는 경우 터미널 선택을 복사할 수 없습니다.",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		"구성 파일에 쓸 수 없습니다(알 수 없는 키).",
		"구성 파일에 쓸 수 없습니다(잘못된 대상).",
		"폴더가 열려 있지 않으므로 설정을 쓸 수 없습니다. 먼저 폴더를 열고 다시 시도하세요.",
		"설정을 쓸 수 없습니다. **사용자 설정**을 열어 파일에서 오류/경고를 해결하고 다시 시도하세요.",
		"설정을 쓸 수 없습니다. **작업 영역 설정**을 열어 파일에서 오류/경고를 해결하고 다시 시도하세요.",
		"파일이 변경되어 설정을 쓸 수 없습니다. **사용자 설정** 파일을 저장하고 다시 시도하세요.",
		"파일이 변경되어 설정을 쓸 수 없습니다. **작업 영역 설정** 파일을 저장하고 다시 시도하세요.",
	],
