 ...
 *--------------------------------------------------------*/
define("vs/workbench/electron-browser/workbench.main.nls.zh-tw", {
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"已新增中斷點，行 {0}，檔案 {1}",
		"已移除中斷點，行 {0}，檔案 {1}",
		"複合必須已設定 \"configurationNames\" 屬性才能啟動多重組態。",
		"請為您的應用程式設定啟動組態檔。",
		"不支援設定的偵錯類型 \'{0}\'。",
		"遺漏所選啟動設定的屬性 \'type\'。",
	...
	"vs/workbench/parts/emmet/node/emmet.contribution": [
		...
		"喜好設定，用以修改某些動作的行為及 Emmet 的解析程式。",
		"為指定的語法定義設定檔，或透過特定規則使用自己的設定檔。",
		"不應展開 Emmet 縮寫的語言陣列。",
	],
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"提供自訂樹狀總管 viewlet 到資訊看板",
		"用以識別透過 vscode.workspace.registerTreeExplorerNodeProvider 所註冊之提供者的唯一識別碼",
		"用以轉譯自訂樹狀總管的易讀字串",
		"活動列上 viewlet 圖示的路徑",
		"顯示 {0}",
		"檢視",
	...
	"vs/workbench/parts/explorers/browser/treeExplorerService": [
		"未註冊識別碼為 {providerId} 的 TreeExplorerNodeProvider。",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"重新命名",
		"重新命名",
		"您要重新命名的資料夾中 1 個檔案有未儲存的變更。要繼續嗎?",
		"您要重新命名的資料夾中 {0} 個檔案有未儲存的變更。要繼續嗎?",
		"您要重新命名的檔案有未儲存的變更。要繼續嗎?",
		"如果您不儲存變更，這些變更將會遺失。",
		"重新命名(&&R)",
		"新增檔案",
		"新增資料夾",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"控制已變更檔案的自動儲存功能。接受的值: \"{0}\"、\"{1}\"、\"{2}\" (編輯器失去焦點)、\"{3}\" (視窗失去焦點)。如果設為 \"{4}\"，您可以在 \"files.autoSaveDelay\" 中設定延遲。",
		...
		"控制重新啟動後是否還原未儲存的檔案。如果啟用此項，就不會在結束編輯器時收到儲存提示。",
		"編輯器",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"{0} (磁碟上) ↔ {1} ({2} 中)",
		"解決儲存衝突",
		"使用編輯器工具列中的動作來「復原」您的變更，或以您的變更「覆寫」磁碟上的內容",
		"使用本機變更並覆寫磁碟內容",
		"捨棄本機變更並還原成磁碟上的內容",
	],
	...
	"vs/workbench/parts/files/browser/views/explorerViewer": [
		...
		"{0}，檔案總管",
		"您要移動的資料夾中 1 個檔案有未儲存的變更。要繼續嗎?",
		"您要移動的資料夾中 {0} 個檔案有未儲存的變更。要繼續嗎?",
		"您要移動的檔案有未儲存的變更。要繼續嗎?",
		"如果您不儲存變更，這些變更將會遺失。",
		"移動(&&M)",
		"目的資料夾中已存在 \'{0}\'。要取代它嗎?",
	...
	"vs/workbench/parts/git/browser/views/gitless/gitlessView": [
		"您可以使用 {0} 進行安裝、從 {1} 下載，或直接在終端機提示時輸入 {3}，以安裝 {2} 命令列開發人員工具。",
		"您可以使用 {0} 進行安裝或從 {1} 下載。",
		"您可以從 {0} 下載。",
		"您可以從 {0} 下載。",
		"您的系統上似乎未安裝 Git。",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"工作已在作用中並處於監看模式。若要終止工作，請使用 F1 > [終止工作]",
	...
	"vs/workbench/parts/tasks/node/processRunnerSystem": [
		"tasks.json 中沒有標記為建置工作的工作。請以 \'isBuildCommand\' 標示工作。",
		"未設定任何測試工作。",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"終端機在 OS X 上使用的殼層路徑。",
		"在 OS X 終端機要使用的命令列引數。",
		"終端機在 Windows 上使用的殼層路徑。使用隨附於 Windows 的殼層 (cmd、PowerShell 或 Bash on Ubuntu) 時，建議選擇 C:\\Windows\\sysnative 而非 C:\\Windows\\System32，以使用 64 位元版本。",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		"無法寫入組態檔 (不明的按鍵)",
		"無法寫入組態檔 (目標無效)",
		"因為未開啟任何資料夾，所以無法寫入設定。請開啟資料夾後再試一次。",
		"無法寫入設定。請開啟 **使用者設定** 以修正檔案中的錯誤/警告後再試一次。",
		"無法寫入設定。請開啟 **工作區設定** 以修正檔案中的錯誤/警告後再試一次。",
		"因為檔案已變更，所以無法寫入設定。請儲存 **使用者設定** 檔案後再試一次。",
		"因為檔案已變更，所以無法寫入設定。請儲存 **工作區設定** 檔案後再試一次。",
	],
