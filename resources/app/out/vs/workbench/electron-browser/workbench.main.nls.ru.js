 ...
 *--------------------------------------------------------*/
define("vs/workbench/electron-browser/workbench.main.nls.ru", {
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"Управляет видимостью кнопки закрытия на вкладках редактора.",
		...
		"Если включено, в заголовке окна отображается полный путь к открытым файлам.",
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"Автоматически открывать представление обозревателя в конце сеанса отладки",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"У составного объекта должен быть задан атрибут configurationNames, чтобы запускать несколько конфигураций.",
	...
	"vs/workbench/parts/debug/node/debugConfigurationManager": [
		...
		"Фрагменты для добавления новых конфигураций в launch.json.",
		...
		"УСТАРЕЛО И НЕ РЕКОМЕНДУЕТСЯ: перенесите debugServer внутрь конфигурации.",
		"Список составных объектов. Каждый из них ссылается на несколько конфигураций, которые будут запущены вместе.",
		"Название составного объекта. Отображается в раскрывающемся меню запуска конфигурации.",
		"Названия конфигураций, которые будут запущены как часть этого составного объекта.",
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"Добавляет в боковую панель настраиваемые деморолики по обозревателю с древовидным представлением",
		"Уникальный идентификатор, используемый для обозначения поставщика, зарегистрированного при помощи vscode.workspace.registerTreeExplorerNodeProvider.",
		"Понятная для пользователей строка, используемая для отображения настраиваемого обозревателя с древовидным представлением",
		"Путь к значку деморолика на панели действий",
		"Показать {0}",
		"Просмотреть",
	],
	...
	"vs/workbench/parts/explorers/browser/treeExplorerService": [
		"TreeExplorerNodeProvider с идентификатором {providerId} не зарегистрирован.",
	],
	"vs/workbench/parts/explorers/browser/views/treeExplorerView": [
		"Раздел обозревателя с древовидным представлением",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"Установка из VSIX...",
		"Расширение установлено. Чтобы включить его, выполните перезапуск.",
		"Перезагрузить",
	],
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		"Отключить другие раскладки клавиатуры, чтобы избежать конфликта между настраиваемыми сочетаниями клавиш?",
		"Да",
		"Нет",
	],
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"Определяет, восстанавливаются ли несохраненные файлы после перезапуска. Если эта возможность включена, запрос на сохранение при выходе из редактора отображаться не будет.",
		"Редактор",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"Невозможно получить для изменения. Сначала нужно зафиксировать или спрятать работу.",
		...
		"Зафиксировать все",
		"Зафиксировать промежуточно сохраненные изменения",
		"Невозможно получить. Зафиксируйте или спрячьте работу.",
	...
	"vs/workbench/parts/git/electron-browser/gitActions": [
		"Укажите URL-адрес репозитория Git.",
		"URL-адрес репозитория",
		"Укажите допустимый URL-адрес репозитория Git.",
		"Каталог-назначение для клонирования",
		"Клонирование репозитория \"{0}\"...",
		"Целевой репозиторий уже существует, выберите другой каталог-назначение для клонирования.",
	],
	...
	"vs/workbench/parts/preferences/browser/preferencesActions": [
		...
		"Поиск параметров фокуса по умолчанию",
	],
	"vs/workbench/parts/preferences/browser/preferencesEditor": [
		"Параметры по умолчанию",
		"Выбор значения и копирование в параметры",
		"Выбор значения",
	...
	"vs/workbench/parts/preferences/browser/preferencesWidgets": [
		"Параметры по умолчанию",
		" — Перезапишите текущие, поместив их в файл параметров справа",
		"Поиск параметров по умолчанию",
		"Поиск параметров по умолчанию",
		"Параметры не найдены.",
		"Показано параметров: {0} из {1}",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"Задача уже активна и находится в режиме наблюдения. Чтобы завершить задачу, выполните команду \"F1 > terminate task\".",
