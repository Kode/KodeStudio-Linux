 ...
 *--------------------------------------------------------*/
define("vs/workbench/electron-browser/workbench.main.nls.ja", {
	...
	"vs/platform/actions/browser/menusExtensionPoint": [
		...
		"プロパティ `{0}` は必須で、型 `string` でなければなりません",
		"プロパティ `{0}` は省略するか、型 `string` にする必要があります",
		"プロパティ `icon` は省略できます。指定する場合には、文字列または `{dark, light}` などのリテラルにする必要があります",
		"実行するコマンドの識別子",
	...
	"vs/platform/markers/common/problemMatcher": [
		"エラー: 正しくない problemMatcher の説明です。マッチャーは少なくともパターン、所有者、ファイルの場所を定義する必要があります。問題のあるマッチャー: \n{0}\n",
		"情報: 不明な重大度 {0}。有効な値は、error、warning、info です。\n",
		"ループ プロパティは、最終行マッチャーでのみサポートされています。",
		"ループ プロパティは、複数行マッチャーでのみサポートされています。",
		"問題のパターンには正規表現がありません。",
	...
	"vs/workbench/browser/parts/editor/binaryDiffEditor": [
		"バイナリ差分ビューアー",
		"バイナリ ファイルと非バイナリ ファイルの比較は現在サポートされていません",
		"{0} ↔ {1}",
	],
	...
	"vs/workbench/electron-browser/actions": [
		...
		"現在のウィンドウ",
		"フォルダーを閉じる",
		"このインスタンスで現在開いているフォルダーがないので、閉じられません。",
		"新しいウィンドウ",
		"全画面表示の切り替え",
		"メニュー バーの切り替え",
		"開発者ツールの切り替え",
		...
		"フォルダー",
		"ファイル",
		"パスを選択 (Cmd キーを押しながら新しいウィンドウで開く)",
		"パスを選択して開く (Ctrl キーを押しながら新しいウィンドウで開く)",
		"通知メッセージを閉じる",
		"問題の報告",
		"キーボード ショートカットの参照",
		"{0} ⟷ {1}",
	...
	"vs/workbench/electron-browser/shell": [
		...
		"共有プロセスが予期せずに終了しました。回復するには、ウィンドウを再度読み込んでください。",
	],
	...
	"vs/workbench/parts/cli/electron-browser/cli.contribution": [
		...
		"\'{1}\' 内の \'{0}\' (行 {2}) を参照する別名を削除してから、この操作をやり直してください。",
		"\'{0}\' の編集",
		"別名 {0}\' を \'{1}\' から削除してから続行してください。",
		"続行",
		"キャンセル",
		...
		"Code \'{0}\' シェル コマンドを変更する必要があります。今すぐ実行してもよろしいですか?",
		"今すぐ変更",
		"後で",
		"いつでもコマンド パレットから \'{0}\' アクションを実行できることに留意してください。",
		"シェル コマンド",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"複合には、複数の構成を開始するために \"configurationNames\" 属性が設定されている必要があります。",
		"アプリケーションの起動構成ファイルをセットアップしてください。",
		...
		"実行中のタスク {0} があります。起動前タスク {1} は実行できません。",
		"ソース {0} を利用できません。",
	],
	...
	"vs/workbench/parts/debug/electron-browser/rawDebugSession": [
		"詳細情報",
		"\'{0}\' デバッグにインストールされている拡張機能はありません。",
		"デバッグ アダプターを {0} から起動できません。",
		"デバッグ アダプターの実行可能ファイル \'{0}\' が見つかりません。",
	...
	"vs/workbench/parts/explorers/browser/treeExplorer.contribution": [
		"カスタム ツリー エクスプローラー Viewlet をサイドバーに追加します",
		"vscode.workspace.registerTreeExplorerNodeProvider を介して登録したプロバイダーを識別するための一意の ID",
		"カスタム ツリー エクスプローラーの表示に使用される、人が判別できる文字列",
		"アクティビティ バーの Viewlet アイコンへのパス",
		"{0} を表示",
		"表示",
	],
	...
	"vs/workbench/parts/explorers/browser/treeExplorerService": [
		"ID {providerId} の TreeExplorerNodeProvider は登録されていません。",
	],
	...
	"vs/workbench/parts/extensions/browser/extensionsActions": [
		...
		"再度読み込む",
		"再度読み込んで更新する",
		"このウィンドウを再度読み込んで、更新済みの拡張機能 \'{0}\' をアクティブ化しますか?",
		"再度読み込んでアクティブにする",
		"このウィンドウを再度読み込んで、拡張機能 \'{0}\' をアクティブ化しますか?",
		"読み込んで非アクティブ化する",
		"このウィンドウを再度読み込んで、拡張機能 \'{0}\' を非アクティブ化しますか?",
		"読み込んで非アクティブ化する",
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		"キーバインド間の競合を回避するために、他のキーマップを無効にしますか?",
		"はい",
		"いいえ",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"名前変更",
		"名前変更",
		"保存されていない変更があるファイルを 1 個含むフォルダーの名前を変更します。続行しますか?",
		"保存されていない変更があるファイルを {0} 個含むフォルダーの名前を変更します。続行しますか?",
		"保存されていない変更があるファイルの名前を変更します。続行しますか?",
		"保存しないと変更内容が失われます。",
		"名前の変更(&&R)",
		"新しいファイル",
		"新しいフォルダー",
	...
	"vs/workbench/parts/files/browser/saveErrorHandler": [
		...
		"{0} (ディスク上) ↔ {1} ({2} 内)",
		"保存時の競合を解決",
		"エディター ツール バーの操作で、変更を [元に戻す] か、ディスクの内容を変更内容で [上書き] します",
		"ローカルでの変更を使ってディスクの内容を上書きします",
		"ローカルでの変更を破棄してディスクの内容に戻します",
	],
	...
	"vs/workbench/parts/files/browser/views/explorerViewer": [
		...
		"{0}、ファイル エクスプローラー",
		"保存されていない変更がある 1 個のファイルを含むフォルダーを移動します。続行しますか?",
		"保存されていない変更がある {0} 個のファイルを含むフォルダーを移動します。続行しますか?",
		"保存されていない変更があるファイルを移動します。続行しますか?",
		"保存しないと変更内容が失われます。",
		"移動(&&M)",
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"ステージング解除",
		"すべてステージング解除",
		"チェックアウトできません。まず作業をコミットまたは一時退避してください。",
		"ステージング済みをコミット",
		"コミットしてステージング (サインオフ)",
		"Commit",
		"コミット メッセージ",
		...
		"すべてコミット",
		"ステージング済みをコミット",
		"プルできません。まず作業をコミットまたは一時退避してください。",
		"Git リモートで認証が失敗しました。",
		"Git リモートで認証が失敗しました。",
		"プッシュ先...",
		"リモートを選んで、ブランチ \'{0}\' を次にプッシュします:",
		"Git リモートで認証が失敗しました。",
		"公開",
		"\'{0}\' を \'{1}\' に発行してよろしいですか?",
		"発行(&&P)",
		"リモートを選んで、ブランチ \'{0}\' を次に公開します:",
		"Git リモートで認証が失敗しました。",
		"このアクションはコミットを \'{0}\' との間でプッシュしたりプルしたりします。",
		"OK",
		"キャンセル",
		"OK、今後は表示しない",
		"Git リモートで認証が失敗しました。",
	...
	"vs/workbench/parts/git/browser/gitServices": [
		...
		"{0} (マージ) ↔ {1}",
		"{0} - 変更のマージ",
		"git {0} がインストールされているようです。Code は 2.0.0 以上の git で最適に動作します。",
		"ダウンロード",
		"今後は表示しない",
		"Git ユーザー名と電子メールを構成してください。",
		"Git {0}",
		"変更をコミットする前に、まずマージされていない変更を解決する必要があります。",
		"出力の表示",
		"キャンセル",
		"Git の操作を実行しているときに問題が発生しました。出力を確認するか、コンソールを使用してリポジトリの状態を確認してください。",
		"{0} (index)",
		"{0} - インデックスでの変更",
		"{0} ({1})",
		"{0} - {1} での変更",
	...
	"vs/workbench/parts/git/browser/views/empty/emptyView": [
		"このワークスペースはまだ Git ソース管理下にありません。",
		"Git リポジトリの初期化",
	],
	"vs/workbench/parts/git/browser/views/gitless/gitlessView": [
		"{0} を使用してインストールするか、{1} からダウンロードするか、ターミナルのプロンプトで単に {3} と入力して {2} コマンド ライン開発者ツールをインストールできます。",
		"{0} を使用してインストールするか、{1} からダウンロードできます。",
		"{0} からダウンロードできます。",
		"{0} からダウンロードできます。",
	...
	"vs/workbench/parts/git/browser/views/notroot/notrootView": [
		...
		"Git 機能にアクセスするには、リポジトリのルート ディレクトリを開きます。",
	],
	"vs/workbench/parts/git/browser/views/noworkspace/noworkspaceView": [
		"現在開いているフォルダーはありません。",
		"Git 機能にアクセスするには、Git リポジトリのあるフォルダーを開きます。",
	],
	...
	"vs/workbench/parts/git/electron-browser/gitActions": [
		...
		"リポジトリ URL",
		"有効な Git リポジトリの URL を入力してください",
		"宛先の複製ディレクトリ",
		"リポジトリ \'{0}\' を複製しています...",
		"宛先レポジトリは既に存在しています。複製するための別のディレクトリを選択してください。",
	],
	"vs/workbench/parts/git/node/git.lib": [
		"Git からファイルを開くことができません",
	...
	"vs/workbench/parts/preferences/browser/preferencesService": [
		...
		"現在開いているフォルダーに含まれるワークスペース設定により、ユーザー設定が上書きされる可能性があります",
		"ワークスペース設定を開く",
		"今後は表示しない",
		"閉じる",
		"\'{0}\' ({1}) を作成できません。",
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"ファイル パスの照合基準となる glob パターン。これを true または false に設定すると、パターンがそれぞれ有効/無効になります。",
		"一致するファイルの兄弟を追加的に検査します。一致するファイル名の変数として $(basename) を使用します。",
	...
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"設定で除外されたファイル",
		"検索除外パターンを構成しました",
		"{1} ファイルで {0} 件の出現箇所を \'{2}\' と置換しました。",
		"{1} ファイルで {0} 件の出現箇所を削除しました。",
		"すべて置換",
		"{1} ファイルで {0} 件の出現箇所を \'{2}\' と置換しますか?",
		"{1} ファイルで {0} 件の出現箇所を削除しますか?",
		"置換",
		"検索結果",
		"{1} のとき {0}",
	...
	"vs/workbench/parts/snippets/electron-browser/snippets.contribution": [
		...
		"スニペットの内容。変数には \'${id}\'、\'${id:label}\'、\'${1:label}\' を使用し、カーソル位置には \'$0\'、\'$1\' を使用します",
		"スニペットについての記述。",
	],
	...
	"vs/workbench/parts/tasks/common/taskTemplates": [
		"TypeScript プロジェクトをコンパイル",
		"ウォッチ モードで TypeScript プロジェクトをコンパイル",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"タスク ランナーが構成されていません。",
		"構成されている有効なタスク ランナーがありません。サポートされているタスク ランナーは \'service\' と \'program\' です。",
		"タスクは既にアクティブおよびウォッチ モードになっています。タスクを終了するには、`F1 > terminate task` を使用します",
		"現在アクティブな実行中のタスクがあります。まずこのタスクを終了してから、別のタスクを実行してください。",
		"実行中のタスクがあります。終了しますか?",
		"タスクの終了(&&T)",
		...
		"問題の場所の一致グループ インデックス。有効な場所のパターンは (line)、(line,column)、(startLine,startColumn,endLine,endColumn) です。省略すると、行と列が想定されます。",
		"問題の行の一致グループ インデックス。既定は 2 です",
		"問題の行の文字一致グループ インデックス。既定は 3 です",
		...
		"問題パターン、または事前定義された問題パターンの名前。base を指定すると省略できます。",
	...
	"vs/workbench/parts/tasks/node/processRunnerConfiguration": [
		"エラー: 有効なコマンド名が指定されていません。",
		"エラー: コマンド引数は文字列の配列でなければなりません。指定された値:\n{0}",
		"警告: グローバル マッチャーとタスクは混合できません。グローバル マッチャーは無視されます。",
		"警告: options.cwd は、型 string でなければなりません。値 {0} を無視します\n",
	...
	"vs/workbench/parts/tasks/node/processRunnerSystem": [
		"tasks.json でビルド タスクとしてマークされているタスクはありません。\'isBuildCommand\' を使用してタスクをマークしてください。",
		"構成されているテスト タスクがありません。",
		"提供されたタスク構成に検証エラーがあります。詳細については、タスク出力ログを参照してください。",
		"実行するタスクが見つかりません。",
		"タスクの実行中に不明なエラーが発生しました。詳細については、タスク出力ログを参照してください。",
		"\nビルド タスクのウォッチが終了しました。",
		"外部プログラム {0} {1} の起動に失敗しました。",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalInstance": [
		"ターミナルにフォーカスがない場合は、ターミナルの選択をコピーできません",
		"端末プロセス コマンド `{0}{1}` を起動できませんでした (終了コード: {2})",
		"端末処理が終了しました (終了コード: {0})",
	],
	...
	"vs/workbench/parts/themes/electron-browser/themes.contribution": [
		"配色テーマ",
		"テーマの読み込み中に問題が発生しました: {0}",
		"配色テーマの選択",
		"ファイル アイコンのテーマ",
		"なし",
		"ファイル アイコンを無効にする",
		"アイコン テーマの読み込みに問題があります: {0}",
		"ファイル アイコンのテーマを選択します",
		"Marketplace でさらに探す...",
		"基本設定",
	],
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		"構成ファイルに書き込めません (不明なキー)",
		"構成ファイルに書き込めません (無効なターゲット)",
		"開いているフォルダーがないため、設定を書き込めません。最初にフォルダーを開いてから、もう一度お試しください。",
	...
	"vs/workbench/services/keybinding/electron-browser/keybindingService": [
		...
		"キーまたはキー シーケンス (キーは + で区切り、シーケンスはスペースで区切る。例: Ctrl+O、Ctrl+L L で同時に押す",
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"拡張点 \'{0}\' は配列でなければなりません。",
		"\'contributes.{0}.path\' に文字列が必要です。提供された値: {1}",
		"拡張機能のフォルダー ({2}) の中に \'contributes.{0}.path\' ({1}) が含まれている必要があります。これにより、拡張機能を移植できなくなる可能性があります。",
		"拡張点 \'{0}\' は配列でなければなりません。",
		"\'contributes.{0}.path\' に文字列が必要です。提供された値: {1}",
		"`contributes.{0}.id` で想定される文字列。指定された値: {1}",
		"拡張機能のフォルダー ({2}) の中に \'contributes.{0}.path\' ({1}) が含まれている必要があります。これにより、拡張機能を移植できなくなる可能性があります。",
		"{0} を読み込めません",
		"アイコン ファイルのファイル解析に問題があります: {0}",
		"{0} を読み込めません",
		"JSON テーマ ファイルの解析中に問題が発生しました: {0}",
		"plist ファイルの解析中に問題が発生しました: {0}",
