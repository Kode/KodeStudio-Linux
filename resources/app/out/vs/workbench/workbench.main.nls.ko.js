...
define("vs/workbench/workbench.main.nls.ko", {
	...
	"vs/base/browser/ui/resourceviewer/resourceViewer": [
		...
		"파일이 텍스트가 아니라 이진이거나 매우 크거나 지원되지 않는 텍스트 인코딩을 사용하기 때문에 편집기에서 파일을 표시할 수 없습니다.",
	],
	...
	"vs/base/common/processes": [
		...
		"경고: isShellCommand는 boolean 형식어야 합니다. {0} 값을 무시합니다.",
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"편집기에서 몇 개의 문자 이후에 줄을 바꿀지를 제어합니다. 이 값을 0으로 설정하면 뷰포트 너비 줄 바꿈이 설정됩니다.",
	...
	"vs/editor/contrib/accessibility/browser/accessibility": [
		...
		"이 편집기에서 Tab 키를 누르면 포커스가 다음 포커스 가능한 요소로 이동합니다. {0} 명령은 현재 키 바인딩으로 트리거할 수 없습니다.",
		"editor.experimentalScreenReader 설정 키로 인해 실험적 화면 판독기 지원이 켜졌습니다.",
		"이 세션에 대해 실험적 화면 판독기 지원이 켜져 있습니다. {0}을(를) 눌러서 이 동작을 설정/해제합니다.",
		"이 세션에 대해 실험적 화면 판독기 지원이 켜져 있습니다. {0} 명령은 현재 키 바인딩으로 트리거할 수 없습니다.",
		"실험적 화면 판독기 지원이 꺼져 있습니다. {0}을(를) 눌러서 이 세션에 대해 이 지원을 켜거나 editor.experimentalScreenReader 설정을 true로 구성하여 모든 세션에 대해 지원을 켜세요.",
		"실험적 화면 판독기 지원이 꺼져 있습니다. {0} 명령은 현재 키 바인딩으로 트리거할 수 없습니다. editor.experimentalScreenReader 설정을 true로 구성하여 모든 세션에 대해 이 지원을 켜세요.",
	...
	"vs/editor/node/textMate/TMSnippets": [
		...
		"이 코드 조각이 적용되는 언어 ID입니다.",
		"코드 조작 파일의 경로입니다. 이 경로는 확장 폴더에 상대적이며 일반적으로 \'./snippets/\'로 시작합니다.",
	...
	"vs/languages/markdown/common/markdown.contribution": [
		"가격 인하 미리 보기 구성",
		"가격 인하 미리 보기에서 사용할 CSS 스타일시트의 로컬 경로 또는 URL 목록입니다.",
	],
	...
	"vs/platform/extensions/common/extensionsRegistry": [
		...
		"다른 확장에 대한 종속성입니다. 확장의 ID는 항상 ${publisher}.${name}입니다. 예: vscode.csharp.",
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"다시 시작한 이후에 폴더를 다시 여는 방법을 제어합니다. 폴더를 다시 열지 않으려면 \'없음\'을 선택하고, 마지막으로 작업한 폴더를 다시 열려면 \'1\'을 선택하고, 마지막 세션의 모든 폴더를 다시 열려면 \'모두\'를 선택합니다.",
		...
		"구성 업데이트",
		"업데이트를 수신할 업데이트 채널을 구성합니다. 변경 후 다시 시작해야 합니다.",
	],
	...
	"vs/workbench/electron-browser/update": [
		...
		"{0}의 이 버전은 만료되어 자동으로 업데이트할 수 없습니다. 최신 버전을 수동으로 다운로드하여 설치하세요.",
		"최신 다운로드",
		"릴리스 정보",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"디버그를 계속합니다.",
		"디버그가 중지되었습니다.",
		"ID가 {0}인 디버그 어댑터에서 스레드를 가져오지 못했습니다.",
		"응용 프로그램에 사용할 구성 시작 파일을 설정하세요.",
		"구성된 디버그 형식 \'{0}\'은(는) 지원되지 않습니다.",
		"launch.json에서 선택된 구성에 대한 \'형식\' 속성이 없습니다.",
		"preLaunchTask \'{0}\'을(를) 실행하는 동안 오류가 발생했습니다.",
		"preLaunchTask \'{0}\'을(를) 실행하는 동안 오류가 발생했습니다.",
	...
	"vs/workbench/parts/debug/node/rawDebugSession": [
		"추가 정보",
		"\'{0}\' 디버깅을 위한 확장이 설치되어 있지 않습니다.",
		"{0}에서 디버그 어댑터를 시작할 수 없습니다.",
		"DebugAdapter bin 폴더가 경로 {0}에 없습니다.",
		"{0}. 디버그 어댑터를 중지합니다.",
		"디버그 어댑터 프로세스가 예기치 않게 종료되었습니다.",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"확장 제거",
		"\'{0}\'을(를) 제거할까요?",
		"\'{0}\'이(가) 제거되었습니다. 비활성화하려면 다시 시작하세요.",
		"지금 다시 시작",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsQuickOpen": [
		...
		"\'{0}\'을(를) 설치하는 중...",
		"{0}, {1}, 확장 선택기",
		"{0}을(를) 아직 다운로드하지 않았습니다.",
		"{0}을(를) 한 번 다운로드했습니다.",
		"{0}을(를) {1}회 다운로드했습니다.",
		"입력하여 설치된 확장 목록 범위 축소",
		"확장을 찾을 수 없음",
		"입력하여 갤러리의 확장 목록 축소",
		"확장을 찾을 수 없음",
		"입력하여 설치된 확장 목록의 범위를 축소합니다.",
		"만료된 확장 없음",
		"권장되는 확장 없음",
	],
	...
	"vs/workbench/parts/files/browser/editors/fileEditorInput": [
		...
		"변경 내용을 저장하는 중...",
		"저장 오류",
		"죄송합니다. 변경 내용을 저장하는 데 문제가 있습니다.",
		"충돌",
		"변경 내용은 디스크에 있는 버전과 충돌하므로 저장할 수 없습니다.",
	],
	"vs/workbench/parts/files/browser/editors/textFileEditor": [
		"텍스트 파일 편집기",
		"파일 만들기",
		"죄송합니다. 파일이 너무 커서 편집기에서 열 수 없습니다.",
		"\'{0}\' 폴더는 현재 열려 있는 루프 폴더의 외부에 있으므로 이 인스턴스에서 열 수 없습니다.",
		"{0}. 텍스트 파일 편집기입니다.",
		"텍스트 파일 편집기입니다.",
	],
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"파일 탐색기 구성",
		"스크롤 막대가 나타나기 전에 표시할 작업 파일의 최대 수입니다.",
		"작업 파일 섹션의 높이가 요소 수에 따라 동적으로 조정되는지 여부를 제어합니다.",
		"이름으로 작업 파일 열기",
		"이름으로 작업 파일 열기",
		"파일",
	],
	...
	"vs/workbench/parts/git/browser/gitActions": [
		...
		"동기화",
		"동기화 중...",
		"분리 모드에서는 동기화할 수 없습니다.",
		"현재 \'{0}\' 분기에 업스트림 분기가 구성되어 있지 않습니다.",
		"현재 \'{0}\' 분기가 최신 상태입니다.",
		"동기화하기 전에 변경 내용을 커밋, 실행 취소 또는 저장하세요.",
		"현재 분기 \'{0}\'은(는) {1}개의 커밋 뒤에 있고 \'{3}\'보다는 {2}개의 커밋 앞에 있습니다.",
		"현재 분기 \'{0}\'은(는) {1}개의 커밋 뒤에 있고 \'{3}\'보다는 {2}개의 커밋 앞에 있습니다.",
		"현재 분기 \'{0}\'은(는) {1}개의 커밋 뒤에 있고 \'{3}\'보다는 {2}개의 커밋 앞에 있습니다.",
		"현재 분기 \'{0}\'은(는) {1}개의 커밋 뒤에 있고 \'{3}\'보다는 {2}개의 커밋 앞에 있습니다.",
		"마지막 커밋 실행 취소",
	...
	"vs/workbench/parts/markdown/browser/markdownActions": [
		"미리 보기 설정/해제",
		"첫 번째 Markdown 파일을 열어서 미리 보기를 표시합니다.",
		"측면에서 미리 보기 열기",
		"첫 번째 Markdown 파일을 열어서 미리 보기를 표시합니다.",
		"미리 보기 열기",
		"미리 보기 열기",
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"이름으로 기호 열기",
		"구성 검색",
		"검색에서 파일 및 폴더를 제외하도록 GLOB 패턴를 구성합니다. file.exclude 설정에서 모든 GLOB 패턴을 상속합니다.",
		"파일 경로를 일치시킬 GLOB 패턴입니다. 패턴을 사용하거나 사용하지 않도록 설정하려면 true 또는 false로 설정하세요.",
		"일치하는 파일의 형제에 대한 추가 검사입니다. $(basename)을 일치하는 파일 이름에 대한 변수로 사용하세요.",
	],
	...
	"vs/workbench/services/themes/node/themeService": [
		...
		"편집기에 대한 색을 정의하는 기본 테마입니다. \'vs\'는 밝은 색 테마이고, \'vs-dark\'는 어두운 색 테마입니다.",
		"tmTheme 파일의 경로입니다. 이 경로는 확장 폴더에 상대적이며 일반적으로 \'./themes/themeFile.tmTheme\'로 시작합니다.",
		"확장점 `{0}`은(는) 배열이어야 합니다.",
		"`contributes.{0}.path`에 문자열이 필요합니다. 제공된 값: {1}",
		"확장 폴더({2})에 포함할 `contributes.{0}.path`({1})가 필요합니다. 확장이 이식 불가능해질 수 있습니다.",
		"{0}을(를) 로드할 수 없습니다.",
		"JSON 테마 파일을 구문 분석하는 중 문제 발생: {0}",
		"plist 파일을 구문 분석하는 동안 문제가 발생했습니다. {0}",
	],
