...
define("vs/workbench/workbench.main.nls.ko", {
	...
	"vs/platform/actions/electron-browser/menusExtensionPoint": [
		...
		"`{0}` 속성은 필수이며 `string` 또는 `object` 형식이어야 합니다.",
		"속성 `{0}`은(는) 필수이며 `string` 형식이어야 합니다.",
		"`{0}` 및 `{1}` 속성은 필수이며 `string` 형식이어야 합니다.",
		"실행할 명령의 식별자",
		"명령이 UI에 표시되는 제목입니다.",
	...
	"vs/platform/extensions/common/extensionsRegistry": [
		...
		"지정된 언어로 확인되는 파일을 열 때마다 활성화 이벤트가 발송됩니다.",
		"지정된 명령을 호출할 때마다 활성화 이벤트가 발송됩니다.",
		"지정된 유형의 디버깅 세션을 시작할 때마다 활성화 알림이 발송됩니다.",
		"지정된 glob 패턴과 일치하는 파일이 하나 이상 있는 폴더를 열 때마다 활성화 알림이 발송됩니다.",
		"지정된 뷰가 확장될 때마다 활성화 이벤트가 내보내 집니다.",
		"VS Code 시작 시 활성화 이벤트가 발송됩니다. 훌륭한 최종 사용자 경험을 보장하려면 사용 케이스에서 다른 활성화 이벤트 조합이 작동하지 않을 때에만 확장에서 이 활성화 이벤트를 사용하세요.",
	...
	"vs/platform/markers/common/problemMatcher": [
		...
		"문제 위치의 일치 그룹 인덱스입니다. 유효한 위치 패턴은 (line), (line,column) 및 (startLine,startColumn,endLine,endColumn)입니다. 생략하면 (line,column)이 사용됩니다.",
		"문제 줄의 일치 그룹 인덱스입니다. 기본값은 2입니다.",
		"문제의 줄바꿈 문자의 일치 그룹 인덱스입니다. 기본값은 3입니다.",
		"문제 끝 줄의 일치 그룹 인덱스입니다. 기본적으로 정의되지 않습니다.",
		"문제의 끝 줄바꿈 문자의 일치 그룹 인덱스입니다. 기본값은 정의되지 않았습니다.",
		...
		"실제 패턴입니다.",
		"문제 패턴을 제공합니다.",
		"잘못된 문제 패턴입니다. 패턴이 무시됩니다.",
		"잘못된 문제 패턴입니다. 패턴이 무시됩니다.",
		"오류: 설명을 문제 선택기로 변환할 수 없습니다.\n{0}\n",
		"오류: 설명에서 유효한 문제 패턴을 정의하지 않습니다.\n{0}\n",
		"오류: 설명에서 소유자를 정의하지 않습니다.\n{0}\n",
		"오류: 설명에서 파일 위치를 정의하지 않습니다.\n{0}\n",
		"정보: 알 수 없는 심각도 {0}. 유효한 값은 오류, 경고 및 정보입니다.\n",
		"오류: 식별자가 {0}인 패턴이 없습니다.",
		"오류: 패턴 속성이 빈 식별자를 참조합니다.",
		"오류: 패턴 속성 {0}이(가) 유효한 패턴 변수 이름이 아닙니다.",
		"문제 검사기에서 감시 시작 패턴과 종료 패턴을 모두 정의해야 합니다.",
		"오류: {0} 문자열은 유효한 정규식이 아닙니다.\n",
		"백그라운드 작업의 시작 또는 종료를 감지하는 정규식입니다.",
		"파일 이름의 일치 그룹 인덱스이며 생략할 수 있습니다.",
		"제공되거나 미리 정의된 패턴의 이름",
		"문제 패턴 또는 제공되거나 미리 정의된 문제 패턴의 이름입니다. 기본이 지정된 경우 생략할 수 있습니다.",
		...
		"백그라운드 작업에서 활성 상태인 matcher의 시작과 끝을 추적하는 패턴입니다.",
		"true로 설정한 경우 작업이 시작되면 백그라운드 모니터가  활성 모드로 전환됩니다. 이는 beginPattern과 일치하는 줄을 실행하는 것과 같습니다.",
		"출력이 일치하는 경우 백그라운드 작업을 시작할 때 신호를 받습니다.",
		"출력이 일치하는 경우 백그라운드 작업을 끝날 때 신호를 받습니다.",
		"조사 속성은 사용되지 않습니다. 백그라운드 속성을 대신 사용하세요.",
		"조사 matcher의 시작과 끝을 추적하는 패턴입니다.",
		...
		"이 속성은 사용되지 않습니다. 대신 감시 속성을 사용하세요.",
		"파일 감시를 통해 트리거되는 감시되는 작업이 시작됨을 나타내는 정규식입니다.",
		"이 속성은 사용되지 않습니다. 대신 감시 속성을 사용하세요.",
		"감시되는 작업이 종료됨을 나타내는 정규식입니다.",
		"참조를 위한 문제 선택기의 이름입니다.",
		"사람이 읽을 수 있는 문제 일치기의 레이블입니다.",
		"문제 선택기를 제공합니다.",
		"Microsoft 컴파일러 문제",
		"문제 적게 보기",
		"Gulp TSC 문제",
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"Tab으로 포커스 이동",
		"화면 읽기 프로그램 검색됨",
		"화면 읽기 프로그램을 사용하지 않는 경우 `editor.accessibilitySupport` 설정을 \"off\"로 변경하세요.",
		"접근성 모드 사용 안 함",
		"줄 이동",
		"들여쓰기",
		"인코딩 선택",
	...
	"vs/workbench/browser/parts/quickopen/quickOpenController": [
		...
		"최근에 사용한 항목",
		"결과 없음",
		"이 Quick Open 처리기는 현재 컨텍스트에서 사용할 수 없습니다.",
		"{0}, 최근에 사용한 항목",
		"기록에서 제거",
		"기록에서 제거할 편집기 항목 선택",
	],
	...
	"vs/workbench/browser/parts/statusbar/statusbarPart": [
		"\'{0}\' 명령은 현재 사용하도록 설정되지 않아 실행할 수 없습니다.",
		"확장 관리",
	],
	...
	"vs/workbench/common/theme": [
		...
		"비활성 그룹의 활성 탭 전경색입니다. 탭은 편집기 영역에서 편집기의 컨테이너입니다. 한 편집기 그룹에서 여러 탭을 열 수 있습니다. 여러 편집기 그룹이 있을 수 있습니다.",
		"비활성 그룹의 비활성 탭 전경색입니다. 탭은 편집기 영역에서 편집기의 컨테이너입니다. 한 편집기 그룹에서 여러 탭을 열 수 있습니다. 여러 편집기 그룹이 있을 수 있습니다.",
		"편집기 그룹의 배경색입니다. 편집기 그룹은 편집기의 컨테이너입니다. 배경색은 편집기 그룹을 끌 때 표시됩니다.",
		"탭을 사용도록 설정한 경우 편집기 그룹 제목 머리글의 배경색입니다. 편집기 그룹은 편집기의 컨테이너입니다.",
		"탭을 사용하도록 설정한 경우 편집기 그룹 제목 머리글의 테두리 색입니다. 편집기 그룹은 편집기의 컨테이너입니다.",
		"탭을 사용하지 않도록 설정한 경우 편집기 그룹 제목 머리글의 배경색입니다. 편집기 그룹은 편집기의 컨테이너입니다.",
		"여러 편집기 그룹을 서로 구분하기 위한 색입니다. 편집기 그룹은 편집기의 컨테이너입니다.",
		"편집기를 끌 때 배경색입니다. 편집기 내용이 계속 비추어 보이도록 이 색은 투명해야 합니다.",
		...
		"폴더가 열리지 않았을 때의 상태 표시줄 전경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"표준 상태 표시줄 배경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"폴더가 열리지 않았을 때의 상태 표시줄 배경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"사이드바 및 편집기와 구분하는 상태 표시줄 테두리 색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		...
		"사이드바와 구분하는 작업 막대 테두리색입니다. 작업 막대는 오른쪽이나 왼쪽 끝에 표시되며 사이드바의 보기 간을 전환할 수 있습니다.",
		"작업 막대 항목의 끌어서 놓기 피드백 색입니다. 작업 막대 항목이 계속 비추어 보이도록 이 색은 투명해야 합니다. 작업 막대는 왼쪽이나 오른쪽 끝에 표시되며 사이드바의 보기를 전환할 수 있습니다.",
		...
		"사이드바 전경색입니다. 사이드바는 탐색기 및 검색과 같은 뷰의 컨테이너입니다.",
		"편집기와 구분하는 측면의 사이드바 테두리 색입니다. 사이드바는 탐색기 및 검색과 같은 뷰의 컨테이너입니다.",
		...
		"사이드바 섹션 헤더 전경색입니다. 사이드바는 탐색기 및 검색과 같은 뷰의 컨테이너입니다.",
		...
		"알림 단추 배경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"떠 있는 알림 단추 배경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 단추 전경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 정보 배경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 정보 전경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 경고 배경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 경고 전경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 오류 배경색입니다. 알림은 창의 위쪽에 표시됩니다.",
		"알림 오류 전경색입니다. 알림은 창의 위쪽에 표시됩니다.",
	],
	...
	"vs/workbench/electron-browser/main.contribution": [
		...
		"Workspaces",
		"개발자",
		"열려 있는 편집기를 탭에서 표시할지 여부를 제어합니다.",
		"편집기의 탭 닫기 단추의 위치를 제어하거나 \'off\'로 설정된 경우 이 단추를 사용하지 않도록 설정합니다.",
		"열린 편집기를 아이콘과 함께 표시할지 여부를 제어합니다. 이를 위해서는 아이콘 테마도 사용하도록 설정해야 합니다.",
		"열려 있는 편집기를 미리 보기로 표시할지 여부를 제어합니다. 미리 보기 편집기는 유지된 상태까지(예: 두 번 클릭 또는 편집을 통해) 다시 사용됩니다.",
		"Quick Open에서 연 편집기를 미리 보기로 표시할지 여부를 제어합니다. 미리 보기 편집기는 유지된 상태까지(예: 두 번 클릭 또는 편집을 통해) 다시 사용됩니다.",
		"편집기가 열리는 위치를 제어합니다. 현재 활성 편집기의 왼쪽 또는 오른쪽에서 편집기를 열려면 \'왼쪽\' 또는 \'오른쪽\'을 선택합니다. 현재 활성 편집기와 독립적으로 편집기를 열려면 \'처음\' 또는 \'마지막\'을 선택합니다.",
		"편집기를 여는 경우 보이는 그룹 중 하나에 표시할지 여부를 제어합니다. 사용하지 않도록 설정할 경우 편집기가 기본적으로 현재 활성 편집기 그룹에 열립니다. 사용하도록 설정할 경우 현재 활성 편집기 그룹에서 편집기가 다시 열리지 않고 이미 열린 편집기가 표시됩니다. 강제로 편집기가 특정 그룹에서 열리거나 현재 활성 그룹 옆에 열리도록 하는 등의 일부 경우에는 이 설정이 무시됩니다.",
		"명령 팔레트 기록에 최근 사용 명령을 몇 개 유지할지 결정합니다. 0으로 설정하면 명령 기록을 사용하지 않습니다.",
		"다음에 열 때 마지막으로 명령 팔레트에 입력한 내용을 복원할지 결정합니다.",
		"Quick Open가 포커스를 잃으면 자동으로 닫을지 여부를 제어합니다.",
		...
		"일부 다른 프로세스에서 파일을 삭제하거나 이름을 바꿀 때 파일을 표시하는 편집기를 자동으로 닫을지 여부를 제어합니다. 사용하지 않도록 설정하는 경우 이러한 이벤트가 발생하면 편집기가 더티 상태로 계속 열려 있습니다. 응용 프로그램 내에서 삭제하면 항상 편집기가 닫히고 데이터를 유지하기 위해 더티 파일은 닫히지 않습니다.",
		...
		"세 손가락으로 가로로 살짝 밀어 열려 있는 파일 간을 이동합니다.",
		"워크벤치",
		"파일이 새 창에서 열립니다.",
		"파일이 파일의 폴더가 열려 있는 창 또는 마지막 활성 창에서 열립니다.",
		"Dock 또는 Finder(macOS 전용)를 통해 파일을 연 경우를 제외하고 파일이 파일의 폴더가 열린 창 또는 마지막 활성 창에서 열립니다.",
		...
		"메뉴가 전체 화면 모드에서만 숨겨집니다.",
		"메뉴가 전체 화면 모드에서도 항상 표시됩니다.",
		"메뉴가 숨겨져 있지만 <Alt> 키를 통해 메뉴를 표시할 수 있습니다.",
		"메뉴가 항상 숨겨집니다.",
		...
		"창 제목 표시줄의 모양을 조정합니다. 변경 내용을 적용하려면 전체 다시 시작해야 합니다.",
		"macOS Sierra 창 탭을 사용하도록 설정합니다. 변경\n 내용을 적용하려면 전체 다시 시작해야 하고, 기본 탭에서\n 사용자 지정 제목 표시줄 스타일(구성된 경우)을 비활성화합니다.",
		"창",
		"Zen 모드",
		"Zen 모드를 켜면 워크벤치도 전체 화면 모드로 전환되는지 여부를 제어합니다.",
		"Zen 모드를 켜면 워크벤치 탭도 숨길지를 제어합니다.",
		"Zen 모드를 켜면 워크벤치 하단에서 상태 표시줄도 숨길지를 제어합니다.",
		"Zen 모드를 켜면 워크벤치의 왼쪽에 있는 작업 막대도 숨길지\n 여부를 제어합니다.",
		"창이 Zen 모드에서 종료된 경우 Zen 모드로 복원할지 제어합니다.",
	],
	"vs/workbench/electron-browser/shell": [
		"Code를 \'루트\'로 실행하지 않는 것이 좋습니다.",
	],
	...
	"vs/workbench/parts/cli/electron-browser/cli.contribution": [
		...
		"이제 Code에서 \'osascript\'를 사용하여 관리자에게 셸 명령을 설치할 권한이 있는지를 묻습니다.",
		"확인",
	...
	"vs/workbench/parts/codeEditor/electron-browser/accessibility": [
		"이제 `editor.accessibilitySupport` 설정을 \'on\'으로 변경합니다.",
		"이제 VS Code 접근성 설명서 페이지를 엽니다.",
		"VS Code의 접근성 옵션을 사용해 주셔서 감사합니다.",
		"상태:",
		"화면 읽기 프로그램에서 사용에 영구적으로 최적화되도록 편집기를 구성하려면 지금 Command+E를 누르세요.",
		"화면 읽기 프로그램에서 사용에 영구적으로 최적화되도록 편집기를 구성하려면 지금 Command+E를 누르세요.",
		"편집기는 플랫폼 API를 사용하여 화면 읽기 프로그램이 연결되는 시기를 검색하도록 구성되어 있지만 현재 런타임에서는 이 구성을 지원하지 않습니다.",
		"편집기는 화면 읽기 프로그램이 연결되어 있음을 자동으로\n 검색했습니다.",
		"편집기는 화면 편집기가 연결되는 시기를 자동으로 검색하도록 구성되어 있지만, 이 구성은 현재 지원되지 않습니다.",
		"편집기는 화면 읽기 프로그램에서 사용에 영구적으로 최적화되도록 편집기를 구성되어 있습니다. `editor.accessibilitySupport` 설정을 편집하여 이 구성을 변경할 수 있습니다.",
		"편집기는 화면 읽기 프로그램에서 사용에 최적화되지 않도록 구성되었습니다.",
		...
		"브라우저 창에 접근성과 관련된 추가 VS Code 정보를 열려면 Command+H를 누르세요.",
		"브라우저 창에 접근성과 관련된 추가 VS Code 정보를 열려면 지금 Control+H를 누르세요.",
	...
	"vs/workbench/parts/codeEditor/electron-browser/languageConfiguration/languageConfigurationExtensionPoint": [
		...
		"주석 기호를 정의합니다.",
		"블록 주석이 표시되는 방법을 정의합니다.",
		"블록 주석을 시작하는 문자 시퀀스입니다.",
		"블록 주석을 끝내는 문자 시퀀스입니다.",
		"줄 주석을 시작하는 문자 시퀀스입니다.",
		"들여쓰기를 늘리거나 줄이는 대괄호 기호를 정의합니다.",
		"대괄호 쌍을 정의합니다. 여는 대괄호를 입력하면 닫는 대괄호가 자동으로 삽입됩니다.",
		"자동 쌍을 사용하지 않도록 설정된 범위 목록을 정의합니다.",
		"선택한 문자열을 둘러싸는 데 사용할 수 있는 대괄호 쌍을 정의합니다.",
		"해당 언어에 대한 단어 정의입니다.",
		"단어 일치에 사용하는 RegEXP 패턴입니다.",
		"단어 일치에 사용하는 RegExp 플래그입니다.",
		"`/^([gimuy]+)$/` 패턴과 일치해야 합니다.",
		"해당 언어의 들여쓰기 설정입니다.",
		"라인이 이 패턴과 일치할 경우 이후의 모든 행을 한 번 들여씁니다(다른 규칙이 일치할 때까지).",
		"increaseIndentPattern에 대한 RegExp 패턴입니다.",
		"increaseIndentPattern에 대한 RegExp 플래그입니다.",
		"`/^([gimuy]+)$/` 패턴과 일치해야 합니다.",
		"행이 이 패턴과 일치하면 이후의 모든 행은 한 번 들여쓰지 않습니다(다른 규칙이 일치할 때까지).",
		"decreaseIndentPattern에 대한 RegExp 패턴입니다.",
		"decreaseIndentPattern에 대한 RegExp 플래그입니다.",
		"`/^([gimuy]+)$/` 패턴과 일치해야 합니다.",
		"행이 이 패턴과 일치하면 **그 다음 행만** 한 번 들여쓰기합니다.",
		"indentNextLinePattern에 대한 RegExp 패턴입니다.",
		"indentNextLinePattern에 대한 RegExp 플래그입니다.",
		"`/^([gimuy]+)$/` 패턴과 일치해야 합니다.",
		"행이 이 패턴과 일치하면 들여쓰기를 수정하지 않고 다른 규칙에 대해서 평가하지도 않습니다.",
		"unIndentedLinePattern에 대한 RegExp 패턴입니다.",
		"unIndentedLinePattern에 대한 RegExp 플래그입니다.",
		"`/^([gimuy]+)$/` 패턴과 일치해야 합니다.",
	],
	...
	"vs/workbench/parts/codeEditor/electron-browser/toggleWordWrap": [
		"보기: 자동 줄 바꿈 설정/해제",
		"diff 편집기에서 자동 줄 바꿈을 설정/해제할 수 없습니다.",
		"이 파일에 대해 줄 바꿈 사용 안 함",
		"이 파일에 대해 줄 바꿈 사용",
	],
	"vs/workbench/parts/codeEditor/electron-browser/wordWrapMigration": [
		...
		"다시 표시 안 함",
		"설정 열기",
		"`editor.wrappingColumn` 설정은 `editor.wordWrap`을 위해 사용되지 않습니다.",
	],
	"vs/workbench/parts/debug/browser/breakpointWidget": [
		"식이 true로 계산될 경우 중단합니다. 적용하려면 \'Enter\' 키를 누르고 취소하려면 \'Esc\' 키를 누릅니다.",
		"이 조건이 true인 경우에만 프로그램이 여기서 중지됩니다. 수락하려면 <Enter> 키를 누르고, 취소하려면 <Esc> 키를 누르세요.",
		"적중 횟수 조건이 충족될 경우 중단합니다. 적용하려면 \'Enter\' 키를 누르고 취소하려면 \'Esc\' 키를 누릅니다.",
		"적중 횟수가 충족되는 경우에만 프로그램이 여기서 중지됩니다. 수락하려면 <Enter> 키를 누르고, 취소하려면 <Esc> 키를 누르세요.",
		"식",
		"적중 횟수",
	],
	...
	"vs/workbench/parts/debug/browser/debugActions": [
		"{0} 열기",
		"\'launch.json\' 구성 또는 수정",
		"고급 디버그 구성을 수행하려면 먼저 폴더를 여세요.",
		"디버깅 시작",
		"디버깅하지 않고 시작",
		"디버깅 선택 및 시작",
		"다시 시작",
	...
	"vs/workbench/parts/debug/browser/debugQuickOpen": [
		"{0}, 디버그",
		"실행할 시작 구성의 이름을 입력하세요.",
		"일치하는 디버그 구성 없음",
		"디버그 구성을 찾을 수 없습니다. \'launch.json\' 파일을 만드세요.",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debug.contribution": [
		...
		"디버그 구성",
		"디버그",
		"모든 파일에 대한 중단점을 설정할 수 있습니다.",
		"디버그 세션 끝에 탐색기 뷰를 자동으로 엽니다.",
		"디버그하는 동안 편집기에서 변수 값을 인라인으로 표시합니다.",
		"부동 디버그 작업 모음을 숨길지 여부를 제거합니다.",
		"전역 디버그 시작 구성입니다. 작업 영역에서 공유되는 \n \'launch.json\'에 대한 대체로 사용되어야 합니다.",
	],
	...
	"vs/workbench/parts/debug/electron-browser/debugConfigurationManager": [
		...
		"디버그 어댑터 프로그램의 경로입니다. 절대 경로이거나 확장 폴더의 상대 경로입니다.",
		"어댑터에 전달할 선택적 인수입니다.",
		...
		"디버그 확장이 \"기본 디버거\"로 간주될 수 있는 언어 목록입니다.",
		"지정하는 경우 VS Code에서 이 명령을 호출하여 디버그 어댑터의 실행 파일 경로 및 전달할 인수를 확인합니다.",
		"지정하는 경우 VS Code에서 이 확장을 대상으로 하는 \"디버그\" 또는 \"실행\" 작업에 대해 이 명령을 호출합니다.",
		"\'launch.json\'에 새 구성을 추가하는 코드 조각입니다.",
		...
		"시작",
		"이 파일 형식의 버전입니다.",
		"구성 목록입니다. IntelliSense를 사용하여 새 구성을 추가하거나 기존 구성을 편집합니다.",
		"복합의 목록입니다. 각 복합은 함께 시작되는 여러 구성을 참조합니다.",
		"복합의 이름입니다. 구성 시작 드롭 다운 메뉴에 표시됩니다.",
		"이 복합의 일부로 시작되는 구성의 이름입니다.",
	...
	"vs/workbench/parts/debug/electron-browser/debugService": [
		...
		"여러 구성을 시작하려면 복합에 \"configurations\" 특성 집합이 있어야 합니다.",
		"\'{0}\' 구성이 \'launch.json\'에 없습니다.",
		...
		"디버그",
		"활성 파일은 디버그할 수 없습니다. 이 파일이 디스크에 저장되어 있고 해당 파일 형식에 대한 디버그 확장이 설치되어 있는지 확인하세요.",
		"응용 프로그램에 사용할 구성 시작 파일을 설정하세요. {0}",
	...
	"vs/workbench/parts/debug/electron-browser/replViewer": [
		...
		"{0}, 읽기 평가 인쇄 루프, 디버그",
		"출력 변수 {0}에 {1} 값이 있습니다. 읽기 평가 인쇄 루프, 디버그",
	],
	"vs/workbench/parts/debug/electron-browser/statusbarColorProvider": [
		"프로그램이 디버그될 때의 상태 표시줄 배경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
		"프로그램이 디버그될 때의 상태 표시줄 전경색입니다. 상태 표시줄은 창의 맨 아래에 표시됩니다.",
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		"디버그 어댑터 실행 파일 \'{0}\'이(가) 없습니다.",
		"디버그 어댑터 \'{0}\'에 대한 실행 파일을 확인할 수 없습니다.",
		"구성의 형식입니다.",
		"디버그 형식이 인식되지 않습니다. 해당하는 디버그 확장을 설치하고 사용하도록 설정했는지 확인하세요.",
		"\"node2\"는 더 이상 지원되지 않습니다. 대신 \"node\"를 사용하고 \"protocol\" 특성을 \"inspector\"로 설정하세요.",
		"구성 이름이며, 구성 시작 드롭다운 메뉴에 표시됩니다.",
		"구성 형식을 요청합니다. \"시작\" 또는 \"연결\"일 수 있습니다.",
		"디버그 확장 배포 전용입니다. 포트가 지정된 경우 VS Code에서는 서버 모드로 실행하는 디버그 어댑터에 연결을 시도합니다.",
		"디버그 세션이 시작되기 이전에 실행할 작업입니다.",
		"Windows 특정 시작 구성 특성입니다.",
		"OS X 특정 시작 구성 특성입니다.",
		"Linux 특정 시작 구성 특성입니다.",
		"\'env.\', \'config.\' 및 \'command.\'는 사용되지 않습니다. 대신 \'env:\', \'config:\' 및 \'command:\'를 사용하세요.",
	],
	...
	"vs/workbench/parts/extensions/browser/extensionsActions": [
		...
		"다시 로드",
		"업데이트하려면 다시 로드",
		"이 창을 다시 로드하여 업데이트된 확장 \'{0}\'을(를) 활성화하시겠습니까?",
		"활성화하려면 다시 로드",
		"이 창을 다시 로드하여 \'{0}\' 확장을 활성화하시겠습니까?",
		"비활성화하려면 다시 로드",
		"이 창을 다시 로드하여 \'{0}\' 확장을 비활성화하시겠습니까?",
		"비활성화하려면 다시 로드",
		"이 창을 다시 로드하여 제거된 확장 \'{0}\'을(를) 비활성화하시겠습니까?",
		"창 다시 로드(&&R)",
		"확장 표시",
		"확장 설치",
		...
		"언어 확장",
		"권장 확장 구성(작업 영역)",
		"권장 사항은 작업 영역 폴더에서만 사용할 수 있습니다.",
		"\'.vscode\' 폴더({0}) 내에 \'extensions.json\' 파일을 만들 수 없습니다.",
		"기본 제공",
		"설치된 모든 확장 사용 안 함",
		"이 작업 영역에 대해 설치된 모든 확장 사용 안 함",
		"설치된 모든 확장 사용",
		"이 작업 영역에 대해 설치된 모든 확장 사용",
		"눈에 잘 띄는 작업 확장의 단추 배경색입니다(예: 설치 단추).",
		"눈에 잘 띄는 작업 확장의 단추 전경색입니다(예: 설치 단추).",
		"눈에 잘 띄는 작업 확장의 단추 배경 커서 올리기 색입니다(예: 설치 단추).",
	],
	"vs/workbench/parts/extensions/browser/extensionsQuickOpen": [
		"확장을 관리하려면 <Enter> 키를 누르세요.",
		"마켓플레이스에서 \'{0}\'을(를) 검색하려면 <Enter> 키를 누르세요.",
		"확장 이름을 입력하세요.",
	],
	"vs/workbench/parts/extensions/common/extensionsFileTemplate": [
		"확장",
		"확장 권장 목록입니다. 확장의 식별자는 항상 \'${publisher}.${name}\'입니다. 예: \'vscode.csharp\'",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionTipsService": [
		"이 파일 형식에 대해 \'{0}\' 확장이 권장됩니다.",
		"권장 사항 표시",
		"다시 표시 안 함",
		"닫기",
		"이 작업 영역에 확장 권장 사항이 있습니다.",
		"권장 사항 표시",
		"다시 표시 안 함",
		"닫기",
		"확장 권장 사항을 모두 무시하시겠습니까?",
		"예, 모두 무시",
		"아니요",
		"취소",
	],
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		"Extensions 폴더 열기",
		"VSIX에서 설치...",
		"확장이 설치되었습니다. 사용하도록 설정하려면 다시 시작하세요.",
		"지금 다시 로드",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsUtils": [
		"키 바인딩 간 충돌을 피하기 위해 다른 키 맵({0})을 사용하지 않도록 설정할까요?",
		"예",
		"아니요",
		"Better Merge 확장이 이제 빌드되었습니다. 설치된 확장은 사용하지 않도록 설정되었으며 제거할 수 있습니다.",
		"제거",
		"나중에",
	],
	"vs/workbench/parts/extensions/electron-browser/extensionsViewlet": [
		...
		"정렬 기준: 등급",
		"정렬 기준: 이름",
		"마켓플레이스에서 \'ECONNREFUSED\'를 반환했습니다. \'http.proxy\' 설정을 확인하세요.",
		"확장",
		"{0}개의 만료된 확장",
	],
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		"\'{0}\'을(를) 사용하도록 설정하면 종속성도 사용하도록 설정됩니다. 계속하시겠습니까?",
		"예",
		"아니요",
		"\'{0}\'만 사용하지 않도록 설정하시겠습니까, 아니면 종속성도 사용하지 않도록 설정하시겠습니까?",
		"만",
		"모두",
		"취소",
		"확장 \'{0}\'을(를) 사용하지 않도록 설정할 수 없습니다. 확장 \'{1}\'이(가) 이 확장에 종속됩니다.",
		"확장 \'{0}\'을(를) 사용하지 않도록 설정할 수 없습니다. 확장 \'{1}\' 및 \'{2}\'이(가) 이 확장에 종속됩니다.",
		"확장 \'{0}\'을(를) 사용하지 않도록 설정할 수 없습니다. 확장 \'{1}\', \'{2}\' 등이 이 확장에 종속됩니다.",
		"\'{0}\' 확장을 설치하시겠습니까?",
		"설치",
		"취소",
	],
	...
	"vs/workbench/parts/files/browser/fileActions": [
		...
		"휴지통으로 이동(&&M)",
		"삭제(&&D)",
		"1개 파일에 저장되지 않은 변경 내용이 있는 폴더를 삭제하려고 합니다. 계속하시겠습니까?",
		"{0}개 파일에 저장되지 않은 변경 내용이 있는 폴더를 삭제하려고 합니다. 계속하시겠습니까?",
		"저장되지 않은 변경 내용이 있는 파일을 삭제하려고 합니다. 계속하시겠습니까?",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"사용하도록 설정하는 경우 파일을 열 때 문자 집합 인코딩을 추측합니다.",
		"줄 바꿈 문자의 기본 끝입니다. LF에는 \\n, CRLF에는 \\r\\n을 사용하세요.",
		"사용하도록 설정되면 파일을 저장할 때 후행 공백이 잘립니다.",
		"사용하도록 설정되면 저장할 때 파일 끝에 마지막 줄바꿈을 삽입합니다.",
		"더티 파일이 자동으로 저장되지 않습니다.",
		"\'files.autoSaveDelay\' 구성 후 더티 파일이 자동으로 저장됩니다.",
		"편집기가 포커스를 잃으면 더티 파일이 자동으로 저장됩니다.",
		"창이 포커스를 잃으면 더티 파일이 자동으로 저장됩니다.",
		"더티 파일 자동 저장을 제어합니다. 허용되는 값은 \'{0}\', \'{1}\', \'{2}\'(편집기가 포커스를 잃음), \'{3}\'(창이 포커스를 잃음)입니다. \'{4}\'(으)로 설정하는 경우 \'files.autoSaveDelay\'에서 지연을 구성할 수 있습니다.",
		...
		"핫 종료를 사용하지 않습니다.",
		"핫 종료는 응용 프로그램을 닫을 때 트리거됩니다. 즉 Windows/Linux에서 마지막 창을 닫을 때나 workbench.action.quit 명령이 트리거될 때(명령 팔레트, 키 바인딩, 메뉴)입니다. 다음 실행 시 백업을 포함한 모든 창이 복원됩니다.",
		"핫 종료는 응용 프로그램을 닫을 때 트리거됩니다. 즉 Windows/Linux에서 마지막 창을 닫을 때나 workbench.action.quit 명령이 트리거될 때(명령 팔레트, 키 바인딩, 메뉴), 또한 마지막 창인지 여부에 상관없이 폴더가 열린 모든 창의 경우입니다. 열린 폴더가 없는 모든 창은 다음 실행 시 복원됩니다. 종료되기 전 상태로 폴더 창을 복원하려면 \"window.restoreWindows\"를 \"all\"로 설정합니다.",
		"저장하지 않은 파일을 세션 간에 기억하여, 편집기를 종료할 때 저장할지 묻는 메시지를 건너뛸지 여부를 제어합니다.",
		"새로운 실험 파일 감시자를 사용하세요.",
	...
	"vs/workbench/parts/markers/common/messages": [
		...
		"({0}, {1})",
		"{0}에 {1}개의 문제가 있음",
		"{0}에 의해 오류 발생: 줄 {2} 및 문자 {3}의 {1}",
		"오류: 줄 {1} 및 문자 {2}의 {0}",
		"{0}에 의해 경고 발생: 줄 {2} 및 문자 {3}의 {1}",
		"경고: 줄 {1} 및 문자 {2}의 {0}",
		"{0}에 의해 정보 생성됨: 줄 {2} 및 문자 {3}의 {1}",
		"정보: 줄 {1} 및 문자 {2}의 {0}",
		"{0}에 의해 문제 발생: 줄 {2} 및 문자 {3}의 {1}",
		"문제: 줄 {1} 및 문자 {2}의 {0}",
		"오류 및 경고 표시",
	],
	...
	"vs/workbench/parts/performance/electron-browser/performance.contribution": [
		"느린 시작 감지됨",
		"방금 느리게 시작되었습니다. 프로파일링을 사용하도록 설정한 상태로 \'{0}\'을(를) 다시 시작하세요. 프로필을 공유해 주시면 다시 빠르게 시작될 수 있도록 최선을 다하겠습니다.",
		"프로필을 만들었습니다.",
		"문제를 발생시키고 다음 파일을 수동으로 첨부하세요.\n{0}",
		"문제 만들기 및 다시 시작",
		"다시 시작",
		"도움을 주셔서 감사합니다.",
		"계속 \'{0}\'을(를) 사용하려면 마지막으로 다시 시작해야 합니다. 기여해 주셔서 다시 한번 감사드립니다.",
		"다시 시작",
	],
	"vs/workbench/parts/preferences/browser/keybindingWidgets": [
		"원하는 키 조합을 입력하고 <Enter> 키를 누릅니다. 취소하려면 <Esc> 키를 누릅니다.",
		"현",
	],
	"vs/workbench/parts/preferences/browser/keybindingsEditor": [
		...
		"충돌 표시",
		"복사",
		"키 바인딩을 편집하는 동안 오류 \'{0}\'이(가) 발생했습니다. \'keybindings.json\' 파일을 열고 확인하세요.",
		"명령",
		"키 바인딩",
		"소스",
		"시기",
	...
	"vs/workbench/parts/preferences/browser/preferencesRenderers": [
		...
		"설정에서 바꾸기",
		"설정에 복사",
		"이 설정은 사용자 설정이어야 합니다. 작업 영역에 대해 PHP를 구성하려면 PHP 파일을 열고 상태 표시줄에서 \'PHP 경로\'를 클릭합니다.",
		"이 설정은 사용자 설정이어야 합니다.",
	...
	"vs/workbench/parts/relauncher/electron-browser/relauncher.contribution": [
		"설정이 변경되어 다시 시작해야만 적용됩니다.",
		"[다시 시작] 단추를 눌러 {0}을(를) 다시 시작하고 설정을 사용하도록 설정하세요.",
		"다시 시작",
	...
	"vs/workbench/parts/scm/electron-browser/dirtydiffDecorator": [
		"수정된 줄의 편집기 여백 배경색입니다.",
		"추가된 줄의 편집기 여백 배경색입니다.",
		"삭제된 줄의 편집기 여백 배경색입니다.",
	],
	...
	"vs/workbench/parts/search/browser/search.contribution": [
		...
		"파일 경로를 일치시킬 GLOB 패턴입니다. 패턴을 사용하거나 사용하지 않도록 설정하려면 true 또는 false로 설정하세요.",
		"일치하는 파일의 형제에 대한 추가 검사입니다. $(basename)을 일치하는 파일 이름에 대한 변수로 사용하세요.",
		"텍스트 검색에서 ripgrep 사용 여부를 제어합니다.",
		"새 작업 영역에서 검색할 때 기본적으로 .gitignore 파일 및 .ignore 파일을 사용할지 여부를 제어합니다.",
		"Quick Open에 대한 파일 결과에 전역 기호 검색 결과를 포함하도록 구성합니다.",
	],
	...
	"vs/workbench/parts/search/browser/searchResultsView": [
		...
		"{3} 텍스트가 있는 줄의 열 위치 {2}에서 용어 {0}을(를) {1}(으)로 바꾸기",
		"{2} 텍스트가 있는 줄의 열 위치 {1}에서 {0} 용어 찾기",
	],
	"vs/workbench/parts/search/browser/searchViewlet": [
		...
		"{1}개 파일에서 {0}개를 \'{2}\'(으)로 바꿨습니다.",
		"{1}개 파일에서 {0}개를 바꿨습니다.",
		"{1}개 파일에서 {0}개를 \'{2}\'(으)로 바꾸시겠습니까?",
		"{1}개 파일에서 {0}개를 바꾸시겠습니까?",
		"{1}개 파일에서 {0}개를 \'{2}\'(으)로 바꾸시겠습니까?",
		"{1}개 파일에서 {0}개를 바꾸시겠습니까?",
		"{1}개 파일에서 {0}개를 \'{2}\'(으)로 바꾸시겠습니까?",
		"{1}개 파일에서 {0}개를 바꾸시겠습니까?",
		...
		"{1}개 파일에서 {0}개 결과",
		"{1}개 파일에서 {0}개 결과",
		"아직 폴더를 열지 않았습니다. 현재 열린 파일만 검색됩니다. ",
		"폴더 열기",
	],
	...
	"vs/workbench/parts/snippets/electron-browser/TMSnippets": [
		...
		"코드 조각 파일의 경로입니다. 이 경로는 확장 폴더의 상대 경로이며 일반적으로 \'./snippets/\'로 시작합니다.",
	...
	"vs/workbench/parts/snippets/electron-browser/snippets.contribution": [
		...
		"코드 조각 콘텐츠입니다. \'$1\', \'${1:defaultText}\'를 사용하여 커서 위치를 정의하고, \'$0\'을 최종 커서 위치에 사용하세요. \'${varName}\' 및 \'${varName:defaultText}\'에 변수 값을 삽입하세요(예: \'$TM_FILENAME 파일입니다\').",
		"코드 조각 설명입니다.",
	],
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchemaCommon": [
		...
		"사용되지 않습니다. 대신 isBackground를 사용합니다.",
		"실행된 작업을 활성 상태로 유지할지 파일 시스템을 조사할지 여부를 나타냅니다.",
		"실행한 작업을 활성 상태로 유지하고 배경에서 실행하는지 여부입니다.",
		"실행 중인 작업이 있는 VS Code가 닫힐 때 사용자에게 메시지를 표시할지 여부입니다.",
		"이 작업을 Code의 기본 빌드 명령에 매핑합니다.",
		"이 작업을 Code의 기본 테스트 명령에 매핑합니다.",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v1": [
		"구성의 버전 번호입니다.",
		"러너가 더 이상 사용되지 않습니다. 공식 러너 속성을 사용하세요.",
		"작업이 프로세스로 실행되는지 여부와 출력이 출력 창이나 터미널 내부 중 어디에 표시되는지를 정의합니다.",
		"Windows 특정 명령 구성",
		"Mac 특정 명령 구성",
		"Linux 특정 명령 구성",
	...
	"vs/workbench/parts/tasks/electron-browser/jsonSchema_v2": [
		"명령이 셸 명령인지 외부 프로그램인지 여부를 지정합니다. 생략하면 기본값 false가 사용됩니다.",
		"isShellCommand 속성은 사용 중단되었습니다. 작업의 유형 속성과 셸 속성을 대신 사용하세요. 1.14 릴리스 노트를 참고하세요.",
		"이 작업이 종속된 또 다른 작업입니다.",
		"이 작업이 종속된 다른 여러 작업입니다.",
		"작업의 출력을 제시하고 입력을 읽는 데 사용하는 패널을 구성합니다.",
		"실행된 명령을 패널에 에코할지 결정합니다. 기본값은 true입니다.",
		"패널이 포커스를 잡는지 결정합니다. 기본값은 false입니다. true로 설정하면 패널도 드러납니다.",
		"작업을 실행 중인 패널이 표시되는지 여부를 제어합니다. 기본값은 \"항상\"입니다.",
		"패널을 작업 간에 공유할지 결정합니다. 이 작업 전용 패널로 사용하거나 실행할 때마다 새로 생성합니다.",
		"이 터미널 속성은 사용되지 않습니다. 프레젠테이션을 대신 사용하세요.",
		"작업 실행 그룹입니다.",
		"작업이 그룹 내 기본 작업에 있는지 정의합니다.",
		"이 작업을 기본 빌드 작업으로 표시합니다.",
		"이 작업을 기본 테스트 작업으로 표시합니다.",
		"이 작업을 \'빌드 작업 실행\' 명령을 통해 액세스 가능한 빌드 작업으로 표시합니다.",
		"이 작업을 \'테스트 작업 실행\' 명령을 통해 액세스할 수 있는 테스트 작업으로 표시합니다.",
		"작업을 그룹에 할당 안 함",
		"이 작업을 할당할 실행 그룹을 정의합니다. 빌드 그룹에 추가를 위한 \"build\'와 테스트 그룹에 추가를 위한 \"test\"를 지원합니다.",
		"작업이 프로세스로 실행되는지 또는 셸 내의 명령으로 실행되는지를 제어합니다. 기본값은 프로세스입니다.",
		"구성의 버전 번호입니다.",
		"작업을 launch.json 또는 dependsOn 구문에서 참조할 사용자 정의 식별자입니다.",
		"작업 레이블",
		"작업 이름",
		"이 작업 이름은 사용되지 않습니다. 레이블 속성을 대신 사용하세요.",
		"실행한 작업을 활성 상태로 유지하고 배경에서 실행하는지 여부입니다.",
		"실행 중인 작업이 있는 VS Code가 닫힐 때 사용자에게 메시지를 표시할지 여부입니다.",
		"사용할 문제 선택기입니다. 문자열, 문제 선택기 정의 또는 문자열 및 문제 선택기 배열일 수 있습니다.",
		"사용자 지정할 작업 유형",
		"사용자 지정 속성은 사용되지 않습니다. 새로운 작업 사용자 지정 방식으로 마이그레이션을 위해 1.14 릴리스 노트를 참고하세요.",
		"showOutput 속성은 사용되지 않습니다. 대신 presentation 속성 내 reveal 속성을 사용하세요. 1.14 릴리스 노트도 참고하세요.",
		"echoCommand 속성은 사용되지 않습니다. 대신 presentation 속성 내 echo 속성을 사용하세요. 1.14 릴리스 노트도 참고하세요.",
		...
		"isBuildCommand 속성은 사용되지 않습니다. 대신 group 속성을 사용하세요. 1.14 릴리스 노트도 참고하세요.",
		"isTestCommand 속성은 사용되지 않습니다. 대신 group 속성을 사용하세요. 1.14 릴리스 노트를 참고하세요.",
		"The property suppressTaskName is deprecated. Inline the command with its arguments into the task instead. See also the 1.14 release notes.",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"작업 시스템을 자동으로 감지하는 중 오류가 발생했습니다. 자세한 내용은 작업 출력을 참조하세요.",
		...
		"Show Running Tasks",
		"작업",
		"작업 실행 엔진을 변경하려면 VS Code를 다시 시작해야 합니다. 변경이 무시됩니다.",
		"정의된 빌드 작업이 없습니다. tasks.json 파일에서 작업을 \'isBuildCommand\'로 표시하세요.",
		"정의된 빌드 작업이 없습니다. tasks.json 파일에서 작업을 \'build\'로 표시하세요.",
		"정의된 테스트 작업이 없습니다. tasks.json 파일에서 작업을 \'isTestCommand\'로 표시하세요.",
		"정의된 테스트 작업이 없습니다. tasks.json 파일에서 작업을 \'test\'로 표시하세요.",
		"실행하도록 요청한 작업 {0}을(를) 찾을 수 없습니다.",
		...
		"현재 작성 구성에 오류가 있습니다. 작업을 사용자 지정하기 전에 오류를 수정하세요.\n",
		"tasks.json에 여러 빌드 작업이 정의되어 있습니다. 첫 번째 작업을 실행합니다.\n",
		...
		"이미 실행 중인 작업이 있습니다. 다른 작업을 실행하려면 먼저 이 작업을 종료하세요.",
		"{0} 작업을 종료하고 다시 시작하지 못했습니다.",
		"오류: 제공한 작업 구성에 유효성 검사 오류가 있으며 사용할 수 없습니다. 먼저 오류를 수정하세요.",
		"오류: tasks.json 파일의 내용에 구문 오류가 있습니다. 작업을 실행하기 전에 오류를 정정하세요.\n",
		"실행 중인 작업이 있습니다. 이 작업을 종료할까요?",
		"작업 종료(&&T)",
		"시작된 작업이 더 이상 존재하지 않습니다. 작업에서 생성된, VS Code를 끝내는 백그라운드 프로세스가 분리된 프로세스가 될 수 있습니다. 이를 방지하려면 wait 플래그를 사용하여 마지막 백그라운드 프로세스를 시작하세요.",
		"끝내기(&&E)",
		"작업 종료",
		...
		"감지된 작업",
		"빌드 작업을 페치하는 중...",
		"빌드 작업을 찾을 수 없습니다. \'빌드 작업 구성\'을 눌러서 빌드 작업을 정의하세요.",
		"실행할 빌드 작업 선택",
		"테스트 작업을 페치하는 중...",
		"테스트 작업을 찾을 수 없습니다. \'Task Runner 구성\'을 눌러서 테스트 작업을 정의하세요.",
		"실행할 테스트 작업 선택",
		"현재 실행 중인 작업이 없습니다.",
		"종료할 작업 선택",
		"시작된 프로세스가 더 이상 존재하지 않습니다. 작업에서 생성된, VS Code를 끝내는 백그라운드 작업이 분리된 프로세스가 될 수 있습니다.",
		"실행 중인 작업을 종료하지 못했습니다.",
		"다시 시작할 작업이 없습니다.",
		"다시 시작할 작업 선택",
		"{0}은(는) 이미 기본 빌드 작업으로 표시되어 있습니다.",
		"기본 빌드 작업으로 사용할 작업을 선택",
		"{0}은(는) 이미 기본 테스트 작업으로 표시되어 있습니다.",
		"기본 테스트 작업으로 사용할 작업 선택",
		"No task is running.",
		"No task is running.",
	...
	"vs/workbench/parts/tasks/electron-browser/terminalTaskSystem": [
		...
		"UNC 드라이브에서 셸 명령을 실행할 수 없습니다.",
		"문제 선택기 {0}을(를) 확인할 수 없습니다. 이 선택기는 무시됩니다.",
	],
	...
	"vs/workbench/parts/tasks/node/taskConfiguration": [
		...
		"경고: 셸 구성은 작업을 터미널에서 실행 중일 때에만 지원됩니다.",
		...
		"오류: 작업 구성은 유형 속성이 필요합니다. 이 구성은 무시됩니다.\n{0}\n",
		"오류: 작업이 사용자 지정 작업으로 선언되지 않았습니다. 이 구성은 무시됩니다.\n{0}\n",
		"오류: 작업에서 taskName 속성을 제공해야 합니다. 이 작업은 무시됩니다.\n{0}\n",
		"경고: 작업 \'{0}\'은(는) 셸 명령이며, 명령 이름이나 인수 중 하나에 이스케이프되지 않은 공백이 있습니다. 명령줄 인용을 올바르게 하려면 인수를 명령으로 병합하세요.",
		"오류: 작업 \'{0}\'에서 명령이나 dependsOn 속성을 지정하지 않습니다. 이 작업은 무시됩니다. 해당 작업의 정의는 {1}입니다.",
		"오류: 작업 \'{0}\'에서 명령을 정의하지 않습니다. 이 작업은 무시됩니다. 해당 작업의 정의는\n{1}입니다.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"Windows 터미널에 있을 때 사용할 명령줄 인수입니다.",
		"설정하는 경우 터미널 내에서 마우스 오른쪽 단추를 클릭할 때 상황에 맞는 메뉴가 표시되지 않고 대신 선택 항목이 있으면 복사하고 선택 항목이 없으면 붙여넣습니다.",
		"터미널의 글꼴 패밀리를 제어하며, 기본값은 editor.fontFamily의 값입니다.",
		"터미널에서 글꼴 합자가 사용되는지를 제어합니다.",
		"터미널의 글꼴 크기(픽셀)를 제어합니다.",
		"터미널의 줄 높이를 제어하며, 이 숫자는 터미널 글꼴 크기를 곱하여 실제 줄 높이(픽셀)를 얻습니다.",
		"터미널 내에서 굵은 텍스트를 사용하도록 설정할지 여부이며, 터미널 셸의 지원이 필요합니다.",
		"터미널 커서 깜박임 여부를 제어합니다.",
		"터미널 커서의 스타일을 제어합니다.",
		"터미널에서 버퍼에 유지하는 최대 줄 수를 제어합니다.",
		"로캘 변수가 터미널 시작 시 설정되는지 여부를 제어하며, 기본값은 OS X에서 true이고 기타 플랫폼에서 false입니다.",
		"터미널이 시작될 명시적 시작 경로입니다. 셸 프로세스의 현재 작업 디렉터리(cwd)로 사용됩니다. 루트 디렉터리가 편리한 cwd가 아닌 경우 작업 영역 설정에서 특히 유용하게 사용할 수 있습니다.",
		"끝낼 때 활성 터미널 세션이 있는지 확인할지 여부입니다.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalInstance": [
		"터미널에 복사할 선택 항목이 없음",
		"터미널 프로세스가 종료 코드 {0}(으)로 종료되었습니다.",
		"터미널을 닫으려면 아무 키나 누르세요.",
		"터미널 프로세스 명령 `{0}{1}`이(가) 시작하지 못했습니다(종료 코드: {2}).",
	],
	...
	"vs/workbench/parts/terminal/electron-browser/terminalService": [
		"사용자 지정 단추를 선택하여 기본 터미널 셸을 변경할 수 있습니다.",
		"사용자 지정",
		"취소",
		"다시 표시 안 함",
		"기본으로 설정할 터미널 셸을 선택하세요. 나중에 설정에서 이 셸을 변경할 수 있습니다.",
		"활성 터미널 세션이 있습니다. 종료할까요?",
		"{0}개의 활성 터미널 세션이 있습니다. 종료할까요?",
		"예",
		"취소",
	],
	"vs/workbench/parts/themes/electron-browser/themes.contribution": [
		"색 테마",
		"추가 색 테마 설치...",
		"색 테마 선택(미리 보려면 위로/아래로 키 사용)",
		"파일 아이콘 테마",
		"추가 파일 아이콘 테마 설치...",
		"없음",
		"파일 아이콘 사용 안 함",
		"아이콘 테마를 설정하는 동안 문제 발생: {0}",
		"파일 아이콘 테마 선택",
		"현재 설정에서 색 테마 생성",
		"기본 설정",
		"개발자",
	...
	"vs/workbench/parts/trust/electron-browser/unsupportedWorkspaceSettings.contribution": [
		"이 작업 영역에는 [사용자 설정]에서만 설정할 수 있는 설정이 포함됩니다. ({0})",
		"작업 영역 설정 열기",
		"자세한 정보",
		"무시",
	],
	...
	"vs/workbench/parts/views/browser/viewsExtensionPoint": [
		...
		"속성 `{0}`은(는) 필수이며 `string` 형식이어야 합니다.",
		"속성 `{0}`은(는) 생략할 수 있으며 `string` 형식이어야 합니다.",
		"뷰의 식별자입니다. \'vscode.window.registerTreeDataProviderForView` API를 통해 데이터 공급자를 등록하는 데 사용합니다. `onView:${id}` 이벤트를 `activationEvents`에 등록하여 확장 활성화를 트리거하는 데에도 사용합니다.",
		"사용자가 읽을 수 있는 뷰 이름입니다. 표시됩니다.",
		"이 보기를 표시하기 위해 true여야 하는 조건입니다.",
		"뷰를 에디터에 적용합니다.",
		"탐색기 뷰",
		"Debug View",
		"`{0}`은(는) 유효한 뷰 위치가 아닙니다.",
	],
	...
	"vs/workbench/parts/welcome/page/electron-browser/vs_code_welcome_page": [
		...
		"기타",
		"색 테마",
		"편집기 및 코드가 좋아하는 방식으로 표시되게 만들기",
		"알아보기",
		"모든 명령 찾기 및 실행",
		"명령 팔레트({0})에서 빠른 액세스 및 명령 검색",
		"인터페이스 개요",
		"UI의 주요 구성 요소를 강조 표시하는 시각적 오버레이 가져오기",
		"대화형 실습",
		"짧은 연습에서 기본 편집기 기능 사용해 보기",
	],
	"vs/workbench/parts/welcome/page/electron-browser/welcomePage": [
		...
		"Sublime",
		"Atom",
		"{0}에 대한 지원이 이미 설치되어 있습니다.",
		"{0}에 대한 추가 지원을 설치한 후 창이 다시 로드됩니다.",
		"{0}에 대한 추가 지원을 설치하는 중...",
		"ID가 {1}인 {0}에 대한 지원을 찾을 수 없습니다.",
		"{0} 바로 가기 키가 이미 설치되어 있습니다.",
		"{0} 바로 가기 키를 설치한 후 창이 다시 로드됩니다.",
		"{0} 바로 가기 키를 설치하는 중...",
		"ID가 {1}인 {0} 바로 가기 키를 찾을 수 없습니다.",
		"시작",
		"경로가 {1}인 {0} 폴더 열기",
		", ",
		"{0} 키맵 설치",
	...
	"vs/workbench/services/configuration/node/configurationEditingService": [
		...
		"설정에 쓸 수 없습니다. **사용자 설정**을 열어 파일에서 오류/경고를 해결하고 다시 시도하세요.",
		"설정에 쓸 수 없습니다. **작업 영역 설정**을 열어 파일에서 오류/경고를 해결하고 다시 시도하세요.",
		"파일이 변경되어 설정에 쓸 수 없습니다. **사용자 설정** 파일을 저장하고 다시 시도하세요.",
		"파일이 변경되어 설정에 쓸 수 없습니다. **작업 영역 설정** 파일을 저장하고 다시 시도하세요.",
		"사용자 설정",
		"작업 영역 설정",
		"Folder Settings",
	],
	...
	"vs/workbench/services/keybinding/common/keybindingEditing": [
		"파일이 변경되었기 때문에 쓸 수 없습니다. **키 바인딩** 파일을 저장하고 다시 시도하세요.",
		"키 바인딩을 쓸 수 없습니다. **키 바인딩 파일**을 열어 파일의 오류/경고를 수정하고 다시 시도하세요.",
		"키 바인딩을 쓸 수 없습니다. **키 바인딩 파일**에 배열 형식이 아닌 개체가 있습니다. 파일을 열어 정리하고 다시 시도하세요.",
		"키 바인딩을 이 파일에 넣어서 기본값을 덮어씁니다.",
	],
	"vs/workbench/services/keybinding/electron-browser/keybindingService": [
		...
		"실행할 명령에 전달할 인수입니다.",
		"키보드",
		"`keydown.code`(권장) 또는 `keydown.keyCode`를 사용하는 키 누름에 대한 디스패치 논리를 제어합니다.",
	],
	...
	"vs/workbench/services/textMate/electron-browser/TMGrammars": [
		...
		"tmLanguage 파일의 경로입니다. 확장 폴더의 상대 경로이며 일반적으로 \'./syntaxes/\'로 시작합니다.",
		"이 문법에 포함된 언어가 있는 경우 언어 ID에 대한 범위 이름의 맵입니다.",
	...
	"vs/workbench/services/textMate/electron-browser/TMSyntax": [
		...
		"`contributes.{0}.embeddedLanguages` 값이 잘못되었습니다. 범위 이름에서 언어까지의 개체 맵이어야 합니다. 제공된 값: {1}",
		"확장 폴더({2})에 포함할 `contributes.{0}.path`({1})가 필요합니다. 확장이 이식 불가능해질 수 있습니다.",
		"이 언어에 대해 등록된 TM 문법이 없습니다.",
	],
	...
	"vs/workbench/services/textfile/common/textFileService": [
		"파일을 백업할 수 없습니다(오류: {0}). 종료하려면 파일을 저장해 보세요.",
	],
	"vs/workbench/services/textfile/electron-browser/textFileService": [
		"{0}에 대한 변경 내용을 저장할까요?",
		"다음 {0}개 파일에 대한 변경 내용을 저장할까요?",
		"...1개의 추가 파일이 표시되지 않음",
		"...{0}개의 추가 파일이 표시되지 않음",
		"모두 저장(&&S)",
		"저장(&&S)",
	...
	"vs/workbench/services/themes/common/colorThemeSchema": [
		...
		"tmTheme 파일의 경로(현재 파일의 상대 경로)",
		"구문 강조 표시를 위한 색",
	],
	"vs/workbench/services/themes/common/fileIconThemeSchema": [
		"확장된 폴더의 폴더 아이콘입니다. 확장된 폴더 아이콘은 선택 사항입니다. 설정하지 않으면 폴더에 대해 정의된 아이콘이 표시됩니다.",
		"축소된 폴더의 폴더 아이콘이며, folderExpanded가 설정되지 않은 경우 확장된 폴더의 폴더 아이콘이기도 합니다.",
		"어떤 확장명, 파일 이름 또는 언어 ID와도 일치하는 모든 파일에 대해 표시되는 기본 파일 아이콘입니다.",
		"폴더 이름을 아이콘과 연결합니다. 개체 키는 경로 세그먼트를 제외한 폴더 이름입니다. 패턴이나 와일드카드는 허용되지 않습니다. 폴더 이름 일치는 대/소문자를 구분하지 않습니다.",
		"연결에 대한 아이콘 정의의 ID입니다.",
		"폴더 이름을 확장된 폴더의 아이콘과 연결합니다. 개체 키는 경로 세그먼트를 제외한 폴더 이름입니다. 패턴이나 와일드카드는 허용되지 않습니다. 폴더 이름 일치는 대/소문자를 구분하지 않습니다.",
		"연결에 대한 아이콘 정의의 ID입니다.",
		"파일 확장명을 아이콘과 연결합니다. 개체 키는 파일 확장명입니다. 확장명은 파일 이름에서 마지막 점 뒤에 있는 마지막 세그먼트(점 불포함)입니다. 확장명은 대/소문자를 구분하지 않고 비교됩니다.",
		"연결에 대한 아이콘 정의의 ID입니다.",
		"파일 이름을 아이콘과 연결합니다. 개체 키는 경로 세그먼트를 제외한 전체 파일 이름입니다. 파일 이름은 점과 파일 확장명을 포함할 수 있습니다. 패턴이나 와일드카드는 허용되지 않습니다. 파일 이름 일치는 대/소문자를 구분하지 않습니다.",
		"연결에 대한 아이콘 정의의 ID입니다.",
		"언어를 아이콘과 연결합니다. 개체 키는 언어 기여 지점에 정의된 언어 ID입니다.",
		"연결에 대한 아이콘 정의의 ID입니다.",
		"아이콘 정의에 사용된 글꼴입니다.",
		"글꼴의 ID입니다.",
		"글꼴의 위치입니다.",
		"현재 아이콘 테마 파일의 상대 글꼴 경로입니다.",
		"글꼴의 형식입니다.",
		"글꼴의 두께입니다.",
		"글꼴의 스타일입니다.",
		"글꼴의 기본 크기입니다.",
		"파일을 아이콘과 연결할 때 사용할 수 있는 모든 아이콘의 설명입니다.",
		"아이콘 정의입니다. 개체 키는 정의의 ID입니다.",
		"SVG 또는 PNG를 사용하는 경우: 이미지의 경로입니다. 아이콘 집합 파일의 상대 경로입니다.",
		"문자 모양 글꼴을 사용하는 경우: 사용할 글꼴의 문자입니다.",
		"문자 모양 글꼴을 사용하는 경우: 사용할 색입니다.",
		"글꼴을 사용하는 경우: 텍스트 글꼴에 대한 글꼴 크기(백분율로 표시)입니다. 설정하지 않으면 기본값으로 글꼴 정의의 크기가 사용됩니다.",
		"글꼴을 사용하는 경우: 글꼴의 ID입니다. 설정하지 않으면 기본값으로 첫 번째 글꼴 정의가 사용됩니다.",
		"밝은 색 테마에서 파일 아이콘에 대한 선택적 연결입니다.",
		"고대비 색 테마에서 파일 아이콘에 대한 선택적 연결입니다.",
	],
	"vs/workbench/services/themes/electron-browser/colorThemeData": [
		"JSON 테마 파일을 구문 분석하는 중 문제 발생: {0}",
		"색 테마 파일 {0}을(를) 구문 분석하는 중 문제가 발생했습니다. \'colors\' 속성이 \'object\' 형식이 아닙니다.",
		"색 테마 파일 {0}을(를) 구문 분석하는 중 문제가 발생했습니다. \'tokenColors\' 속성이 \'object\' 형식이 아닙니다. \'tokenColors\' 속성은 색을 지정하는 배열 또는 텍스트 짝 테마 파일의 경로여야 합니다.",
		"tmTheme 파일 {0}을(를) 구문 분석하는 중 문제가 발생했습니다. \'settings\'가 배열이 아닙니다.",
		"tmTheme 파일 {0}을(를) 구문 분석하는 중 문제가 발생했습니다.",
		"tmTheme 파일 {0}을(를) 로드하는 중 문제가 발생했습니다. {1}",
	],
	"vs/workbench/services/themes/electron-browser/workbenchThemeService": [
		"Contributes textmate color themes.",
		"사용자 설정에 사용된 아이콘 테마의 ID입니다.",
		"UI에 표시되는 색 테마의 레이블입니다.",
		"편집기 주변의 색을 정의하는 기본 테마입니다. \'vs\'는 밝은색 테마이고, \'vs-dark\'는 어두운색 테마입니다. \'hc-black\'은 어두운 고대비 테마입니다.",
		"tmTheme 파일의 경로입니다. 확장 폴더의 상대 경로이며 일반적으로 \'./themes/themeFile.tmTheme\'입니다.",
		"Contributes file icon themes.",
		"사용자 설정에 사용된 아이콘 테마의 ID입니다.",
		"UI에 표시된 아이콘 테마의 레이블입니다.",
		"아이콘 테마 정의 파일의 경로입니다. 확장 폴더의 상대 경로이며 일반적으로 \'./icons/awesome-icon-theme.json\'입니다.",
		"새 테마 설정이 사용자 설정에 추가되었습니다. {0}에서 백업을 사용할 수 있습니다.",
		"Unable to load {0}: {1}",
		...
		"Extension point `{0}` must be an array.",
		"`contributes.{0}.path`에 문자열이 필요합니다. 제공된 값: {1}",
		"`contributes.{0}.id`에 문자열이 필요합니다. 제공된 값: {1}",
		"확장 폴더({2})에 포함할 `contributes.{0}.path`({1})가 필요합니다. 확장이 이식 불가능해질 수 있습니다.",
		"Unable to load {0}",
		...
		"이 설정은 더 이상 실험적 설정이 아니며 이름이\n \'workbench.colorCustomizations\'로 변경되었습니다.",
		"대신 \'workbench.colorCustomizations\'를 사용합니다.",
