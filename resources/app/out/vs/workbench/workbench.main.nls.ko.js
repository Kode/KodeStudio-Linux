...
define("vs/workbench/workbench.main.nls.ko", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"편집기에서 공백 문자를 렌더링하는 방법을 제어합니다. 가능한 값은 \'없음\', \'경계\' 및 \'모두\'입니다. \'경계\' 옵션은 단어 사이의 한 칸 공백을 렌더링하지 않습니다.",
	...
	"vs/editor/node/textMate/TMSyntax": [
		...
		"`contributes.{0}.embeddedLanguages`의 잘못된 값입니다. 범위 이름에서 언어까지의 개체 맵이어야 합니다. 제공된 값: {1}",
		"확장 폴더({2})에 포함할 `contributes.{0}.path`({1})가 필요합니다. 확장이 이식 불가능해질 수 있습니다.",
	],
	...
	"vs/platform/environment/node/argv": [
		"`--goto` 모드에서 인수는 `FILE(:LINE(:COLUMN))` 형식이어야 합니다.",
		...
		"확장의 루트 경로를 설정합니다.",
		"설치된 확장을 나열합니다.",
		"--list-extension을 사용할 경우 설치된 확장의 버전을 표시합니다.",
		"확장을 설치합니다.",
		"확장을 제거합니다.",
	...
	"vs/workbench/browser/actions/openSettings": [
		...
		"가장 일반적으로 사용되는 설정은 http://go.microsoft.com/fwlink/?LinkId=808995를 참조하세요.",
		"기본 설정",
	...
	"vs/workbench/browser/parts/editor/editorActions": [
		...
		"편집기 그룹 간 탐색",
		"활성 편집기 그룹에 포커스",
		"첫 번째 편집기 그룹으로 포커스 이동",
		"두 번째 편집기 그룹으로 포커스 이동",
		"세 번째 편집기 그룹으로 포커스 이동",
		"이전 그룹으로 포커스 이동",
		"다음 그룹으로 포커스 이동",
		"측면에서 열기",
		"편집기 닫기",
	...
	"vs/workbench/parts/debug/node/debugAdapter": [
		...
		"이 \"복합\" 구성의 일부로 실행될 구성입니다. 이 구성의 형식이 \"복합\"인 경우에만 적용됩니다.",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"지금 다시 로드",
		"활성화하려면 다시 로드",
		"\'{0}\' 확장을 활성화하도록 이 창을 다시 로드할까요?",
		"사용하도록 다시 로드",
		"\'{0}\' 확장을 사용하도록 이 창을 다시 로드할까요?",
		"사용하지 않으려면 다시 로드",
		"\'{0}\' 확장을 사용하지 않도록 이 창을 다시 로드할까요?",
		"비활성화하려면 다시 로드",
		"\'{0}\' 확장을 비활성화하도록 이 창을 다시 로드할까요?",
		"모든 확장 업데이트",
		"확장 표시",
		"확장 설치",
		"설치된 확장 표시",
		...
		"\'.vscode\' 폴더 내에 \'extensions.json\' 파일을 만들 수 없습니다({0}).",
		"VSIX에서 설치...",
		"기본 제공",
		"모두 사용 안 함",
		"모두 사용 안 함(작업 영역)",
	...
	"vs/workbench/parts/files/browser/files.contribution": [
		...
		"파일 저장 시 서식을 지정합니다. 포맷터를 사용할 수 있어야 하며, 파일이 자동으로 저장되어야 하고, 편집기가 종료되지 않아야 합니다.",
		"파일 탐색기",
	...
	"vs/workbench/parts/tasks/electron-browser/task.contribution": [
		...
		"닫기",
		"실행 중인 작업 종료",
		"시작된 프로세스가 더 이상 존재하지 않습니다. 작업에서 생성된, VS 코드를 끝내는 백그라운드 작업이 분리된 프로세스가 될 수 있습니다.",
		...
		"작업이 이미 활성 상태이며 감시 모드입니다.",
		"지금 실행 중인 활성 작업이 있습니다. 다른 작업을 실행하려면 먼저 활성 작업을 종료하세요.",
		"실행 중인 작업이 있습니다. 이 작업을 종료할까요?",
		"작업 종료(&&T)",
		"시작된 작업이 더 이상 존재하지 않습니다. 작업에서 생성된, VS 코드를 끝내는 백그라운드 프로세스가 분리된 프로세스가 될 수 있습니다. 이를 방지하려면 wait 플래그를 사용하여 마지막 백그라운드 프로세스를 시작하세요.",
		"끝내기(&&E)",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"터미널의 글꼴 크기(픽셀)를 제어하며, 기본값으로 editor.fontSize의 값이 사용됩니다.",
		...
		"키 바인딩이 셸에 전송되지 않고 항상 코드에서 처리되는 명령 ID 집합입니다. 따라서 셸에서 정상적으로 사용되어 터미널에 포커스가 없을 때와 동일하게 작동하는 키 바인딩을 사용할 수 있습니다(예: <Ctrl+P>를 사용하여 Quick Open 시작).",
		"터미널",
		"터미널",
		"보기",
	],
	...
	"vs/workbench/services/configurationResolver/node/configurationResolverService": [
		"대화형 변수 {0}이(가) 제공되지 않지만 구성에 지정됩니다.",
	],
	...
	"vs/workbench/services/themes/electron-browser/themeService": [
		...
		"아이콘 테마 정의 파일의 경로입니다. 경로는 확장 폴더를 기준으로 하며 일반적으로 \'./icons/awesome-icon-theme.json\'입니다.",
		"확장점 `{0}`은(는) 배열이어야 합니다.",
		"`contributes.{0}.path`에 문자열이 필요합니다. 제공된 값: {1}",
		...
		"SVG 또는 PNG를 사용하는 경우: 이미지의 경로입니다. 경로는 아이콘 집합 파일을 기준으로 합니다.",
