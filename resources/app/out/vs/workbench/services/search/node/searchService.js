                ...
                models.forEach(function (model) {
                    ...
                    if (ranges.length) {
                        ...
                        ranges.forEach(function (range) {
                            fileMatch.lineMatches.push(new search_1.LineMatch(model.getLineContent(range.startLineNumber), range.startLineNumber - 1, [[range.startColumn - 1, range.endColumn - range.startColumn]]));
                        });
                    }
                    else {
