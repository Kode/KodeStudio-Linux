...
define(["require", "exports", 'vs/nls', 'vs/base/common/winjs.base', 'vs/platform/platform', 'vs/platform/jsonschemas/common/jsonContributionRegistry', 'vs/platform/plugins/common/pluginsRegistry', 'vs/platform/keybinding/common/keybindingResolver', 'vs/platform/keybinding/browser/keybindingServiceImpl', 'vs/platform/keybinding/common/keybindingsRegistry', 'vs/base/common/platform', 'vs/workbench/services/keybinding/electron-browser/nativeKeymap', 'vs/workbench/common/events'], function (require, exports, nls, winjs_base_1, platform_1, JSONContributionRegistry, pluginsRegistry_1, keybindingResolver_1, keybindingServiceImpl_1, keybindingsRegistry_1, Platform, nativeKeymap_1, events_1) {
    ...
    var keybindingsExtPoint = pluginsRegistry_1.PluginsRegistry.registerExtensionPoint('keybindings', {
    ...
    var WorkbenchKeybindingService = (function (_super) {
        ...
        function WorkbenchKeybindingService(contextService, eventService, telemetryService, domNode) {
            var _this = this;
        ...
        WorkbenchKeybindingService.prototype.setPluginService = function (pluginService) {
        ...
        WorkbenchKeybindingService.prototype._invokeHandler = function (commandId, args) {
            ...
            if (this._pluginService) {
                return this._pluginService.activateByEvent('onCommand:' + commandId).then(function (_) {
    ...
    var schemaId = 'local://schemas/keybindings';
    var schema = {
        'id': schemaId,
        'type': 'array',
