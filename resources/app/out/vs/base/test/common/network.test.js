 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/base/common/uri', 'vs/base/common/network', 'vs/base/common/marshalling'], function (require, exports, assert, uri_1, network_1, marshalling_1) {
    function assertUrl(raw, scheme, domain, port, path, queryString, fragmentId) {
        var url = new network_1.ParsedUrl(raw);
    ...
    function assertCombine(base, relativeUrl, expectedUrl) {
        var url = new network_1.ParsedUrl(base);
    ...
    suite('Network', function () {
        test('urls', function () {
            ...
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '\\test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '/test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '////test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '\\test.js?token=123', 'http://www.test.com:8000/test.js?token=123');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '\\test.js?query=foo#hash', 'http://www.test.com:8000/test.js?query=foo#hash');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '\\test.js#hash', 'http://www.test.com:8000/test.js#hash');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', 'test.js', 'http://www.test.com:8000/this/that/test.js');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '../test.js', 'http://www.test.com:8000/this/test.js');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '..\\test.js', 'http://www.test.com:8000/this/test.js');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '..\\test.js?token=123', 'http://www.test.com:8000/this/test.js?token=123');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '..\\test.js?query=foo#hash', 'http://www.test.com:8000/this/test.js?query=foo#hash');
            assertCombine('http://www.test.com:8000/this/that/theother.html?query=foo#hash', '..\\test.js#hash', 'http://www.test.com:8000/this/test.js#hash');
            assertCombine('http://www.test.com:8000/this/that/', 'test.js', 'http://www.test.com:8000/this/that/test.js');
            assertCombine('http://www.test.com:8000/this/that/', './test.js', 'http://www.test.com:8000/this/that/test.js');
            assertCombine('http://www.test.com:8000/', './test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com:8000/', './././test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com:8000', './././test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com:8000', 'test.js', 'http://www.test.com:8000/test.js');
            assertCombine('http://www.test.com', '../test.js', 'http://www.test.com/test.js');
            assertCombine('http://www.test.com', 'a/b/../../../test.js', 'http://www.test.com/test.js');
            assertCombine('http://www.test.com/a/b', 'a/b/../../../../../test.js', 'http://www.test.com/test.js');
            assertCombine('http://www.test.com', 'test.js', 'http://www.test.com/test.js');
            assertCombine('http://www.test.com', 'a/b/test.js', 'http://www.test.com/a/b/test.js');
            assertCombine('http://www.test.com', './a/b/test.js', 'http://www.test.com/a/b/test.js');
            assertCombine('http://www.test.com/index.html', './a/b/test.js', 'http://www.test.com/a/b/test.js');
            var url = new network_1.URL('inmemory://model/1#css');
            assert.equal(url.toUnique(), 'inmemory://model/1');
        });
        test('Bug 16793:# in folder name => mirror models get out of sync', function () {
            var uri = uri_1.default.parse('file:///C:/model/1#css');
            assert.equal(marshalling_1.deserialize(marshalling_1.serialize(uri)).toString(), uri.toString());
        });
    });
});
