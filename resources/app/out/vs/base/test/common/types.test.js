...
define(["require", "exports", 'assert', 'vs/base/common/types'], function (require, exports, assert, types) {
    suite('Types', function () {
        ...
        test('validateConstraints', function () {
            ...
            function isFoo(f) { }
            assert.throws(function () { return types.validateConstraints([new foo()], [isFoo]); });
            function isFoo2(f) { return true; }
            types.validateConstraints([new foo()], [isFoo2]);
            assert.throws(function () { return types.validateConstraints([1, true], [types.isNumber, types.isString]); });
            assert.throws(function () { return types.validateConstraints(['2'], [types.isNumber]); });
            assert.throws(function () { return types.validateConstraints([1, 'test', true], [Number, String, Number]); });
        });
