 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'assert', 'vs/base/common/bits/hash', 'vs/base/common/strings'], function (require, exports, assert, hash_1, strings) {
    suite('Hash', function () {
        test('SHA1', function () {
            var sha1 = new hash_1.SHA1();
            sha1.update(new ArrayBuffer(0));
            assert.equal(sha1.digest(), 'da39a3ee5e6b4b0d3255bfef95601890afd80709');
            sha1 = new hash_1.SHA1();
            sha1.update('');
            assert.equal(sha1.digest(), 'da39a3ee5e6b4b0d3255bfef95601890afd80709');
            sha1 = new hash_1.SHA1();
            sha1.update('');
