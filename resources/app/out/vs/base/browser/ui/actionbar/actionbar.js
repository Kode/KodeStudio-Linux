...
define(["require", "exports", 'vs/nls', 'vs/base/common/lifecycle', 'vs/base/browser/builder', 'vs/base/common/actions', 'vs/base/browser/dom', 'vs/base/common/events', 'vs/base/common/types', 'vs/base/common/eventEmitter', 'vs/base/browser/touch', 'vs/base/browser/keyboardEvent', 'vs/base/common/keyCodes', 'vs/css!./actionbar'], function (require, exports, nls, lifecycle, builder_1, actions, DOM, events_1, types, eventEmitter_1, touch_1, keyboardEvent_1, keyCodes_1) {
    ...
    var ActionItem = (function (_super) {
        ...
        ActionItem.prototype.render = function (container) {
            ...
            this.$e = builder_1.$('a.action-label').attr('tabIndex', '-1').appendTo(this.builder);
    ...
    var ActionBar = (function (_super) {
        ...
        function ActionBar(container, options) {
            ...
            builder_1.$(this.domNode).on(DOM.EventType.KEY_DOWN, function (e) {
                ...
                else if (event.equals(keyCodes_1.CommonKeybindings.ENTER)) {
                }
                else {
                    eventHandled = false;
                }
            ...
            focusTracker.addBlurListener(function (e) {
        ...
        ActionBar.prototype.push = function (actions, options) {
            ...
            actions.forEach(function (action) {
                ...
                if (!_this.options.disableTabIndex && !_this.domNode.hasAttribute('tabIndex')) {
                    _this.domNode.tabIndex = 0; // make sure an action bar with actions participates in tab navigation
                }
        ...
        ActionBar.nlsActionBarAccessibleLabel = nls.localize('actionBarAccessibleLabel', "Action Bar");
        ActionBar.DEFAULT_OPTIONS = {
            orientation: ActionsOrientation.HORIZONTAL
        };
        return ActionBar;
    })(eventEmitter_1.EventEmitter);
    ...
    var SelectActionItem = (function (_super) {
        ...
        SelectActionItem.prototype.registerListeners = function () {
            ...
            this.toDispose.push(DOM.addStandardDisposableListener(this.select, 'change', function (e) {
                _this.actionRunner.run(_this._action, e.target.value).done();
            }));
        };
        ...
        SelectActionItem.prototype.doSetOptions = function () {
            ...
            this.options.forEach(function (option) {
                _this.select.options.add(_this.createOption(option));
            });
            if (this.selected >= 0) {
