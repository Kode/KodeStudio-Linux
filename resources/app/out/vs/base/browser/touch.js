 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/base/common/arrays', 'vs/base/common/lifecycle', 'vs/base/browser/dom'], function (require, exports, Arrays, Lifecycle, DomUtils) {
    var EventType;
    (function (EventType) {
    ...
    var Gesture = (function () {
        ...
        Object.defineProperty(Gesture.prototype, "target", {
            set: function (element) {
                ...
                this.callOnTarget.push(DomUtils.addListener(this.targetElement, 'touchstart', function (e) { return _this.onTouchStart(e); }));
                this.callOnTarget.push(DomUtils.addListener(this.targetElement, 'touchend', function (e) { return _this.onTouchEnd(e); }));
                this.callOnTarget.push(DomUtils.addListener(this.targetElement, 'touchmove', function (e) { return _this.onTouchMove(e); }));
            },
            enumerable: true,
            configurable: true
        });
