...
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/base/common/types', 'vs/base/common/strings', 'vs/base/common/assert', 'vs/base/browser/dom', 'vs/base/browser/browserService', 'vs/css!./builder'], function (require, exports, winjs_base_1, types, strings, assert, DOM, BrowserService) {
    /**
    ...
    var Builder = (function () {
        ...
        Builder.prototype.on = function (arg1, fn, listenerToUnbindContainer, useCapture) {
            ...
            if (types.isArray(arg1)) {
                ...
                var type = arg1;
                // Add Listener
                var unbind = DOM.addListener(this.currentElement, type, function (e) {
                    fn(e, _this, unbind); // Pass in Builder as Second Argument
                }, useCapture || false);
        ...
        Builder.prototype.showDelayed = function (delay) {
            ...
            // Cancel any pending showDelayed() invocation
            this.cancelVisibilityPromise();
            var promise = winjs_base_1.Promise.timeout(delay);
