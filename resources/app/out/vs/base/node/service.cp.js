            ...
            get: function () {
                ...
                if (!this._client) {
                    ...
                    this._client = new service_1.Client({
                        send: function (r) { return _this.child.connected && _this.child.send(r); },
                        onMessage: function (cb) {
                            _this.child.on('message', function (msg) {
                                ...
                                if (msg && msg.type === '__$console') {
                                    ...
                                    try {
                                        var parsed = JSON.parse(msg.arguments);
                                        args_1 = args_1.concat(Object.getOwnPropertyNames(parsed).map(function (o) { return parsed[o]; }));
                                    }
                                    catch (error) {
                    ...
                    var onExit = function () { return _this.disposeClient(); };
