 ...
 *--------------------------------------------------------------------------------------------*/
'use strict';
define(["require", "exports", 'vs/nls', 'vs/base/common/objects', 'vs/base/common/platform', 'vs/base/common/types', 'vs/base/common/arrays', 'vs/base/common/strings'], function (require, exports, nls, objects, platform, types, arrays, strings) {
    ...
    var ConnectionError = (function () {
        ...
        ConnectionError.prototype.connectionErrorDetailsToMessage = function (error, verbose) {
            ...
            if (errorCode !== null && errorMessage !== null) {
                ...
                }, "{0}. Error code: {1}", strings.rtrim(errorMessage, '.'), errorCode);
            }
        ...
        ConnectionError.prototype.connectionErrorToMessage = function (error, verbose) {
            ...
            if (error.status === 401) {
                if (details !== null) {
                    ...
                    }, "Permission Denied (HTTP {0})", details);
                }
