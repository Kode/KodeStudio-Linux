...
define(["require", "exports", 'vs/base/common/assert', 'vs/base/common/lifecycle', 'vs/base/common/arrays', 'vs/base/common/eventEmitter', 'vs/base/common/winjs.base'], function (require, exports, Assert, lifecycle_1, arrays, Events, WinJS) {
    ...
    var Lock = (function () {
        ...
        Lock.prototype.run = function (item, fn) {
            ...
            if (lock) {
                ...
                }, function () { return unbindListener(); });
            }
            var result;
            return new WinJS.Promise(function (c, e) {
                if (item.isDisposed()) {
    ...
    var Item = (function (_super) {
        ...
        Item.prototype.refreshChildren = function (recursive, safe, force) {
            ...
            var doRefresh = function () {
                ...
                return childrenPromise.then(function (elements) {
                    ...
                    _this.emit('item:childrenRefreshed', eventData);
                });
            };
    ...
    var TreeModel = (function (_super) {
        ...
        TreeModel.prototype.setInput = function (element) {
            ...
            this.registryDisposable = lifecycle_1.combinedDispose(this.addEmitter2(this.registry), this.registry.addListener2('item:dispose', function (event) {
