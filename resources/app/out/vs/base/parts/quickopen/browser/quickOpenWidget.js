...
define(["require", "exports", 'vs/base/common/winjs.base', 'vs/base/common/platform', 'vs/base/browser/browser', 'vs/base/common/events', 'vs/base/common/types', 'vs/base/common/errors', 'vs/base/common/uuid', 'vs/base/parts/quickopen/common/quickOpen', 'vs/base/parts/quickopen/browser/quickOpenViewer', 'vs/base/browser/builder', 'vs/base/browser/ui/inputbox/inputBox', 'vs/base/parts/tree/browser/treeImpl', 'vs/base/browser/ui/progressbar/progressbar', 'vs/base/browser/keyboardEvent', 'vs/base/parts/tree/browser/treeDefaults', 'vs/base/browser/dom', 'vs/base/common/keyCodes', 'vs/css!./quickopen'], function (require, exports, winjs_base_1, platform, browser, events_1, types, errors, uuid, quickOpen_1, quickOpenViewer_1, builder_1, inputBox_1, treeImpl_1, progressbar_1, keyboardEvent_1, treeDefaults_1, DOM, keyCodes_1) {
    ...
    var QuickOpenWidget = (function () {
            ...
            this.builder = builder_1.$().div(function (div) {
                ...
                div.div({ 'class': 'quick-open-input' }, function (inputContainer) {
                    ...
                    _this.inputBox = new inputBox_1.InputBox(inputContainer.getHTMLElement(), null, {
                        ...
                        ariaLabel: _this.options.inputAriaLabel
                    });
                    DOM.addDisposableListener(_this.inputBox.inputElement, DOM.EventType.KEY_DOWN, function (e) {
                        ...
                        if (keyboardEvent.keyCode === keyCodes_1.KeyCode.Tab || keyboardEvent.keyCode === keyCodes_1.KeyCode.DownArrow || keyboardEvent.keyCode === keyCodes_1.KeyCode.UpArrow || keyboardEvent.keyCode === keyCodes_1.KeyCode.PageDown || keyboardEvent.keyCode === keyCodes_1.KeyCode.PageUp) {
                            DOM.EventHelper.stop(e, true);
        ...
        QuickOpenWidget.prototype.setInput = function (input, autoFocus) {
            if (!this.isVisible()) {
                return;
            }
        ...
        QuickOpenWidget.prototype.loosingFocus = function (e) {
            ...
            winjs_base_1.Promise.timeout(0).then(function () {
