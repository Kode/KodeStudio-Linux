...
define("vs/code/electron-main/main.nls.ru", {
	...
	"vs/code/electron-main/menus": [
		...
		"Для работы в режиме нескольких курсоров нажмите левую кнопку мыши, удерживая клавишу CTRL",
		...
		"Show Runnin&&g Tasks...",
		"П&&ерезапустить запущенную задачу...",
		"&&Завершить задачу...",
		"&&Настроить задачи",
		"Настроить задачу сборки по у&&молчанию",
		"Специальные возможности",
	...
	"vs/platform/environment/node/argv": [
		...
		"Открыть файл по пути, указанному в определенной строке и символе (требуется добавить \":строка[:символ]\" в путь).",
