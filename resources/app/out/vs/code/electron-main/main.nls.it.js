...
define("vs/code/electron-main/main.nls.it", {
	...
	"vs/code/electron-main/menus": [
		...
		"E&&mmet...",
		"Attiva/Disattiva commento per &&riga",
		"Attiva/Disattiva commento per &&blocco",
		"Passare ad ALT+clic per multi-cursore",
		"Passare a Cmd+clic per multi-cursore",
		"Passare a CTRL+clic per multi-cursore",
		...
		"&&Copia riga in alto",
		"Co&&pia riga in basso",
		"Sposta riga in &&alto",
		"Sposta riga in &&basso",
		"Seleziona &&tutto",
		"Seleziona &&tutto",
		"Espan&&di selezione",
		"&&Riduci selezione",
		...
		"&&Editor successivo",
		"Editor &&precedente",
		"&&Editor successivo usato nel gruppo",
		"Editor &&precedente usato nel gruppo",
		"Cambia &&editor",
		"&&Primo gruppo",
		"&&Secondo gruppo",
		"&&Terzo gruppo",
		...
		"Seguici su T&&witter",
		"&&Cerca in richieste di funzionalità",
		"&&Visualizza licenza",
		...
		"Show Runnin&&g Tasks...",
		"Ria&&vvia attività in esecuzione...",
		"&&Termina attività...",
		"&&Configura attività",
		"Configura atti&&vità di compilazione predefinita",
		"Opzioni accessibilità",
