...
define("vs/code/electron-main/main.nls.es", {
	"vs/code/electron-main/auth": [
		...
		"El proxy {0} requiere autenticación.",
	],
	"vs/code/electron-main/menus": [
		...
		"&&Extensiones de distribución de teclado",
		...
		"Emmet: E&&xpandir abreviatura",
		"E&&mmet...",
		"&&Alternar comentario de línea",
		"Alternar &&Bloquear comentario",
		"Cambiar a Alt+Clic para cursor múltiple",
		"Cambiar a Cmd+Clic para cursor múltiple",
		"Cambiar a Ctrl+Clic para cursor múltiple",
		...
		"Dividir &&editor",
		"Alternar diseño del grupo de &&editores",
		...
		"&&Editor siguiente",
		"&&Editor anterior",
		"&&Editor siguiente usado del grupo",
		"&&Editor anterior usado del grupo",
		"Cambiar &&editor",
		"&&Primer grupo",
		"&&Segundo grupo",
		"&&Tercer grupo",
		...
		"Depurar paso a paso por proce&&dimientos",
		"&&Depurar paso a paso por instrucciones",
		"Depurar paso a paso para &&salir",
		"&&Continuar",
		"Alter&&nar punto de interrupción",
		"Punto de interrupción &&condicional...",
		"Punto de interrupción de c&&olumna",
		"Punto de interrupción de &&función...",
		...
		"&&Instalar los depuradores adicionales...",
		"Minimizar",
		"Zoom",
