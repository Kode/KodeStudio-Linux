...
define("vs/code/node/cliProcessMain.nls.it", {
	...
	"vs/code/node/cliProcessMain": [
		"L\'estensione \'{0}\' non è stata trovata.",
		"L\'estensione \'{0}\' non è installata.",
		"Assicurarsi di usare l\'ID estensione completo, incluso l\'editore, ad esempio {0}",
		"L\'estensione \'{0}\' è stata installata.",
		"L\'estensione \'{0}\' è già installata.",
		"L\'estensione \'{0}\' è stata trovata nel Marketplace.",
		"Installazione...",
		"L\'estensione \'{0}\' versione {1} è stata installata.",
		"Disinstallazione di {0}...",
