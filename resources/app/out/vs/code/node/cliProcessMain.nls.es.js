...
define("vs/code/node/cliProcessMain.nls.es", {
	...
	"vs/code/node/cliProcessMain": [
		...
		"La extensión \'{0}\' no está instalada.",
		"Asegúrese de usar el identificador de extensión completo, incluido el publicador, por ejemplo: {0}.",
		"La extensión \'{0}\' se ha instalado correctamente.",
		"La extensión \'{0}\' ya está instalada.",
		"Se encontró \'{0}\' en Marketplace.",
		"Instalando...",
		"La extensión \'{0}\' v{1} se instaló correctamente.",
		"Desinstalando {0}...",
