...
define("vs/code/node/cliProcessMain.nls.fr", {
	...
	"vs/code/node/cliProcessMain": [
		...
		"L\'extension \'{0}\' n\'est pas installée.",
		"Veillez à utiliser l\'ID complet de l\'extension (serveur de publication inclus). Exemple : {0}",
		"L\'extension \'{0}\' a été installée correctement !",
		"L\'extension \'{0}\' est déjà installée.",
		"\'{0}\' trouvé dans le Marketplace.",
		"Installation...",
		"L\'extension \'{0}\' v{1} a été correctement installée !",
		"Désinstallation de {0}...",
