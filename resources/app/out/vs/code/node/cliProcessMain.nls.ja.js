...
define("vs/code/node/cliProcessMain.nls.ja", {
	...
	"vs/platform/extensionManagement/node/extensionManagementService": [
		...
		"{0} を再インストールする前に、Code を再起動してください。",
		"\'{0}\' をインストールすると、その依存関係もインストールされます。続行してもよろしいですか?",
		"はい",
		"いいえ",
		"{0} を再インストールする前に、Code を再起動してください。",
		"\'{0}\' のみをアンインストールしますか、または依存関係もアンインストールしますか?",
		"限定",
		"すべて",
		"キャンセル",
		...
		"OK",
		"キャンセル",
		"拡張機能 \'{0}\' をアンインストールできません。拡張機能 \'{1}\' がこの拡張機能に依存しています。",
		"拡張機能 \'{0}\' をアンインストールできません。拡張機能 \'{1}\' と \'{2}\' がこの拡張機能に依存しています。",
