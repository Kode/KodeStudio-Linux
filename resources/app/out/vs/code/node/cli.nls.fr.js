...
define("vs/code/node/cli.nls.fr", {
	"vs/platform/environment/node/argv": [
		"Les arguments en mode \'--goto\' doivent être au format \'FILE(:LINE(:CHARACTER))\'.",
		"Ouvrez un éditeur de différences. Nécessite de passer deux chemins de fichiers comme arguments.",
		"Ouvrez le fichier sur le chemin, à la ligne et au caractère indiqués (ajoutez :line[:character] au chemin).",
		...
		"Définissez le chemin racine des extensions.",
		"Listez les extensions installées.",
		"Affichez les versions des extensions installées, quand --list-extension est utilisé.",
		"Installe une extension.",
		"Désinstalle une extension.",
		"Active les fonctionnalités d\'API proposées pour une extension.",
		"Désactivez toutes les extensions installées.",
		"Désactivez l\'accélération matérielle du GPU.",
		"Affichez la version.",
