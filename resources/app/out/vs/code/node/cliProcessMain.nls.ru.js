...
define("vs/code/node/cliProcessMain.nls.ru", {
	...
	"vs/code/node/cliProcessMain": [
		...
		"Расширение \"{0}\" успешно установлено.",
	...
	"vs/platform/extensionManagement/node/extensionManagementService": [
		...
		"Перезапустите код перед переустановкой {0}.",
		"При установке \"{0}\" также устанавливаются зависимости. Вы хотите продолжить?",
		"Да",
		"Нет",
		"Перезапустите код перед переустановкой {0}.",
		"Вы хотите удалить \"{0}\" отдельно или вместе с зависимостями?",
		"Только",
		"Все",
		"Отмена",
		...
		"ОК",
		"Отмена",
		"Не удается удалить расширение \"{0}\". От него зависит расширение \"{1}\".",
		"Не удается удалить расширение \"{0}\". От него зависят расширения \"{1}\" и \"{2}\".",
		"Не удается удалить расширение \"{0}\". От него зависят расширения \"{1}\", \"{2}\" и другие.",
