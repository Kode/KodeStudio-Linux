 ...
 *--------------------------------------------------------*/
define("vs/code/node/cliProcessMain.nls.tr", {
	...
	"vs/code/node/cliProcessMain": [
		"\'{0}\' eklentisi bulunamadı.",
		"\'{0}\' eklentisi yüklü değil.",
		"Eklentinin tam ID\'sini, yayıncı da dahil olmak üzere kullandığınızdan emin olun, ör: {0}",
		"\'{0}\' eklentisi başarıyla yüklendi.",
		"\'{0}\' eklentisi zaten yüklü.",
		"\'{0}\' markette bulundu.",
		"Yükleniyor...",
		"\'{0}\' v{1} eklentisi başarıyla kuruldu!",
		"{0} kaldırılıyor...",
		"\'{0}\' eklentisi başarıyla kaldırıldı!",
	],
