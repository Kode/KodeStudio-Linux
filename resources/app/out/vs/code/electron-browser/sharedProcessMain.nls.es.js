 ...
 *--------------------------------------------------------*/
define("vs/code/electron-browser/sharedProcessMain.nls.es", {
	...
	"vs/platform/extensionManagement/node/extensionManagementService": [
		...
		"No",
		"Reinicie Code antes de volver a instalar {0}.",
		"¿Quiere desinstalar solo \'{0}\' o también sus dependencias?",
		"Solo",
		"Todo",
		"Cancelar",
		...
		"Aceptar",
		"Cancelar",
		"No se puede desinstalar la extensión \'{0}\'. La extensión \'{1}\' depende de esta.",
