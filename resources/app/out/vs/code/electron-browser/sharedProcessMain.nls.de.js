 ...
 *--------------------------------------------------------*/
define("vs/code/electron-browser/sharedProcessMain.nls.de", {
	...
	"vs/platform/extensionManagement/node/extensionManagementService": [
		...
		"Nein",
		"Bitte starten Sie Code vor der Neuinstallation von {0} neu.",
		"Möchten Sie nur \"{0}\" oder auch die zugehörigen Abhängigkeiten deinstallieren?",
		"Nur",
		"Alle",
		"Abbrechen",
		"Möchten Sie \"{0}\" deinstallieren?",
		"OK",
		"Abbrechen",
		"Die Erweiterung \"{0}\" kann nicht deinstalliert werden. Die Erweiterung \"{1}\" hängt von dieser Erweiterung ab.",
