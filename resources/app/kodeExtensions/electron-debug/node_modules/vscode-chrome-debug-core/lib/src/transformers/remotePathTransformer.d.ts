...
import { ISetBreakpointsArgs, IAttachRequestArgs, ILaunchRequestArgs, IStackTraceResponseBody } from '../debugAdapterInterfaces';
/**
 * Converts a local path from Code to a path on the target.
 */
export declare class RemotePathTransformer extends BasePathTransformer {
    private _localRoot;
    private _remoteRoot;
