...
export declare abstract class ChromeDebugAdapter implements IDebugAdapter {
    ...
    protected onPaused(notification: Crdp.Debugger.PausedEvent, expectingStopReason?: ReasonType): Promise<void>;
    ...
    private scriptToLoadedSourceEvent(reason, script);
    ...
    fixPathCasing(str: string): string;
}
