 ...
 */
export declare function pathToFileURL(absPath: string, normalize?: boolean): string;
 ...
 */
export declare function pathToRegex(aPath: string, caseSensitive: boolean): string;
