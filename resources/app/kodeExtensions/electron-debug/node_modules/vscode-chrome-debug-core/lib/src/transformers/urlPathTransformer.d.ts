 ...
 */
export declare class UrlPathTransformer extends BasePathTransformer {
    private _webRoot;
    ...
    setBreakpoints(args: ISetBreakpointsArgs): ISetBreakpointsArgs;
    clearTargetContext(): void;
    scriptParsed(scriptUrl: string): Promise<string>;
    ...
    protected targetUrlToClientPath(webRoot: string, scriptUrl: string): Promise<string>;
}
