...
class UrlPathTransformer extends basePathTransformer_1.BasePathTransformer {
    ...
    scriptParsed(scriptUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!clientPath) {
                clientPath = yield this.targetUrlToClientPath(this._webRoot, scriptUrl);
            }
            if (!clientPath) {
                // It's expected that eval scripts (eval://) won't be resolved
                if (!scriptUrl.startsWith(ChromeUtils.EVAL_NAME_PREFIX)) {
                    vscode_debugadapter_1.logger.log(`Paths.scriptParsed: could not resolve ${scriptUrl} to a file under webRoot: ${this._webRoot}. It may be external or served directly from the server's memory (and that's OK).`);
                }
            }
            else {
                vscode_debugadapter_1.logger.log(`Paths.scriptParsed: resolved ${scriptUrl} to ${clientPath}. webRoot: ${this._webRoot}`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (source && source.path) {
                ...
                const clientPath = this.getClientPathFromTargetPath(source.path) ||
                    (yield this.targetUrlToClientPath(this._webRoot, source.path));
    ...
    targetUrlToClientPath(webRoot, scriptUrl) {
        return __awaiter(this, void 0, void 0, function* () {
