...
class BaseSourceMapTransformer {
    constructor(sourceHandles, enableSourceMapCaching) {
    ...
    init(args) {
        if (args.sourceMaps) {
            this._sourceMaps = new sourceMaps_1.SourceMaps(args.webRoot, args.sourceMapPathOverrides, this._enableSourceMapCaching);
