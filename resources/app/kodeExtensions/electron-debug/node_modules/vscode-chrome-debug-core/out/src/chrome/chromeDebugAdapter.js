...
class ChromeDebugAdapter {
    ...
    */
    ...
    onPaused(notification, expectingStopReason = this._expectingStopReason) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }).catch(err => vscode_debugadapter_1.logger.error('Problem while smart stepping: ' + (err && err.stack) ? err.stack : err));
        });
    }
    /* __GDPR__
    ...
    */
    ...
    sendLoadedSourceEvent(script, loadedSourceEventReason = 'new') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const scriptEvent = yield this.scriptToLoadedSourceEvent(loadedSourceEventReason, script);
    ...
    resolveSkipFiles(script, mappedUrl, sources, toggling) {
        return __awaiter(this, void 0, void 0, function* () {
            if (sources && sources.length) {
                ...
                const allSources = yield this.sourceMapTransformer.allSources(mappedUrl);
    ...
    */
    ...
    scriptToLoadedSourceEvent(reason, script) {
        return __awaiter(this, void 0, void 0, function* () {
            const source = yield this.scriptToSource(script);
            return new vscode_debugadapter_1.LoadedSourceEvent(reason, source);
        });
    }
