...
module.exports = function (argv) {
    ...
    program
        ...
        .action(function (_a) {
        var yarn = _a.yarn;
        return main(package_1.ls(undefined, yarn));
    });
    program
        .command('package')
        ...
        .action(function (_a) {
        var out = _a.out, baseContentUrl = _a.baseContentUrl, baseImagesUrl = _a.baseImagesUrl;
        return main(package_1.packageCommand({ packagePath: out, baseContentUrl: baseContentUrl, baseImagesUrl: baseImagesUrl }));
    });
    program
        ...
        var pat = _a.pat, packagePath = _a.packagePath, baseContentUrl = _a.baseContentUrl, baseImagesUrl = _a.baseImagesUrl;
        return main(publish_1.publish({ pat: pat, version: version, packagePath: packagePath, baseContentUrl: baseContentUrl, baseImagesUrl: baseImagesUrl }));
    });
    program
