 ...
 */
export declare function errP(msg: string | Error): Promise<any>;
/**
 ...
 */
export declare function localize(idOrInfo: any, msg: string, ...args: any[]): string;
...
export declare function trimLastNewline(msg: string): string;
