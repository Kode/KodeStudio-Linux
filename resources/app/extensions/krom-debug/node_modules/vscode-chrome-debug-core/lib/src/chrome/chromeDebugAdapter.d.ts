...
export declare abstract class ChromeDebugAdapter implements IDebugAdapter {
    ...
    disconnect(): void;
    setBreakpoints(args: ISetBreakpointsArgs, requestSeq: number): Promise<ISetBreakpointsResponseBody>;
    ...
    private chromeBreakpointResponsesToODPBreakpoints(url, responses, requestBps);
