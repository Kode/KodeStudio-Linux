...
export declare class BasePathTransformer {
    ...
    setBreakpoints(args: ISetBreakpointsArgs): void;
    clearTargetContext(): void;
    scriptParsed(scriptPath: string): string;
    breakpointResolved(bp: DebugProtocol.Breakpoint, scriptPath: string): string;
