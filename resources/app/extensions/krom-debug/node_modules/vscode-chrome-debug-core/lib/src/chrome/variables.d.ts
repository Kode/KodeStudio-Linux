...
export declare abstract class BaseVariableContainer implements IVariableContainer {
    ...
    expand(adapter: ChromeDebugAdapter, filter?: string, start?: number, count?: number): Promise<DebugProtocol.Variable[]>;
    abstract setValue(adapter: ChromeDebugAdapter, name: string, value: string): Promise<string>;
}
...
export declare function getArrayPreview(object: Crdp.Runtime.RemoteObject, context?: string): string;
export declare function getObjectPreview(object: Crdp.Runtime.RemoteObject, context?: string): string;
