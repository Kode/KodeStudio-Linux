...
class TypeScriptVersion {
    ...
    get version() {
        ...
        if (tsdkVersion) {
            return new api_1.default(tsdkVersion);
        }
        return undefined;
    }
    get versionString() {
    ...
    getTypeScriptVersion(serverPath) {
        ...
        return desc.version ? new api_1.default(desc.version) : undefined;
    }
}
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/0eb40ad2cd45f7b02b138b1a4090966905ed0fec/extensions/typescript/out/utils/versionProvider.js.map
