...
vshaxe_Main.prototype = {
	...
	,startLanguageServer: function() {
		...
		var client = new LanguageClient("Haxe",serverOptions,clientOptions2);
		client.onNotification({ method : "vshaxe/log"},$bind(this,this.log));
		client.onReady().then(function(_) {
			var message = "Haxe language server started with Kha at " + vshaxe_Main.findKha() + "\n";
			_gthis.vshaxeChannel.append(message);
