...
export declare function getStackTraceResponseBody(aPath: string, locations: DebugProtocol.SourceBreakpoint[], sourceReferences?: number[]): IStackTraceResponseBody;
/**
 ...
 */
export declare function registerMockGetURL(utilsRelativePath: string, url: string, contents: string, utilsMock?: Mock<typeof utils>, isError?: boolean): void;
export declare function registerMockGetURLFail(utilsRelativePath: string, url: string, failContents?: string, utilsMock?: Mock<typeof utils>): void;
/**
 * Returns a promise that is resolved if the given promise is rejected, and is rejected if the given
 * promise is resolved
 */
export declare function assertPromiseRejected(promise: Promise<any>): Promise<any>;
export declare function assertFail(msg: string): void;
