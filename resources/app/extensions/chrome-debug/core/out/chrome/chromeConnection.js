...
var ChromeConnection = (function () {
    ...
    ChromeConnection.prototype._attach = function (address, port, targetUrl) {
        var _this = this;
        return utils.retryAsync(function () { return _this._targetDiscoveryStrategy(address, port, _this._targetFilter, targetUrl); }, /*timeoutMs=*/ 7000, /*intervalDelay=*/ 200)
