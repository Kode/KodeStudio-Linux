...
exports.DefaultWebsourceMapPathOverrides = {
    'webpack:///*': '${webRoot}/*',
    'meteor://💻app/*': '${webRoot}/*'
};
/**
...
var SourceMapTransformer = (function () {
    ...
    SourceMapTransformer.prototype.init = function (args) {
        if (args.sourceMaps) {
            this._sourceMaps = new sourceMaps_1.SourceMaps(args.webRoot, args.sourceMapPathOverrides || exports.DefaultWebsourceMapPathOverrides);
            ...
            if (_this._sourceMaps && args.source.path) {
                ...
                if (mappedPath_1) {
                    ...
                    var mappedLines = args.lines.map(function (line, i) {
                        ...
                        if (mapped) {
                            logger.log("SourceMaps.setBP: Mapped " + argsPath_1 + ":" + (line + 1) + ":1 to " + mappedPath_1 + ":" + (mapped.line + 1) + ":" + (mapped.column + 1));
