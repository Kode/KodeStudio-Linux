...
var ChromeDebugSession = (function (_super) {
    ...
    function ChromeDebugSession(targetLinesStartAt1, isServer, opts) {
        ...
        var connection = new chromeConnection_1.ChromeConnection(opts.targetFilter);
        var adapter = opts.adapter || new chromeDebugAdapter_1.ChromeDebugAdapter(connection);
        var logFileDirectory = opts.logFileDirectory;
        logger.init(function (msg, level) { return _this.onLog(msg, level); }, logFileDirectory);
        logVersionInfo();
