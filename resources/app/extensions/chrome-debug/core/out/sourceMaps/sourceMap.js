...
var SourceMap = (function () {
     ...
     */
    function SourceMap(generatedPath, json, webRoot, sourceMapPathOverrides) {
        var _this = this;
        ...
        // Absolute path
        var computedSourceRoot = sourceMapUtils.getComputedSourceRoot(sm.sourceRoot, this._generatedPath, webRoot);
        ...
        var origSourceRoot = sm.sourceRoot;
        sm.sourceRoot = null;
        ...
        this._sources = sm.sources.map(function (sourcePath) {
            if (sourceMapPathOverrides) {
                var fullSourceEntry = origSourceRoot ? (origSourceRoot + sourcePath) : sourcePath;
                var mappedFullSourceEntry = sourceMapUtils.applySourceMapPathOverrides(fullSourceEntry, sourceMapPathOverrides);
