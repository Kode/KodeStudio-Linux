...
import { RequestType, RequestType0, RequestHandler, RequestHandler0, GenericRequestHandler, NotificationType, NotificationType0, NotificationHandler, NotificationHandler0, GenericNotificationHandler, ResponseError, ErrorCodes, MessageReader, DataCallback, StreamMessageReader, IPCMessageReader, MessageWriter, StreamMessageWriter, IPCMessageWriter, CancellationToken, Disposable, Event } from 'vscode-jsonrpc';
...
export declare class TextDocuments {
     ...
     */
    onWillSaveWaitUntil: RequestHandler<TextDocumentWillSaveEvent, TextEdit[], void>;
    /**
     * An event that fires when a text document managed by this manager
     * has been saved.
     */
