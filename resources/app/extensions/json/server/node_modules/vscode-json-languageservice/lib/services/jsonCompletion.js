                ...
                if (s.node === node && !s.inverted) {
                    ...
                    if (schemaProperties_1) {
                        Object.keys(schemaProperties_1).forEach(function (key) {
                            ...
                            collector.add({ kind: 10 /* Property */, label: key, insertText: _this.getTextForProperty(key, propertySchema, addValue, isLast), documentation: propertySchema.description || '' });
                        });
                    }
                }
            });
        ...
        JSONCompletion.prototype.getSchemaLessPropertySuggestions = function (doc, node, currentKey, currentWord, isLast, collector) {
            ...
            var collectSuggestionsForSimilarObject = function (obj) {
                obj.properties.forEach(function (p) {
                    var key = p.key.value;
                    collector.add({ kind: 10 /* Property */, label: key, insertText: _this.getTextForSimilarProperty(key, p.value), documentation: '' });
                });
            };
            if (node.parent) {
            ...
            if (!currentKey && currentWord.length > 0) {
                collector.add({ kind: 10 /* Property */, label: this.getLabelForValue(currentWord), insertText: this.getTextForProperty(currentWord, null, true, isLast), documentation: '' });
            }
        };
