(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '../parser/cssNodes', '../parser/cssSymbolScope', './languageFacts', '../utils/strings'], factory);
    }
    ...
    var CSSCompletion = (function () {
        ...
        CSSCompletion.prototype.getCompletionsForDeclarationProperty = function (result) {
            return this.getPropertyProposals(result);
        };
        CSSCompletion.prototype.getPropertyProposals = function (result) {
        ...
        CSSCompletion.prototype.getValueEnumProposals = function (entry, result) {
            if (entry.values) {
        ...
        CSSCompletion.prototype.getCSSWideKeywordProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getVariableProposals = function (result) {
        ...
        CSSCompletion.prototype.getUnitProposals = function (entry, result) {
            var currentWord = '0';
        ...
        CSSCompletion.prototype.getColorProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getPositionProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getRepeatStyleProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getLineProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getBoxProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getImageProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getTimingFunctionProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getBasicShapeProposals = function (entry, result) {
        ...
        CSSCompletion.prototype.getTermProposals = function (result) {
            ...
            allFunctions.forEach(function (functionSymbol) {
                if (functionSymbol.node instanceof nodes.FunctionDeclaration) {
                    ...
                    result.items.push({
                        ...
                        insertText: functionSymbol.name + '(' + params.map(function (p) { return '{{' + p + '}}'; }).join(', ') + ')',
                        kind: 3 /* Function */
                    });
                }
            });
