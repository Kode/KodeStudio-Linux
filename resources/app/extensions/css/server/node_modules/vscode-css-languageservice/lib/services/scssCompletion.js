...
(function (factory) {
    ...
    var SCSSCompletion = (function (_super) {
        ...
        SCSSCompletion.prototype.createFunctionProposals = function (proposals, result) {
        ...
        SCSSCompletion.prototype.getTermProposals = function (result) {
            this.createFunctionProposals(SCSSCompletion.builtInFuncs, result);
            return _super.prototype.getTermProposals.call(this, result);
        };
        SCSSCompletion.prototype.getColorProposals = function (entry, result) {
        ...
        SCSSCompletion.prototype.getCompletionsForDeclarationProperty = function (result) {
